...
`C` and `{m B hB C _}`. -/
/-
**Cardinal.SharplyLT.existsIsCardinalFilteredSetOfExistsCofinal.** 是 Mathlib 中的一
个定义，位于命名空间 `Cardinal.SharplyLT.existsIsCardinalFilteredSetOfExistsCofinal`。
...
include hY' hm in
/-
**Cardinal.SharplyLT.existsIsCardinalFilteredSetOfExistsCofinal.h** 是 Mathlib 中的
一个引理，位于命名空间 `Cardinal.SharplyLT.existsIsCardinalFilteredSetOfExistsCofinal`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Cardinal.SharplyLT.existsIsCardinalFilteredSetOfExistsCofinal.** 是 Mathlib 中的一
个引理，位于命名空间 `Cardinal.SharplyLT.existsIsCardinalFilteredSetOfExistsCofinal`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Cardinal.SharplyLT.existsIsCardinalFilteredSetOfExistsCofinal.le_** 是 Mathlib 
中的一个引理，位于命名空间 `Cardinal.SharplyLT.existsIsCardinalFilteredSetOfExistsCofinal`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Cardinal.SharplyLT.existsIsCardinalFilteredSetOfExistsCofinal.hasCardinalLT_tr
ansfiniteIterate_** 是 Mathlib 中的一个引理，位于命名空间 `Cardinal.SharplyLT.existsIsCardinal
FilteredSetOfExistsCofinal`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
omit [Fact κ₂.IsRegular] [PartialOrder X] in
/-
**Cardinal.SharplyLT.existsIsCardinalFilteredSetOfExistsCofinal.monotone_transfi
niteIterate_** 是 Mathlib 中的一个引理，位于命名空间 `Cardinal.SharplyLT.existsIsCardinalFilte
redSetOfExistsCofinal`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Cardinal.SharplyLT.existsIsCardinalFilteredSetOfExistsCofinal.subset_iUnion** 
是 Mathlib 中的一个引理，位于命名空间 `Cardinal.SharplyLT.existsIsCardinalFilteredSetOfExistsC
ofinal`。
形式化陈述：subset_iUnion : A subseteq ⋃ (j : κ₁.ord.ToType), transfiniteIterate (φ Y 
m) j A
该定理/引理描述了相关对象所满足的性质。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Cardinal.SharplyLT.existsIsCardinalFilteredSetOfExistsCofinal.isCardinalFilter
ed_iUnion** 是 Mathlib 中的一个引理，位于命名空间 `Cardinal.SharplyLT.existsIsCardinalFiltered
SetOfExistsCofinal`。
形式化陈述：isCardinalFiltered_iUnion : IsCardinalFiltered (⋃ (j : κ₁.ord.ToType), tra
nsfiniteIterate (φ Y m) j A) κ₁
该定理/引理描述了相关对象所满足的性质。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
