...
(natCast_eq_natCast_iff _ _ 2).1 sub_eq_zero.1 by
    simpa [add_left_comm, sub_eq_add_neg, ← mul_sum, mul_comm, ha2, Nat.cast_sum,
      ...
      Eq.symm (eisenstein_lemma_aux₁ p ha
...
theorem eisenstein_lemma
  ...
  rw [neg_one_pow_eq_pow_mod_two]; rw [gauss_lemma hp ha0']; rw [neg_one_pow_eq_pow_mod_two]; rw [(by norm_cast : ((a : Int) : ZMod p) = (a : ZMod p))];
