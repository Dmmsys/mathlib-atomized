...
@[simp]
/--
lemma `toLinearEquiv_continuousLinearEquiv` / 引理 `toLinearEquiv_continuousLinearEquiv`

English:
lemma toLinearEquiv_continuousLinearEquiv
  given: (e : α ≃ β)
  proof: e.topologicalSpace
    letI := e.addCommMonoid
    letI := e.module R
    (e.continuousLinearEquiv R).toLinearEquiv = e.linearEquiv R := rfl

中文:
引理 toLinearEquiv_continuousLinearEquiv
  条件: (e : α ≃ β)
  证明: e.topologicalSpace
    letI := e.addCommMonoid
    letI := e.module R
    (e.continuousLinearEquiv R).toLinearEquiv = e.linearEquiv R := rfl
...
then so is `α`. -/]
/--
lemma `ContinuousMulEquiv.isTopologicalGroup` / 引理 `ContinuousMulEquiv.isTopologicalGroup`
...
/--
lemma `ContinuousLinearEquiv.continuousSMul` / 引理 `ContinuousLinearEquiv.continuousSMul`
...
Depends on / 依赖: Continuous, e.symm, fun_prop, this.congr
-/
lemma ContinuousLinearEquiv.continuousSMul
...
@[simps!]
/--
Definition of `Shrink.continuousLinearEquiv` / `Shrink.continuousLinearEquiv` 的定义

English:
definition Shrink.continuousLinearEquiv
  body: (equivShrink α).symm.continuousLinearEquiv R

中文:
定义 Shrink.continuousLinearEquiv
  定义体: (equivShrink α).symm.continuousLinearEquiv R

Depends on / 依赖: continuousLinearEquiv, equivShrink, symm.continuousLinearEquiv
-/
