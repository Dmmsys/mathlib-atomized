...
include G in
/--
lemma `Algebra.IsInvariant.isIntegral_of_profinite` / 引理 `Algebra.IsInvariant.isIntegral_of_profinite`
...
/--
lemma `Algebra.IsInvariant.exists_smul_of_under_eq_of_profinite` / 引理 `Algebra.IsInvariant.exists_smul_of_under_eq_of_profinite`
...
/--
lemma `Ideal.Quotient.stabilizerHomSurjectiveAuxFunctor_aux` / 引理 `Ideal.Quotient.stabilizerHomSurjectiveAuxFunctor_aux`
...
lemma Ideal.Quotient.stabilizerHomSurjectiveAuxFunctor_aux
    ...
    (x : G ⧸ N.1.1)
    (hx : x in MulAction.stabilizer (G ⧸ N.1.1) (Q.under (FixedPoints.subalgebra A B N.1.1))) :
    QuotientGroup.map _ _ (.id _) e x in
...
/--
Definition of `Ideal.Quotient.stabilizerHomSurjectiveAuxFunctor` / `Ideal.Quotient.stabilizerHomSurjectiveAuxFunctor` 的定义

English:
definition Ideal.Quotient.stabilizerHomSurjectiveAuxFunctor
  body: letI B' := FixedPoints.subalgebra A B N.1.1
...
/--
theorem `Ideal.Quotient.stabilizerHom_surjective_of_profinite` / 定理 `Ideal.Quotient.stabilizerHom_surjective_of_profinite`
