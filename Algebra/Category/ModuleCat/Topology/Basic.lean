...
/-
**TopModuleCat** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：(R : Type u) → [Ring R] → [TopologicalSpace R] → Type (max u (v + 1))
参数：v + 1。
...
/-
**TopModuleCat.** 是 Mathlib 中的一个实例，位于命名空间 `TopModuleCat`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**TopModuleCat.of** 是 Mathlib 中的一个缩写定义，位于命名空间 `TopModuleCat`。
形式化陈述：of (M : Type v) [AddCommGroup M] [Module R M] [TopologicalSpace M] [Contin
uousAdd M] [ContinuousSMul R M] : TopModuleCat R
参数：M : Type v。
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
abbrev of (M : Type v) [AddCommGroup M] [Module R M] [TopologicalSpace M] [ContinuousAdd M]
  ...
  ⟨.of R M⟩
/-
**TopModuleCat.coe_of** 是 Mathlib 中的一个引理，位于命名空间 `TopModuleCat`。
形式化陈述：coe_of (M : Type v) [AddCommGroup M] [Module R M] [TopologicalSpace M] [Co
ntinuousAdd M] [ContinuousSMul R M] : (of R M) = M
参数：M : Type v。
该定理/引理给出了一组等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**TopModuleCat.Hom** 是 Mathlib 中的一个归纳类型，位于命名空间 `TopModuleCat`。
形式化陈述：{R : Type u} → [inst : Ring R] → [inst_1 : TopologicalSpace R] → TopModule
Cat R → TopModuleCat R → Type v
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**TopModuleCat.Hom.hom** 是 Mathlib 中的一个定义，位于命名空间 `TopModuleCat.Hom`。
形式化陈述：{R : Type u} →   [inst : Ring R] →     [inst_1 : TopologicalSpace R] → {X 
Y : TopModuleCat R} → X.Hom Y → ↑X.toModuleCat →L[R] ↑Y.toModuleCat
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**TopModuleCat.ofHom** 是 Mathlib 中的一个缩写定义，位于命名空间 `TopModuleCat`。
形式化陈述：ofHom {X Y : Type v} [AddCommGroup X] [Module R X] [TopologicalSpace X] [C
ontinuousAdd X] [ContinuousSMul R X] [AddCommGroup Y] [Module R Y] [TopologicalS
pace Y] [ContinuousAdd Y] [ContinuousSMul R Y] (f : X ->L[R] Y) : of R X ⟶ of R 
Y
参数：f : X ->L[R] Y。
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**TopModuleCat.hom_ofHom** 是 Mathlib 中的一个定理，位于命名空间 `TopModuleCat`。
形式化陈述：∀ (R : Type u) [inst : Ring R] [inst_1 : TopologicalSpace R] {X Y : Type v
} [inst_2 : AddCommGroup X]   [inst_3 : _root_.Module R X] [inst_4 : Topological
Space X] [inst_5 : ContinuousAdd X] [inst_6 : ContinuousSMul R X]   [inst_7 : Ad
dCommGroup Y] [inst_8 : _root_.Module R Y] [inst_9 : TopologicalSpace Y] [inst_1
0 : ContinuousAdd Y]   [inst_11 : ContinuousSMul R Y] (f : X →L[R] Y), TopModule
Cat.Hom.hom (TopModuleCat.ofHom f) = f
参数：R : Type u；f : X →L[R] Y；TopModuleCat.ofHom f。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
@[simp] lemma hom_ofHom {X Y : Type v}
    ...
    (ofHom f).hom = f := rfl
/-
**TopModuleCat.ofHom_hom** 是 Mathlib 中的一个定理，位于命名空间 `TopModuleCat`。
形式化陈述：∀ (R : Type u) [inst : Ring R] [inst_1 : TopologicalSpace R] {X Y : TopMod
uleCat R} (f : X.Hom Y),   TopModuleCat.ofHom f.hom = f
参数：R : Type u；f : X.Hom Y。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `IsTopologicalAddGroup.toContinuousAdd`：∀ {G : Type u} {inst : Topologica
lSpace G} {inst_1 : AddGroup G} [self : IsTopologicalAddGroup G], ContinuousAdd 
G
· 使用定理 `TopModuleCat.isTopologicalAddGroup`：∀ {R : Type u} [inst : Ring R] [inst
_1 : TopologicalSpace R] (self : TopModuleCat R),   IsTopologicalAddGroup ↑self.
toModuleCat
· 使用定理 `TopModuleCat.continuousSMul`：∀ {R : Type u} [inst : Ring R] [inst_1 : To
pologicalSpace R] (self : TopModuleCat R), ContinuousSMul R ↑self.toModuleCat
-/
@[simp] lemma ofHom_hom {X Y : TopModuleCat R} (f : X.Hom Y) : ofHom f.hom = f := rfl
/-
**TopModuleCat.hom_comp** 是 Mathlib 中的一个定理，位于命名空间 `TopModuleCat`。
形式化陈述：∀ (R : Type u) [inst : Ring R] [inst_1 : TopologicalSpace R] {X Y Z : TopM
oduleCat R} (f : X ⟶ Y) (g : Y ⟶ Z),   TopModuleCat.Hom.hom (CategoryTheory.Cate
goryStruct.comp f g) = TopModuleCat.Hom.hom g ∘SL TopModuleCat.Hom.hom f
参数：R : Type u；f : X ⟶ Y；g : Y ⟶ Z；CategoryTheory.CategoryStruct.comp f g。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
@[simp] lemma hom_comp {X Y Z : TopModuleCat R} (f : X ⟶ Y) (g : Y ⟶ Z) :
    (f ≫ g).hom = g.hom.comp f.hom := rfl
/-
**TopModuleCat.hom_id** 是 Mathlib 中的一个定理，位于命名空间 `TopModuleCat`。
形式化陈述：∀ (R : Type u) [inst : Ring R] [inst_1 : TopologicalSpace R] (X : TopModul
eCat R),   CategoryTheory.ConcreteCategory.hom (CategoryTheory.CategoryStruct.id
 X) = ContinuousLinearMap.id R ↑X.toModuleCat
参数：R : Type u；X : TopModuleCat R；CategoryTheory.CategoryStruct.id X。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**TopModuleCat.Hom.Simps.hom** 是 Mathlib 中的一个定义，位于命名空间 `TopModuleCat.Hom.Simps`。
形式化陈述：(R : Type u) →   [inst : Ring R] →     [inst_1 : TopologicalSpace R] → (A 
B : TopModuleCat R) → A.Hom B → ↑A.toModuleCat →L[R] ↑B.toModuleCat
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**TopModuleCat.ofIso** 是 Mathlib 中的一个定义，位于命名空间 `TopModuleCat`。
形式化陈述：ofIso {X Y : TopModuleCat R} (e : X ≃L[R] Y) : X ≅ Y
参数：e : X ≃L[R] Y。
该定义给出了上述对象。
...
/-
**TopModuleCat._root_.CategoryTheory.Iso.toContinuousLinearEquiv** 是 Mathlib 中的一
个定义，位于命名空间 `TopModuleCat`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**TopModuleCat.hom_zero** 是 Mathlib 中的一个定理，位于命名空间 `TopModuleCat`。
形式化陈述：∀ (R : Type u) [inst : Ring R] [inst_1 : TopologicalSpace R] {M₁ M₂ : TopM
oduleCat R}, TopModuleCat.Hom.hom 0 = 0
参数：R : Type u。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
@[simp] lemma hom_zero : (0 : M₁ ⟶ M₂).hom = 0 := rfl
/-
**TopModuleCat.hom_zero_apply** 是 Mathlib 中的一个引理，位于命名空间 `TopModuleCat`。
形式化陈述：hom_zero_apply (m : M₁) : (0 : M₁ ⟶ M₂).hom m = 0
参数：m : M₁。
该定理/引理给出了一组等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**TopModuleCat.hom_add** 是 Mathlib 中的一个定理，位于命名空间 `TopModuleCat`。
形式化陈述：∀ (R : Type u) [inst : Ring R] [inst_1 : TopologicalSpace R] {M₁ M₂ : TopM
oduleCat R} (φ₁ φ₂ : M₁ ⟶ M₂),   TopModuleCat.Hom.hom (φ₁ + φ₂) = TopModuleCat.H
om.hom φ₁ + TopModuleCat.Hom.hom φ₂
参数：R : Type u；φ₁ φ₂ : M₁ ⟶ M₂；φ₁ + φ₂。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
@[simp] lemma hom_add (φ₁ φ₂ : M₁ ⟶ M₂) : (φ₁ + φ₂).hom = φ₁.hom + φ₂.hom := rfl
/-
**TopModuleCat.hom_neg** 是 Mathlib 中的一个定理，位于命名空间 `TopModuleCat`。
形式化陈述：∀ (R : Type u) [inst : Ring R] [inst_1 : TopologicalSpace R] {M₁ M₂ : TopM
oduleCat R} (φ : M₁ ⟶ M₂),   TopModuleCat.Hom.hom (-φ) = -TopModuleCat.Hom.hom φ
参数：R : Type u；φ : M₁ ⟶ M₂；-φ。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
@[simp] lemma hom_neg (φ : M₁ ⟶ M₂) : (-φ).hom = -φ.hom := rfl
/-
**TopModuleCat.hom_sub** 是 Mathlib 中的一个定理，位于命名空间 `TopModuleCat`。
形式化陈述：∀ (R : Type u) [inst : Ring R] [inst_1 : TopologicalSpace R] {M₁ M₂ : TopM
oduleCat R} (φ₁ φ₂ : M₁ ⟶ M₂),   TopModuleCat.Hom.hom (φ₁ - φ₂) = TopModuleCat.H
om.hom φ₁ - TopModuleCat.Hom.hom φ₂
参数：R : Type u；φ₁ φ₂ : M₁ ⟶ M₂；φ₁ - φ₂。
...
/-
**TopModuleCat.hom_nsmul** 是 Mathlib 中的一个定理，位于命名空间 `TopModuleCat`。
形式化陈述：∀ (R : Type u) [inst : Ring R] [inst_1 : TopologicalSpace R] {M₁ M₂ : TopM
oduleCat R} (n : ℕ) (φ : M₁ ⟶ M₂),   TopModuleCat.Hom.hom (n • φ) = n • TopModul
eCat.Hom.hom φ
参数：R : Type u；n : ℕ；φ : M₁ ⟶ M₂；n • φ。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
@[simp] lemma hom_nsmul (n : ℕ) (φ : M₁ ⟶ M₂) : (n • φ).hom = n • φ.hom := rfl
/-
**TopModuleCat.hom_zsmul** 是 Mathlib 中的一个定理，位于命名空间 `TopModuleCat`。
形式化陈述：∀ (R : Type u) [inst : Ring R] [inst_1 : TopologicalSpace R] {M₁ M₂ : TopM
oduleCat R} (n : ℤ) (φ : M₁ ⟶ M₂),   TopModuleCat.Hom.hom (n • φ) = n • TopModul
eCat.Hom.hom φ
参数：R : Type u；n : ℤ；φ : M₁ ⟶ M₂；n • φ。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**TopModuleCat.hom_smul** 是 Mathlib 中的一个引理，位于命名空间 `TopModuleCat`。
形式化陈述：hom_smul {M₁ M₂ : TopModuleCat S} (s : S) (φ : M₁ ⟶ M₂) : (s • φ).hom = s 
• φ.hom
参数：s : S；φ : M₁ ⟶ M₂。
该定理/引理给出了一组等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
@[simp]
/-
**TopModuleCat.hom_forget** 是 Mathlib 中的一个引理，位于命名空间 `TopModuleCat`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**TopModuleCat.forget** 是 Mathlib 中的一个引理，位于命名空间 `TopModuleCat`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**TopModuleCat.coinduced** 是 Mathlib 中的一个定义，位于命名空间 `TopModuleCat`。
形式化陈述：coinduced : TopModuleCat R
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
The coinduced topology on `M` from a family of continuous linear maps into `M`, 
which is the
finest topology that makes it into a topological module and makes every map cont
inuous.
-/
...
/-
**TopModuleCat.toCoinduced** 是 Mathlib 中的一个定义，位于命名空间 `TopModuleCat`。
形式化陈述：toCoinduced (i) : X i ⟶ coinduced f
参数：i。
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**TopModuleCat.ofCocone** 是 Mathlib 中的一个定义，位于命名空间 `TopModuleCat`。
形式化陈述：ofCocone {J : Type*} [Category* J] {F : J ⥤ TopModuleCat R} (c : Cocone (F
 ⋙ forget₂ _ (ModuleCat R))) : Cocone F where pt
参数：c : Cocone (F ⋙ forget₂ _ (ModuleCat R))。
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
The cocone of topological modules associated to a cocone over the underlying mod
ules, where
the cocone point is given the coinduced topology. This is colimiting when the gi
ven cocone is.
-/
...
/-
**TopModuleCat.isColimit** 是 Mathlib 中的一个定义，位于命名空间 `TopModuleCat`。
形式化陈述：isColimit {J : Type*} [Category* J] {F : J ⥤ TopModuleCat R} {c : Cocone (
F ⋙ forget₂ _ (ModuleCat R))} (hc : IsColimit c) : IsColimit (ofCocone c) where 
desc s
参数：F ⋙ forget₂ _ (ModuleCat R)；hc : IsColimit c。
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
Given a colimit cocone over the underlying modules, equipping the cocone point w
ith
the coinduced topology gives a colimit cocone in `TopModuleCat R`.
-/
...
/-
**TopModuleCat.induced** 是 Mathlib 中的一个定义，位于命名空间 `TopModuleCat`。
形式化陈述：induced : TopModuleCat R
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
The induced topology on `M` from a family of continuous linear maps from `M`, wh
ich is the
coarsest topology that makes every map continuous.
-/
...
/-
**TopModuleCat.fromInduced** 是 Mathlib 中的一个定义，位于命名空间 `TopModuleCat`。
形式化陈述：fromInduced (i) : induced f ⟶ X i
参数：i。
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**TopModuleCat.ofCone** 是 Mathlib 中的一个定义，位于命名空间 `TopModuleCat`。
形式化陈述：ofCone {J : Type*} [Category* J] {F : J ⥤ TopModuleCat R} (c : Cone (F ⋙ f
orget₂ _ (ModuleCat R))) : Cone F where pt
参数：c : Cone (F ⋙ forget₂ _ (ModuleCat R))。
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
The cone of topological modules associated to a cone over the underlying modules
, where
the cone point is given the induced topology. This is limiting when the given co
ne is.
-/
...
/-
**TopModuleCat.isLimit** 是 Mathlib 中的一个定义，位于命名空间 `TopModuleCat`。
形式化陈述：isLimit {J : Type*} [Category* J] {F : J ⥤ TopModuleCat R} {c : Cone (F ⋙ 
forget₂ _ (ModuleCat R))} (hc : IsLimit c) : IsLimit (ofCone c) where lift s
参数：F ⋙ forget₂ _ (ModuleCat R)；hc : IsLimit c。
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
def isLimit {J : Type*} [Category* J] {F : J ⥤ TopModuleCat R}
  ...
  uniq s m H := by
    ...
    exact congr($(H j).hom y)
/-
**TopModuleCat.hasLimit_of_hasLimit_forget** 是 Mathlib 中的一个实例，位于命名空间 `TopModuleC
at`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**TopModuleCat.withModuleTopology** 是 Mathlib 中的一个定义，位于命名空间 `TopModuleCat`。
形式化陈述：withModuleTopology : ModuleCat R ⥤ TopModuleCat R where obj X
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
The functor equipping a module over a topological ring with the finest possible
topology making it into a topological module. This is left adjoint to the forget
ful functor.
-/
...
/-
**TopModuleCat.withModuleTopologyAdj** 是 Mathlib 中的一个定义，位于命名空间 `TopModuleCat`。
形式化陈述：withModuleTopologyAdj : withModuleTopology R ⊣ forget₂ (TopModuleCat R) (M
oduleCat R) where unit
该定义给出了上述对象。
本定义的构造引用了以下数学事实（定理与引理）：
· 使用定理 `TopModuleCat.continuousSMul`：∀ {R : Type u} [inst : Ring R] [inst_1 : To
pologicalSpace R] (self : TopModuleCat R), ContinuousSMul R ↑self.toModuleCat
...
/-
**TopModuleCat.indiscrete** 是 Mathlib 中的一个定义，位于命名空间 `TopModuleCat`。
形式化陈述：indiscrete : ModuleCat.{v} R ⥤ TopModuleCat.{v} R where obj X
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**TopModuleCat.indiscreteAdj** 是 Mathlib 中的一个定义，位于命名空间 `TopModuleCat`。
形式化陈述：indiscreteAdj : forget₂ (TopModuleCat.{v} R) (ModuleCat.{v} R) ⊣ indiscret
e.{v} R where counit
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
noncomputable
/-
**TopModuleCat.freeObj** 是 Mathlib 中的一个定义，位于命名空间 `TopModuleCat`。
形式化陈述：freeObj (X : TopCat.{v}) : TopModuleCat.{max v u} R
参数：X : TopCat.{v}。
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
def freeObj (X : TopCat.{v}) : TopModuleCat.{max v u} R :=
  ...
  of R (X →₀ R)
/-
**TopModuleCat.coe_freeObj** 是 Mathlib 中的一个引理，位于命名空间 `TopModuleCat`。
形式化陈述：coe_freeObj (X : TopCat.{v}) : freeObj R X = (X ->₀ R)
参数：X : TopCat.{v}。
该定理/引理给出了一组等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
noncomputable
/-
**TopModuleCat.freeMap** 是 Mathlib 中的一个定义，位于命名空间 `TopModuleCat`。
形式化陈述：freeMap {X Y : TopCat.{v}} (f : X ⟶ Y) : freeObj R X ⟶ freeObj R Y
参数：f : X ⟶ Y。
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
def freeMap {X Y : TopCat.{v}} (f : X ⟶ Y) : freeObj R X ⟶ freeObj R Y :=
  ConcreteCategory.ofHom ⟨Finsupp.lmapDomain _ _ f.hom, by
    ...
    simp [coe_freeObj]⟩
/-
**TopModuleCat.freeMap_map** 是 Mathlib 中的一个引理，位于命名空间 `TopModuleCat`。
形式化陈述：freeMap_map {X Y : TopCat.{v}} (f : X ⟶ Y) (v : X ->₀ R) : (freeMap R f : 
(X ->₀ R) -> (Y ->₀ R)) v = Finsupp.mapDomain f.hom v
参数：f : X ⟶ Y；v : X ->₀ R。
该定理/引理给出了一组等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simps] noncomputable
/-
**TopModuleCat.free** 是 Mathlib 中的一个定义，位于命名空间 `TopModuleCat`。
形式化陈述：free : TopCat.{v} ⥤ TopModuleCat.{max v u} R
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
noncomputable
/-
**TopModuleCat.freeAdj** 是 Mathlib 中的一个定义，位于命名空间 `TopModuleCat`。
形式化陈述：freeAdj : free.{max v u} R ⊣ forget₂ (TopModuleCat.{max v u} R) TopCat.{ma
x v u} where unit
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simps]
/-
**TopModuleCat.endRingEquiv** 是 Mathlib 中的一个定义，位于命名空间 `TopModuleCat`。
形式化陈述：endRingEquiv (M : TopModuleCat R) : End M ≃+* (M ->L[R] M) where toFun
参数：M : TopModuleCat R。
该定义给出了上述对象。
本定义的构造引用了以下数学事实（定理与引理）：
· 使用定理 `TopModuleCat.continuousSMul`：∀ {R : Type u} [inst : Ring R] [inst_1 : To
...
--- 原说明 ---
The ring isomorphism between the endomorphisms of an object `M` in `TopModuleCat
 R` and the
continuous `R`-linear endomorphisms of `M`.
-/
