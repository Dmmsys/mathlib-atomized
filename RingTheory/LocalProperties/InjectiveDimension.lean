...
English:
instance [Small.{v}
  signature: R] [IsNoetherianRing R] (S
  body: by
...
Depends on / 依赖: Localization, Localization.mkHom_surjective, Module, Module.injective_iff_injective_object, Module.injective_of_isLocalizedModule, ModuleCat, ModuleCat.localizedModuleFunctor, X.localizedModuleMkLinearMap, injective_iff_injective_object, injective_of_isLocalizedModule, localizedModuleFunctor, localizedModuleMkLinearMap, mkHom_surjective, small_of_surjective
-/
...
/--
lemma `localizedModule_hasInjectiveDimensionLE` / 引理 `localizedModule_hasInjectiveDimensionLE`

English:
lemma localizedModule_hasInjectiveDimensionLE
  statement: [Small.{v, u} R] [IsNoetherianRing R] (n : Nat)
  proof: by
...
-/
lemma localizedModule_hasInjectiveDimensionLE [Small.{v, u} R] [IsNoetherianRing R] (n : Nat)
...
open Limits in
/--
lemma `injectiveDimension_le_injectiveDimension_of_isLocalizedModule` / 引理 `injectiveDimension_le_injectiveDimension_of_isLocalizedModule`

English:
lemma injectiveDimension_le_injectiveDimension_of_isLocalizedModule
  statement: [Small.{v, u} R]
  proof: by
  have aux (n : Nat) : injectiveDimension M <= n -> injectiveDimension (M.localizedModule S) <= n := by
...
/--
lemma `hasInjectiveDimensionLE_iff_forall_maximalSpectrum` / 引理 `hasInjectiveDimensionLE_iff_forall_maximalSpectrum`

English:
lemma hasInjectiveDimensionLE_iff_forall_maximalSpectrum
  statement: [Small.{v, u} R] [IsNoetherianRing R]
  proof: by
  induction n generalizing M with
  | zero =>
    simp only [HasInjectiveDimensionLE, zero_add, ← injective_iff_hasInjectiveDimensionLT_one]
...
lemma hasInjectiveDimensionLE_iff_forall_maximalSpectrum [Small.{v, u} R] [IsNoetherianRing R]
    (n : Nat) (M : ModuleCat.{v} R) : HasInjectiveDimensionLE M n ↔
    forall (m : MaximalSpectrum R), HasInjectiveDimensionLE (M.localizedModule m.1.primeCompl) n := by
  induction n generalizing M with
  | zero =>
    simp only [HasInjectiveDimensionLE, zero_add, ← injective_iff_hasInjectiveDimensionLT_one]
    refine ⟨fun h m => ?_, fun h => ?_⟩
...
/--
lemma `hasInjectiveDimensionLE_iff_forall_primeSpectrum` / 引理 `hasInjectiveDimensionLE_iff_forall_primeSpectrum`

English:
lemma hasInjectiveDimensionLE_iff_forall_primeSpectrum
  statement: [Small.{v, u} R] [IsNoetherianRing R]
  proof: ⟨fun _ p => M.localizedModule_hasInjectiveDimensionLE n p.1.primeCompl,
...
Depends on / 依赖: Ideal.IsMaximal.isPrime, IsMaximal, M.hasInjectiveDimensionLE_iff_forall_maximalSpectrum, M.localizedModule_hasInjectiveDimensionLE, Monoid, SMulCommClass, SMulCommClass.continuousConstSMul, continuousConstSMul, hasInjectiveDimensionLE_iff_forall_maximalSpectrum, isPrime, localizedModule_hasInjectiveDimensionLE, primeCompl
-/
lemma hasInjectiveDimensionLE_iff_forall_primeSpectrum [Small.{v, u} R] [IsNoetherianRing R]
    (n : Nat) (M : ModuleCat.{v} R) : HasInjectiveDimensionLE M n ↔
    forall (p : PrimeSpectrum R), HasInjectiveDimensionLE (M.localizedModule p.1.primeCompl) n :=
  ⟨fun _ p => M.localizedModule_hasInjectiveDimensionLE n p.1.primeCompl,
    fun h => (M.hasInjectiveDimensionLE_iff_forall_maximalSpectrum n).mpr
    fun m => h ⟨m.1, Ideal.IsMaximal.isPrime' m.1⟩⟩

/--
lemma `injectiveDimension_eq_iSup_localizedModule_prime` / 引理 `injectiveDimension_eq_iSup_localizedModule_prime`

English:
lemma injectiveDimension_eq_iSup_localizedModule_prime
  statement: [Small.{v, u} R] [IsNoetherianRing R]
  proof: by
...
/--
lemma `injectiveDimension_eq_iSup_localizedModule_maximal` / 引理 `injectiveDimension_eq_iSup_localizedModule_maximal`

English:
lemma injectiveDimension_eq_iSup_localizedModule_maximal
  statement: [Small.{v, u} R] [IsNoetherianRing R]
  proof: by
