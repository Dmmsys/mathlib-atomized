...
/--
lemma `epi_iff_surjective_up_to_refinements` / 引理 `epi_iff_surjective_up_to_refinements`

English:
lemma epi_iff_surjective_up_to_refinements
  given: (f : X ⟶ Y)
  proof: by
  constructor
  · intro _ A a
...
中文:
引理 epi_iff_surjective_up_to_refinements
  条件: (f : X ⟶ Y)
  证明: by
  constructor
  · intro _ A a
...
Depends on / 依赖: comp_id, condition, epi_of_epi_fac, fac.symm, pullback, pullback.condition, pullback.fst, pullback.snd
-/
lemma epi_iff_surjective_up_to_refinements (f : X ⟶ Y) :
    Epi f ↔ forall ⦃A : C⦄ (y : A ⟶ Y),
      exists (A' : C) (π : A' ⟶ A) (_ : Epi π) (x : A' ⟶ X), π ≫ y = x ≫ f := by
  constructor
  · intro _ A a
    exact ⟨pullback a f, pullback.fst a f, inferInstance, pullback.snd a f, pullback.condition⟩
  · intro hf
...
/--
lemma `surjective_up_to_refinements_of_epi` / 引理 `surjective_up_to_refinements_of_epi`

English:
lemma surjective_up_to_refinements_of_epi
  given: (f : X ⟶ Y) [Epi f] {A : C} (y : A ⟶ Y)
  proof: (epi_iff_surjective_up_to_refinements f).1 inferInstance y
...
/--
lemma `ShortComplex.exact_iff_exact_up_to_refinements` / 引理 `ShortComplex.exact_iff_exact_up_to_refinements`
...
Depends on / 依赖: S.exact_iff_epi_toCycles, S.iCycles, S.liftCycles, cancel_mono, epi_iff_surjective_up_to_refinements, exact_iff_epi_toCycles, iCycles, liftCycles, liftCycles_i, toCycles_i
-/
lemma ShortComplex.exact_iff_exact_up_to_refinements :
    S.Exact ↔ forall ⦃A : C⦄ (x₂ : A ⟶ S.X₂) (_ : x₂ ≫ S.g = 0),
      exists (A' : C) (π : A' ⟶ A) (_ : Epi π) (x₁ : A' ⟶ S.X₁), π ≫ x₂ = x₁ ≫ S.f := by
  rw [S.exact_iff_epi_toCycles]; rw [epi_iff_surjective_up_to_refinements]
  constructor
  · intro hS A a ha
    obtain ⟨A', π, hπ, x₁, fac⟩ := hS (S.liftCycles a ha)
...
/--
lemma `ShortComplex.Exact.exact_up_to_refinements` / 引理 `ShortComplex.Exact.exact_up_to_refinements`
...
Depends on / 依赖: ShortComplex, ShortComplex.exact_iff_exact_up_to_refinements, exact_iff_exact_up_to_refinements
-/
lemma ShortComplex.Exact.exact_up_to_refinements
...
/--
lemma `ShortComplex.eq_liftCycles_homologyπ_up_to_refinements` / 引理 `ShortComplex.eq_liftCycles_homologyπ_up_to_refinements`

English:
lemma ShortComplex.eq_liftCycles_homologyπ_up_to_refinements
  given: {A : C} (γ : A ⟶ S.homology)
  proof: by
...
Depends on / 依赖: S.homology, S.iCycles, cancel_mono, iCycles, liftCycles_i, surjective_up_to_refinements_of_epi
-/
lemma ShortComplex.eq_liftCycles_homologyπ_up_to_refinements {A : C} (γ : A ⟶ S.homology) :
    exists (A' : C) (π : A' ⟶ A) (_ : Epi π) (z : A' ⟶ S.X₂) (hz : z ≫ S.g = 0),
...
/--
lemma `Limits.CokernelCofork.IsColimit.comp_π_eq_zero_iff_up_to_refinements` / 引理 `Limits.CokernelCofork.IsColimit.comp_π_eq_zero_iff_up_to_refinements`

English:
lemma Limits.CokernelCofork.IsColimit.comp_π_eq_zero_iff_up_to_refinements
  statement: {f : X ⟶ Y}
  proof: by
  refine ⟨fun hy => ?_, ?_⟩
...
Depends on / 依赖: Cofork, Cofork.ext, IsColimit, IsColimit.ofIsoColimit, Iso.refl, ShortComplex, ShortComplex.exact_iff_exact_up_to_refinements, ShortComplex.mk, c.condition, cancel_epi, condition, exact_iff_exact_up_to_refinements, exact_of_g_is_cokernel, ofIsoColimit, reassoc_of
-/
lemma Limits.CokernelCofork.IsColimit.comp_π_eq_zero_iff_up_to_refinements {f : X ⟶ Y}
    ...
    y ≫ c.π = 0 ↔ exists (A' : C) (π : A' ⟶ A) (_ : Epi π) (x : A' ⟶ X), π ≫ y = x ≫ f := by
  refine ⟨fun hy => ?_, ?_⟩
  · have h := (ShortComplex.mk _ _ c.condition).exact_of_g_is_cokernel
      (IsColimit.ofIsoColimit hc (Cofork.ext (Iso.refl _) (by simp)))
    rw [ShortComplex.exact_iff_exact_up_to_refinements] at h
...
/--
lemma `ShortComplex.liftCycles_comp_homologyπ_eq_zero_iff_up_to_refinements` / 引理 `ShortComplex.liftCycles_comp_homologyπ_eq_zero_iff_up_to_refinements`
...
Depends on / 依赖: CokernelCofork, CokernelCofork.IsColimit.comp_, IsColimit, S.homologyIsCokernel, S.iCycles, S.liftCycles, cancel_mono, homologyIsCokernel, iCycles, liftCycles
-/
lemma ShortComplex.liftCycles_comp_homologyπ_eq_zero_iff_up_to_refinements
...
/--
lemma `ShortComplex.liftCycles_comp_homologyπ_eq_iff_up_to_refinements` / 引理 `ShortComplex.liftCycles_comp_homologyπ_eq_iff_up_to_refinements`
...
lemma ShortComplex.liftCycles_comp_homologyπ_eq_iff_up_to_refinements
  ...
  suffices S.liftCycles x₂ hx₂ ≫ S.homologyπ = S.liftCycles x₂' hx₂' ≫ S.homologyπ ↔
    ...
    simp [this, S.liftCycles_comp_homologyπ_eq_zero_iff_up_to_refinements,
      sub_eq_iff_eq_add']
  rw [← sub_eq_zero]; rw [← sub_comp]; rw [sub_liftCycles]
...
Depends on / 依赖: S.homology, S.liftCycles, S.liftCycles_comp_homology, liftCycles, sub_comp, sub_eq_iff_eq_add, sub_eq_zero, sub_liftCycles
-/
lemma ShortComplex.liftCycles_comp_homologyπ_eq_iff_up_to_refinements
    {A : C} (x₂ x₂' : A ⟶ S.X₂) (hx₂ : x₂ ≫ S.g = 0) (hx₂' : x₂' ≫ S.g = 0) :
    S.liftCycles x₂ hx₂ ≫ S.homologyπ = S.liftCycles x₂' hx₂' ≫ S.homologyπ ↔
      exists (A' : C) (π : A' ⟶ A) (_ : Epi π) (x₁ : A' ⟶ S.X₁), π ≫ x₂ = π ≫ x₂' + x₁ ≫ S.f := by
  suffices S.liftCycles x₂ hx₂ ≫ S.homologyπ = S.liftCycles x₂' hx₂' ≫ S.homologyπ ↔
      S.liftCycles (x₂ - x₂') (by simp [hx₂, hx₂']) ≫ S.homologyπ = 0 by
    simp [this, S.liftCycles_comp_homologyπ_eq_zero_iff_up_to_refinements,
      sub_eq_iff_eq_add']
...
/--
lemma `ShortComplex.comp_homologyπ_eq_zero_iff_up_to_refinements` / 引理 `ShortComplex.comp_homologyπ_eq_zero_iff_up_to_refinements`
...
Depends on / 依赖: S.iCycles, S.liftCycles, cancel_mono, iCycles, liftCycles, liftCycles_i
-/
lemma ShortComplex.comp_homologyπ_eq_zero_iff_up_to_refinements
    {A : C} (z₂ : A ⟶ S.cycles) :
    z₂ ≫ S.homologyπ = 0 ↔
      exists (A' : C) (π : A' ⟶ A) (_ : Epi π) (x₁ : A' ⟶ S.X₁), π ≫ z₂ = x₁ ≫ S.toCycles := by
  obtain ⟨x₂, hx₂, rfl⟩ : exists (x₂ : A ⟶ S.X₂) (hx₂ : x₂ ≫ S.g = 0), z₂ = S.liftCycles x₂ hx₂ :=
    ⟨z₂ ≫ S.iCycles, by simp, by simp [← cancel_mono S.iCycles, liftCycles_i]⟩
  simp [liftCycles_comp_homologyπ_eq_zero_iff_up_to_refinements, ← cancel_mono S.iCycles]

/--
lemma `ShortComplex.comp_homologyπ_eq_iff_up_to_refinements` / 引理 `ShortComplex.comp_homologyπ_eq_iff_up_to_refinements`
...
lemma ShortComplex.comp_homologyπ_eq_iff_up_to_refinements
  ...
  obtain ⟨x₂', hx₂', rfl⟩ : exists (x₂' : A ⟶ S.X₂) (hx₂' : x₂' ≫ S.g = 0), z₂' =
...
Depends on / 依赖: S.iCycles, S.liftCycles, cancel_mono, iCycles, liftCycles
-/
lemma ShortComplex.comp_homologyπ_eq_iff_up_to_refinements
    {A : C} (z₂ z₂' : A ⟶ S.cycles) :
    z₂ ≫ S.homologyπ = z₂' ≫ S.homologyπ ↔
      exists (A' : C) (π : A' ⟶ A) (_ : Epi π) (x₁ : A' ⟶ S.X₁),
...
/--
lemma `ShortComplex.comp_pOpcycles_eq_zero_iff_up_to_refinements` / 引理 `ShortComplex.comp_pOpcycles_eq_zero_iff_up_to_refinements`

English:
lemma ShortComplex.comp_pOpcycles_eq_zero_iff_up_to_refinements
  proof: CokernelCofork.IsColimit.comp_π_eq_zero_iff_up_to_refinements
...
Depends on / 依赖: CokernelCofork, CokernelCofork.IsColimit.comp_, IsColimit, S.opcyclesIsCokernel, opcyclesIsCokernel
-/
lemma ShortComplex.comp_pOpcycles_eq_zero_iff_up_to_refinements
    {A : C} (x₂ : A ⟶ S.X₂) :
    x₂ ≫ S.pOpcycles = 0 ↔
      exists (A' : C) (π : A' ⟶ A) (_ : Epi π) (x₁ : A' ⟶ S.X₁), π ≫ x₂ = x₁ ≫ S.f :=
  CokernelCofork.IsColimit.comp_π_eq_zero_iff_up_to_refinements
    S.opcyclesIsCokernel x₂

variable {K L} in
/--
lemma `ShortComplex.mono_homologyMap_iff_up_to_refinements` / 引理 `ShortComplex.mono_homologyMap_iff_up_to_refinements`
...
lemma ShortComplex.mono_homologyMap_iff_up_to_refinements
  ...
  · rw [Preadditive.mono_iff_cancel_zero]
    ...
    rw [← cancel_epi π₁]; rw [fac]; rw [comp_zero]
    replace hγ := π₁ ≫= hγ
...
Depends on / 依赖: Preadditive, Preadditive.mono_iff_cancel_zero, cancel_mono, eq_li, homologyMap, liftCycles, liftCycles_comp_cyclesMap_assoc, mono_iff_cancel_zero, zero_comp
-/
lemma ShortComplex.mono_homologyMap_iff_up_to_refinements (φ : S₁ ⟶ S₂) :
    Mono (homologyMap φ) ↔
      forall ⦃A : C⦄ (x₂ : A ⟶ S₁.X₂) (_ : x₂ ≫ S₁.g = 0) (y₁ : A ⟶ S₂.X₁)
          (_ : x₂ ≫ φ.τ₂ = y₁ ≫ S₂.f),
        exists (A' : C) (π : A' ⟶ A) (_ : Epi π) (x₁ : A' ⟶ S₁.X₁),
          π ≫ x₂ = x₁ ≫ S₁.f := by
  refine ⟨fun h A x₂ hx₂ y₁ fac => ?_, fun h => ?_⟩
...
variable {K L} in
/--
lemma `ShortComplex.epi_homologyMap_iff_up_to_refinements` / 引理 `ShortComplex.epi_homologyMap_iff_up_to_refinements`
...
Depends on / 依赖: comp_liftCycles_assoc, epi_iff_surjective_up_to_refinements, liftCycles, liftCycles_comp_cyclesMap_assoc, reassoc_of, replace
-/
lemma ShortComplex.epi_homologyMap_iff_up_to_refinements (φ : S₁ ⟶ S₂) :
    Epi (homologyMap φ) ↔
      forall ⦃A : C⦄ (y₂ : A ⟶ S₂.X₂) (_ : y₂ ≫ S₂.g = 0),
        exists (A' : C) (π : A' ⟶ A) (_ : Epi π) (x₂ : A' ⟶ S₁.X₂) (_ : x₂ ≫ S₁.g = 0)
