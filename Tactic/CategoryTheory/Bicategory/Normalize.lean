...
theorem evalComp_nil_cons
  given: (α : f ≅ g) (β : g ≅ h) (η : h ⟶ i) (ηs : i ⟶ j)
  proof: by
  simp

中文:
定理 evalComp_nil_cons
  条件: (α : f ≅ g) (β : g ≅ h) (η : h ⟶ i) (ηs : i ⟶ j)
  证明: by
  simp
-/
...
theorem evalComp_cons
  statement: (α : f ≅ g) (η : g ⟶ h) {ηs : h ⟶ i} {θ : i ⟶ j} {ι : h ⟶ j}
  proof: by
  simp [e_ι]

中文:
定理 evalComp_cons
  结论: (α : f ≅ g) (η : g ⟶ h) {ηs : h ⟶ i} {θ : i ⟶ j} {ι : h ⟶ j}
  证明: by
  simp [e_ι]
-/
...
theorem evalWhiskerLeft_nil
  given: (f : a ⟶ b) {g h : b ⟶ c} (α : g ≅ h)
  proof: by
  simp

中文:
定理 evalWhiskerLeft_nil
  条件: (f : a ⟶ b) {g h : b ⟶ c} (α : g ≅ h)
  证明: by
  simp
-/
...
/--
theorem `eval_bicategoricalComp` / 定理 `eval_bicategoricalComp`
...
English:
instance :
  signature: MkEvalComp BicategoryM
  body: do
    let ctx ← read
...
English:
instance :
  signature: MkEvalWhiskerLeft BicategoryM
  body: do
    let ctx ← read
    let _bicat := ctx.instBicategory
    let g ← α.srcM
...
中文:
实例 :
  签名: MkEvalWhiskerLeft BicategoryM
  定义体: do
    let ctx ← read
    let _bicat := ctx.instBicategory
    let g ← α.srcM
...
English:
instance :
  signature: MkEvalWhiskerRight BicategoryM
  body: do
    let ctx ← read
    let _bicat := ctx.instBicategory
    let f ← η.srcM
...
中文:
实例 :
  签名: MkEvalWhiskerRight BicategoryM
  定义体: do
    let ctx ← read
    let _bicat := ctx.instBicategory
    let f ← η.srcM
...
English:
instance :
  signature: MkEvalHorizontalComp BicategoryM
  body: do
    throwError "not implemented"
...
中文:
实例 :
  签名: MkEvalHorizontalComp BicategoryM
  定义体: do
    throwError "not implemented"
  mkEvalHorizontalCompAuxCons _ _ _ _ _ _ _ _ _ _ _ := do
    throwError "not implemented"
...
English:
instance :
  signature: MonadNormalExpr BicategoryM
  body: do
...
中文:
实例 :
  签名: MonadNormalExpr BicategoryM
  定义体: do
    return .whisker (← MonadMor₂.whiskerRightM η.e (.of h)) η h
  hConsM _ _ := do
    throwError "not implemented"
