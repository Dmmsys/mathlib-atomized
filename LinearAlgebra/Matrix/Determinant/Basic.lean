...
定理 det_apply
  条件: (M : Matrix n n R)
  结论: M.det = ∑ σ : Perm n, Equiv.Perm.sign σ • ∏ i, M (σ i) i
...
定理 det_apply'
  条件: (M : Matrix n n R)
  结论: M.det = ∑ σ : Perm n, ε σ * ∏ i, M (σ i) i
  证明: by
  simp [det_apply, Units.smul_def]
...
定理 coe_det_isEmpty
  条件: [IsEmpty n]
  结论: (det : Matrix n n R -> R) = Function.const _ 1
  证明: by
  ext
  exact det_isEmpty
...
定理 det_eq_one_of_card_eq_zero
  条件: {A : Matrix n n R} (h : Fintype.card n = 0)
  结论: det A = 1
...
定理 det_eq_elem_of_card_eq_one
  条件: {A : Matrix n n R} (h : Fintype.card n = 1) (k : n)
...
中文:
定理 det_mul_aux
  条件: {M N : Matrix n n R} {p : n -> n} (H : ¬Bijective p)
  证明: by
  obtain ⟨i, j, hpij, hij⟩ : exists i j, p i = p j ∧ i != j := by
    rw [← Finite.injective_iff_bijective]; rw [Injective] at H
    push Not at H
...
中文:
定理 coe_detMonoidHom
  结论: (detMonoidHom : Matrix n n R -> R) = det
  证明: rfl
-/
...
中文:
定理 det_smul
  条件: (A : Matrix n n R) (c : R)
  结论: det (c • A) = c ^ Fintype.card n * det A
  证明: calc
    det (c • A) = det ((diagonal fun _ => c) * A) := by rw [smul_eq_diagonal_mul]
    _ = det (diagonal fun _ => c) * det A := det_mul _ _
    _ = c ^ Fintype.card n * det A := by simp
...
定理 det_smul_of_tower
  结论: {α} [Monoid α] [MulAction α R] [IsScalarTower α R R]
  证明: by
  rw [← smul_one_smul R c A]; rw [det_smul]; rw [smul_pow]; rw [one_pow]; rw [smul_mul_assoc]; rw [one_mul]
...
定理 det_neg
  条件: (A : Matrix n n R)
  结论: det (-A) = (-1) ^ Fintype.card n * det A
  证明: by
  rw [← det_smul]; rw [neg_one_smul]
...
中文:
定理 _root_.RingHom.map_det
  条件: (f : R ->+* S) (M : Matrix n n R)
  证明: by
  simp [Matrix.det_apply', map_sum f, map_prod f]
...
中文:
定理 _root_.AlgHom.map_det
  结论: [Algebra R S] {T : Type z} [CommRing T] [Algebra R T] (f : S ->ₐ[R] T)
  证明: f.toRingHom.map_det _
...
中文:
定理 _root_.AlgEquiv.map_det
  结论: [Algebra R S] {T : Type z} [CommRing T] [Algebra R T]
...
中文:
定理 _root_.Rat.cast_det
  条件: {F : 类型} [Field F] [CharZero F] (M : Matrix n n Rat)
...
定理 det_eq_zero_of_row_eq_zero
  条件: {A : Matrix n n R} (i : n) (h : 对任意 j, A i j = 0)
  结论: det A = 0
...
定理 det_eq_zero_of_column_eq_zero
  条件: {A : Matrix n n R} (j : n) (h : 对任意 i, A i j = 0)
  证明: by
  rw [← det_transpose]
  exact det_eq_zero_of_row_eq_zero j h
...
定理 det_updateRow_smul
  条件: (M : Matrix n n R) (j : n) (s : R) (u : n -> R)
...
定理 det_updateRow_sum_aux
  结论: (M : Matrix n n R) {j : n} (s : Finset n) (hj : j ∉ s) (c : n -> R)
  证明: by
  induction s using Finset.induction_on with
  | empty => rw [Finset.sum_empty, add_zero, smul_eq_mul, det_updateRow_smul, updateRow_eq_self]
  | insert k _ hk h_ind =>
...
定理 det_eq_of_eq_mul_det_one
  结论: {A B : Matrix n n R} (C : Matrix n n R) (hC : det C = 1)
  证明: calc
    det A = det (B * C) := congr_arg _ hA
    _ = det B * det C := det_mul _ _
    _ = det B := by rw [hC, mul_one]
...
定理 det_updateRow_add_self
  条件: (A : Matrix n n R) {i j : n} (hij : i != j)
  证明: by
  simp [det_updateRow_add,
    det_zero_of_row_eq hij (updateRow_self.trans (updateRow_ne hij.symm).symm)]
...
定理 det_updateRow_add_smul_self
  条件: (A : Matrix n n R) {i j : n} (hij : i != j) (c : R)
  证明: by
  simp [det_updateRow_add, det_updateRow_smul,
    det_zero_of_row_eq hij (updateRow_self.trans (updateRow_ne hij.symm).symm)]
...
定理 linearIndependent_rows_of_det_ne_zero
  条件: [IsDomain R] {A : Matrix m m R} (hA : A.det != 0)
  证明: by
  contrapose hA
  exact det_eq_zero_of_not_linearIndependent_rows hA
...
中文:
定理 det_eq_of_forall_row_eq_smul_add_const_aux
  条件: {A B : Matrix n n R} {s : Finset n}
  证明: by
  induction s using Finset.induction_on generalizing B with
  | empty =>
    rintro c hs k - A_eq
...
中文:
定理 det_eq_of_forall_row_eq_smul_add_const
  结论: {A B : Matrix n n R} (c : n -> R) (k : n)
...
中文:
定理 det_eq_of_forall_row_eq_smul_add_pred_aux
  条件: {n : 自然数} (k : Fin (n + 1))
  证明: by
  refine Fin.induction ?_ (fun k ih => ?_) k <;> intro c hc M N h0 hsucc
  · congr
...
中文:
定理 det_eq_of_forall_row_eq_smul_add_pred
  结论: {n : 自然数} {A B : Matrix (Fin (n + 1)) (Fin (n + 1)) R}
...
中文:
定理 det_eq_of_forall_col_eq_smul_add_pred
  结论: {n : 自然数} {A B : Matrix (Fin (n + 1)) (Fin (n + 1)) R}
  证明: by
  rw [← det_transpose A]; rw [← det_transpose B]
  exact det_eq_of_forall_row_eq_smul_add_pred c A_zero fun i j => A_succ j i
...
定理 det_blockDiagonal
  条件: {o : 类型} [Fintype o] [DecidableEq o] (M : o -> Matrix n n R)
  证明: by
  -- Rewrite the determinants as a sum over permutations.
  simp_rw [det_apply']
  -- The right-hand side is a product of sums, rewrite it as a sum of products.
...
定理 det_fromBlocks_zero₂₁
  条件: (A : Matrix m m R) (B : Matrix m n R) (D : Matrix n n R)
  证明: by
  classical
    simp_rw [det_apply']
    convert!
...
中文:
定理 det_fromBlocks_zero₁₂
  条件: (A : Matrix m m R) (C : Matrix n m R) (D : Matrix n n R)
  证明: by
  rw [← det_transpose]; rw [fromBlocks_transpose]; rw [transpose_zero]; rw [det_fromBlocks_zero₂₁]; rw [det_transpose]; rw [det_transpose]
...
定理 det_succ_column_zero
  条件: {n : 自然数} (A : Matrix (Fin n.succ) (Fin n.succ) R)
  证明: by
  rw [Matrix.det_apply]; rw [Finset.univ_perm_fin_succ]; rw [← Finset.univ_product_univ]
  simp only [Finset.sum_map, Equiv.toEmbedding_apply, Finset.sum_product, Matrix.submatrix]
  refine Finset.sum_congr rfl fun i _ => Fin.cases ?_ (fun i => ?_) i
...
中文:
定理 det_succ_row
  条件: {n : 自然数} (A : Matrix (Fin n.succ) (Fin n.succ) R) (i : Fin n.succ)
  证明: by
  simp_rw [pow_add, mul_assoc, ← mul_sum]
  have : det A = (-1 : R) ^ (i : Nat) * (Perm.sign i.cycleRange⁻¹) * det A := by
    calc
...
中文:
定理 det_succ_column
  条件: {n : 自然数} (A : Matrix (Fin n.succ) (Fin n.succ) R) (j : Fin n.succ)
  证明: by
  rw [← det_transpose]; rw [det_succ_row _ j]
  refine Finset.sum_congr rfl fun i _ => ?_
  rw [add_comm]; rw [← det_transpose]; rw [transpose_apply]; rw [transpose_submatrix]; rw [transpose_transpose]
