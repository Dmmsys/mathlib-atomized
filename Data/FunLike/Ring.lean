...
/--
Definition of `FunLike.monoidWithZero` / `FunLike.monoidWithZero` 的定义

English:
abbreviation FunLike.monoidWithZero
  signature: : MonoidWithZero F where
  body: by apply DFunLike.ext; simp
...
variable [FunLike F α α] [Zero F] [One F] [Mul F] [Add F] [AddCommMonoid α]
  ...
  [SMul Nat F] [IsSMulApply Nat F α α] [AddMonoidHomClass F α α] [NatCast F] [IsNatCastApply F α]

/--
Definition of `FunLike.semiring` / `FunLike.semiring` 的定义

English:
abbreviation FunLike.semiring
  signature: : Semiring F where
  body: FunLike.monoidWithZero
...
variable [FunLike F α α] [Zero F] [One F] [Mul F] [Add F] [Neg F] [Sub F]
  ...
  [SMul Nat F] [IsSMulApply Nat F α α]
  [SMul Int F] [IsSMulApply Int F α α] [AddMonoidHomClass F α α]
  [NatCast F] [IsNatCastApply F α] [IntCast F] [IsIntCastApply F α]

/--
Definition of `FunLike.ring` / `FunLike.ring` 的定义

English:
abbreviation FunLike.ring
  signature: : Ring F where
  body: FunLike.semiring
