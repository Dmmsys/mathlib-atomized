...
/--
theorem `isFiltered_of_nonempty_limit_colimit_to_colimit_limit` / 定理 `isFiltered_of_nonempty_limit_colimit_to_colimit_limit`
...
-/
theorem isFiltered_of_nonempty_limit_colimit_to_colimit_limit
    (h : forall {J : Type v} [SmallCategory J] [FinCategory J] (F : J ⥤ K ⥤ Type v),
