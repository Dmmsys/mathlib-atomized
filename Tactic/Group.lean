...
@[to_additive]
/--
theorem `_zpow_trick` / 定理 `_zpow_trick`

English:
theorem _zpow_trick
  given: {G : Type*} [Group G] (a b : G) (n m : Int)
  proof: by rw [mul_assoc, ← zpow_add]
...
Depends on / 依赖: mul_assoc, zpow_add
-/
theorem _zpow_trick {G : Type*} [Group G] (a b : G) (n m : Int) :
    a * b ^ n * b ^ m = a * b ^ (n + m) := by rw [mul_assoc, ← zpow_add]

@[to_additive _zsmul_trick_one]
/--
theorem `_zpow_trick_one` / 定理 `_zpow_trick_one`

English:
theorem _zpow_trick_one
  given: {G : Type*} [Group G] (a b : G) (m : Int)
  proof: by rw [mul_assoc, mul_self_zpow]
...
Depends on / 依赖: mul_assoc, mul_self_zpow
-/
theorem _zpow_trick_one {G : Type*} [Group G] (a b : G) (m : Int) :
...
English:
theorem _zpow_trick_one'
  given: {G : Type*} [Group G] (a b : G) (n : Int)
  proof: by rw [mul_assoc, mul_zpow_self]
...
-/
theorem _zpow_trick_one' {G : Type*} [Group G] (a b : G) (n : Int) :
