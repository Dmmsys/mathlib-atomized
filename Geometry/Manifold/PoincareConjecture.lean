...
/-
**ContinuousMap.HomotopyEquiv.NonemptyDiffeomorphSphere** 是 Mathlib 中的一个定义，位于命名空
间 ``。
形式化陈述：ContinuousMap.HomotopyEquiv.NonemptyDiffeomorphSphere (n : Nat) : Prop
参数：n : Nat。
该定义给出了上述对象。
...
--- 原说明 ---
The smooth Poincaré conjecture; true for n = 1, 2, 3, 5, 6, 12, 56, and 61,
open for n = 4, and it is conjectured that there are no other n > 4 for which it
 is true
(Conjecture 1.17, https://annals.math.princeton.edu/2017/186-2/p03).
-/
