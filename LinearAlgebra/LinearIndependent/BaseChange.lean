...
/--
lemma `LinearIndependent.linearIndependent_algebraMap_comp_aux` / 引理 `LinearIndependent.linearIndependent_algebraMap_comp_aux`

English:
lemma LinearIndependent.linearIndependent_algebraMap_comp_aux
  statement: {K : Type*} (L : Type*)
  proof: by
  classical
...
/--
lemma `linearIndependent_algebraMap_comp_iff` / 引理 `linearIndependent_algebraMap_comp_iff`

English:
lemma linearIndependent_algebraMap_comp_iff
  statement: {R S : Type*}
  proof: by
