...
@[to_additive (attr := instance_reducible) AddOreLocalization.oreEqv
  /-- The setoid on `R × S` used for the Ore localization. -/]
/-
**OreLocalization.oreEqv** 是 Mathlib 中的一个定义，位于命名空间 `OreLocalization`。
形式化陈述：oreEqv : Setoid (X × S) where r rs rs'
该定义给出了上述对象。
...
/-
**OreLocalization** 是 Mathlib 中的一个定义，位于命名空间 ``。
形式化陈述：OreLocalization {R : Type*} [Monoid R] (S : Submonoid R) [OreSet S] (X : T
ype*) [MulAction R X]
参数：S : Submonoid R；X : Type*。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**OreLocalization.oreDiv** 是 Mathlib 中的一个定义，位于命名空间 `OreLocalization`。
形式化陈述：oreDiv (r : X) (s : S) : X[S⁻¹]
参数：r : X；s : S。
该定义给出了上述对象。
...
/-
**OreLocalization.ind** 是 Mathlib 中的一个定理，位于命名空间 `OreLocalization`。
形式化陈述：∀ {R : Type u_1} [inst : Monoid R] {S : Submonoid R} [inst_1 : OreLocaliza
tion.OreSet S] {X : Type u_2}   [inst_2 : MulAction R X] {β : OreLocalization S 
X → Prop},   (∀ (r : X) (s : ↥S), β (r /ₒ s)) → ∀ (q : OreLocalization S X), β q
参数：∀ (r : X) (s : ↥S), β (r /ₒ s)；q : OreLocalization S X。
黑盒证明引用了以下数学事实（定理与引理）：
...
@[to_additive]
/-
**OreLocalization.oreDiv_eq_iff** 是 Mathlib 中的一个定理，位于命名空间 `OreLocalization`。
形式化陈述：oreDiv_eq_iff {r₁ r₂ : X} {s₁ s₂ : S} : r₁ /ₒ s₁ = r₂ /ₒ s₂ ↔ exists (u : 
S) (v : R), u • r₂ = v • r₁ ∧ u * s₂ = v * s₁
该定理/引理刻画了左右两侧的等价关系。
黑盒证明引用了以下数学事实（定理与引理）：
...
/-
**OreLocalization.expand** 是 Mathlib 中的一个定理，位于命名空间 `OreLocalization`。
形式化陈述：∀ {R : Type u_1} [inst : Monoid R] {S : Submonoid R} [inst_1 : OreLocaliza
tion.OreSet S] {X : Type u_2}   [inst_2 : MulAction R X] (r : X) (s : ↥S) (t : R
) (hst : t * ↑s ∈ S), r /ₒ s = t • r /ₒ ⟨t * ↑s, hst⟩
参数：r : X；s : ↥S；t : R；hst : t * ↑s ∈ S。
黑盒证明引用了以下数学事实（定理与引理）：
...
**OreLocalization.expand'** 是 Mathlib 中的一个定理，位于命名空间 `OreLocalization`。
形式化陈述：∀ {R : Type u_1} [inst : Monoid R] {S : Submonoid R} [inst_1 : OreLocaliza
tion.OreSet S] {X : Type u_2}   [inst_2 : MulAction R X] (r : X) (s s' : ↥S), r 
/ₒ s = s' • r /ₒ (s' * s)
参数：r : X；s s' : ↥S；s' * s。
黑盒证明引用了以下数学事实（定理与引理）：
...
/-
**OreLocalization.eq_of_num_factor_eq** 是 Mathlib 中的一个定理，位于命名空间 `OreLocalization
`。
形式化陈述：∀ {R : Type u_1} [inst : Monoid R] {S : Submonoid R} [inst_1 : OreLocaliza
tion.OreSet S] {r r' r₁ r₂ : R} {s t : ↥S},   ↑t * r = ↑t * r' → r₁ * r * r₂ /ₒ 
s = r₁ * r' * r₂ /ₒ s
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
...
/-
**OreLocalization.liftExpand** 是 Mathlib 中的一个定义，位于命名空间 `OreLocalization`。
形式化陈述：liftExpand {C : Sort*} (P : X -> S -> C) (hP : forall (r : X) (t : R) (s :
 S) (ht : t * s in S), P r s = P (t • r) ⟨t * s, ht⟩) : X[S⁻¹] -> C
参数：P : X -> S -> C；hP : forall (r : X) (t : R) (s : S) (ht : t * s in S), P r s 
= P (t • r) ⟨t * s, ht⟩。
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**OreLocalization.liftExpand_of** 是 Mathlib 中的一个定理，位于命名空间 `OreLocalization`。
形式化陈述：liftExpand_of {C : Sort*} {P : X -> S -> C} {hP : forall (r : X) (t : R) (
s : S) (ht : t * s in S), P r s = P (t • r) ⟨t * s, ht⟩} (r : X) (s : S) : liftE
xpand P hP (r /ₒ s) = P r s
参数：r : X；t : R；s : S；ht : t * s in S；t • r；r : X；s : S。
该定理/引理给出了一组等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-- A version of `liftExpand` used to simultaneously lift functions with two arguments. -/]
/-
**OreLocalization.lift** 是 Mathlib 中的一个定义，位于命名空间 `OreLocalization`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[to_additive (attr := simp)]
/-
**OreLocalization.lift** 是 Mathlib 中的一个定理，位于命名空间 `OreLocalization`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[to_additive]
/-
**OreLocalization.smul'** 是 Mathlib 中的一个缩写定义，位于命名空间 `OreLocalization`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[to_additive]
/-
**OreLocalization.smul'_char** 是 Mathlib 中的一个定理，位于命名空间 `OreLocalization`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**OreLocalization.smul** 是 Mathlib 中的一个定义，位于命名空间 `OreLocalization`。
形式化陈述：{R : Type u_1} →   [inst : Monoid R] →     {S : Submonoid R} →       [inst
_1 : OreLocalization.OreSet S] →         {X : Type u_2} → [inst_2 : MulAction R 
X] → OreLocalization S R → OreLocalization S X → OreLocalization S X
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[to_additive]
/-
**OreLocalization.oreDiv_smul_oreDiv** 是 Mathlib 中的一个定理，位于命名空间 `OreLocalization`
。
形式化陈述：oreDiv_smul_oreDiv {r₁ : R} {r₂ : X} {s₁ s₂ : S} : (r₁ /ₒ s₁) • (r₂ /ₒ s₂)
 = oreNum r₁ s₂ • r₂ /ₒ (oreDenom r₁ s₂ * s₁)
该定理/引理给出了一组等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[to_additive]
/-
**OreLocalization.oreDiv_mul_oreDiv** 是 Mathlib 中的一个定理，位于命名空间 `OreLocalization`。
形式化陈述：oreDiv_mul_oreDiv {r₁ : R} {r₂ : R} {s₁ s₂ : S} : (r₁ /ₒ s₁) * (r₂ /ₒ s₂) 
= oreNum r₁ s₂ * r₂ /ₒ (oreDenom r₁ s₂ * s₁)
该定理/引理给出了一组等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**OreLocalization.oreDiv_smul_char** 是 Mathlib 中的一个定理，位于命名空间 `OreLocalization`。
形式化陈述：oreDiv_smul_char (r₁ : R) (r₂ : X) (s₁ s₂ : S) (r' : R) (s' : S) (huv : s'
 * r₁ = r' * s₂) : (r₁ /ₒ s₁) • (r₂ /ₒ s₂) = r' • r₂ /ₒ (s' * s₁)
参数：r₁ : R；r₂ : X；s₁ s₂ : S；r' : R；s' : S；huv : s' * r₁ = r' * s₂。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `_private.Mathlib.GroupTheory.OreLocalization.Basic.0.OreLocalization.smu
l'_char`：∀ {R : Type u_1} [inst : Monoid R] {S : Submonoid R} [inst_1 : OreLocal
ization.OreSet S] {X : Type u_2}   [inst_2 : MulAction R X] (r₁ : R) …
-/
...
allowing for a choice of Ore minuend and Ore subtrahend. -/]
/-
**OreLocalization.oreDiv_mul_char** 是 Mathlib 中的一个定理，位于命名空间 `OreLocalization`。
形式化陈述：oreDiv_mul_char (r₁ r₂ : R) (s₁ s₂ : S) (r' : R) (s' : S) (huv : s' * r₁ =
 r' * s₂) : r₁ /ₒ s₁ * (r₂ /ₒ s₂) = r' * r₂ /ₒ (s' * s₁)
参数：r₁ r₂ : R；s₁ s₂ : S；r' : R；s' : S；huv : s' * r₁ = r' * s₂。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `_private.Mathlib.GroupTheory.OreLocalization.Basic.0.OreLocalization.smu
l'_char`：∀ {R : Type u_1} [inst : Monoid R] {S : Submonoid R} [inst_1 : OreLocal
...
/-
**OreLocalization.oreDivSMulChar'** 是 Mathlib 中的一个定义，位于命名空间 `OreLocalization`。
形式化陈述：oreDivSMulChar' (r₁ : R) (r₂ : X) (s₁ s₂ : S) : Σ' r' : R, Σ' s' : S, s' *
 r₁ = r' * s₂ ∧ (r₁ /ₒ s₁) • (r₂ /ₒ s₂) = r' • r₂ /ₒ (s' * s₁)
参数：r₁ : R；r₂ : X；s₁ s₂ : S。
该定义给出了一等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
@[to_additive /-- Another characterization lemma for the addition on the Ore localization delivering
  Ore witnesses and conditions bundled in a sigma type. -/]
/-
**OreLocalization.oreDivMulChar'** 是 Mathlib 中的一个定义，位于命名空间 `OreLocalization`。
形式化陈述：oreDivMulChar' (r₁ r₂ : R) (s₁ s₂ : S) : Σ' r' : R, Σ' s' : S, s' * r₁ = r
' * s₂ ∧ r₁ /ₒ s₁ * (r₂ /ₒ s₂) = r' * r₂ /ₒ (s' * s₁)
参数：r₁ r₂ : R；s₁ s₂ : S。
该定义给出了一等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**OreLocalization.one** 是 Mathlib 中的一个定义，位于命名空间 `OreLocalization`。
形式化陈述：{R : Type u_1} →   [inst : Monoid R] →     {S : Submonoid R} →       [inst
_1 : OreLocalization.OreSet S] → {X : Type u_2} → [inst_2 : MulAction R X] → [On
e X] → OreLocalization S X
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
@[to_additive]
/-
**OreLocalization.one_def** 是 Mathlib 中的一个定理，位于命名空间 `OreLocalization`。
形式化陈述：∀ {R : Type u_1} [inst : Monoid R] {S : Submonoid R} [inst_1 : OreLocaliza
tion.OreSet S] {X : Type u_2}   [inst_2 : MulAction R X] [inst_3 : One X], 1 = 1
 /ₒ 1
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[to_additive (attr := simp)]
/-
**OreLocalization.div_eq_one'** 是 Mathlib 中的一个定理，位于命名空间 `OreLocalization`。
形式化陈述：∀ {R : Type u_1} [inst : Monoid R] {S : Submonoid R} [inst_1 : OreLocaliza
tion.OreSet S] {r : R} (hr : r ∈ S),   r /ₒ ⟨r, hr⟩ = 1
参数：hr : r ∈ S。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
...
**OreLocalization.div_eq_one** 是 Mathlib 中的一个定理，位于命名空间 `OreLocalization`。
形式化陈述：∀ {R : Type u_1} [inst : Monoid R] {S : Submonoid R} [inst_1 : OreLocaliza
tion.OreSet S] {s : ↥S}, ↑s /ₒ s = 1
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `OreLocalization.div_eq_one'`：∀ {R : Type u_1} [inst : Monoid R] {S : Sub
monoid R} [inst_1 : OreLocalization.OreSet S] {r : R} (hr : r ∈ S),   r /ₒ ⟨r, h
r⟩ = 1
...
@[to_additive]
/-
**OreLocalization.one_smul** 是 Mathlib 中的一个定理，位于命名空间 `OreLocalization`。
形式化陈述：∀ {R : Type u_1} [inst : Monoid R] {S : Submonoid R} [inst_1 : OreLocaliza
tion.OreSet S] {X : Type u_2}   [inst_2 : MulAction R X] (x : OreLocalization S 
X), 1 • x = x
...
@[to_additive]
/-
**OreLocalization.one_mul** 是 Mathlib 中的一个定理，位于命名空间 `OreLocalization`。
形式化陈述：∀ {R : Type u_1} [inst : Monoid R] {S : Submonoid R} [inst_1 : OreLocaliza
tion.OreSet S] (x : OreLocalization S R),   1 * x = x
参数：x : OreLocalization S R。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `OreLocalization.one_smul`：∀ {R : Type u_1} [inst : Monoid R] {S : Submon
oid R} [inst_1 : OreLocalization.OreSet S] {X : Type u_2}   [inst_2 : MulAction 
R X] (x : OreL…
-/
...
@[to_additive]
/-
**OreLocalization.mul_one** 是 Mathlib 中的一个定理，位于命名空间 `OreLocalization`。
形式化陈述：∀ {R : Type u_1} [inst : Monoid R] {S : Submonoid R} [inst_1 : OreLocaliza
tion.OreSet S] (x : OreLocalization S R),   x * 1 = x
参数：x : OreLocalization S R。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `OreLocalization.ind`：∀ {R : Type u_1} [inst : Monoid R] {S : Submonoid R
} [inst_1 : OreLocalization.OreSet S] {X : Type u_2}   [inst_2 : MulAction R X] 
...
id R} [inst_1 : OreLocalization.OreSet S] {X : Type u_2}   [inst_2 : MulAction R
 X] [inst_3 :…
· 使用定理 `OreLocalization.oreDiv_mul_char`：oreDiv_mul_char (r₁ r₂ : R) (s₁ s₂ : S)
 (r' : R) (s' : S) (huv : s' * r₁ = r' * s₂) : r₁ /ₒ s₁ * (r₂ /ₒ s₂) = r' * r₂ /
ₒ (s' * s₁)
· 使用定理 `congr`：∀ {α : Sort u} {β : Sort v} {f₁ f₂ : α → β} {a₁ a₂ : α}, f₁ = f₂ 
→ a₁ = a₂ → f₁ a₁ = f₂ a₂
· 使用定理 `one_mul`：one_mul : forall a : M, 1 * a = a
...
@[to_additive]
/-
**OreLocalization.mul_smul** 是 Mathlib 中的一个定理，位于命名空间 `OreLocalization`。
形式化陈述：∀ {R : Type u_1} [inst : Monoid R] {S : Submonoid R} [inst_1 : OreLocaliza
tion.OreSet S] {X : Type u_2}   [inst_2 : MulAction R X] (x y : OreLocalization 
S R) (z : OreLocalization S X), (x * y) • z = x • y • z
参数：x y : OreLocalization S R；z : OreLocalization S X；x * y。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `OreLocalization.ind`：∀ {R : Type u_1} [inst : Monoid R] {S : Submonoid R
} [inst_1 : OreLocalization.OreSet S] {X : Type u_2}   [inst_2 : MulAction R X] 
{β : OreL…
...
@[to_additive]
/-
**OreLocalization.mul_assoc** 是 Mathlib 中的一个定理，位于命名空间 `OreLocalization`。
形式化陈述：∀ {R : Type u_1} [inst : Monoid R] {S : Submonoid R} [inst_1 : OreLocaliza
tion.OreSet S] (x y z : OreLocalization S R),   x * y * z = x * (y * z)
参数：x y z : OreLocalization S R；y * z。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `OreLocalization.mul_smul`：∀ {R : Type u_1} [inst : Monoid R] {S : Submon
oid R} [inst_1 : OreLocalization.OreSet S] {X : Type u_2}   [inst_2 : MulAction 
R X] (x y : Or…
-/
...
/-
**OreLocalization.npow** 是 Mathlib 中的一个定义，位于命名空间 `OreLocalization`。
形式化陈述：{R : Type u_1} →   [inst : Monoid R] →     {S : Submonoid R} → [inst_1 : O
reLocalization.OreSet S] → ℕ → OreLocalization S R → OreLocalization S R
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
@[to_additive]
/-
**OreLocalization.oreDiv_pow** 是 Mathlib 中的一个定理，位于命名空间 `OreLocalization`。
形式化陈述：oreDiv_pow (r : R) (s : S) (n : Nat) (h : Commute r (s : R)) : (r /ₒ s) ^ 
n = (r ^ n) /ₒ (s ^ n)
参数：r : R；s : S；n : Nat；h : Commute r (s : R)。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `Submonoid.instSubmonoidClass`：∀ {M : Type u_1} [inst : MulOneClass M], S
ubmonoidClass (Submonoid M) M
...
@[to_additive]
/-
**OreLocalization.instMulActionOreLocalization** 是 Mathlib 中的一个实例，位于命名空间 `OreLoc
alization`。
形式化陈述：instMulActionOreLocalization : MulAction R[S⁻¹] X[S⁻¹] where one_smul
该定义给出了上述对象。
本声明引用了以下数学事实（定理与引理）：
· 使用定理 `OreLocalization.mul_smul`：∀ {R : Type u_1} [inst : Monoid R] {S : Submon
oid R} [inst_1 : OreLocalization.OreSet S] {X : Type u_2}   [inst_2 : MulAction 
...
@[to_additive]
/-
**OreLocalization.mul_inv** 是 Mathlib 中的一个定理，位于命名空间 `OreLocalization`。
形式化陈述：∀ {R : Type u_1} [inst : Monoid R] {S : Submonoid R} [inst_1 : OreLocaliza
tion.OreSet S] (s s' : ↥S),   ↑s /ₒ s' * (↑s' /ₒ s) = 1
参数：s s' : ↥S；↑s' /ₒ s。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `of_eq_true`：∀ {p : Prop}, p = True → p
· 使用定理 `Eq.trans`：∀ {α : Sort u} {a b c : α}, a = b → b = c → a = c
...
· 使用定理 `one_mul`：one_mul : forall a : M, 1 * a = a
· 使用定理 `eq_self`：∀ {α : Sort u_1} (a : α), (a = a) = True
· 使用定理 `OreLocalization.div_eq_one`：∀ {R : Type u_1} [inst : Monoid R] {S : Subm
onoid R} [inst_1 : OreLocalization.OreSet S] {s : ↥S}, ↑s /ₒ s = 1
-/
...
@[to_additive (attr := simp)]
/-
**OreLocalization.one_div_smul** 是 Mathlib 中的一个定理，位于命名空间 `OreLocalization`。
形式化陈述：∀ {R : Type u_1} [inst : Monoid R] {S : Submonoid R} [inst_1 : OreLocaliza
tion.OreSet S] {X : Type u_2}   [inst_2 : MulAction R X] {r : X} {s t : ↥S}, (1 
/ₒ t) • (r /ₒ s) = r /ₒ (s * t)
参数：1 /ₒ t；r /ₒ s；s * t。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `of_eq_true`：∀ {p : Prop}, p = True → p
...
@[to_additive (attr := simp)]
/-
**OreLocalization.one_div_mul** 是 Mathlib 中的一个定理，位于命名空间 `OreLocalization`。
形式化陈述：∀ {R : Type u_1} [inst : Monoid R] {S : Submonoid R} [inst_1 : OreLocaliza
tion.OreSet S] {r : R} {s t : ↥S},   1 /ₒ t * (r /ₒ s) = r /ₒ (s * t)
参数：r /ₒ s；s * t。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `of_eq_true`：∀ {p : Prop}, p = True → p
· 使用定理 `Eq.trans`：∀ {α : Sort u} {a b c : α}, a = b → b = c → a = c
...
@[to_additive (attr := simp)]
/-
**OreLocalization.smul_cancel** 是 Mathlib 中的一个定理，位于命名空间 `OreLocalization`。
形式化陈述：∀ {R : Type u_1} [inst : Monoid R] {S : Submonoid R} [inst_1 : OreLocaliza
tion.OreSet S] {X : Type u_2}   [inst_2 : MulAction R X] {r : X} {s t : ↥S}, (↑s
 /ₒ t) • (r /ₒ s) = r /ₒ t
参数：↑s /ₒ t；r /ₒ s。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `of_eq_true`：∀ {p : Prop}, p = True → p
...
@[to_additive (attr := simp)]
/-
**OreLocalization.mul_cancel** 是 Mathlib 中的一个定理，位于命名空间 `OreLocalization`。
形式化陈述：∀ {R : Type u_1} [inst : Monoid R] {S : Submonoid R} [inst_1 : OreLocaliza
tion.OreSet S] {r : R} {s t : ↥S},   ↑s /ₒ t * (r /ₒ s) = r /ₒ t
参数：r /ₒ s。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `of_eq_true`：∀ {p : Prop}, p = True → p
· 使用定理 `Eq.trans`：∀ {α : Sort u} {a b c : α}, a = b → b = c → a = c
...
**OreLocalization.smul_cancel'** 是 Mathlib 中的一个定理，位于命名空间 `OreLocalization`。
形式化陈述：∀ {R : Type u_1} [inst : Monoid R] {S : Submonoid R} [inst_1 : OreLocaliza
tion.OreSet S] {X : Type u_2}   [inst_2 : MulAction R X] {r₁ : R} {r₂ : X} {s t 
: ↥S}, (r₁ * ↑s /ₒ t) • (r₂ /ₒ s) = r₁ • r₂ /ₒ t
参数：r₁ * ↑s /ₒ t；r₂ /ₒ s。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `of_eq_true`：∀ {p : Prop}, p = True → p
· 使用定理 `Eq.trans`：∀ {α : Sort u} {a b c : α}, a = b → b = c → a = c
...
**OreLocalization.mul_cancel'** 是 Mathlib 中的一个定理，位于命名空间 `OreLocalization`。
形式化陈述：∀ {R : Type u_1} [inst : Monoid R] {S : Submonoid R} [inst_1 : OreLocaliza
tion.OreSet S] {r₁ r₂ : R} {s t : ↥S},   r₁ * ↑s /ₒ t * (r₂ /ₒ s) = r₁ * r₂ /ₒ t
参数：r₂ /ₒ s。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `of_eq_true`：∀ {p : Prop}, p = True → p
· 使用定理 `Eq.trans`：∀ {α : Sort u} {a b c : α}, a = b → b = c → a = c
...
@[to_additive (attr := simp)]
/-
**OreLocalization.smul_div_one** 是 Mathlib 中的一个定理，位于命名空间 `OreLocalization`。
形式化陈述：smul_div_one {p : R} {r : X} {s : S} : (p /ₒ s) • (r /ₒ 1) = (p • r) /ₒ s
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `of_eq_true`：∀ {p : Prop}, p = True → p
· 使用定理 `Eq.trans`：∀ {α : Sort u} {a b c : α}, a = b → b = c → a = c
...
@[to_additive (attr := simp)]
/-
**OreLocalization.mul_div_one** 是 Mathlib 中的一个定理，位于命名空间 `OreLocalization`。
形式化陈述：mul_div_one {p r : R} {s : S} : (p /ₒ s) * (r /ₒ 1) = (p * r) /ₒ s
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `of_eq_true`：∀ {p : Prop}, p = True → p
· 使用定理 `Eq.trans`：∀ {α : Sort u} {a b c : α}, a = b → b = c → a = c
...
/-
**OreLocalization.numeratorUnit** 是 Mathlib 中的一个定义，位于命名空间 `OreLocalization`。
形式化陈述：numeratorUnit (s : S) : Units R[S⁻¹] where val
参数：s : S。
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**OreLocalization.numeratorHom** 是 Mathlib 中的一个缩写定义，位于命名空间 `OreLocalization`。
形式化陈述：numeratorHom : R ->* R[S⁻¹] where toFun r
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[to_additive]
/-
**OreLocalization.numeratorHom_apply** 是 Mathlib 中的一个定理，位于命名空间 `OreLocalization`
。
形式化陈述：numeratorHom_apply {r : R} : numeratorHom r = r /ₒ (1 : S)
该定理/引理给出了一组等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[to_additive]
/-
**OreLocalization.numerator_isUnit** 是 Mathlib 中的一个定理，位于命名空间 `OreLocalization`。
形式化陈述：numerator_isUnit (s : S) : IsUnit (numeratorHom (s : R) : R[S⁻¹])
参数：s : S。
该定理/引理描述了相关对象所满足的性质。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**OreLocalization.universalMulHom** 是 Mathlib 中的一个定义，位于命名空间 `OreLocalization`。
形式化陈述：universalMulHom (hf : forall s : S, f s = fS s) : R[S⁻¹] ->* T where toFun
 x
参数：hf : forall s : S, f s = fS s。
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[to_additive]
/-
**OreLocalization.universalMulHom_apply** 是 Mathlib 中的一个定理，位于命名空间 `OreLocalizati
on`。
形式化陈述：universalMulHom_apply {r : R} {s : S} : universalMulHom f fS hf (r /ₒ s) =
 ((fS s)⁻¹ : Units T) * f r
该定理/引理给出了一组等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[to_additive]
/-
**OreLocalization.universalMulHom_commutes** 是 Mathlib 中的一个定理，位于命名空间 `OreLocaliz
ation`。
形式化陈述：universalMulHom_commutes {r : R} : universalMulHom f fS hf (numeratorHom r
) = f r
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `of_eq_true`：∀ {p : Prop}, p = True → p
...
/-
**OreLocalization.universalMulHom_unique** 是 Mathlib 中的一个定理，位于命名空间 `OreLocalizat
ion`。
形式化陈述：universalMulHom_unique (φ : R[S⁻¹] ->* T) (huniv : forall r : R, φ (numera
torHom r) = f r) : φ = universalMulHom f fS hf
...
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
· 使用定理 `OreLocalization.universalMulHom_apply`：universalMulHom_apply {r : R} {s 
: S} : universalMulHom f fS hf (r /ₒ s) = ((fS s)⁻¹ : Units T) * f r
· 使用定理 `Eq.symm`：∀ {α : Sort u} {a b : α}, a = b → b = a
...
· 使用定理 `OreLocalization.mul_cancel`：∀ {R : Type u_1} [inst : Monoid R] {S : Subm
onoid R} [inst_1 : OreLocalization.OreSet S] {r : R} {s t : ↥S},   ↑s /ₒ t * (r 
/ₒ s) = r /ₒ t
...
/-
**OreLocalization.hsmul** 是 Mathlib 中的一个定义，位于命名空间 `OreLocalization`。
形式化陈述：{R : Type u_1} →   {M : Type u_3} →     {X : Type u_4} →       [inst : Mon
oid M] →         {S : Submonoid M} →           [inst_1 : OreLocalization.OreSet 
S] →             [inst_2 : MulAction M X] → [SMul R M] → R → OreLocalization S X
 → OreLocalization S X
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
@[to_additive]
/-
**OreLocalization.smul_oreDiv** 是 Mathlib 中的一个定理，位于命名空间 `OreLocalization`。
形式化陈述：smul_oreDiv (r : R) (x : X) (s : S) : r • (x /ₒ s) = oreNum (r • 1) s • x 
/ₒ oreDenom (r • 1) s
参数：r : R；x : X；s : S。
该定理/引理给出了一组等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
@[to_additive (attr := simp)]
/-
**OreLocalization.oreDiv_one_smul** 是 Mathlib 中的一个定理，位于命名空间 `OreLocalization`。
形式化陈述：oreDiv_one_smul (r : M) (x : X[S⁻¹]) : (r /ₒ (1 : S)) • x = r • x
参数：r : M；x : X[S⁻¹]。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `OreLocalization.ind`：∀ {R : Type u_1} [inst : Monoid R] {S : Submonoid R
...
@[to_additive]
/-
**OreLocalization.smul_one_smul** 是 Mathlib 中的一个定理，位于命名空间 `OreLocalization`。
形式化陈述：smul_one_smul (r : R) (x : X[S⁻¹]) : (r • 1 : M) • x = r • x
参数：r : R；x : X[S⁻¹]。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `OreLocalization.ind`：∀ {R : Type u_1} [inst : Monoid R] {S : Submonoid R
...
@[to_additive]
/-
**OreLocalization.smul_one_oreDiv_one_smul** 是 Mathlib 中的一个定理，位于命名空间 `OreLocaliz
ation`。
形式化陈述：smul_one_oreDiv_one_smul (r : R) (x : X[S⁻¹]) : ((r • 1 : M) /ₒ (1 : S)) •
 x = r • x
参数：r : R；x : X[S⁻¹]。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
· 使用定理 `OreLocalization.oreDiv_one_smul`：oreDiv_one_smul (r : M) (x : X[S⁻¹]) : 
(r /ₒ (1 : S)) • x = r • x
· 使用定理 `OreLocalization.smul_one_smul`：smul_one_smul (r : R) (x : X[S⁻¹]) : (r •
 1 : M) • x = r • x
-/
...
@[to_additive]
/-
**OreLocalization.smul_oreDiv_one** 是 Mathlib 中的一个定理，位于命名空间 `OreLocalization`。
形式化陈述：smul_oreDiv_one (r : R) (x : X) : r • (x /ₒ (1 : S)) = (r • x) /ₒ (1 : S)
参数：r : R；x : X。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
...
@[to_additive]
/-
**OreLocalization.oreDiv_mul_oreDiv_comm** 是 Mathlib 中的一个定理，位于命名空间 `OreLocalizat
ion`。
形式化陈述：oreDiv_mul_oreDiv_comm {r₁ r₂ : R} {s₁ s₂ : S} : r₁ /ₒ s₁ * (r₂ /ₒ s₂) = r
₁ * r₂ /ₒ (s₁ * s₂)
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
...
@[irreducible]
/-
**OreLocalization.zero** 是 Mathlib 中的一个定义，位于命名空间 `OreLocalization`。
形式化陈述：{R : Type u_1} →   [inst : Monoid R] →     {S : Submonoid R} →       [inst
_1 : OreLocalization.OreSet S] → {X : Type u_2} → [Zero X] → [inst_3 : MulAction
 R X] → OreLocalization S X
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**OreLocalization.zero_def** 是 Mathlib 中的一个定理，位于命名空间 `OreLocalization`。
形式化陈述：∀ {R : Type u_1} [inst : Monoid R] {S : Submonoid R} [inst_1 : OreLocaliza
tion.OreSet S] {X : Type u_2}   [inst_2 : Zero X] [inst_3 : MulAction R X], 0 = 
0 /ₒ 1
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
