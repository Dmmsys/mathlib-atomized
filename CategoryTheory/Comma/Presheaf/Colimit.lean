...
/--
Definition of `CostructuredArrow.toOverCompYonedaColimit` / `CostructuredArrow.toOverCompYonedaColimit` 的定义

English:
definition CostructuredArrow.toOverCompYonedaColimit
  signature: :
  body: calc
...
中文:
定义 CostructuredArrow.toOverCompYonedaColimit
  签名: :
  定义体: calc
  (CostructuredArrow.toOver yoneda A).op ⋙ yoneda.obj (colimit F)
    ≅ yoneda.op ⋙ yoneda.obj (E.obj (colimit F)) :=
