...
/--
theorem `TopologicalSpace.PositiveCompacts.locallyCompactSpace_of_group` / 定理 `TopologicalSpace.PositiveCompacts.locallyCompactSpace_of_group`

English:
theorem TopologicalSpace.PositiveCompacts.locallyCompactSpace_of_group
  proof: let ⟨_x, hx⟩ := K.interior_nonempty
...
Depends on / 依赖: K.interior_nonempty, K.isCompact.locallyCompactSpace_of_mem_nhds_of_group, interior_nonempty, isCompact, locallyCompactSpace_of_mem_nhds_of_group, mem_interior_iff_mem_nhds
-/
theorem TopologicalSpace.PositiveCompacts.locallyCompactSpace_of_group
