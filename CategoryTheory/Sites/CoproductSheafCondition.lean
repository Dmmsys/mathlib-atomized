...
noncomputable
/--
Definition of `PreZeroHypercover.isLimitSigmaOfIsColimitEquiv` / `PreZeroHypercover.isLimitSigmaOfIsColimitEquiv` 的定义

English:
definition PreZeroHypercover.isLimitSigmaOfIsColimitEquiv
  signature: (E : PreZeroHypercover.{w} S)
  body: by
...
def PreZeroHypercover.isLimitSigmaOfIsColimitEquiv (E : PreZeroHypercover.{w} S)
    ...
    [forall i, HasPullback (E.f i) ((E.sigmaOfIsColimit hc).f PUnit.unit)]
    (F : Cᵒᵖ ⥤ A)
...
/--
lemma `Presieve.isSheafFor_sigmaDesc_iff` / 引理 `Presieve.isSheafFor_sigmaDesc_iff`

English:
lemma Presieve.isSheafFor_sigmaDesc_iff
  statement: {ι : Type*} {X : ι -> C} (f : forall i, X i ⟶ S)
  proof: by
...
-/
lemma Presieve.isSheafFor_sigmaDesc_iff {ι : Type*} {X : ι -> C} (f : forall i, X i ⟶ S)
    ...
    [forall i, HasPullback (f i) (Cofan.IsColimit.desc hc f)]
    (F : Cᵒᵖ ⥤ Type*)
