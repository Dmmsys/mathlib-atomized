...
/--
lemma `Algebra.trace_quotient_mk` / 引理 `Algebra.trace_quotient_mk`

English:
lemma Algebra.trace_quotient_mk
  given: [IsLocalRing R] (x : S)
  proof: by
...
/--
lemma `trace_quotient_eq_trace_localization_quotient` / 引理 `trace_quotient_eq_trace_localization_quotient`

English:
lemma trace_quotient_eq_trace_localization_quotient
  given: (x)
  proof: by
...
/--
lemma `Algebra.trace_quotient_eq_of_isDedekindDomain` / 引理 `Algebra.trace_quotient_eq_of_isDedekindDomain`

English:
lemma Algebra.trace_quotient_eq_of_isDedekindDomain
  statement: (x) [IsDedekindDomain R] [IsDomain S]
  proof: by
