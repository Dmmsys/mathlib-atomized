...
/--
lemma `projective_iff_llp_epimorphisms_of_isZero` / 引理 `projective_iff_llp_epimorphisms_of_isZero`
...
中文:
引理 projective_iff_llp_epimorphisms_of_isZero
  证明: by
  obtain rfl := hZ.eq_of_src i 0
  constructor
  · intro _ X Y p (_ : Epi p)
...
Depends on / 依赖: CommSq, Projective, Projective.hasLiftingProperty_of_isZero, eq_of_src, hZ.eq_of_src, hasLiftingProperty_of_isZero, sq.lift
-/
lemma projective_iff_llp_epimorphisms_of_isZero
...
/--
lemma `projective_iff_llp_epimorphisms_zero` / 引理 `projective_iff_llp_epimorphisms_zero`

English:
lemma projective_iff_llp_epimorphisms_zero
  proof: projective_iff_llp_epimorphisms_of_isZero _ (isZero_zero C)

中文:
引理 projective_iff_llp_epimorphisms_zero
  证明: projective_iff_llp_epimorphisms_of_isZero _ (isZero_zero C)

Depends on / 依赖: isZero_zero, projective_iff_llp_epimorphisms_of_isZero
-/
lemma projective_iff_llp_epimorphisms_zero
