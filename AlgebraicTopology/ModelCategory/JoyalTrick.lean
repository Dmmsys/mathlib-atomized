...
/--
lemma `hasLiftingProperty_of_joyalTrick` / 引理 `hasLiftingProperty_of_joyalTrick`
...
set_option backward.isDefEq.respectTransparency false in
/--
lemma `hasLiftingProperty_of_joyalTrickDual` / 引理 `hasLiftingProperty_of_joyalTrickDual`
