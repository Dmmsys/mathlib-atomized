...
variable [forall (i : ι) (U : TopologicalSpace.Opens (X i)), IsGeneratedBy X U]

/--
lemma `IsOpen.isGeneratedBy` / 引理 `IsOpen.isGeneratedBy`

English:
lemma IsOpen.isGeneratedBy
  given: [IsGeneratedBy X Y] {U : Set Y} (hU : IsOpen U)
  proof: by
...
/--
lemma `Topology.IsOpenEmbedding.isGeneratedBy` / 引理 `Topology.IsOpenEmbedding.isGeneratedBy`

English:
lemma Topology.IsOpenEmbedding.isGeneratedBy
  statement: [IsGeneratedBy X Y]
  proof: have := hf.isOpen_range.isGeneratedBy (X := X)
...
Depends on / 依赖: hf.isOpen_range.isGeneratedBy, hf.toIsEmbedding.toHomeomorph.symm.isQuotientMap.isGeneratedBy, isGeneratedBy, isOpen_range, isQuotientMap, toHomeomorph, toIsEmbedding
-/
...
variable [forall (i : ι) (F : TopologicalSpace.Closeds (X i)), IsGeneratedBy X F]

/--
lemma `IsClosed.isGeneratedBy` / 引理 `IsClosed.isGeneratedBy`

English:
lemma IsClosed.isGeneratedBy
  given: [IsGeneratedBy X Y] {F : Set Y} (hF : IsClosed F)
  proof: by
...
/--
lemma `Topology.IsClosedEmbedding.isGeneratedBy` / 引理 `Topology.IsClosedEmbedding.isGeneratedBy`

English:
lemma Topology.IsClosedEmbedding.isGeneratedBy
  statement: [IsGeneratedBy X Y]
  proof: have := hf.isClosed_range.isGeneratedBy (X := X)
  hf.toIsEmbedding.toHomeomorph.symm.isQuotientMap.isGeneratedBy
...
Depends on / 依赖: hf.isClosed_range.isGeneratedBy, hf.toIsEmbedding.toHomeomorph.symm.isQuotientMap.isGeneratedBy, isClosed_range, isGeneratedBy, isQuotientMap, toHomeomorph, toIsEmbedding
-/
