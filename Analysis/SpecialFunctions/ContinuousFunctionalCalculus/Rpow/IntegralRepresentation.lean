...
/-
**Real.rpowIntegrand** 是 Mathlib 中的一个定义，位于命名空间 `Real`。
...
@[simp]
/-
**Real.rpowIntegrand** 是 Mathlib 中的一个引理，位于命名空间 `Real`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Real.continuousOn_rpowIntegrand** 是 Mathlib 中的一个引理，位于命名空间 `Real`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Real.aestronglyMeasurable_rpowIntegrand** 是 Mathlib 中的一个引理，位于命名空间 `Real`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Real.integrableOn_rpowIntegrand** 是 Mathlib 中的一个引理，位于命名空间 `Real`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
This lemma is private because it is strictly weaker than `integrableOn_rpowInteg
rand₀₁_Ioi`
-/
...
/-
**Real.integral_rpowIntegrand** 是 Mathlib 中的一个引理，位于命名空间 `Real`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Real.le_integral_rpowIntegrand** 是 Mathlib 中的一个引理，位于命名空间 `Real`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Real.rpow_eq_const_mul_integral** 是 Mathlib 中的一个引理，位于命名空间 `Real`。
形式化陈述：rpow_eq_const_mul_integral (hp : p in Ioo 0 1) (hx : 0 <= x) : x ^ p = (∫ 
t in Ioi 0, rpowIntegrand₀₁ p t 1)⁻¹ * ∫ t in Ioi 0, rpowIntegrand₀₁ p t x
参数：hp : p in Ioo 0 1；hx : 0 <= x。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
...
/-- The integral representation of the function `x ↦ x ^ p` (where `p ∈ (0, 1)`) . -/
/-
**Real.exists_measure_rpow_eq_integral_rpowIntegrand** 是 Mathlib 中的一个引理，位于命名空间 `
Real`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Real.monotoneOn_rpowIntegrand** 是 Mathlib 中的一个引理，位于命名空间 `Real`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Real.rpow_eq_const_mul_integral_rpowIntegrand** 是 Mathlib 中的一个引理，位于命名空间 `Real`
。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**CFC.cfc** 是 Mathlib 中的一个引理，位于命名空间 `CFC`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-- The integral representation of the function `x ↦ x ^ p` (where `p ∈ (0, 1)`). -/
/-
**CFC.exists_measure_nnrpow_eq_integral_cfc** 是 Mathlib 中的一个引理，位于命名空间 `CFC`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**CFC.concaveOn_cfc_rpowIntegrand** 是 Mathlib 中的一个引理，位于命名空间 `CFC`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**CFC.monotoneOn_cfc** 是 Mathlib 中的一个引理，位于命名空间 `CFC`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
`rpowIntegrand₀₁ p t` is operator monotone for all `p ∈ Ioo 0 1` and all `t ∈ Io
i 0`.
-/
...
/-
**CFC.concaveOn_cfc** 是 Mathlib 中的一个引理，位于命名空间 `CFC`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
