...
/-
**WeierstrassCurve.Projective** 是 Mathlib 中的一个缩写定义，位于命名空间 `WeierstrassCurve`。
形式化陈述：Projective : Type r
该定义给出了上述对象。
...
/-
**WeierstrassCurve.toProjective** 是 Mathlib 中的一个缩写定义，位于命名空间 `WeierstrassCurve`。
形式化陈述：toProjective (W : WeierstrassCurve R) : Projective R
...
/-
**WeierstrassCurve.Projective.toAffine** 是 Mathlib 中的一个缩写定义，位于命名空间 `WeierstrassC
urve.Projective`。
形式化陈述：toAffine (W' : Projective R) : Affine R
参数：W' : Projective R。
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
The conversion from a Weierstrass curve in projective coordinates to affine coor
dinates.
-/
abbrev toAffine (W' : Projective R) : Affine R :=
  W'
/-
**WeierstrassCurve.Projective.fin3_def** 是 Mathlib 中的一个引理，位于命名空间 `WeierstrassCur
ve.Projective`。
...
/-
**WeierstrassCurve.Projective.fin3_def_ext** 是 Mathlib 中的一个引理，位于命名空间 `Weierstras
sCurve.Projective`。
...
lemma fin3_def_ext (a b c : R) : ![a, b, c] x = a ∧ ![a, b, c] y = b ∧ ![a, b, c] z = c :=
  ⟨rfl, rfl, rfl⟩
/-
**WeierstrassCurve.Projective.comp_fin3** 是 Mathlib 中的一个引理，位于命名空间 `WeierstrassCu
rve.Projective`。
...
/-
**WeierstrassCurve.Projective.smul_fin3** 是 Mathlib 中的一个引理，位于命名空间 `WeierstrassCu
rve.Projective`。
形式化陈述：smul_fin3 (P : Fin 3 -> R) (u : R) : u • P = ![u * P x, u * P y, u * P z]
参数：P : Fin 3 -> R；u : R。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
...
/-
**WeierstrassCurve.Projective.smul_fin3_ext** 是 Mathlib 中的一个引理，位于命名空间 `Weierstra
ssCurve.Projective`。
形式化陈述：smul_fin3_ext (P : Fin 3 -> R) (u : R) : (u • P) x = u * P x ∧ (u • P) y =
 u * P y ∧ (u • P) z = u * P z
参数：P : Fin 3 -> R；u : R。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
...
lemma smul_fin3_ext (P : Fin 3 → R) (u : R) :
  ...
  ⟨rfl, rfl, rfl⟩
/-
**WeierstrassCurve.Projective.comp_smul** 是 Mathlib 中的一个引理，位于命名空间 `WeierstrassCu
rve.Projective`。
...
@[reducible]
/-
**WeierstrassCurve.Projective.** 是 Mathlib 中的一个实例，位于命名空间 `WeierstrassCurve.Proje
ctive`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
The equivalence setoid for a projective point representative on a Weierstrass cu
rve.
-/
...
/-
**WeierstrassCurve.Projective.PointClass** 是 Mathlib 中的一个缩写定义，位于命名空间 `Weierstras
sCurve.Projective`。
...
--- 原说明 ---
The equivalence class of a projective point representative on a Weierstrass curv
e.
-/
abbrev PointClass : Type r :=
  MulAction.orbitRel.Quotient Rˣ <| Fin 3 → R
/-
**WeierstrassCurve.Projective.smul_equiv** 是 Mathlib 中的一个引理，位于命名空间 `WeierstrassC
urve.Projective`。
...
@[simp]
/-
**WeierstrassCurve.Projective.smul_eq** 是 Mathlib 中的一个引理，位于命名空间 `WeierstrassCurv
e.Projective`。
...
⟧ ↔ r x y
· 使用引理 `WeierstrassCurve.Projective.smul_equiv`：smul_equiv (P : Fin 3 -> R) {u :
 R} (hu : IsUnit u) : u • P ≈ P
-/
lemma smul_eq (P : Fin 3 → R) {u : R} (hu : IsUnit u) : (⟦u • P⟧ : PointClass R) = ⟦P⟧ :=
  Quotient.eq.mpr <| smul_equiv P hu
/-
**WeierstrassCurve.Projective.smul_equiv_smul** 是 Mathlib 中的一个引理，位于命名空间 `Weierst
...
/-
**WeierstrassCurve.Projective.equiv_iff_eq_of_Z_eq'** 是 Mathlib 中的一个引理，位于命名空间 `W
...
lemma equiv_iff_eq_of_Z_eq' {P Q : Fin 3 → R} (hz : P z = Q z) (hQz : Q z ∈ nonZeroDivisors R) :
  ...
  rw [one_smul]
/-
**WeierstrassCurve.Projective.equiv_iff_eq_of_Z_eq** 是 Mathlib 中的一个引理，位于命名空间 `We
ierstrassCurve.Projective`。
...
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `Nat.instNeZeroSucc`：∀ {n : ℕ}, NeZero (n + 1)
· 使用引理 `WeierstrassCurve.Projective.equiv_iff_eq_of_Z_eq'`：equiv_iff_eq_of_Z_eq'
 {P Q : Fin 3 -> R} (hz : P z = Q z) (hQz : Q z in nonZeroDivisors R) : P ≈ Q ↔ 
P = Q
...
/-
**WeierstrassCurve.Projective.Z_eq_zero_of_equiv** 是 Mathlib 中的一个引理，位于命名空间 `Weie
rstrassCurve.Projective`。
...
/-
**WeierstrassCurve.Projective.X_eq_of_equiv** 是 Mathlib 中的一个引理，位于命名空间 `Weierstra
ssCurve.Projective`。
形式化陈述：X_eq_of_equiv {P Q : Fin 3 -> R} (h : P ≈ Q) : P x * Q z = Q x * P z
参数：h : P ≈ Q。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `Nat.instNeZeroSucc`：∀ {n : ℕ}, NeZero (n + 1)
...
lemma X_eq_of_equiv {P Q : Fin 3 → R} (h : P ≈ Q) : P x * Q z = Q x * P z := by
  ...
  ring1
/-
**WeierstrassCurve.Projective.Y_eq_of_equiv** 是 Mathlib 中的一个引理，位于命名空间 `Weierstra
ssCurve.Projective`。
形式化陈述：Y_eq_of_equiv {P Q : Fin 3 -> R} (h : P ≈ Q) : P y * Q z = Q y * P z
参数：h : P ≈ Q。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `Nat.instNeZeroSucc`：∀ {n : ℕ}, NeZero (n + 1)
...
lemma Y_eq_of_equiv {P Q : Fin 3 → R} (h : P ≈ Q) : P y * Q z = Q y * P z := by
  ...
  ring1
/-
**WeierstrassCurve.Projective.not_equiv_of_Z_eq_zero_left** 是 Mathlib 中的一个引理，位于命
名空间 `WeierstrassCurve.Projective`。
...
· 使用定理 `Nat.instNeZeroSucc`：∀ {n : ℕ}, NeZero (n + 1)
· 使用定理 `Iff.mp`：∀ {a b : Prop}, (a ↔ b) → a → b
· 使用引理 `WeierstrassCurve.Projective.Z_eq_zero_of_equiv`：Z_eq_zero_of_equiv {P Q 
...
/-
**WeierstrassCurve.Projective.not_equiv_of_Z_eq_zero_right** 是 Mathlib 中的一个引理，位于
...
/-
**WeierstrassCurve.Projective.not_equiv_of_X_ne** 是 Mathlib 中的一个引理，位于命名空间 `Weier
strassCurve.Projective`。
形式化陈述：not_equiv_of_X_ne {P Q : Fin 3 -> R} (hx : P x * Q z != Q x * P z) : ¬P ≈ 
Q
参数：hx : P x * Q z != Q x * P z。
该定理/引理描述了相关对象所满足的性质。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `Nat.instNeZeroSucc`：∀ {n : ℕ}, NeZero (n + 1)
· 使用引理 `WeierstrassCurve.Projective.X_eq_of_equiv`：X_eq_of_equiv {P Q : Fin 3 ->
 R} (h : P ≈ Q) : P x * Q z = Q x * P z
-/
lemma not_equiv_of_X_ne {P Q : Fin 3 → R} (hx : P x * Q z ≠ Q x * P z) : ¬P ≈ Q :=
  hx.comp X_eq_of_equiv
/-
**WeierstrassCurve.Projective.not_equiv_of_Y_ne** 是 Mathlib 中的一个引理，位于命名空间 `Weier
strassCurve.Projective`。
形式化陈述：not_equiv_of_Y_ne {P Q : Fin 3 -> R} (hy : P y * Q z != Q y * P z) : ¬P ≈ 
Q
参数：hy : P y * Q z != Q y * P z。
该定理/引理描述了相关对象所满足的性质。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `Nat.instNeZeroSucc`：∀ {n : ℕ}, NeZero (n + 1)
· 使用引理 `WeierstrassCurve.Projective.Y_eq_of_equiv`：Y_eq_of_equiv {P Q : Fin 3 ->
 R} (h : P ≈ Q) : P y * Q z = Q y * P z
-/
lemma not_equiv_of_Y_ne {P Q : Fin 3 → R} (hy : P y * Q z ≠ Q y * P z) : ¬P ≈ Q :=
  hy.comp Y_eq_of_equiv
/-
**WeierstrassCurve.Projective.equiv_of_X_eq_of_Y_eq** 是 Mathlib 中的一个引理，位于命名空间 `W
eierstrassCurve.Projective`。
形式化陈述：equiv_of_X_eq_of_Y_eq {P Q : Fin 3 -> F} (hPz : P z != 0) (hQz : Q z != 0)
 (hx : P x * Q z = Q x * P z) (hy : P y * Q z = Q y * P z) : P ≈ Q
参数：hPz : P z != 0；hQz : Q z != 0；hx : P x * Q z = Q x * P z；hy : P y * Q z = Q y
 * P z。
该定理/引理描述了相关对象所满足的性质。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `Nat.instNeZeroSucc`：∀ {n : ℕ}, NeZero (n + 1)
...
· 使用引理 `WeierstrassCurve.Projective.fin3_def`：fin3_def (P : Fin 3 -> R) : ![P x,
 P y, P z] = P
· 使用定理 `eq_self`：∀ {α : Sort u_1} (a : α), (a = a) = True
-/
...
/-
**WeierstrassCurve.Projective.equiv_some_of_Z_ne_zero** 是 Mathlib 中的一个引理，位于命名空间 
...
/-
**WeierstrassCurve.Projective.X_eq_iff** 是 Mathlib 中的一个引理，位于命名空间 `WeierstrassCur
ve.Projective`。
形式化陈述：X_eq_iff {P Q : Fin 3 -> F} (hPz : P z != 0) (hQz : Q z != 0) : P x * Q z 
= Q x * P z ↔ P x / P z = Q x / Q z
参数：hPz : P z != 0；hQz : Q z != 0。
该定理/引理刻画了左右两侧的等价关系。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `Nat.instNeZeroSucc`：∀ {n : ℕ}, NeZero (n + 1)
...
/-
**WeierstrassCurve.Projective.Y_eq_iff** 是 Mathlib 中的一个引理，位于命名空间 `WeierstrassCur
ve.Projective`。
形式化陈述：Y_eq_iff {P Q : Fin 3 -> F} (hPz : P z != 0) (hQz : Q z != 0) : P y * Q z 
= Q y * P z ↔ P y / P z = Q y / Q z
参数：hPz : P z != 0；hQz : Q z != 0。
该定理/引理刻画了左右两侧的等价关系。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `Nat.instNeZeroSucc`：∀ {n : ℕ}, NeZero (n + 1)
...
/-
**WeierstrassCurve.Projective.polynomial** 是 Mathlib 中的一个定义，位于命名空间 `WeierstrassC
urve.Projective`。
...
/-
**WeierstrassCurve.Projective.eval_polynomial** 是 Mathlib 中的一个引理，位于命名空间 `Weierst
rassCurve.Projective`。
形式化陈述：eval_polynomial (P : Fin 3 -> R) : eval P W'.polynomial = P y ^ 2 * P z + 
W'.a₁ * P x * P y * P z + W'.a₃ * P y * P z ^ 2 - (P x ^ 3 + W'.a₂ * P x ^ 2 * P
 z + W'.a₄ * P x * P z ^ 2 + W'.a₆ * P z ^ 3)
参数：P : Fin 3 -> R。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `Nat.instNeZeroSucc`：∀ {n : ℕ}, NeZero (n + 1)
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
· 使用定理 `WeierstrassCurve.Projective.polynomial.eq_1`：∀ {R : Type r} [inst : Comm
Ring R] (W' : WeierstrassCurve.Projective R),   W'.polynomial =     MvPolynomial
.X 1 ^ 2 * MvPolynomial.X 2 +    …
· 使用定理 `of_eq_true`：∀ {p : Prop}, p = True → p
· 使用定理 `Eq.trans`：∀ {α : Sort u} {a b c : α}, a = b → b = c → a = c
· 使用定理 `congrFun'`：∀ {α : Sort u} {β : Sort v} {f g : α → β}, f = g → ∀ (a : α),
 f a = g a
...
lemma eval_polynomial (P : Fin 3 → R) : eval P W'.polynomial =
  ...
  simp
/-
**WeierstrassCurve.Projective.eval_polynomial_of_Z_ne_zero** 是 Mathlib 中的一个引理，位于
命名空间 `WeierstrassCurve.Projective`。
形式化陈述：eval_polynomial_of_Z_ne_zero {P : Fin 3 -> F} (hPz : P z != 0) : eval P W.
polynomial / P z ^ 3 = W.toAffine.polynomial.evalEval (P x / P z) (P y / P z)
参数：hPz : P z != 0。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `Nat.instNeZeroSucc`：∀ {n : ℕ}, NeZero (n + 1)
...
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
· 使用引理 `WeierstrassCurve.Projective.eval_polynomial`：eval_polynomial (P : Fin 3 
-> R) : eval P W'.polynomial = P y ^ 2 * P z + W'.a₁ * P x * P y * P z + W'.a₃ *
 P y * P z ^ 2 - (P x ^ 3 + W'.a₂…
...
/-
**WeierstrassCurve.Projective.Equation** 是 Mathlib 中的一个定义，位于命名空间 `WeierstrassCur
ve.Projective`。
...
--- 原说明 ---
The proposition that a projective point representative `(x, y, z)` lies in a Wei
erstrass curve
`W`.

In other words, it satisfies the homogeneous Weierstrass equation `W(X, Y, Z) = 
0`.
-/
def Equation (P : Fin 3 → R) : Prop :=
  eval P W'.polynomial = 0
/-
**WeierstrassCurve.Projective.equation_iff** 是 Mathlib 中的一个引理，位于命名空间 `Weierstras
sCurve.Projective`。
形式化陈述：equation_iff (P : Fin 3 -> R) : W'.Equation P ↔ P y ^ 2 * P z + W'.a₁ * P 
x * P y * P z + W'.a₃ * P y * P z ^ 2 - (P x ^ 3 + W'.a₂ * P x ^ 2 * P z + W'.a₄
 * P x * P z ^ 2 + W'.a₆ * P z ^ 3) = 0
参数：P : Fin 3 -> R。
该定理/引理刻画了左右两侧的等价关系。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `Nat.instNeZeroSucc`：∀ {n : ℕ}, NeZero (n + 1)
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
· 使用定理 `WeierstrassCurve.Projective.Equation.eq_1`：∀ {R : Type r} [inst : CommRi
ng R] (W' : WeierstrassCurve.Projective R) (P : Fin 3 → R),   W'.Equation P = ((
MvPolynomial.eval P) W'.polynom…
· 使用引理 `WeierstrassCurve.Projective.eval_polynomial`：eval_polynomial (P : Fin 3 
-> R) : eval P W'.polynomial = P y ^ 2 * P z + W'.a₁ * P x * P y * P z + W'.a₃ *
 P y * P z ^ 2 - (P x ^ 3 + W'.a₂…
...
/-
**WeierstrassCurve.Projective.equation_smul** 是 Mathlib 中的一个引理，位于命名空间 `Weierstra
ssCurve.Projective`。
...
/-
**WeierstrassCurve.Projective.equation_of_equiv** 是 Mathlib 中的一个引理，位于命名空间 `Weier
strassCurve.Projective`。
...
该定理/引理刻画了左右两侧的等价关系。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用引理 `WeierstrassCurve.Projective.equation_smul`：equation_smul (P : Fin 3 -> R
...
/-
**WeierstrassCurve.Projective.equation_of_Z_eq_zero** 是 Mathlib 中的一个引理，位于命名空间 `W
eierstrassCurve.Projective`。
...
lemma equation_of_Z_eq_zero {P : Fin 3 → R} (hPz : P z = 0) : W'.Equation P ↔ P x ^ 3 = 0 := by
  simp only [equation_iff, hPz, add_zero, zero_sub, mul_zero, zero_pow <| OfNat.ofNat_ne_zero _,
    neg_eq_zero]
/-
**WeierstrassCurve.Projective.equation_zero** 是 Mathlib 中的一个引理，位于命名空间 `Weierstra
ssCurve.Projective`。
形式化陈述：equation_zero : W'.Equation ![0, 1, 0]
该定理/引理描述了相关对象所满足的性质。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `of_eq_true`：∀ {p : Prop}, p = True → p
· 使用定理 `Eq.trans`：∀ {α : Sort u} {a b c : α}, a = b → b = c → a = c
...
/-
**WeierstrassCurve.Projective.equation_some** 是 Mathlib 中的一个引理，位于命名空间 `Weierstra
ssCurve.Projective`。
...
/-
**WeierstrassCurve.Projective.equation_of_Z_ne_zero** 是 Mathlib 中的一个引理，位于命名空间 `W
eierstrassCurve.Projective`。
形式化陈述：equation_of_Z_ne_zero {P : Fin 3 -> F} (hPz : P z != 0) : W.Equation P ↔ W
.toAffine.Equation (P x / P z) (P y / P z)
参数：hPz : P z != 0。
该定理/引理刻画了左右两侧的等价关系。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `Nat.instNeZeroSucc`：∀ {n : ℕ}, NeZero (n + 1)
· 使用定理 `Iff.trans`：∀ {a b c : Prop}, (a ↔ b) → (b ↔ c) → (a ↔ c)
· 使用引理 `WeierstrassCurve.Projective.equation_of_equiv`：equation_of_equiv {P Q : 
Fin 3 -> R} (h : P ≈ Q) : W'.Equation P ↔ W'.Equation Q
· 使用引理 `WeierstrassCurve.Projective.equiv_some_of_Z_ne_zero`：equiv_some_of_Z_ne_
zero {P : Fin 3 -> F} (hPz : P z != 0) : P ≈ ![P x / P z, P y / P z, 1]
· 使用引理 `WeierstrassCurve.Projective.equation_some`：equation_some (a b : R) : W'.
Equation ![a, b, 1] ↔ W'.toAffine.Equation a b
-/
...
/-
**WeierstrassCurve.Projective.X_eq_zero_of_Z_eq_zero** 是 Mathlib 中的一个引理，位于命名空间 `
WeierstrassCurve.Projective`。
形式化陈述：X_eq_zero_of_Z_eq_zero [NoZeroDivisors R] {P : Fin 3 -> R} (hP : W'.Equati
on P) (hPz : P z = 0) : P x = 0
...
· 使用定理 `Iff.mp`：∀ {a b : Prop}, (a ↔ b) → a → b
· 使用引理 `WeierstrassCurve.Projective.equation_of_Z_eq_zero`：equation_of_Z_eq_zero
 {P : Fin 3 -> R} (hPz : P z = 0) : W'.Equation P ↔ P x ^ 3 = 0
-/
...
/-
**WeierstrassCurve.Projective.polynomialX** 是 Mathlib 中的一个定义，位于命名空间 `Weierstrass
Curve.Projective`。
...
/-
**WeierstrassCurve.Projective.polynomialX_eq** 是 Mathlib 中的一个引理，位于命名空间 `Weierstr
assCurve.Projective`。
...
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
· 使用定理 `WeierstrassCurve.Projective.polynomialX.eq_1`：∀ {R : Type r} [inst : Com
mRing R] (W' : WeierstrassCurve.Projective R),   W'.polynomialX = (MvPolynomial.
...
lemma polynomialX_eq : W'.polynomialX =
  ...
  ring1
/-
**WeierstrassCurve.Projective.eval_polynomialX** 是 Mathlib 中的一个引理，位于命名空间 `Weiers
trassCurve.Projective`。
形式化陈述：eval_polynomialX (P : Fin 3 -> R) : eval P W'.polynomialX = W'.a₁ * P y * 
P z - (3 * P x ^ 2 + 2 * W'.a₂ * P x * P z + W'.a₄ * P z ^ 2)
参数：P : Fin 3 -> R。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `Nat.instNeZeroSucc`：∀ {n : ℕ}, NeZero (n + 1)
...
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
· 使用引理 `WeierstrassCurve.Projective.polynomialX_eq`：polynomialX_eq : W'.polynomi
alX = C W'.a₁ * Y * Z - (C 3 * X ^ 2 + C (2 * W'.a₂) * X * Z + C W'.a₄ * Z ^ 2)
· 使用定理 `of_eq_true`：∀ {p : Prop}, p = True → p
· 使用定理 `Eq.trans`：∀ {α : Sort u} {a b c : α}, a = b → b = c → a = c
· 使用定理 `congrFun'`：∀ {α : Sort u} {β : Sort v} {f g : α → β}, f = g → ∀ (a : α),
 f a = g a
...
lemma eval_polynomialX (P : Fin 3 → R) : eval P W'.polynomialX =
  ...
  simp
/-
**WeierstrassCurve.Projective.eval_polynomialX_of_Z_ne_zero** 是 Mathlib 中的一个引理，位
于命名空间 `WeierstrassCurve.Projective`。
形式化陈述：eval_polynomialX_of_Z_ne_zero {P : Fin 3 -> F} (hPz : P z != 0) : eval P W
.polynomialX / P z ^ 2 = W.toAffine.polynomialX.evalEval (P x / P z) (P y / P z)
参数：hPz : P z != 0。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `Nat.instNeZeroSucc`：∀ {n : ℕ}, NeZero (n + 1)
...
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
· 使用引理 `WeierstrassCurve.Projective.eval_polynomialX`：eval_polynomialX (P : Fin 
3 -> R) : eval P W'.polynomialX = W'.a₁ * P y * P z - (3 * P x ^ 2 + 2 * W'.a₂ *
 P x * P z + W'.a₄ * P z ^ 2)
...
associated to a Weierstrass curve `W` in projective coordinates. -/
/-
**WeierstrassCurve.Projective.polynomialY** 是 Mathlib 中的一个定义，位于命名空间 `Weierstrass
Curve.Projective`。
...
/-
**WeierstrassCurve.Projective.polynomialY_eq** 是 Mathlib 中的一个引理，位于命名空间 `Weierstr
assCurve.Projective`。
形式化陈述：polynomialY_eq : W'.polynomialY = C 2 * Y * Z + C W'.a₁ * X * Z + C W'.a₃ 
* Z ^ 2
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `Nat.instAtLeastTwoHAddOfNat`：∀ (n : ℕ) [NeZero n], (n + 1).AtLeastTwo
...
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
· 使用定理 `WeierstrassCurve.Projective.polynomialY.eq_1`：∀ {R : Type r} [inst : Com
mRing R] (W' : WeierstrassCurve.Projective R),   W'.polynomialY = (MvPolynomial.
...
lemma polynomialY_eq : W'.polynomialY =
  ...
  ring1
/-
**WeierstrassCurve.Projective.eval_polynomialY** 是 Mathlib 中的一个引理，位于命名空间 `Weiers
trassCurve.Projective`。
形式化陈述：eval_polynomialY (P : Fin 3 -> R) : eval P W'.polynomialY = 2 * P y * P z 
+ W'.a₁ * P x * P z + W'.a₃ * P z ^ 2
参数：P : Fin 3 -> R。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `Nat.instAtLeastTwoHAddOfNat`：∀ (n : ℕ) [NeZero n], (n + 1).AtLeastTwo
...
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
· 使用引理 `WeierstrassCurve.Projective.polynomialY_eq`：polynomialY_eq : W'.polynomi
alY = C 2 * Y * Z + C W'.a₁ * X * Z + C W'.a₃ * Z ^ 2
· 使用定理 `of_eq_true`：∀ {p : Prop}, p = True → p
· 使用定理 `Eq.trans`：∀ {α : Sort u} {a b c : α}, a = b → b = c → a = c
· 使用定理 `congrFun'`：∀ {α : Sort u} {β : Sort v} {f g : α → β}, f = g → ∀ (a : α),
 f a = g a
...
lemma eval_polynomialY (P : Fin 3 → R) :
  ...
  simp
/-
**WeierstrassCurve.Projective.eval_polynomialY_of_Z_ne_zero** 是 Mathlib 中的一个引理，位
于命名空间 `WeierstrassCurve.Projective`。
形式化陈述：eval_polynomialY_of_Z_ne_zero {P : Fin 3 -> F} (hPz : P z != 0) : eval P W
.polynomialY / P z ^ 2 = W.toAffine.polynomialY.evalEval (P x / P z) (P y / P z)
参数：hPz : P z != 0。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `Nat.instNeZeroSucc`：∀ {n : ℕ}, NeZero (n + 1)
...
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
· 使用引理 `WeierstrassCurve.Projective.eval_polynomialY`：eval_polynomialY (P : Fin 
3 -> R) : eval P W'.polynomialY = 2 * P y * P z + W'.a₁ * P x * P z + W'.a₃ * P 
z ^ 2
...
associated to a Weierstrass curve `W` in projective coordinates. -/
/-
**WeierstrassCurve.Projective.polynomialZ** 是 Mathlib 中的一个定义，位于命名空间 `Weierstrass
Curve.Projective`。
...
/-
**WeierstrassCurve.Projective.polynomialZ_eq** 是 Mathlib 中的一个引理，位于命名空间 `Weierstr
assCurve.Projective`。
形式化陈述：polynomialZ_eq : W'.polynomialZ = Y ^ 2 + C W'.a₁ * X * Y + C (2 * W'.a₃) 
* Y * Z - (C W'.a₂ * X ^ 2 + C (2 * W'.a₄) * X * Z + C (3 * W'.a₆) * Z ^ 2)
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `Nat.instNeZeroSucc`：∀ {n : ℕ}, NeZero (n + 1)
· 使用定理 `Nat.instAtLeastTwoHAddOfNat`：∀ (n : ℕ) [NeZero n], (n + 1).AtLeastTwo
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
· 使用定理 `WeierstrassCurve.Projective.polynomialZ.eq_1`：∀ {R : Type r} [inst : Com
mRing R] (W' : WeierstrassCurve.Projective R),   W'.polynomialZ = (MvPolynomial.
...
lemma polynomialZ_eq : W'.polynomialZ =
  ...
  ring1
/-
**WeierstrassCurve.Projective.eval_polynomialZ** 是 Mathlib 中的一个引理，位于命名空间 `Weiers
trassCurve.Projective`。
形式化陈述：eval_polynomialZ (P : Fin 3 -> R) : eval P W'.polynomialZ = P y ^ 2 + W'.a
₁ * P x * P y + 2 * W'.a₃ * P y * P z - (W'.a₂ * P x ^ 2 + 2 * W'.a₄ * P x * P z
 + 3 * W'.a₆ * P z ^ 2)
参数：P : Fin 3 -> R。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
...
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
· 使用引理 `WeierstrassCurve.Projective.polynomialZ_eq`：polynomialZ_eq : W'.polynomi
alZ = Y ^ 2 + C W'.a₁ * X * Y + C (2 * W'.a₃) * Y * Z - (C W'.a₂ * X ^ 2 + C (2 
* W'.a₄) * X * Z + C (3 * W'.a₆)…
· 使用定理 `of_eq_true`：∀ {p : Prop}, p = True → p
· 使用定理 `Eq.trans`：∀ {α : Sort u} {a b c : α}, a = b → b = c → a = c
· 使用定理 `congrFun'`：∀ {α : Sort u} {β : Sort v} {f g : α → β}, f = g → ∀ (a : α),
...
/-
**WeierstrassCurve.Projective.polynomial_relation** 是 Mathlib 中的一个定理，位于命名空间 `Wei
erstrassCurve.Projective`。
形式化陈述：polynomial_relation (P : Fin 3 -> R) : 3 * eval P W'.polynomial = P x * ev
al P W'.polynomialX + P y * eval P W'.polynomialY + P z * eval P W'.polynomialZ
参数：P : Fin 3 -> R。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `Nat.instAtLeastTwoHAddOfNat`：∀ (n : ℕ) [NeZero n], (n + 1).AtLeastTwo
...
3 -> R) : eval P W'.polynomialY = 2 * P y * P z + W'.a₁ * P x * P z + W'.a₃ * P 
z ^ 2
· 使用引理 `WeierstrassCurve.Projective.eval_polynomialZ`：eval_polynomialZ (P : Fin 
3 -> R) : eval P W'.polynomialZ = P y ^ 2 + W'.a₁ * P x * P y + 2 * W'.a₃ * P y 
* P z - (W'.a₂ * P x ^ 2 + 2 * W'.…
· 使用定理 `Mathlib.Tactic.Ring.of_eq`：∀ {α : Sort u_2} {a b c : α}, a = c → b = c →
 a = b
· 使用定理 `Mathlib.Tactic.Ring.Common.mul_congr`：∀ {R : Type u_1} [inst : CommSemir
...
/-
**WeierstrassCurve.Projective.Nonsingular** 是 Mathlib 中的一个定义，位于命名空间 `Weierstrass
Curve.Projective`。
...
/-
**WeierstrassCurve.Projective.nonsingular_iff** 是 Mathlib 中的一个引理，位于命名空间 `Weierst
rassCurve.Projective`。
形式化陈述：nonsingular_iff (P : Fin 3 -> R) : W'.Nonsingular P ↔ W'.Equation P ∧ (W'.
a₁ * P y * P z - (3 * P x ^ 2 + 2 * W'.a₂ * P x * P z + W'.a₄ * P z ^ 2) != 0 ∨ 
2 * P y * P z + W'.a₁ * P x * P z + W'.a₃ * P z ^ 2 != 0 ∨ P y ^ 2 + W'.a₁ * P x
 * P y + 2 * W'.a₃ * P y * P z - (W'.a₂ * P x ^ 2 + 2 * W'.a₄ * P x * P z + 3 * 
W'.a₆ * P z ^ 2) != 0)
参数：P : Fin 3 -> R。
该定理/引理刻画了左右两侧的等价关系。
黑盒证明引用了以下数学事实（定理与引理）：
...
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
· 使用定理 `WeierstrassCurve.Projective.Nonsingular.eq_1`：∀ {R : Type r} [inst : Com
mRing R] (W' : WeierstrassCurve.Projective R) (P : Fin 3 → R),   W'.Nonsingular 
P =     (W'.Equation P ∧       ((M…
· 使用引理 `WeierstrassCurve.Projective.eval_polynomialX`：eval_polynomialX (P : Fin 
3 -> R) : eval P W'.polynomialX = W'.a₁ * P y * P z - (3 * P x ^ 2 + 2 * W'.a₂ *
 P x * P z + W'.a₄ * P z ^ 2)
...
/-
**WeierstrassCurve.Projective.nonsingular_smul** 是 Mathlib 中的一个引理，位于命名空间 `Weiers
trassCurve.Projective`。
...
· 使用定理 `Nat.instAtLeastTwoHAddOfNat`：∀ (n : ℕ) [NeZero n], (n + 1).AtLeastTwo
· 使用定理 `Iff.mp`：∀ {a b : Prop}, (a ↔ b) → a → b
· 使用引理 `WeierstrassCurve.Projective.nonsingular_iff`：nonsingular_iff (P : Fin 3 
...
/-
**WeierstrassCurve.Projective.nonsingular_of_equiv** 是 Mathlib 中的一个引理，位于命名空间 `We
ierstrassCurve.Projective`。
...
/-
**WeierstrassCurve.Projective.nonsingular_of_Z_eq_zero** 是 Mathlib 中的一个引理，位于命名空间
 `WeierstrassCurve.Projective`。
形式化陈述：nonsingular_of_Z_eq_zero {P : Fin 3 -> R} (hPz : P z = 0) : W'.Nonsingular
 P ↔ W'.Equation P ∧ (3 * P x ^ 2 != 0 ∨ P y ^ 2 + W'.a₁ * P x * P y - W'.a₂ * P
 x ^ 2 != 0)
参数：hPz : P z = 0。
该定理/引理刻画了左右两侧的等价关系。
黑盒证明引用了以下数学事实（定理与引理）：
...
/-
**WeierstrassCurve.Projective.nonsingular_zero** 是 Mathlib 中的一个引理，位于命名空间 `Weiers
trassCurve.Projective`。
形式化陈述：nonsingular_zero [Nontrivial R] : W'.Nonsingular ![0, 1, 0]
该定理/引理描述了相关对象所满足的性质。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `Nat.instAtLeastTwoHAddOfNat`：∀ (n : ℕ) [NeZero n], (n + 1).AtLeastTwo
· 使用定理 `Nat.instNeZeroSucc`：∀ {n : ℕ}, NeZero (n + 1)
...
/-
**WeierstrassCurve.Projective.nonsingular_some** 是 Mathlib 中的一个引理，位于命名空间 `Weiers
trassCurve.Projective`。
...
/-
**WeierstrassCurve.Projective.nonsingular_of_Z_ne_zero** 是 Mathlib 中的一个引理，位于命名空间
 `WeierstrassCurve.Projective`。
形式化陈述：nonsingular_of_Z_ne_zero {P : Fin 3 -> F} (hPz : P z != 0) : W.Nonsingular
 P ↔ W.toAffine.Nonsingular (P x / P z) (P y / P z)
参数：hPz : P z != 0。
该定理/引理刻画了左右两侧的等价关系。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `Nat.instNeZeroSucc`：∀ {n : ℕ}, NeZero (n + 1)
· 使用定理 `Iff.trans`：∀ {a b c : Prop}, (a ↔ b) → (b ↔ c) → (a ↔ c)
· 使用引理 `WeierstrassCurve.Projective.nonsingular_of_equiv`：nonsingular_of_equiv {
P Q : Fin 3 -> R} (h : P ≈ Q) : W'.Nonsingular P ↔ W'.Nonsingular Q
· 使用引理 `WeierstrassCurve.Projective.equiv_some_of_Z_ne_zero`：equiv_some_of_Z_ne_
zero {P : Fin 3 -> F} (hPz : P z != 0) : P ≈ ![P x / P z, P y / P z, 1]
...
/-
**WeierstrassCurve.Projective.nonsingular_iff_of_Z_ne_zero** 是 Mathlib 中的一个引理，位于
命名空间 `WeierstrassCurve.Projective`。
...
· 使用定理 `Eq.symm`：∀ {α : Sort u} {a b : α}, a = b → b = a
· 使用引理 `WeierstrassCurve.Projective.equation_of_Z_ne_zero`：equation_of_Z_ne_zero
 {P : Fin 3 -> F} (hPz : P z != 0) : W.Equation P ↔ W.toAffine.Equation (P x / P
 z) (P y / P z)
· 使用引理 `WeierstrassCurve.Projective.eval_polynomialX_of_Z_ne_zero`：eval_polynomi
alX_of_Z_ne_zero {P : Fin 3 -> F} (hPz : P z != 0) : eval P W.polynomialX / P z 
^ 2 = W.toAffine.polynomialX.evalEval (P x / P …
...
in α], NoZeroDivisors α
· 使用定理 `instIsDomain`：∀ {R : Type u} [inst : Semifield R], IsDomain R
· 使用引理 `WeierstrassCurve.Projective.eval_polynomialY_of_Z_ne_zero`：eval_polynomi
alY_of_Z_ne_zero {P : Fin 3 -> F} (hPz : P z != 0) : eval P W.polynomialY / P z 
^ 2 = W.toAffine.polynomialY.evalEval (P x / P …
· 使用定理 `Iff.rfl`：∀ {a : Prop}, a ↔ a
-/
...
/-
**WeierstrassCurve.Projective.Y_ne_zero_of_Z_eq_zero** 是 Mathlib 中的一个引理，位于命名空间 `
WeierstrassCurve.Projective`。
...
· 使用定理 `Eq.trans`：∀ {α : Sort u} {a b c : α}, a = b → b = c → a = c
· 使用定理 `Nat.instAtLeastTwoHAddOfNat`：∀ (n : ℕ) [NeZero n], (n + 1).AtLeastTwo
· 使用引理 `WeierstrassCurve.Projective.nonsingular_of_Z_eq_zero`：nonsingular_of_Z_e
q_zero {P : Fin 3 -> R} (hPz : P z = 0) : W'.Nonsingular P ↔ W'.Equation P ∧ (3 
* P x ^ 2 != 0 ∨ P y ^ 2 + W'.a₁ * P x * P…
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
· 使用定理 `congr`：∀ {α : Sort u} {β : Sort v} {f₁ f₂ : α → β} {a₁ a₂ : α}, f₁ = f₂ 
→ a₁ = a₂ → f₁ a₁ = f₂ a₂
...
/-
**WeierstrassCurve.Projective.isUnit_Y_of_Z_eq_zero** 是 Mathlib 中的一个引理，位于命名空间 `W
eierstrassCurve.Projective`。
...
· 使用定理 `Ne.isUnit`：∀ {G₀ : Type u_3} [inst : GroupWithZero G₀] {a : G₀}, a ≠ 0 →
 IsUnit a
· 使用引理 `WeierstrassCurve.Projective.Y_ne_zero_of_Z_eq_zero`：Y_ne_zero_of_Z_eq_ze
ro [NoZeroDivisors R] {P : Fin 3 -> R} (hP : W'.Nonsingular P) (hPz : P z = 0) :
 P y != 0
· 使用定理 `IsDomain.to_noZeroDivisors`：∀ (α : Type u_3) [inst : Semiring α] [IsDoma
in α], NoZeroDivisors α
· 使用定理 `instIsDomain`：∀ {R : Type u} [inst : Semifield R], IsDomain R
...
/-
**WeierstrassCurve.Projective.equiv_of_Z_eq_zero** 是 Mathlib 中的一个引理，位于命名空间 `Weie
rstrassCurve.Projective`。
...
/-
**WeierstrassCurve.Projective.equiv_zero_of_Z_eq_zero** 是 Mathlib 中的一个引理，位于命名空间 
`WeierstrassCurve.Projective`。
...
: Fin 3 -> F} (hP : W.Nonsingular P) (hQ : W.Nonsingular Q) (hPz : P z = 0) (hQz
 : Q z = 0) : P ≈ Q
· 使用引理 `WeierstrassCurve.Projective.nonsingular_zero`：nonsingular_zero [Nontrivi
al R] : W'.Nonsingular ![0, 1, 0]
· 使用定理 `IsLocalRing.toNontrivial`：∀ {R : Type u_1} {inst : Semiring R} [self : I
sLocalRing R], Nontrivial R
· 使用定理 `Field.instIsLocalRing`：∀ (K : Type u_3) [inst : Field K], IsLocalRing K
-/
...
/-
**WeierstrassCurve.Projective.comp_equiv_comp** 是 Mathlib 中的一个引理，位于命名空间 `Weierst
rassCurve.Projective`。
...
ZeroOneClass β} {inst_2 : Fun…
· 使用定理 `Eq.symm`：∀ {α : Sort u} {a b : α}, a = b → b = a
· 使用引理 `WeierstrassCurve.Projective.comp_smul`：comp_smul (f : R ->+* S) (P : Fin
 3 -> R) (u : R) : f ∘ (u • P) = f u • f ∘ P
-/
...
Note that this definition is only mathematically accurate for fields. -/
/-
**WeierstrassCurve.Projective.NonsingularLift** 是 Mathlib 中的一个定义，位于命名空间 `Weierst
rassCurve.Projective`。
...
--- 原说明 ---
The proposition that a projective point class on a Weierstrass curve `W` is nons
ingular.

If `P` is a projective point representative on `W`, then `W.NonsingularLift ⟦P⟧`
 is definitionally
equivalent to `W.Nonsingular P`.
...
/-
**WeierstrassCurve.Projective.nonsingularLift_iff** 是 Mathlib 中的一个引理，位于命名空间 `Wei
erstrassCurve.Projective`。
...
lemma nonsingularLift_iff (P : Fin 3 → R) : W'.NonsingularLift ⟦P⟧ ↔ W'.Nonsingular P :=
  Iff.rfl
/-
**WeierstrassCurve.Projective.nonsingularLift_zero** 是 Mathlib 中的一个引理，位于命名空间 `We
ierstrassCurve.Projective`。
形式化陈述：nonsingularLift_zero [Nontrivial R] : W'.NonsingularLift ⟦![0, 1, 0]⟧
该定理/引理描述了相关对象所满足的性质。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用引理 `WeierstrassCurve.Projective.nonsingular_zero`：nonsingular_zero [Nontrivi
al R] : W'.Nonsingular ![0, 1, 0]
...
lemma nonsingularLift_zero [Nontrivial R] : W'.NonsingularLift ⟦![0, 1, 0]⟧ :=
  nonsingular_zero
/-
**WeierstrassCurve.Projective.nonsingularLift_some** 是 Mathlib 中的一个引理，位于命名空间 `We
ierstrassCurve.Projective`。
...
-/
/-
**WeierstrassCurve.Projective.map** 是 Mathlib 中的一个缩写定义，位于命名空间 `WeierstrassCurve.
Projective`。
形式化陈述：map : Projective S
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
The Weierstrass curve in projective coordinates mapped over a ring homomorphism 
`f : R →+* S`.
-/
...
/-
**WeierstrassCurve.Projective.baseChange** 是 Mathlib 中的一个缩写定义，位于命名空间 `Weierstras
sCurve.Projective`。
形式化陈述：baseChange [Algebra R S] : Projective S
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
The Weierstrass curve in projective coordinates base changed to an algebra `S` o
ver `R`.
-/
...
@[simp]
/-
**WeierstrassCurve.Projective.map_polynomial** 是 Mathlib 中的一个引理，位于命名空间 `Weierstr
assCurve.Projective`。
...
variable {W'} in
/-
**WeierstrassCurve.Projective.Equation.map** 是 Mathlib 中的一个定理，位于命名空间 `Weierstras
sCurve.Projective.Equation`。
形式化陈述：∀ {R : Type r} [inst : CommRing R] {W' : WeierstrassCurve.Projective R} {S
...
ng R] (W' : WeierstrassCurve.Projective R) (P : Fin 3 → R),   W'.Equation P = ((
MvPolynomial.eval P) W'.polynom…
· 使用引理 `WeierstrassCurve.Projective.map_polynomial`：map_polynomial : (W'.map f).
polynomial = .map f W'.polynomial
...
@[simp]
/-
**WeierstrassCurve.Projective.map_equation** 是 Mathlib 中的一个引理，位于命名空间 `Weierstras
sCurve.Projective`。
...
@[simp]
/-
**WeierstrassCurve.Projective.map_polynomialX** 是 Mathlib 中的一个引理，位于命名空间 `Weierst
rassCurve.Projective`。
...
@[simp]
/-
**WeierstrassCurve.Projective.map_polynomialY** 是 Mathlib 中的一个引理，位于命名空间 `Weierst
rassCurve.Projective`。
...
@[simp]
/-
**WeierstrassCurve.Projective.map_polynomialZ** 是 Mathlib 中的一个引理，位于命名空间 `Weierst
rassCurve.Projective`。
...
@[simp]
/-
**WeierstrassCurve.Projective.map_nonsingular** 是 Mathlib 中的一个引理，位于命名空间 `Weierst
rassCurve.Projective`。
...
· 使用定理 `congr`：∀ {α : Sort u} {β : Sort v} {f₁ f₂ : α → β} {a₁ a₂ : α}, f₁ = f₂ 
→ a₁ = a₂ → f₁ a₁ = f₂ a₂
· 使用引理 `WeierstrassCurve.Projective.map_equation`：map_equation (hf : Function.In
jective f) (P : Fin 3 -> R) : (W'.map f).Equation (f ∘ P) ↔ W'.Equation P
· 使用引理 `WeierstrassCurve.Projective.map_polynomialX`：map_polynomialX : (W'.map f
...
ype u_6)} {β : outParam (Type u_7)} [inst : NonAssocSemiring α]   [inst_1 : NonA
ssocSemiring β] [inst_2 : F…
· 使用引理 `WeierstrassCurve.Projective.map_polynomialY`：map_polynomialY : (W'.map f
).polynomialY = .map f W'.polynomialY
· 使用引理 `WeierstrassCurve.Projective.map_polynomialZ`：map_polynomialZ : (W'.map f
...
/-
**WeierstrassCurve.Projective.map_baseChange** 是 Mathlib 中的一个引理，位于命名空间 `Weierstr
assCurve.Projective`。
...
/-
**WeierstrassCurve.Projective.baseChange_polynomial** 是 Mathlib 中的一个引理，位于命名空间 `W
eierstrassCurve.Projective`。
...
variable {W'} in
/-
**WeierstrassCurve.Projective.Equation.baseChange** 是 Mathlib 中的一个定理，位于命名空间 `Wei
erstrassCurve.Projective.Equation`。
形式化陈述：∀ {R : Type r} [inst : CommRing R] {W' : WeierstrassCurve.Projective R} {S
 : Type s} [inst_1 : CommRing S] {A : Type u}   [inst_2 : CommRing A] {B : Type 
v} [inst_3 : CommRing B] [inst_4 : Algebra R S] [inst_5 : Algebra R A]   [inst_6
 : Algebra S A] [IsScalarTower R S A] [inst_8 : Algebra R B] [inst_9 : Algebra S
 B] [IsScalarTower R S B]   (f : A →ₐ[S] B) {P : Fin 3 → A}, (W'.baseChange A).E
quation P → (W'.baseChange B).Equation (⇑f ∘ P)
...
· 使用引理 `WeierstrassCurve.Projective.map_baseChange`：map_baseChange : (W'⁄A).map 
f = W'⁄B
· 使用定理 `WeierstrassCurve.Projective.Equation.map`：∀ {R : Type r} [inst : CommRin
g R] {W' : WeierstrassCurve.Projective R} {S : Type s} [inst_1 : CommRing S] (f 
: R →+* S)   {P : Fin 3 → R}, …
-/
...
variable {f} in
/-
**WeierstrassCurve.Projective.baseChange_equation** 是 Mathlib 中的一个引理，位于命名空间 `Wei
erstrassCurve.Projective`。
...
/-
**WeierstrassCurve.Projective.baseChange_polynomialX** 是 Mathlib 中的一个引理，位于命名空间 `
WeierstrassCurve.Projective`。
...
/-
**WeierstrassCurve.Projective.baseChange_polynomialY** 是 Mathlib 中的一个引理，位于命名空间 `
WeierstrassCurve.Projective`。
...
/-
**WeierstrassCurve.Projective.baseChange_polynomialZ** 是 Mathlib 中的一个引理，位于命名空间 `
WeierstrassCurve.Projective`。
...
variable {f} in
/-
**WeierstrassCurve.Projective.baseChange_nonsingular** 是 Mathlib 中的一个引理，位于命名空间 `
WeierstrassCurve.Projective`。
...
· 使用引理 `WeierstrassCurve.Projective.map_nonsingular`：map_nonsingular (hf : Funct
ion.Injective f) (P : Fin 3 -> R) : (W'.map f).Nonsingular (f ∘ P) ↔ W'.Nonsingu
lar P
· 使用定理 `AlgHom.toRingHom_eq_coe`：toRingHom_eq_coe (f : A ->ₐ[R] B) : f.toRingHom
 = f
· 使用引理 `WeierstrassCurve.Projective.map_baseChange`：map_baseChange : (W'⁄A).map 
