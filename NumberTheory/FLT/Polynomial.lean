...
/--
lemma `Ne.isUnit_C` / 引理 `Ne.isUnit_C`

English:
lemma Ne.isUnit_C
  given: {u : k} (hu : u != 0)
  statement: IsUnit (C u)
...
/--
lemma `rot_coprime` / 引理 `rot_coprime`
...
/--
lemma `ineq_pqr_contradiction` / 引理 `ineq_pqr_contradiction`

English:
lemma ineq_pqr_contradiction
  statement: {p q r a b c : Nat}
  proof: by
...
/--
theorem `Polynomial.flt_catalan_deriv` / 定理 `Polynomial.flt_catalan_deriv`
...
/--
lemma `find_contract` / 引理 `find_contract`
...
/--
theorem `Polynomial.flt_catalan_aux` / 定理 `Polynomial.flt_catalan_aux`
...
/--
theorem `Polynomial.flt_catalan` / 定理 `Polynomial.flt_catalan`
...
/--
theorem `Polynomial.flt` / 定理 `Polynomial.flt`
...
/--
theorem `fermatLastTheoremWith'_polynomial` / 定理 `fermatLastTheoremWith'_polynomial`

English:
theorem fermatLastTheoremWith'_polynomial
  given: {n : Nat} (hn : 3 <= n) (chn : (n : k) != 0)
  proof: by
  classical
