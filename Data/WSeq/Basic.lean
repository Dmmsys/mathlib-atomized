...
/-
**Stream.WSeq** 是 Mathlib 中的一个定义，位于命名空间 `Stream`。
...
@[coe]
/-
**Stream.WSeq.ofSeq** 是 Mathlib 中的一个定义，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
@[coe]
/-
**Stream.WSeq.ofList** 是 Mathlib 中的一个定义，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
@[coe]
/-
**Stream.WSeq.ofStream** 是 Mathlib 中的一个定义，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
def ofStream (l : Stream' α) : WSeq α :=
  ofSeq l
/-
**Stream.WSeq.coeSeq** 是 Mathlib 中的一个实例，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
instance coeSeq : Coe (Seq α) (WSeq α) :=
  ⟨ofSeq⟩
/-
**Stream.WSeq.coeList** 是 Mathlib 中的一个实例，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
instance coeList : Coe (List α) (WSeq α) :=
  ⟨ofList⟩
/-
**Stream.WSeq.coeStream** 是 Mathlib 中的一个实例，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.WSeq.nil** 是 Mathlib 中的一个定义，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
def nil : WSeq α :=
  Seq.nil
/-
**Stream.WSeq.inhabited** 是 Mathlib 中的一个实例，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.WSeq.cons** 是 Mathlib 中的一个定义，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Stream.WSeq.think** 是 Mathlib 中的一个定义，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Stream.WSeq.destruct** 是 Mathlib 中的一个定义，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
@[elab_as_elim]
/-
**Stream.WSeq.recOn** 是 Mathlib 中的一个定义，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Stream.WSeq.Mem** 是 Mathlib 中的一个定义，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
protected def Mem (s : WSeq α) (a : α) :=
  Seq.Mem s (some a)
/-
**Stream.WSeq.membership** 是 Mathlib 中的一个实例，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
instance membership : Membership α (WSeq α) :=
  ⟨WSeq.Mem⟩
/-
**Stream.WSeq.notMem_nil** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.WSeq.head** 是 Mathlib 中的一个定义，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Stream.WSeq.flatten** 是 Mathlib 中的一个定义，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Stream.WSeq.tail** 是 Mathlib 中的一个定义，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Stream.WSeq.drop** 是 Mathlib 中的一个定义，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Stream.WSeq.get** 是 Mathlib 中的一个定义，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Stream.WSeq.toList** 是 Mathlib 中的一个定义，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Stream.WSeq.append** 是 Mathlib 中的一个定义，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Stream.WSeq.join** 是 Mathlib 中的一个定义，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Stream.WSeq.map** 是 Mathlib 中的一个定义，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Stream.WSeq.ret** 是 Mathlib 中的一个定义，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Stream.WSeq.bind** 是 Mathlib 中的一个定义，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Stream.WSeq.monad** 是 Mathlib 中的一个实例，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
Unfortunately, `WSeq` is not a lawful monad, because it does not satisfy the mon
ad laws exactly,
only up to sequence equivalence. Furthermore, even quotienting by the equivalenc
e is not sufficient,
because the join operation involves lists of quotient elements, with a lifted eq
uivalence relation,
and pure quotients cannot handle this type of construction.
-/
...
@[simp]
/-
**Stream.WSeq.destruct_nil** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.destruct_cons** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.destruct_think** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.seq_destruct_nil** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.seq_destruct_cons** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.seq_destruct_think** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.head_nil** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.head_cons** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.head_think** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.flatten_pure** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.flatten_think** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.destruct_flatten** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.WSeq.head_terminates_iff** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.tail_nil** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.tail_cons** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.tail_think** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.dropn_nil** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.dropn_cons** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.dropn_think** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
theorem dropn_think (s : WSeq α) (n) : drop (think s) n = (drop s n).think := by
  induction n <;> simp [*, drop]
/-
**Stream.WSeq.dropn_add** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.WSeq.dropn_tail** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
theorem dropn_tail (s : WSeq α) (n) : drop (tail s) n = drop s (n + 1) := by
  ...
  apply dropn_add
/-
**Stream.WSeq.get** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.join_nil** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.join_think** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.join_cons** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.nil_append** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.cons_append** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.think_append** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.append_nil** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.append_assoc** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.tail.aux** 是 Mathlib 中的一个定义，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
def tail.aux : Option (α × WSeq α) → Computation (Option (α × WSeq α))
  ...
  | some (_, s) => destruct s
/-
**Stream.WSeq.destruct_tail** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.drop.aux** 是 Mathlib 中的一个定义，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Stream.WSeq.drop.aux_none** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.WSeq.destruct_dropn** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
theorem destruct_dropn : ∀ (s : WSeq α) (n), destruct (drop s n) = destruct s >>= drop.aux n
  ...
  | s, n + 1 => by
    ...
    rfl
/-
**Stream.WSeq.head_terminates_of_head_tail_terminates** 是 Mathlib 中的一个定理，位于命名空间 
`Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.WSeq.destruct_some_of_destruct_tail_some** 是 Mathlib 中的一个定理，位于命名空间 `Str
eam.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
theorem destruct_some_of_destruct_tail_some {s : WSeq α} {a} (h : some a ∈ destruct (tail s)) :
  ...
  · exact ⟨_, ht'⟩
/-
**Stream.WSeq.head_some_of_head_tail_some** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq
`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.WSeq.head_some_of_get** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.WSeq.head_terminates_of_get** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.WSeq.destruct_terminates_of_get** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`
。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.WSeq.mem_rec_on** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.mem_think** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.WSeq.eq_or_mem_iff_mem** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.mem_cons_iff** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
theorem mem_cons_iff (s : WSeq α) (b) {a} : a ∈ cons b s ↔ a = b ∨ a ∈ s :=
  eq_or_mem_iff_mem <| by simp
/-
**Stream.WSeq.mem_cons_of_mem** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
theorem mem_cons_of_mem {s : WSeq α} (b) {a} (h : a ∈ s) : a ∈ cons b s :=
  (mem_cons_iff _ _).2 (Or.inr h)
/-
**Stream.WSeq.mem_cons** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
theorem mem_cons (s : WSeq α) (a) : a ∈ cons a s :=
  (mem_cons_iff _ _).2 (Or.inl rfl)
/-
**Stream.WSeq.mem_of_mem_tail** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
theorem mem_of_mem_tail {s : WSeq α} {a} (h : a ∈ tail s) : a ∈ s := by
  ...
  case succ.think n IH s =>
    ...
    rfl
/-
**Stream.WSeq.mem_of_mem_dropn** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.WSeq.exists_get** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
theorem exists_get?_of_mem {s : WSeq α} {a} (h : a ∈ s) : ∃ n, some a ∈ get? s n := by
  ...
  · intro s' h
    ...
    apply think_mem h
/-
**Stream.WSeq.exists_dropn_of_mem** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
theorem exists_dropn_of_mem {s : WSeq α} {a} (h : a ∈ s) :
  ...
  ⟨n, by
    ...
    exact ⟨_, om⟩⟩
/-
**Stream.WSeq.head_terminates_of_mem** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.WSeq.of_mem_append** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
theorem of_mem_append {s₁ s₂ : WSeq α} {a : α} : a ∈ append s₁ s₂ → a ∈ s₁ ∨ a ∈ s₂ :=
  Seq.of_mem_append
/-
**Stream.WSeq.mem_append_left** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
theorem mem_append_left {s₁ s₂ : WSeq α} {a : α} : a ∈ s₁ → a ∈ append s₁ s₂ :=
  Seq.mem_append_left
/-
**Stream.WSeq.exists_of_mem_map** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.ofList_nil** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.ofList_cons** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.toList'_nil** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.toList'_cons** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.toList'_think** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.WSeq.toList'_map** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.toList_cons** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.toList_nil** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
theorem toList_nil : toList (nil : WSeq α) = Computation.pure [] :=
  destruct_eq_pure rfl
/-
**Stream.WSeq.toList_ofList** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.destruct_ofSeq** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.head_ofSeq** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.tail_ofSeq** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.dropn_ofSeq** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.map_nil** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.map_cons** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.map_think** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.map_id** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.map_ret** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.map_append** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
set_option backward.isDefEq.respectTransparency false in
/-
**Stream.WSeq.map_comp** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
theorem map_comp (f : α → β) (g : β → γ) (s : WSeq α) : map (g ∘ f) s = map g (map f s) := by
  ...
  ext ⟨⟩ <;> rfl
/-
**Stream.WSeq.mem_map** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.WSeq.exists_of_mem_join** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.WSeq.exists_of_mem_bind** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
theorem exists_of_mem_bind {s : WSeq α} {f : α → WSeq β} {b} (h : b ∈ bind s f) :
  ...
  ⟨a, as, by rwa [e]⟩
/-
**Stream.WSeq.destruct_map** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.destruct_append.aux** 是 Mathlib 中的一个定义，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Stream.WSeq.destruct_append** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.destruct_join.aux** 是 Mathlib 中的一个定义，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Stream.WSeq.destruct_join** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.WSeq.map_join** 是 Mathlib 中的一个定理，位于命名空间 `Stream.WSeq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
