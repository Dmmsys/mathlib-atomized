...
variable (I I') in
/--
Definition of `mlieBracketWithin` / `mlieBracketWithin` 的定义

English:
definition mlieBracketWithin
  signature: (V W : Π (x : M), TangentSpace I x) (s : Set M) (x₀ : M)
  body: mpullback I 𝓘(𝕜, E) (extChartAt I x₀)
    (lieBracketWithin 𝕜
      (mpullbackWithin 𝓘(𝕜, E) I (extChartAt I x₀).symm V (range I))
      (mpullbackWithin 𝓘(𝕜, E) I (extChartAt I x₀).symm W (range I))
      ((extChartAt I x₀).symm ⁻¹' s inter range I)) x₀
...
Depends on / 依赖: extChartAt, lieBracketWithin, mpullback, mpullbackWithin
-/
...
variable (I I') in
/--
Definition of `mlieBracket` / `mlieBracket` 的定义

English:
definition mlieBracket
  signature: (V W : Π (x : M), TangentSpace I x) (x₀ : M)
  body: mlieBracketWithin I V W univ x₀

中文:
定义 mlieBracket
  签名: (V W : Π (x : M), TangentSpace I x) (x₀ : M)
  定义体: mlieBracketWithin I V W univ x₀

Depends on / 依赖: mlieBracketWithin
-/
def mlieBracket (V W : Π (x : M), TangentSpace I x) (x₀ : M) : TangentSpace I x₀ :=
  mlieBracketWithin I V W univ x₀

/--
lemma `mlieBracketWithin_def` / 引理 `mlieBracketWithin_def`
...
lemma mlieBracketWithin_def :
    ...
    (lieBracketWithin 𝕜
      (mpullbackWithin 𝓘(𝕜, E) I (extChartAt I x₀).symm V (range I))
      (mpullbackWithin 𝓘(𝕜, E) I (extChartAt I x₀).symm W (range I))
      ((extChartAt I x₀).symm ⁻¹' s inter range I)) x₀ := (rfl)

/--
lemma `mlieBracketWithin_apply` / 引理 `mlieBracketWithin_apply`
...
lemma mlieBracketWithin_apply :
    ...
    ((lieBracketWithin 𝕜
      (mpullbackWithin 𝓘(𝕜, E) I (extChartAt I x₀).symm V (range I))
      (mpullbackWithin 𝓘(𝕜, E) I (extChartAt I x₀).symm W (range I))
      ((extChartAt I x₀).symm ⁻¹' s inter range I)) ((extChartAt I x₀ x₀))) := (rfl)

set_option backward.isDefEq.respectTransparency false in
/--
lemma `mlieBracketWithin_eq_lieBracketWithin` / 引理 `mlieBracketWithin_eq_lieBracketWithin`

English:
lemma mlieBracketWithin_eq_lieBracketWithin
  given: {V W : Π (x : E), TangentSpace 𝓘(𝕜, E) x} {s : Set E}
  proof: by
  ext x
...
Depends on / 依赖: mlieBracketWithin_apply
-/
...
/--
lemma `mlieBracketWithin_univ` / 引理 `mlieBracketWithin_univ`

English:
lemma mlieBracketWithin_univ
  proof: (rfl)

中文:
引理 mlieBracketWithin_univ
  证明: (rfl)
-/
...
set_option backward.isDefEq.respectTransparency false in
/--
lemma `mlieBracketWithin_eq_zero_of_eq_zero` / 引理 `mlieBracketWithin_eq_zero_of_eq_zero`

English:
lemma mlieBracketWithin_eq_zero_of_eq_zero
...
中文:
引理 mlieBracketWithin_eq_zero_of_eq_zero
...
Depends on / 依赖: extChartAt, instances, lieBracketWithin_eq_zero_of_eq_zero, mlieBracketWithin, mpullbackWithin_apply, mpullback_apply
-/
...
set_option backward.isDefEq.respectTransparency false in
/--
lemma `mlieBracketWithin_swap_apply` / 引理 `mlieBracketWithin_swap_apply`

English:
lemma mlieBracketWithin_swap_apply
  proof: by
  rw [mlieBracketWithin]; rw [lieBracketWithin_swap]; rw [mpullback_neg]
  rfl

中文:
引理 mlieBracketWithin_swap_apply
  证明: by
  rw [mlieBracketWithin]; rw [lieBracketWithin_swap]; rw [mpullback_neg]
  rfl

Depends on / 依赖: lieBracketWithin_swap, mlieBracketWithin, mpullback_neg
-/
lemma mlieBracketWithin_swap_apply :
...
/--
lemma `mlieBracketWithin_swap` / 引理 `mlieBracketWithin_swap`
...
中文:
引理 mlieBracketWithin_swap
  证明: by
  ext x
  exact mlieBracketWithin_swap_apply

Depends on / 依赖: mlieBracketWithin_swap_apply
-/
lemma mlieBracketWithin_swap :
...
/--
lemma `mlieBracket_swap_apply` / 引理 `mlieBracket_swap_apply`

English:
lemma mlieBracket_swap_apply
  statement: mlieBracket I V W x = - mlieBracket I W V x
  proof: mlieBracketWithin_swap_apply

中文:
引理 mlieBracket_swap_apply
  结论: mlieBracket I V W x = - mlieBracket I W V x
  证明: mlieBracketWithin_swap_apply
...
/--
lemma `mlieBracket_swap` / 引理 `mlieBracket_swap`

English:
lemma mlieBracket_swap
  statement: mlieBracket I V W = - mlieBracket I W V
  proof: mlieBracketWithin_swap

中文:
引理 mlieBracket_swap
  结论: mlieBracket I V W = - mlieBracket I W V
  证明: mlieBracketWithin_swap

Depends on / 依赖: mlieBracketWithin_swap
-/
...
set_option backward.isDefEq.respectTransparency false in
/--
lemma `mlieBracketWithin_self` / 引理 `mlieBracketWithin_self`

English:
lemma mlieBracketWithin_self
  statement: mlieBracketWithin I V V = 0
  proof: by
  ext x; simp [mlieBracketWithin, mpullback]

中文:
引理 mlieBracketWithin_self
  结论: mlieBracketWithin I V V = 0
  证明: by
  ext x; simp [mlieBracketWithin, mpullback]
-/
...
/--
lemma `mlieBracket_self` / 引理 `mlieBracket_self`

English:
lemma mlieBracket_self
  statement: mlieBracket I V V = 0
  proof: by
  ext x; simp_rw [mlieBracket, mlieBracketWithin_self, Pi.zero_apply]

中文:
引理 mlieBracket_self
  结论: mlieBracket I V V = 0
  证明: by
  ext x; simp_rw [mlieBracket, mlieBracketWithin_self, Pi.zero_apply]
-/
...
@[simp]
/--
lemma `mlieBracketWithin_zero_left` / 引理 `mlieBracketWithin_zero_left`

English:
lemma mlieBracketWithin_zero_left
  statement: mlieBracketWithin I 0 W s = 0
  proof: by
  ext x
  simp [mlieBracketWithin]

中文:
引理 mlieBracketWithin_zero_left
  结论: mlieBracketWithin I 0 W s = 0
  证明: by
  ext x
  simp [mlieBracketWithin]
...
@[simp]
/--
lemma `mlieBracketWithin_zero_right` / 引理 `mlieBracketWithin_zero_right`

English:
lemma mlieBracketWithin_zero_right
  statement: mlieBracketWithin I W 0 s = 0
  proof: by
  rw [mlieBracketWithin_swap]; simp

中文:
引理 mlieBracketWithin_zero_right
  结论: mlieBracketWithin I W 0 s = 0
  证明: by
  rw [mlieBracketWithin_swap]; simp
...
@[simp]
/--
lemma `mlieBracket_zero_left` / 引理 `mlieBracket_zero_left`

English:
lemma mlieBracket_zero_left
  statement: mlieBracket I 0 W = 0
  proof: by simp [← mlieBracketWithin_univ]

中文:
引理 mlieBracket_zero_left
  结论: mlieBracket I 0 W = 0
  证明: by simp [← mlieBracketWithin_univ]

Depends on / 依赖: mlieBracketWithin_univ
-/
...
@[simp]
/--
lemma `mlieBracket_zero_right` / 引理 `mlieBracket_zero_right`

English:
lemma mlieBracket_zero_right
  statement: mlieBracket I W 0 = 0
  proof: by simp [← mlieBracketWithin_univ]

中文:
引理 mlieBracket_zero_right
  结论: mlieBracket I W 0 = 0
  证明: by simp [← mlieBracketWithin_univ]
...
/--
theorem `mlieBracketWithin_congr_set'` / 定理 `mlieBracketWithin_congr_set'`

English:
theorem mlieBracketWithin_congr_set'
  given: (y : M) (h : s =ᶠ[𝓝[{y}ᶜ] x] t)
  proof: by
  simp only [mlieBracketWithin_apply]
  congr 1
  suffices A : ((extChartAt I x).symm ⁻¹' s inter range I : Set E)
    =ᶠ[𝓝[{(extChartAt I x) x}ᶜ] (extChartAt I x x)]
      ((extChartAt I x).symm ⁻¹' t inter range I : Set E) by
    apply lieBracketWithin_congr_set' _ A
  exact preimage_extChartAt

中文:
定理 mlieBracketWithin_congr_set'
...
Depends on / 依赖: extChartAt, lieBracketWithin_congr_set, mlieBracketWithin_apply, preimage_extChartAt_eventuallyEq_compl_singleton
-/
...
theorem mlieBracketWithin_congr_set
  given: (h : s =ᶠ[𝓝 x] t)
  proof: mlieBracketWithin_congr_set' x h.filter_mono inf_le_left

中文:
定理 mlieBracketWithin_congr_set
  条件: (h : s =ᶠ[𝓝 x] t)
  证明: mlieBracketWithin_congr_set' x h.filter_mono inf_le_left

Depends on / 依赖: filter_mono, h.filter_mono, inf_le_left, mlieBracketWithin_congr_set
-/
...
/--
theorem `mlieBracketWithin_inter` / 定理 `mlieBracketWithin_inter`

English:
theorem mlieBracketWithin_inter
  given: (ht : t in 𝓝 x)
  proof: by
  apply mlieBracketWithin_congr_set
  filter_upwards [ht] with y hy
  change (y in s inter t) = (y in s)
  simp_all

中文:
定理 mlieBracketWithin_inter
  条件: (ht : t in 𝓝 x)
  证明: by
  apply mlieBracketWithin_congr_set
  filter_upwards [ht] with y hy
...
Depends on / 依赖: filter_upwards, mlieBracketWithin_congr_set
-/
theorem mlieBracketWithin_inter (ht : t in 𝓝 x) :
    mlieBracketWithin I V W (s inter t) x = mlieBracketWithin I V W s x := by
  apply mlieBracketWithin_congr_set
  filter_upwards [ht] with y hy
  change (y in s inter t) = (y in s)
  simp_all
...
/--
theorem `mlieBracketWithin_of_mem_nhds` / 定理 `mlieBracketWithin_of_mem_nhds`

English:
theorem mlieBracketWithin_of_mem_nhds
  given: (h : s in 𝓝 x)
  proof: by
  rw [← mlieBracketWithin_univ]; rw [← univ_inter s]; rw [mlieBracketWithin_inter h]

中文:
定理 mlieBracketWithin_of_mem_nhds
  条件: (h : s in 𝓝 x)
  证明: by
  rw [← mlieBracketWithin_univ]; rw [← univ_inter s]; rw [mlieBracketWithin_inter h]

Depends on / 依赖: mlieBracketWithin_inter, mlieBracketWithin_univ, univ_inter
-/
theorem mlieBracketWithin_of_mem_nhds (h : s in 𝓝 x) :
    mlieBracketWithin I V W s x = mlieBracket I V W x := by
  rw [← mlieBracketWithin_univ]; rw [← univ_inter s]; rw [mlieBracketWithin_inter h]

/--
theorem `mlieBracketWithin_of_isOpen` / 定理 `mlieBracketWithin_of_isOpen`

English:
theorem mlieBracketWithin_of_isOpen
  given: (hs : IsOpen s) (hx : x in s)
  proof: mlieBracketWithin_of_mem_nhds (hs.mem_nhds hx)
...
-/
theorem mlieBracketWithin_of_isOpen (hs : IsOpen s) (hx : x in s) :
    mlieBracketWithin I V W s x = mlieBracket I V W x :=
  mlieBracketWithin_of_mem_nhds (hs.mem_nhds hx)

/--
theorem `mlieBracketWithin_eventually_congr_set'` / 定理 `mlieBracketWithin_eventually_congr_set'`

English:
theorem mlieBracketWithin_eventually_congr_set'
  given: (y : M) (h : s =ᶠ[𝓝[{y}ᶜ] x] t)
  proof: (eventually_nhds_nhdsWithin.2 h).mono fun _ => mlieBracketWithin_congr_set' y

中文:
定理 mlieBracketWithin_eventually_congr_set'
  条件: (y : M) (h : s =ᶠ[𝓝[{y}ᶜ] x] t)
  证明: (eventually_nhds_nhdsWithin.2 h).mono fun _ => mlieBracketWithin_congr_set' y

Depends on / 依赖: eventually_nhds_nhdsWithin, mlieBracketWithin_congr_set
-/
...
theorem mlieBracketWithin_eventually_congr_set
  given: (h : s =ᶠ[𝓝 x] t)
  proof: mlieBracketWithin_eventually_congr_set' x h.filter_mono inf_le_left

中文:
定理 mlieBracketWithin_eventually_congr_set
  条件: (h : s =ᶠ[𝓝 x] t)
  证明: mlieBracketWithin_eventually_congr_set' x h.filter_mono inf_le_left

Depends on / 依赖: filter_mono, h.filter_mono, inf_le_left, mlieBracketWithin_eventually_congr_set
-/
...
set_option backward.isDefEq.respectTransparency false in
/--
theorem `_root_.Filter.EventuallyEq.mlieBracketWithin_vectorField_eq` / 定理 `_root_.Filter.EventuallyEq.mlieBracketWithin_vectorField_eq`
...
Depends on / 依赖: EventuallyEq, Filter, Filter.EventuallyEq.lieBracketWithin_vectorField_eq, NormedAddCommGroup, NormedSpace, TangentSpace, continuousAt_extChartAt_symm, continuousWithinAt, continuousWithinAt.preimage_mem_nhdsWithin, extChartAt, filter_upwards, inter_subset_left, lieBracketWithin_vectorField_eq, mlieBracketWithin_apply, mpullbackWithin_apply, nhdsWithin_mono, preimage_mem_nhdsWithin
-/
theorem _root_.Filter.EventuallyEq.mlieBracketWithin_vectorField_eq
...
/--
theorem `_root_.Filter.EventuallyEq.mlieBracketWithin_vectorField_eq_of_mem` / 定理 `_root_.Filter.EventuallyEq.mlieBracketWithin_vectorField_eq_of_mem`

English:
theorem _root_.Filter.EventuallyEq.mlieBracketWithin_vectorField_eq_of_mem
  proof: hV.mlieBracketWithin_vectorField_eq (mem_of_mem_nhdsWithin hx hV :)
...
Depends on / 依赖: hV.mlieBracketWithin_vectorField_eq, mem_of_mem_nhdsWithin, mlieBracketWithin_vectorField_eq
-/
theorem _root_.Filter.EventuallyEq.mlieBracketWithin_vectorField_eq_of_mem
...
/--
theorem `_root_.Filter.EventuallyEq.mlieBracketWithin_vectorField'` / 定理 `_root_.Filter.EventuallyEq.mlieBracketWithin_vectorField'`
...
Depends on / 依赖: EventuallyEq, Filter, Filter.EventuallyEq.mlieBracketWithin_vectorField_eq, eventually_eventually_nhdsWithin, filter_upwards, mlieBracketWithin_vectorField_eq, nhdsWithin_mono
-/
theorem _root_.Filter.EventuallyEq.mlieBracketWithin_vectorField'
...
/--
theorem `_root_.Filter.EventuallyEq.mlieBracketWithin_vectorField_of_insert` / 定理 `_root_.Filter.EventuallyEq.mlieBracketWithin_vectorField_of_insert`

English:
theorem _root_.Filter.EventuallyEq.mlieBracketWithin_vectorField_of_insert
  proof: by
...
/--
theorem `_root_.Filter.EventuallyEq.mlieBracketWithin_vectorField_eq_nhds` / 定理 `_root_.Filter.EventuallyEq.mlieBracketWithin_vectorField_eq_nhds`

English:
theorem _root_.Filter.EventuallyEq.mlieBracketWithin_vectorField_eq_nhds
  proof: (hV.filter_mono nhdsWithin_le_nhds).mlieBracketWithin_vectorField_eq hV.self_of_nhds
...
Depends on / 依赖: filter_mono, hV.filter_mono, hV.self_of_nhds, hW.filter_mono, hW.self_of_nhds, mlieBracketWithin_vectorField_eq, nhdsWithin_le_nhds, self_of_nhds
-/
theorem _root_.Filter.EventuallyEq.mlieBracketWithin_vectorField_eq_nhds
...
/--
theorem `mlieBracketWithin_congr` / 定理 `mlieBracketWithin_congr`

English:
theorem mlieBracketWithin_congr
  proof: (hV.eventuallyEq.filter_mono inf_le_right).mlieBracketWithin_vectorField_eq hVx
    (hW.eventuallyEq.filter_mono inf_le_right) hWx

中文:
定理 mlieBracketWithin_congr
  证明: (hV.eventuallyEq.filter_mono inf_le_right).mlieBracketWithin_vectorField_eq hVx
    (hW.eventuallyEq.filter_mono inf_le_right) hWx

Depends on / 依赖: eventuallyEq, filter_mono, hV.eventuallyEq.filter_mono, hW.eventuallyEq.filter_mono, inf_le_right, mlieBracketWithin_vectorField_eq
-/
theorem mlieBracketWithin_congr
...
theorem mlieBracketWithin_congr'
  ...
  proof: mlieBracketWithin_congr hV (hV hx) hW (hW hx)

中文:
定理 mlieBracketWithin_congr'
  条件: (hV : EqOn V₁ V s) (hW : EqOn W₁ W s) (hx : x in s)
  证明: mlieBracketWithin_congr hV (hV hx) hW (hW hx)

Depends on / 依赖: mlieBracketWithin_congr
-/
theorem mlieBracketWithin_congr' (hV : EqOn V₁ V s) (hW : EqOn W₁ W s) (hx : x in s) :
    mlieBracketWithin I V₁ W₁ s x = mlieBracketWithin I V W s x :=
  mlieBracketWithin_congr hV (hV hx) hW (hW hx)

/--
theorem `_root_.Filter.EventuallyEq.mlieBracket_vectorField_eq` / 定理 `_root_.Filter.EventuallyEq.mlieBracket_vectorField_eq`
...
Depends on / 依赖: hV.mlieBracketWithin_vectorField_eq_nhds, mlieBracketWithin_univ, mlieBracketWithin_vectorField_eq_nhds
-/
theorem _root_.Filter.EventuallyEq.mlieBracket_vectorField_eq
    (hV : V₁ =ᶠ[𝓝 x] V) (hW : W₁ =ᶠ[𝓝 x] W) :
...
/--
theorem `_root_.Filter.EventuallyEq.mlieBracket_vectorField` / 定理 `_root_.Filter.EventuallyEq.mlieBracket_vectorField`

English:
theorem _root_.Filter.EventuallyEq.mlieBracket_vectorField
  proof: by
...
/--
lemma `_root_.MDifferentiableWithinAt.differentiableWithinAt_mpullbackWithin_vectorField` / 引理 `_root_.MDifferentiableWithinAt.differentiableWithinAt_mpullbackWithin_vectorField`
...
lemma _root_.MDifferentiableWithinAt.differentiableWithinAt_mpullbackWithin_vectorField
  ...
  have := MDifferentiableWithinAt.mpullbackWithin_vectorField_inter_of_eq hV
    ...
    (isInvertible_mfderivWithin_extChartAt_symm (mem_extChartAt_target x)) (mem_range_self 

中文:
引理 _root_.MDifferentiableWithinAt.differentiableWithinAt_mpullbackWithin_vectorField
  证明: by
  apply MDifferentiableWithinAt.differentiableWithinAt
  have := MDifferentiableWithinAt.mpullbackWithin_vectorField_inter_of_eq hV
    (contMDiffWithinAt_extChartAt_symm_range x (mem_extChartAt_target x))
...
Depends on / 依赖: I.uniqueMDiffOn, MDifferentiableWithinAt, MDifferentiableWithinAt.differentiableWithinAt, MDifferentiableWithinAt.mpullbackWithin_vectorField_inter_of_eq, comp_mdifferentiableWithinAt, contMDiffAt, contMDiffAt.mdifferentiableAt, contMDiffWithinAt_extChartAt_symm_range, contMDiff_snd_tangentBundle_modelSpace, differentiableWithinAt, extChartAt_to_inv, inter_comm, isInvertible_mfderivWithin_extChartAt_symm, le_rfl, mdifferentiableAt, mem_extChartAt_target, mem_range_self, mpullbackWithin_vectorField_inter_of_eq, one_ne_zero, uniqueMDiffOn
-/
lemma _root_.MDifferentiableWithinAt.differentiableWithinAt_mpullbackWithin_vectorField
    [CompleteSpace E]
...
set_option backward.isDefEq.respectTransparency false in
/--
lemma `mfderiv_extChartAt_inverse_comp_mfderivWithin_extChartAT_symm` / 引理 `mfderiv_extChartAt_inverse_comp_mfderivWithin_extChartAT_symm`

English:
lemma mfderiv_extChartAt_inverse_comp_mfderivWithin_extChartAT_symm
  given: (Y : TangentSpace I x)
  ...
  rw [extChartAt_to_inv x]; rw [← ContinuousLinearMap.IsInvertible.inverse_comp_of_left]; rw [← ContinuousLinearMap.in

中文:
引理 mfderiv_extChartAt_inverse_comp_mfderivWithin_extChartAT_symm
  条件: (Y : TangentSpace I x)
  证明: extChartAt I x
    ((mfderiv% φ x).inverse.comp ((mfderiv[range I] φ.symm (φ x)).inverse) Y) = Y := by
  set φ := extChartAt I x
  trans (ContinuousLinearMap.id 𝕜 _) Y; swap; · simp
...
lemma mfderiv_extChartAt_inverse_comp_mfderivWithin_extChartAT_symm (Y : TangentSpace I x) :
  ...
  set φ := extChartAt I x
  trans (ContinuousLinearMap.id 𝕜 _) Y; swap; · simp
  rw [extChartAt_to_inv x]; rw [← ContinuousLinearMap.IsInvertible.inverse_comp_of_left]; rw [← ContinuousLinearMap.inverse_id]; rw [mfderivWithin_extChartAt_symm_comp_mfderiv_extChartAt' (mem_extChartAt_source x)]
  exact isInvertible_mfderivWithin_extChartAt_symm (mem_extChartAt_target x)

set_option backward.isDefEq.respectTransparency false in
variable (x W) in
/--
lemma `mfderiv_extChart_inverse_comp_aux` / 引理 `mfderiv_extChart_inverse_comp_aux`

English:
lemma mfderiv_extChart_inverse_comp_aux
  proof: extChartAt I x
    (mfderiv% φ x).inverse.comp
      ((mfderiv[range I] φ.symm (φ x)).inverse) (W (φ.symm (φ x))) = W x := by
  rw [mfderiv_extChartAt_inverse_comp_mfderivWithin_extChartAT_symm]; rw [extChartAt_to_inv]

中文:
引理 mfderiv_extChart_inverse_comp_aux
  证明: extChartAt I x
    (mfderiv% φ x).inverse.comp
      ((mfderiv[range I] φ.symm (φ x)).inverse) (W (φ.symm (φ x))) = W x := by
  rw [mfderiv_extChartAt_inverse_comp_mfderivWithin_extChartAT_symm]; rw [extChartAt_to_inv]
...
set_option backward.isDefEq.respectTransparency false in
/--
lemma `mpullback_mfderivWithin_apply_smul` / 引理 `mpullback_mfderivWithin_apply_smul`

English:
lemma mpullback_mfderivWithin_apply_smul
  statement: {f : M -> 𝕜}
  proof: mpullbackWithin 𝓘(𝕜, E) I (extChartAt I x).symm V (range I)
    let W' := mpullbackWithin 𝓘(𝕜, E) I (extChartAt I x).symm W (range I)
    letI s' : Set E := (extChartAt I x).symm ⁻¹' s inter range I
    mpullback I 𝓘(𝕜, E) (extChartAt I x)
        (fun x₀ => (fderivWithin 𝕜 (f ∘ (extChartAt I x).sym

中文:
引理 mpullback_mfderivWithin_apply_smul
  结论: {f : M -> 𝕜}
  证明: mpullbackWithin 𝓘(𝕜, E) I (extChartAt I x).symm V (range I)
    let W' := mpullbackWithin 𝓘(𝕜, E) I (extChartAt I x).symm W (range I)
    letI s' : Set E := (extChartAt I x).symm ⁻¹' s inter range I
    mpullback I 𝓘(𝕜, E) (extChartAt I x)
        (fun x₀ => (fderivWithin 𝕜 (f ∘ (extChartAt I x).sym

Depends on / 依赖: extChartAt, mpullbackWithin
-/
...
set_option backward.isDefEq.respectTransparency false in
/--
lemma `mlieBracketWithin_smul_right` / 引理 `mlieBracketWithin_smul_right`

English:
lemma mlieBracketWithin_smul_right
  statement: {f : M -> 𝕜} (hf : MDiffAt[s] f x)
  proof: by
...
中文:
引理 mlieBracketWithin_smul_right
  结论: {f : M -> 𝕜} (hf : MDiffAt[s] f x)
  证明: by
  simp only [mlieBracketWithin, mpullbackWithin_smul]
  -- Simplify local notation a bit.
  set V' := mpullbackWithin 𝓘(𝕜, E) I (extChartAt I x).symm V (range I)
...
Depends on / 依赖: mlieBracketWithin, mpullbackWithin_smul
-/
lemma mlieBracketWithin_smul_right {f : M -> 𝕜} (hf : MDiffAt[s] f x)
  ...
  set W' := mpullbackWithin 𝓘(𝕜, E) I (extChartAt I x).symm W (range I)
  set f' := f ∘ (extChartAt I x).symm
  set s' := (extChartAt I x).symm ⁻¹' s inter range I
  ...
  rw [← Pi.add_def]; rw [mpullback_add_apply]; congr
  · simpa only [A] using! mpullback_mfderivWithin_apply_smul hf
  · simp [B, ← Pi.smul_def', mpullback_smul (V := lieBracketWithin 𝕜 V' W' s'), f']

/--
lemma `mlieBracket_smul_right` / 引理 `mlieBracket_smul_right`

English:
lemma mlieBracket_smul_right
  statement: {f : M -> 𝕜} (hf : MDiffAt f x)
  proof: by
  rw [← mdifferentiableWithinAt_univ] at hf hW
  rw [← mlieBracketWithin_univ]; rw [← mvfderivWithin_univ]
  exact mlieBracketWithin_smul_right hf hW (uniqueMDiffWithinAt_univ I)

中文:
引理 mlieBracket_smul_right
  结论: {f : M -> 𝕜} (hf : MDiffAt f x)
  证明: by
  rw [← mdifferentiableWithinAt_univ] at hf hW
  rw [← mlieBracketWithin_univ]; rw [← mvfderivWithin_univ]
  exact mlieBracketWithin_smul_right hf hW (uniqueMDiffWithinAt_univ I)

Depends on / 依赖: mdifferentiableWithinAt_univ, mlieBracketWithin_smul_right, mlieBracketWithin_univ, mvfderivWithin_univ, uniqueMDiffWithinAt_univ
-/
...
/--
lemma `mlieBracketWithin_smul_left` / 引理 `mlieBracketWithin_smul_left`

English:
lemma mlieBracketWithin_smul_left
  statement: {f : M -> 𝕜} (hf : MDiffAt[s] f x)
  proof: by
  rw [mlieBracketWithin_swap]; rw [Pi.neg_apply]; rw [mlieBracketWithin_smul_right hf hV (V := W) hs]; rw [mlieBracketWithin_swap]
  simp; abel

中文:
引理 mlieBracketWithin_smul_left
  结论: {f : M -> 𝕜} (hf : MDiffAt[s] f x)
  证明: by
  rw [mlieBracketWithin_swap]; rw [Pi.neg_apply]; rw [mlieBracketWithin_smul_right hf hV (V := W) hs]; rw [mlieBracketWithin_swap]
  simp; abel

Depends on / 依赖: Pi.neg_apply, mlieBracketWithin_smul_right, mlieBracketWithin_swap, neg_apply
-/
...
/--
lemma `mlieBracket_smul_left` / 引理 `mlieBracket_smul_left`
...
lemma mlieBracket_smul_left
  ...
  rw [← mlieBracketWithin_univ]; rw [mvfderiv]; rw [← mfderivWithin_univ]
  exact mlieBracketWithin_smul_left hf hV (uniqueMDiffWithinAt_univ I)

中文:
引理 mlieBracket_smul_left
  结论: {f : M -> 𝕜} (hf : MDiffAt f x)
  证明: by
  rw [← mdifferentiableWithinAt_univ] at hf hV
  rw [← mlieBracketWithin_univ]; rw [mvfderiv]; rw [← mfderivWithin_univ]
...
Depends on / 依赖: mdifferentiableWithinAt_univ, mfderivWithin_univ, mlieBracketWithin_smul_left, mlieBracketWithin_univ, mvfderiv, uniqueMDiffWithinAt_univ
-/
...
/--
lemma `mlieBracketWithin_const_smul_left` / 引理 `mlieBracketWithin_const_smul_left`
...
中文:
引理 mlieBracketWithin_const_smul_left
  证明: by
  simpa [mfderivWithin_const, mvfderivWithin] using!
    mlieBracketWithin_smul_left (mdifferentiableWithinAt_const (c := c)) (W := W) hV hs

Depends on / 依赖: mdifferentiableWithinAt_const, mfderivWithin_const, mlieBracketWithin_smul_left, mvfderivWithin
-/
lemma mlieBracketWithin_const_smul_left
...
/--
lemma `mlieBracket_const_smul_left` / 引理 `mlieBracket_const_smul_left`

English:
lemma mlieBracket_const_smul_left
  given: (hV : MDiffAt (T% V) x)
  proof: by
  simp only [← mlieBracketWithin_univ] at hV ⊢
  exact mlieBracketWithin_const_smul_left hV (uniqueMDiffWithinAt_univ _)

中文:
引理 mlieBracket_const_smul_left
  条件: (hV : MDiffAt (T% V) x)
  证明: by
  simp only [← mlieBracketWithin_univ] at hV ⊢
  exact mlieBracketWithin_const_smul_left hV (uniqueMDiffWithinAt_univ _)

Depends on / 依赖: mlieBracketWithin_const_smul_left, mlieBracketWithin_univ, uniqueMDiffWithinAt_univ
-/
...
/--
lemma `mlieBracketWithin_const_smul_right` / 引理 `mlieBracketWithin_const_smul_right`
...
中文:
引理 mlieBracketWithin_const_smul_right
  证明: by
  simpa [mfderivWithin_const, mvfderivWithin] using!
    mlieBracketWithin_smul_right (mdifferentiableWithinAt_const (c := c)) (V := V) hW hs

Depends on / 依赖: mdifferentiableWithinAt_const, mfderivWithin_const, mlieBracketWithin_smul_right, mvfderivWithin
-/
lemma mlieBracketWithin_const_smul_right
...
/--
lemma `mlieBracket_const_smul_right` / 引理 `mlieBracket_const_smul_right`

English:
lemma mlieBracket_const_smul_right
  given: (hW : MDiffAt (T% W) x)
  proof: by
  simp only [← mlieBracketWithin_univ] at hW ⊢
  exact mlieBracketWithin_const_smul_right hW (uniqueMDiffWithinAt_univ _)

中文:
引理 mlieBracket_const_smul_right
  条件: (hW : MDiffAt (T% W) x)
  证明: by
  simp only [← mlieBracketWithin_univ] at hW ⊢
  exact mlieBracketWithin_const_smul_right hW (uniqueMDiffWithinAt_univ _)

Depends on / 依赖: mlieBracketWithin_const_smul_right, mlieBracketWithin_univ, uniqueMDiffWithinAt_univ
-/
...
set_option backward.isDefEq.respectTransparency false in
/--
lemma `mlieBracketWithin_add_left` / 引理 `mlieBracketWithin_add_left`

English:
lemma mlieBracketWithin_add_left
  proof: by
  simp only [mlieBracketWithin_apply]
  rw [← map_add]; rw [mpullbackWithin_add]; rw [lieBracketWithin_add_left]
  · exact hV.differentiableWithinAt_mpullbackWithin_vectorField
  · exact hV₁.differentiableWithinAt_mpullbackWithin_vectorField
  · exact uniqueMDiffWithinAt_iff_inter_range.1 hs

中文:
引理 mlieBracketWithin_add_left
  证明: by
  simp only [mlieBracketWithin_apply]
  rw [← map_add]; rw [mpullbackWithin_add]; rw [lieBracketWithin_add_left]
  · exact hV.differentiableWithinAt_mpullbackWithin_vectorField
...
Depends on / 依赖: differentiableWithinAt_mpullbackWithin_vectorField, hV.differentiableWithinAt_mpullbackWithin_vectorField, lieBracketWithin_add_left, map_add, mlieBracketWithin_apply, mpullbackWithin_add, uniqueMDiffWithinAt_iff_inter_range
-/
lemma mlieBracketWithin_add_left
...
/--
lemma `mlieBracket_add_left` / 引理 `mlieBracket_add_left`

English:
lemma mlieBracket_add_left
  given: (hV : MDiffAt (T% V) x) (hV₁ : MDiffAt (T% V₁) x)
  proof: by
  simp only [← mlieBracketWithin_univ] at hV hV₁ ⊢
  exact mlieBracketWithin_add_left hV hV₁ (uniqueMDiffWithinAt_univ _)

中文:
引理 mlieBracket_add_left
  条件: (hV : MDiffAt (T% V) x) (hV₁ : MDiffAt (T% V₁) x)
  证明: by
  simp only [← mlieBracketWithin_univ] at hV hV₁ ⊢
  exact mlieBracketWithin_add_left hV hV₁ (uniqueMDiffWithinAt_univ _)

Depends on / 依赖: mlieBracketWithin_add_left, mlieBracketWithin_univ, uniqueMDiffWithinAt_univ
-/
...
/--
lemma `mlieBracketWithin_add_right` / 引理 `mlieBracketWithin_add_right`

English:
lemma mlieBracketWithin_add_right
  proof: by
  rw [mlieBracketWithin_swap]; rw [Pi.neg_apply]; rw [mlieBracketWithin_add_left hW hW₁ hs]; rw [mlieBracketWithin_swap (V := V)]; rw [mlieBracketWithin_swap (V := V)]; rw [Pi.neg_apply]; rw [Pi.neg_apply]
  abel

中文:
引理 mlieBracketWithin_add_right
  证明: by
  rw [mlieBracketWithin_swap]; rw [Pi.neg_apply]; rw [mlieBracketWithin_add_left hW hW₁ hs]; rw [mlieBracketWithin_swap (V := V)]; rw [mlieBracketWithin_swap (V := V)]; rw [Pi.neg_apply]; rw [Pi.neg_apply]
  abel

Depends on / 依赖: Pi.neg_apply, mlieBracketWithin_add_left, mlieBracketWithin_swap, neg_apply
-/
lemma mlieBracketWithin_add_right
...
/--
lemma `mlieBracket_add_right` / 引理 `mlieBracket_add_right`

English:
lemma mlieBracket_add_right
  given: (hW : MDiffAt (T% W) x) (hW₁ : MDiffAt (T% W₁) x)
  proof: by
  simp only [← mlieBracketWithin_univ] at hW hW₁ ⊢
  exact mlieBracketWithin_add_right hW hW₁ (uniqueMDiffWithinAt_univ _)

中文:
引理 mlieBracket_add_right
  条件: (hW : MDiffAt (T% W) x) (hW₁ : MDiffAt (T% W₁) x)
  证明: by
  simp only [← mlieBracketWithin_univ] at hW hW₁ ⊢
  exact mlieBracketWithin_add_right hW hW₁ (uniqueMDiffWithinAt_univ _)

Depends on / 依赖: mlieBracketWithin_add_right, mlieBracketWithin_univ, uniqueMDiffWithinAt_univ
-/
...
set_option backward.isDefEq.respectTransparency false in
/--
theorem `mlieBracketWithin_of_mem_nhdsWithin` / 定理 `mlieBracketWithin_of_mem_nhdsWithin`

English:
theorem mlieBracketWithin_of_mem_nhdsWithin
  statement: (st : t in 𝓝[s] x) (hs : UniqueMDiffAt[s] x)
  proof: by
  simp only [mlieBracketWithin_apply]
  congr 1
...
· apply nhdsWithin_mono _ inter_subset_left
    ...
    · exact nhdsWithin_mono _ inter_s

中文:
定理 mlieBracketWithin_of_mem_nhdsWithin
  结论: (st : t in 𝓝[s] x) (hs : UniqueMDiffAt[s] x)
  证明: by
  simp only [mlieBracketWithin_apply]
  congr 1
  rw [lieBracketWithin_of_mem_nhdsWithin]
...
Depends on / 依赖: Filter, Filter.inter_mem, continuousAt_extChartAt_symm, continuousWithinAt, continuousWithinAt.preimage_mem_nhdsWithin, differentiableWithinAt_mpullbackWithin_vectorField, hV.differentiableWithinAt_mpullbackWithin_vectorField, hW.differentiableWithinAt_mpullbackWithin_vectorField, inter_mem, inter_subset_left, inter_subset_right, lieBracketWithin_of_mem_nhdsWithin, mlieBracketWithin_apply, nhdsWithin_mono, preimage_mem_nhdsWithin, self_mem_nhdsWithin, uniqueMDiffWithinAt_iff_inter_range
-/
theorem mlieBracketWithin_of_mem_nhdsWithin (st : t in 𝓝[s] x) (hs : UniqueMDiffAt[s] x)
...
/--
theorem `mlieBracketWithin_subset` / 定理 `mlieBracketWithin_subset`

English:
theorem mlieBracketWithin_subset
  statement: (st : s subseteq t) (ht : UniqueMDiffAt[s] x)
  proof: mlieBracketWithin_of_mem_nhdsWithin (nhdsWithin_mono _ st self_mem_nhdsWithin) ht hV hW

中文:
定理 mlieBracketWithin_subset
  结论: (st : s subseteq t) (ht : UniqueMDiffAt[s] x)
  证明: mlieBracketWithin_of_mem_nhdsWithin (nhdsWithin_mono _ st self_mem_nhdsWithin) ht hV hW

Depends on / 依赖: mlieBracketWithin_of_mem_nhdsWithin, nhdsWithin_mono, self_mem_nhdsWithin
-/
theorem mlieBracketWithin_subset (st : s subseteq t) (ht : UniqueMDiffAt[s] x)
    (hV : MDiffAt[t] (T% V) x) (hW : MDiffAt[t] (T% W) x) :
    mlieBracketWithin I V W s x = mlieBracketWithin I V W t x :=
  mlieBracketWithin_of_mem_nhdsWithin (nhdsWithin_mono _ st self_mem_nhdsWithin) ht hV hW

/--
theorem `mlieBracketWithin_eq_mlieBracket` / 定理 `mlieBracketWithin_eq_mlieBracket`

English:
theorem mlieBracketWithin_eq_mlieBracket
...
中文:
定理 mlieBracketWithin_eq_mlieBracket
  结论: (hs : UniqueMDiffAt[s] x)
  证明: by
  simp only [← mlieBracketWithin_univ, ← mdifferentiableWithinAt_univ] at hV hW ⊢
  exact mlieBracketWithin_subset (subset_univ _) hs hV hW

Depends on / 依赖: mdifferentiableWithinAt_univ, mlieBracketWithin_subset, mlieBracketWithin_univ, subset_univ
-/
...
/--
theorem `_root_.DifferentiableWithinAt.mlieBracketWithin_congr_mono` / 定理 `_root_.DifferentiableWithinAt.mlieBracketWithin_congr_mono`
...
中文:
定理 _root_.DifferentiableWithinAt.mlieBracketWithin_congr_mono
  证明: by
  rw [mlieBracketWithin_congr hVs hVx hWs hWx]
  exact mlieBracketWithin_subset h₁ hxt hV hW

Depends on / 依赖: mlieBracketWithin_congr, mlieBracketWithin_subset
-/
theorem _root_.DifferentiableWithinAt.mlieBracketWithin_congr_mono
    (hV : MDiffAt[s] (T% V) x) (hVs : EqOn V₁ V t) (hVx : V₁ x = V x)
    (hW : MDiffAt[s] (T% W) x) (hWs : EqOn W₁ W t) (hWx : W₁ x = W x)
    (hxt : UniqueMDiffAt[t] x) (h₁ : t subseteq s) :
...
set_option backward.isDefEq.respectTransparency false in
/--
lemma `mpullbackWithin_mlieBracketWithin_aux` / 引理 `mpullbackWithin_mlieBracketWithin_aux`
...
private lemma mpullbackWithin_mlieBracketWithin_aux [CompleteSpace E']
    ...
    (hu : UniqueMDiff[s]) (hf : CMDiff[s] 2 f) (hx₀ : x₀ in s)
    (ht : t subseteq (extChartAt I' (f x₀)).source) (hst : MapsTo f s t)
  ...
  rw [eq_comm]; rw [(isInvertible_mfderiv_extChartAt (mem_extChartAt_source x₀)).inverse_apply_eq]
  have : (mfderiv[range I] (extChartAt I x₀).symm (extChartAt I x₀ x₀)).inverse =
    ...
    · convert!
      mfderiv_extChartAt_comp_mfderivWithin_extChartAt_symm (I := I) (x := x₀) (y :=
        extChartAt I x₀ x₀) (by simp)
  rw [← this]; rw [← ContinuousLinearMap.IsInvertible.inverse_comp_apply_of_right]; swap
  · exact isInvertible_mfderivWithin_extChartAt_symm (mem_extChartAt_target x₀)
  have : mfderiv[range I] (extChartAt I x₀).symm (extChartAt I x₀ x₀) =
      mfderiv[(extChartAt I x₀).symm ⁻¹' s inter range I] (extChartAt I x₀).symm (extChartAt I x₀ x₀) :=
  ...
  rw [hFx₀]; rw [← mpullbackWithin_apply]
  ...
  have P (Y : (x : M') -> TangentSpace I' x) :
      ...
      (range I)) =ᶠ[𝓝[(extChartAt I x₀).symm ⁻¹' s inter range I] (extChartAt I x₀ x₀)]
        mpullbackWithin 𝓘(𝕜, E) 𝓘(𝕜, E') F
          (mpullbackWithin 𝓘(𝕜, E') I' ((extChartAt I' (f x₀)).symm) Y (range I'))
          ((extChartAt I x₀).symm ⁻¹' s inter range I) := by
    have : (extChartAt I x₀).target
        in 𝓝[(extChartAt I x₀).symm ⁻¹' s inter range I] (extChartAt I x₀ x₀) :=
    ...
    have h'y : f ((extChartAt I x₀).symm y) in (extChartAt I' (f x₀)).source := ht (hst hy.1)
    have h''y : f ((extChartAt I x₀).symm y) in (chartAt H' (f x₀)).source := by simpa using h'y
    have huy : UniqueMDiffAt[(extChartAt I x₀).symm ⁻¹' s inter range I] y := by
  ...
  rw [pullbackWithin_lieBracketWithin_of_isSymmSndFDerivWithinAt_of_eventuallyEq
      (u := (extChartAt I x₀).symm ⁻¹' s inter (extChartAt I x₀).target)]
  · exact hsymm
  · rw [hF, comp_assoc]
...
set_option backward.isDefEq.respectTransparency false in
/--
lemma `mpullbackWithin_mlieBracketWithin_of_isSymmSndFDerivWithinAt` / 引理 `mpullbackWithin_mlieBracketWithin_of_isSymmSndFDerivWithinAt`
...
lemma mpullbackWithin_mlieBracketWithin_of_isSymmSndFDerivWithinAt
  ...
  · simp only [mlieBracketWithin_apply, mpullbackWithin_apply,
    ...
    rw [lieBracketWithin_eq_zero_of_eq

中文:
引理 mpullbackWithin_mlieBracketWithin_of_isSymmSndFDerivWithinAt
  证明: by
  have A : (extChartAt I x₀).symm (extChartAt I x₀ x₀) = x₀ := by simp
  by_cases hfi : (mfderiv[s] f x₀).IsInvertible; swap
  · simp only [mlieBracketWithin_apply, mpullbackWithin_apply,
...
Depends on / 依赖: ContinuousLinearMap, ContinuousLinearMap.inverse_of_not_isInvertible, IsInvertible, extChartAt, inverse_of_not_isInvertible, lieBracketWithin_eq_zero_of_eq_zero, mfderiv, mlieBracketWithin_apply, mpullbackWithin_apply, zero_apply
-/
lemma mpullbackWithin_mlieBracketWithin_of_isSymmSndFDerivWithinAt
    {f : M -> M'} {V W : Π (x : M'), TangentSpace I' x} {x₀ : M} {s : Set M} {t : Set M'}
    (hV : MDiffAt[t] (T% V) (f x₀)) (hW : MDiffAt[t] (T% W) (f x₀))
    (hu : UniqueMDiff[s]) (hf : CMDiffAt[s] 2 f x₀) (hx₀ : x₀ in s)
    (hst : f ⁻¹' t in 𝓝[s] x₀)
    (hsymm : IsSymmSndFDerivWithinAt 𝕜 ((extChartAt I' (f x₀)) ∘ f ∘ (extChartAt I x₀).symm)
      ((extChartAt I x₀).symm ⁻¹' s inter range I) (extChartAt I x₀ x₀)) :
    mpullbackWithin I I' f (mlieBracketWithin I' V W t) s x₀ =
  ...
  · simp only [mlieBracketWithin_apply, mpullbackWithin_apply,
    ...
    · simp [-extChartAt]
    · simp only [mpullbackWithin_apply]
      rw [A]; rw [ContinuousLinearMap.inverse_of_not_isInvertible hfi]
      simp [-extChartAt]
    · simp only [mpullbackWithin_apply]
      rw [A]; rw [ContinuousLinearMap.inverse_of_not_isInvertible hfi]
      simp [-extChartAt]
  ...
  obtain ⟨u, u_open, x₀u, ut, maps_u, u_smooth⟩ :
      exists u, IsOpen u ∧ x₀ in u ∧ s inter u subseteq f ⁻¹' t ∧
        s inter u subseteq f ⁻¹' (extChartAt I' (f x₀)).source ∧ CMDiff[s inter u] 2 f := by
    obtain ⟨u, u_open, x₀u, hu⟩ : exists u, IsOpen u ∧ x₀ in u ∧ CMDiff[insert x₀ s inter u] 2 f :=
      hf.contMDiffOn' le_rfl (by simp)
    have : f ⁻¹' (extChartAt I' (f x₀)).source in 𝓝[s] x₀ :=
    ...
    refine ⟨u inter w, u_open.inter w_open, by simp [x₀u, x₀w], ?_, ?_, ?_⟩
  ...
  have u_mem : u in 𝓝 x₀ := u_open.mem_nhds x₀u
  -- apply the auxiliary version to `s ∩ u`
  set s' := s inter u with hs'
  have s'_eq : s' =ᶠ[𝓝 x₀] s := by
    filter_upwards [u_mem] with y hy
    change (y in s inter u) = (y in s)
    simp [hy]
  set t' := t inter (extChartAt I' (f x₀)).source with ht'
  ...
  _ = mlieBracketWithin I (mpullbackWithin I I' f V s') (mpullbackWithin I I' f W s') s' x₀ := by
    ...
    have : (extChartAt I x₀).symm ⁻¹' u in 𝓝 (extChartAt I x₀ x₀) := by
      apply (continuousAt_extChartAt_symm x₀).preimage_mem_nhds
      apply u_open.mem_nhds (by simpa using x₀u)
    filter_upwards [this] with y hy
    change (y in (extChartAt I x₀).symm ⁻¹' s inter range I) =
      (y in (extChartAt I x₀).symm ⁻¹' (s inter u) inter range I)
    simp [-extChartAt, hy]
  _ = mlieBracketWithin I (mpullbackWithin I I' f V s') (mpullbackWithin I I' f W s') s x₀ := by
...
variable [IsManifold I (minSmoothness 𝕜 2) M] [IsManifold I' (minSmoothness 𝕜 2) M']
  [CompleteSpace E] {n : Nat∞ω}

/--
lemma `mpullbackWithin_mlieBracketWithin'` / 引理 `mpullbackWithin_mlieBracketWithin'`

English:
lemma mpullbackWithin_mlieBracketWithin'
  proof: by
  have B : ContDiffWithinAt 𝕜 n ((extChartAt I' (f x₀)) ∘ f ∘ (extChartAt I x₀).symm)
      ((extChartAt I x₀).symm ⁻¹' u inter (extChartAt I x₀).target) (extChartAt I x₀ x₀) := by
    apply (contMDiffWithinAt_iff.1 hf).2.congr_set
    exact EventuallyEq.inter (by rfl) extChartAt_target_eventuall

中文:
引理 mpullbackWithin_mlieBracketWithin'
  证明: by
  have B : ContDiffWithinAt 𝕜 n ((extChartAt I' (f x₀)) ∘ f ∘ (extChartAt I x₀).symm)
      ((extChartAt I x₀).symm ⁻¹' u inter (extChartAt I x₀).target) (extChartAt I x₀ x₀) := by
    apply (contMDiffWithinAt_iff.1 hf).2.congr_set
...
Depends on / 依赖: ContDiffWithinAt, EventuallyEq, EventuallyEq.inter, congr_set, contMDiffWithinAt_iff, extChartAt, extChartAt_target_eventuallyEq, extChartAt_target_eventuallyEq.symm, hf.mono, le_minSmoothness, le_minSmoothness.trans, mpullbackWithin_mlieBracketWithin_of_isSymmSndFDerivWithinAt, of_le, target
-/
lemma mpullbackWithin_mlieBracketWithin'
    {f : M -> M'} {V W : Π (x : M'), TangentSpace I' x} {x₀ : M} {s u : Set M} {t : Set M'}
    (hV : MDiffAt[t] (T% V) (f x₀)) (hW : MDiffAt[t] (T% W) (f x₀))
    (hs : UniqueMDiff[s]) (hu : UniqueMDiff[u])
    (hf : CMDiffAt[u] n f x₀) (hx₀ : x₀ in s) (hn : minSmoothness 𝕜 2 <= n)
    (hst : f ⁻¹' t in 𝓝[s] x₀) (h'x₀ : x₀ in closure (interior u)) (hsu : s subseteq u) :
    mpullbackWithin I I' f (mlieBracketWithin I' V W t) s x₀ =
      mlieBracketWithin I (mpullbackWithin I I' f V s) (mpullbackWithin I I' f W s) s x₀ := by
  have B : ContDiffWithinAt 𝕜 n ((extChartAt I' (f x₀)) ∘ f ∘ (extChartAt I x₀).symm)
      ((extChartAt I x₀).symm ⁻¹' u inter (extChartAt I x₀).target) (extChartAt I x₀ x₀) := by
  ...
  have : ((extChartAt I x₀).symm ⁻¹' s inter (extChartAt I x₀).target : Set E)
      =ᶠ[𝓝 (extChartAt I x₀ x₀)] ((extChartAt I x₀).symm ⁻¹' s inter range I : Set E) :=
...
English:
lemma mpullbackWithin_mlieBracketWithin
  proof: mpullbackWithin_mlieBracketWithin' hV hW hu hu hf hx₀ hn hst h'x₀ Subset.rfl

中文:
引理 mpullbackWithin_mlieBracketWithin
  证明: mpullbackWithin_mlieBracketWithin' hV hW hu hu hf hx₀ hn hst h'x₀ Subset.rfl

Depends on / 依赖: Subset, Subset.rfl, mpullbackWithin_mlieBracketWithin
-/
lemma mpullbackWithin_mlieBracketWithin
    {f : M -> M'} {V W : Π (x : M'), TangentSpace I' x} {x₀ : M} {s : Set M} {t : Set M'}
    (hV : MDiffAt[t] (T% V) (f x₀)) (hW : MDiffAt[t] (T% W) (f x₀))
    (hu : UniqueMDiff[s]) (hf : CMDiffAt[s] n f x₀) (hx₀ : x₀ in s)
    (hn : minSmoothness 𝕜 2 <= n)
    (hst : f ⁻¹' t in 𝓝[s] x₀) (h'x₀ : x₀ in closure (interior s)) :
    mpullbackWithin I I' f (mlieBracketWithin I' V W t) s x₀ =
...
/--
lemma `mpullback_mlieBracketWithin` / 引理 `mpullback_mlieBracketWithin`
...
lemma mpullback_mlieBracketWithin
  ...
  have : mpullback I I' f (mlieBracketWithin I' V W t) x₀ =
    ...
    exact hf.mdifferentiableAt (two_pos.trans_le (le_minSmoo

中文:
引理 mpullback_mlieBracketWithin
  证明: by
  have : mpullback I I' f (mlieBracketWithin I' V W t) x₀ =
      mpullbackWithin I I' f (mlieBracketWithin I' V W t) s x₀ := by
    simp only [mpullback, mpullbackWithin]
...
Depends on / 依赖: EventuallyEq, Filter, Filter.EventuallyEq.mlieBracketWithin_vectorField_of_insert, contMDiffWithinAt, hf.contMDiffWithinAt, hf.mdifferentiableAt, le_minSmoothness, le_minSmoothness.trans, mdifferentiableAt, mfderivWithin_eq_mfderiv, mlieBracketWithin, mlieBracketWithin_vectorField_of_insert, mpullback, mpullbackWithin, mpullbackWithin_mlieBracketWithin, subset_univ, trans_le, two_pos, two_pos.trans_le, uniqueMDiffOn_univ
-/
lemma mpullback_mlieBracketWithin
    {f : M -> M'} {V W : Π (x : M'), TangentSpace I' x} {x₀ : M} {s : Set M} {t : Set M'}
    (hV : MDiffAt[t] (T% V) (f x₀)) (hW : MDiffAt[t] (T% W) (f x₀))
    (hu : UniqueMDiff[s]) (hf : CMDiffAt n f x₀) (hx₀ : x₀ in s)
    (hn : minSmoothness 𝕜 2 <= n) (hst : f ⁻¹' t in 𝓝[s] x₀) :
  ...
  rw [this]; rw [mpullbackWithin_mlieBracketWithin' hV hW hu uniqueMDiffOn_univ hf.contMDiffWithinAt
...
/--
lemma `mpullback_mlieBracket` / 引理 `mpullback_mlieBracket`
...
中文:
引理 mpullback_mlieBracket
  证明: by
  simp only [← mlieBracketWithin_univ, ← mdifferentiableWithinAt_univ] at hV hW ⊢
  exact mpullback_mlieBracketWithin hV hW uniqueMDiffOn_univ hf (mem_univ _) hn (by simp)

Depends on / 依赖: mdifferentiableWithinAt_univ, mem_univ, mlieBracketWithin_univ, mpullback_mlieBracketWithin, uniqueMDiffOn_univ
-/
lemma mpullback_mlieBracket
...
/--
lemma `_root_.ContMDiffWithinAt.mlieBracketWithin_vectorField` / 引理 `_root_.ContMDiffWithinAt.mlieBracketWithin_vectorField`

English:
lemma _root_.ContMDiffWithinAt.mlieBracketWithin_vectorField
  proof: by
...
中文:
引理 _root_.ContMDiffWithinAt.mlieBracketWithin_vectorField
  证明: by
  /- The statement is not obvious, since at different points the Lie bracket is defined using
  different charts. However, since we know that the Lie bracket is invariant under diffeos, we can
  use a single chart to prove the statement. Let `U'` and `V'` denote the pullbacks of `U` and `V`
...
protected lemma _root_.ContMDiffWithinAt.mlieBracketWithin_vectorField
  ...
  have pre_mem : (extChartAt I x) ⁻¹' ((extChartAt I x).target inter (extChartAt I x).symm ⁻¹' s)
      in 𝓝[s] x := by
  ...
  have A : ContDiffWithinAt 𝕜 m' (lieBracketWithin 𝕜 U' V'
      ((extChartAt I x).target inter (extChartAt I x).symm ⁻¹' s))
      ((extChartAt I x).target inter (extChartAt I x).symm ⁻¹' s) (extChartAt I x x) :=
  ...
  have B : CMDiffAt[((extChartAt I x).target inter (extChartAt I x).symm ⁻¹' s)] m'
      (T% (mlieBracketWithin 𝓘(𝕜, E) U' V' ((extChartAt I x).target inter (extChartAt I x).symm ⁻¹' s)))
      (extChartAt I x x) := by
  ...
  have C : CMDiffAt[s] m' (T% ((mpullback I 𝓘(𝕜, E) (extChartAt I x)
      ...
      ((extChartAt I x).target inter (extChartAt I x).symm ⁻¹' s)))))) x :=
...
/--
lemma `_root_.ContMDiffAt.mlieBracket_vectorField` / 引理 `_root_.ContMDiffAt.mlieBracket_vectorField`

English:
lemma _root_.ContMDiffAt.mlieBracket_vectorField
  statement: {m n : Nat∞}
  proof: by
...
中文:
引理 _root_.ContMDiffAt.mlieBracket_vectorField
  结论: {m n : 自然数∞}
  证明: by
  simp only [← contMDiffWithinAt_univ, ← mlieBracketWithin_univ] at hU hV ⊢
  exact hU.mlieBracketWithin_vectorField hV uniqueMDiffOn_univ (mem_univ _) hmn

Depends on / 依赖: contMDiffWithinAt_univ, hU.mlieBracketWithin_vectorField, mem_univ, mlieBracketWithin_univ, mlieBracketWithin_vectorField, uniqueMDiffOn_univ
-/
lemma _root_.ContMDiffAt.mlieBracket_vectorField {m n : Nat∞}
...
/--
lemma `_root_.ContMDiffOn.mlieBracketWithin_vectorField` / 引理 `_root_.ContMDiffOn.mlieBracketWithin_vectorField`

English:
lemma _root_.ContMDiffOn.mlieBracketWithin_vectorField
  statement: {m n : Nat∞}
  proof: fun x hx => (hU x hx).mlieBracketWithin_vectorField (hV x hx) hs hx hmn

中文:
引理 _root_.ContMDiffOn.mlieBracketWithin_vectorField
  结论: {m n : 自然数∞}
  证明: fun x hx => (hU x hx).mlieBracketWithin_vectorField (hV x hx) hs hx hmn

Depends on / 依赖: mlieBracketWithin_vectorField
-/
lemma _root_.ContMDiffOn.mlieBracketWithin_vectorField {m n : Nat∞}
...
/--
lemma `_root_.ContDiff.mlieBracket_vectorField` / 引理 `_root_.ContDiff.mlieBracket_vectorField`

English:
lemma _root_.ContDiff.mlieBracket_vectorField
  statement: {m n : Nat∞}
  proof: by
...
Depends on / 依赖: contMDiffOn_univ, hU.mlieBracketWithin_vectorField, mlieBracketWithin_vectorField, uniqueMDiffOn_univ
-/
lemma _root_.ContDiff.mlieBracket_vectorField {m n : Nat∞}
    [IsManifold I (n + 1) M] {U V : Π (x : M), TangentSpace I x}
...
set_option backward.isDefEq.respectTransparency false in
/--
theorem `leibniz_identity_mlieBracketWithin_apply` / 定理 `leibniz_identity_mlieBracketWithin_apply`
...
theorem leibniz_identity_mlieBracketWithin_apply
  ...
  have A : minSmoothness 𝕜 2 + 1 <= minSmoothness 𝕜 3 := by
    ...
    exact le_rfl
  have s_inter_mem : s inter (extChartAt I x).source in 𝓝[s] x :=
    inter_mem self_mem_nhdsWithin (nhdsWithin_le_nhds (extChartAt_source_mem_nhds x))
  have pre_mem : (extChartAt I x

中文:
定理 leibniz_identity_mlieBracketWithin_apply
  证明: by
  have A : minSmoothness 𝕜 2 + 1 <= minSmoothness 𝕜 3 := by
    simp only [← minSmoothness_add]
    exact le_rfl
...
Depends on / 依赖: extChartAt, extChartAt_source_mem_nhds, filter_upwards, inter_mem, le_rfl, left_inv, map_source, mem_preimage, minSmoothness, minSmoothness_add, nhdsWithin_le_nhds, pre_mem, s_inter_mem, self_mem_nhdsWithin, source, target
-/
theorem leibniz_identity_mlieBracketWithin_apply
    {U V W : Π (x : M), TangentSpace I x} {s : Set M} {x : M}
    (hs : UniqueMDiff[s]) (h's : x in closure (interior s)) (hx : x in s)
  ...
  have J0U : CMDiffAt[(extChartAt I x).target inter (extChartAt I x).symm ⁻¹' s] (minSmoothness 𝕜 2)
      (T% U') (extChartAt I x x) :=
    contMDiffWithinAt_mpullbackWithin_extChartAt_symm hU hs hx A
  have J0V : CMDiffAt[(extChartAt I x).target inter (extChartAt I x).symm ⁻¹' s] (minSmoothness 𝕜 2)
      (T% V') (extChartAt I x x) :=
    contMDiffWithinAt_mpullbackWithin_extChartAt_symm hV hs hx A
  have J0W : CMDiffAt[(extChartAt I x).target inter (extChartAt I x).symm ⁻¹' s] (minSmoothness 𝕜 2)
      (T% W') (extChartAt I x x) :=
    contMDiffWithinAt_mpullbackWithin_extChartAt_symm hW hs hx A
  have J1U : forallᶠ y in 𝓝[s] x, CMDiffAt[(extChartAt I x).target inter (extChartAt I x).symm ⁻¹' s]
      (minSmoothness 𝕜 2) (T% U') (extChartAt I x y) :=
    eventually_contMDiffWithinAt_mpullbackWithin_extChartAt_symm hU hs hx A (by simp)
  have J1V : forallᶠ y in 𝓝[s] x, CMDiffAt[(extChartAt I x).target inter (extChartAt I x).symm ⁻¹' s]
      (minSmoothness 𝕜 2) (T% V') (extChartAt I x y) :=
    eventually_contMDiffWithinAt_mpullbackWithin_extChartAt_symm hV hs hx A (by simp)
  have J1W : forallᶠ y in 𝓝[s] x, CMDiffAt[(extChartAt I x).target inter (extChartAt I x).symm ⁻¹' s]
  ...
  rw [JU.mlieBracketWithin_vectorField_eq_of_mem (JV.mlieBracketWithin_vectorField JW) hx]; rw [(JU.mlieBracketWithin_vectorField JV).mlieBracketWithin_vectorField_eq_of_mem JW hx]; rw [JV.mlieBracketWithin_vectorField_eq_of_mem (JU.mlieBracketWithin_vectorField JW) hx]
  /- Rewrite the first term as a pullback-/
  have : forallᶠ y in 𝓝[s] x, mlieBracketWithin I
      ...
      = mpullback I 𝓘(𝕜, E) (extChartAt I x) (mlieBracketWithin 𝓘(𝕜, E) V' W'
        ((extChartAt I x).target inter (extChartAt I x).symm ⁻¹' s)) y := by
  ...
  rw [Filter.EventuallyEq.mlieBracketWithin_vectorField_eq_of_mem EventuallyEq.rfl this hx]; rw [← mpullback_mlieBracketWithin (J0U.mdifferentiableWithinAt
  ...
  have : forallᶠ y in 𝓝[s] x, mlieBracketWithin I
    ...
    exact mpullback_mlieBracketWithin (n := minSmoothness 𝕜 2)
      ...
      (contMDiffAt_extChartAt' h'y) ys le_rfl hy
  rw [Filter.EventuallyEq.mlieBracketWithin_vectorField_eq_of_mem this EventuallyEq.rfl hx]; rw [← mpullback_mlieBracketWithin _ (J0W.mdifferentiableWithinAt
  ...
  have : forallᶠ y in 𝓝[s] x, mlieBracketWithin I
    ...
    exact mpullback_mlieBracketWithin (n := minSmoothness 𝕜 2)
      ...
      (hyW.mdifferentiableWithinAt (two_pos.trans_le le_minSmoothness).ne') hs
      (contMDiffAt_extChartAt' h'y) ys le_rfl hy
  rw [Filter.EventuallyEq.mlieBracketWithin_vectorField_eq_of_mem EventuallyEq.rfl this hx]; rw [← mpullback_mlieBracketWithin (J0V.mdifferentiableWithinAt
      (two_pos.trans_le le_minSmoothness).ne') _ hs contMDiffAt_extChartAt hx le_rfl pre_mem]; swap
  · apply ContMDiffWithinAt.mdifferentiableWithinAt _ one_ne_zero
  ...
  rw [← mpullback_add_apply]; rw [mpullback_apply]; rw [mpullback_apply]
  congr 1
...
/--
lemma `leibniz_identity_mlieBracket_apply` / 引理 `leibniz_identity_mlieBracket_apply`
...
中文:
引理 leibniz_identity_mlieBracket_apply
  证明: by
  simp only [← mlieBracketWithin_univ, ← contMDiffWithinAt_univ] at hU hV hW ⊢
  exact leibniz_identity_mlieBracketWithin_apply uniqueMDiffOn_univ (by simp) (mem_univ _) hU hV hW

Depends on / 依赖: contMDiffWithinAt_univ, leibniz_identity_mlieBracketWithin_apply, mem_univ, mlieBracketWithin_univ, uniqueMDiffOn_univ
-/
lemma leibniz_identity_mlieBracket_apply
...
/--
lemma `leibniz_identity_mlieBracket` / 引理 `leibniz_identity_mlieBracket`
...
中文:
引理 leibniz_identity_mlieBracket
  证明: by
  ext x
  exact leibniz_identity_mlieBracket_apply (hU x) (hV x) (hW x)

Depends on / 依赖: leibniz_identity_mlieBracket_apply
-/
lemma leibniz_identity_mlieBracket
