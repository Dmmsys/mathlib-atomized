...
/--
lemma `isUltrametricDist_of_forall_norm_add_one_le_max_norm_one` / 引理 `isUltrametricDist_of_forall_norm_add_one_le_max_norm_one`
...
-/
lemma isUltrametricDist_of_forall_norm_add_one_le_max_norm_one
    (h : forall x : R, ‖x + 1‖ <= max ‖x‖ 1) : IsUltrametricDist R := by
  refine isUltrametricDist_of_forall_norm_add_le_max_norm (fun x y => ?_)
  rcases eq_or_ne y 0 with rfl | hy
  · simpa only [add_zero] using le_max_left _ _
  · have p : 0 < ‖y‖ := norm_pos_iff.mpr hy
...
/--
lemma `isUltrametricDist_of_forall_norm_add_one_of_norm_le_one` / 引理 `isUltrametricDist_of_forall_norm_add_one_of_norm_le_one`
...
-/
lemma isUltrametricDist_of_forall_norm_add_one_of_norm_le_one
    (h : forall x : R, ‖x‖ <= 1 -> ‖x + 1‖ <= 1) : IsUltrametricDist R := by
  refine isUltrametricDist_of_forall_norm_add_one_le_max_norm_one fun x => ?_
  rcases le_or_gt ‖x‖ 1 with H | H
  · exact (h _ H).trans (le_max_right _ _)
  · suffices ‖x + 1‖ <= ‖x‖ from this.trans (le_max_left _ _)
...
/--
lemma `isUltrametricDist_of_forall_norm_sub_one_of_norm_le_one` / 引理 `isUltrametricDist_of_forall_norm_sub_one_of_norm_le_one`
...
Depends on / 依赖: isUltrametricDist_of_forall_norm_add_one_of_norm_le_one, neg_add, norm_neg
-/
lemma isUltrametricDist_of_forall_norm_sub_one_of_norm_le_one
    (h : forall x : R, ‖x‖ <= 1 -> ‖x - 1‖ <= 1) : IsUltrametricDist R := by
  have (x : R) (hx : ‖x‖ <= 1) : ‖x + 1‖ <= 1 := by
...
/--
lemma `isUltrametricDist_of_forall_pow_norm_le_nsmul_pow_max_one_norm` / 引理 `isUltrametricDist_of_forall_pow_norm_le_nsmul_pow_max_one_norm`
...
/--
lemma `isUltrametricDist_of_forall_norm_natCast_le_one` / 引理 `isUltrametricDist_of_forall_norm_natCast_le_one`
...
/--
theorem `isUltrametricDist_iff_forall_norm_natCast_le_one` / 定理 `isUltrametricDist_iff_forall_norm_natCast_le_one`

English:
theorem isUltrametricDist_iff_forall_norm_natCast_le_one
  statement: {R : Type*}
  proof: ⟨fun _ => IsUltrametricDist.norm_natCast_le_one R,
...
Depends on / 依赖: IsUltrametricDist, IsUltrametricDist.isUltrametricDist_of_forall_norm_natCast_le_one, IsUltrametricDist.norm_natCast_le_one, isUltrametricDist_of_forall_norm_natCast_le_one, norm_natCast_le_one
-/
theorem isUltrametricDist_iff_forall_norm_natCast_le_one {R : Type*}
    [NormedDivisionRing R] : IsUltrametricDist R ↔ forall n : Nat, ‖(n : R)‖ <= 1 :=
