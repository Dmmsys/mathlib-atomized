...
/--
Definition of `applyFunHyp` / `applyFunHyp` 的定义

English:
definition applyFunHyp
  signature: (f : Term) (using? : Option Term) (h : FVarId) (g : MVarId)
  body: do
...
/--
Definition of `applyFunTargetFailure` / `applyFunTargetFailure` 的定义

English:
definition applyFunTargetFailure
  signature: (f : Term)
  body: do
...
/--
Definition of `maybeProveInjective` / `maybeProveInjective` 的定义

English:
definition maybeProveInjective
  signature: (ginj : Expr) (using? : Option Expr)
  body: do
...
Depends on / 依赖: EqOnSource, PartialEquiv, PartialEquiv.EqOnSource.trans
-/
...
/--
Definition of `applyFunTarget` / `applyFunTarget` 的定义

English:
definition applyFunTarget
  signature: (f : Term) (using? : Option Term) (g : MVarId)
  body: do
