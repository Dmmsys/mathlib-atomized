...
noncomputable
/--
Definition of `effectiveEpiStructOfQuotientMap` / `effectiveEpiStructOfQuotientMap` 的定义

English:
definition effectiveEpiStructOfQuotientMap
  signature: {B X : TopCat.{u}} (π : X ⟶ B) (hπ : IsQuotientMap π)
  body: ofHom hπ.lift e.hom fun a b hab =>
...
/--
theorem `effectiveEpi_iff_isQuotientMap` / 定理 `effectiveEpi_iff_isQuotientMap`

English:
theorem effectiveEpi_iff_isQuotientMap
  given: {B X : TopCat.{u}} (π : X ⟶ B)
  proof: by
