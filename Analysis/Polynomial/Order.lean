...
variable {P : Real[X]} {x : Real}

/--
theorem `zero_lt_eval_of_roots_lt_of_leadingCoeff_nonneg` / 定理 `zero_lt_eval_of_roots_lt_of_leadingCoeff_nonneg`
...
-/
theorem zero_lt_eval_of_roots_lt_of_leadingCoeff_nonneg
    (hroots : forall y, P.IsRoot y -> y < x) (hlc : 0 <= P.leadingCoeff) : 0 < P.eval x := by
  replace hlc : 0 < P.leadingCoeff := by
    contrapose! hroots
    exact ⟨x, by simp [leadingCoeff_eq_zero.mp <| eq_of_le_of_ge hroots hlc], le_refl x⟩
  by_cases! hdeg : P.degree <= 0
...
/--
theorem `zero_le_eval_of_roots_le_of_leadingCoeff_nonneg` / 定理 `zero_le_eval_of_roots_le_of_leadingCoeff_nonneg`

English:
theorem zero_le_eval_of_roots_le_of_leadingCoeff_nonneg
  proof: by
  by_cases! hroots' : exists y, P.IsRoot y ∧ x <= y
  · obtain ⟨y, hroot, hle⟩ := hroots'
    rw [eq_of_le_of_ge hle (hroots y hroot)]; rw [hroot]
  · exact (zero_lt_eval_of_roots_lt_of_leadingCoeff_nonneg hroots' hlc).le

中文:
定理 zero_le_eval_of_roots_le_of_leadingCoeff_nonneg
  证明: by
  by_cases! hroots' : exists y, P.IsRoot y ∧ x <= y
  · obtain ⟨y, hroot, hle⟩ := hroots'
    rw [eq_of_le_of_ge hle (hroots y hroot)]; rw [hroot]
...
Depends on / 依赖: IsRoot, P.IsRoot, eq_of_le_of_ge, hroots, zero_lt_eval_of_roots_lt_of_leadingCoeff_nonneg
-/
theorem zero_le_eval_of_roots_le_of_leadingCoeff_nonneg
    (hroots : forall y, P.IsRoot y -> y <= x) (hlc : 0 <= P.leadingCoeff) : 0 <= P.eval x := by
  by_cases! hroots' : exists y, P.IsRoot y ∧ x <= y
...
/--
theorem `eval_lt_zero_of_roots_lt_of_leadingCoeff_nonpos` / 定理 `eval_lt_zero_of_roots_lt_of_leadingCoeff_nonpos`
...
中文:
定理 eval_lt_zero_of_roots_lt_of_leadingCoeff_nonpos
  证明: by
  suffices 0 < (-P).eval x by apply neg_pos.mp; rwa [← eval_neg]
  refine zero_lt_eval_of_roots_lt_of_leadingCoeff_nonneg (fun y hy => hroots y ?_) ?_
  · rwa [IsRoot, ← neg_zero, ← neg_eq_iff_eq_neg, ← eval_neg]
...
Depends on / 依赖: IsRoot, eval_neg, hroots, le_neg, leadingCoeff_neg, neg_eq_iff_eq_neg, neg_pos, neg_pos.mp, neg_zero, zero_lt_eval_of_roots_lt_of_leadingCoeff_nonneg
-/
theorem eval_lt_zero_of_roots_lt_of_leadingCoeff_nonpos
    (hroots : forall y, P.IsRoot y -> y < x) (hlc : P.leadingCoeff <= 0) : P.eval x < 0 := by
  suffices 0 < (-P).eval x by apply neg_pos.mp; rwa [← eval_neg]
  refine zero_lt_eval_of_roots_lt_of_leadingCoeff_nonneg (fun y hy => hroots y ?_) ?_
  · rwa [IsRoot, ← neg_zero, ← neg_eq_iff_eq_neg, ← eval_neg]
  · rwa [leadingCoeff_neg, le_neg, neg_zero]
...
/--
theorem `eval_le_zero_of_roots_le_of_leadingCoeff_nonpos` / 定理 `eval_le_zero_of_roots_le_of_leadingCoeff_nonpos`
...
中文:
定理 eval_le_zero_of_roots_le_of_leadingCoeff_nonpos
  证明: by
  suffices 0 <= (-P).eval x by apply neg_nonneg.mp; rwa [← eval_neg]
  refine zero_le_eval_of_roots_le_of_leadingCoeff_nonneg (fun y hy => hroots y ?_) ?_
  · rwa [IsRoot, ← neg_zero, ← neg_eq_iff_eq_neg, ← eval_neg]
...
Depends on / 依赖: IsRoot, eval_neg, hroots, leadingCoeff_neg, neg_eq_iff_eq_neg, neg_nonneg, neg_nonneg.mp, neg_zero, zero_le_eval_of_roots_le_of_leadingCoeff_nonneg
-/
theorem eval_le_zero_of_roots_le_of_leadingCoeff_nonpos
    (hroots : forall y, P.IsRoot y -> y <= x) (hlc : P.leadingCoeff <= 0) : P.eval x <= 0 := by
  suffices 0 <= (-P).eval x by apply neg_nonneg.mp; rwa [← eval_neg]
...
/--
theorem `zero_lt_negOnePow_mul_eval_of_lt_roots_of_leadingCoeff_nonneg` / 定理 `zero_lt_negOnePow_mul_eval_of_lt_roots_of_leadingCoeff_nonneg`
...
-/
theorem zero_lt_negOnePow_mul_eval_of_lt_roots_of_leadingCoeff_nonneg
    (hroots : forall y, P.IsRoot y -> x < y) (hlc : 0 <= P.leadingCoeff) :
...
/--
theorem `zero_le_negOnePow_mul_eval_of_le_roots_of_leadingCoeff_nonneg` / 定理 `zero_le_negOnePow_mul_eval_of_le_roots_of_leadingCoeff_nonneg`

English:
theorem zero_le_negOnePow_mul_eval_of_le_roots_of_leadingCoeff_nonneg
  proof: by
  by_cases! hroots' : exists y, P.IsRoot y ∧ y <= x
  · obtain ⟨y, hroot, hle⟩ := hroots'
    rw [eq_of_ge_of_le hle (hroots y hroot)]; rw [hroot]; rw [mul_zero]
  · exact (zero_lt_negOnePow_mul_eval_of_lt_roots_of_leadingCoeff_nonneg hroots' hlc).le

中文:
定理 zero_le_negOnePow_mul_eval_of_le_roots_of_leadingCoeff_nonneg
  证明: by
  by_cases! hroots' : exists y, P.IsRoot y ∧ y <= x
  · obtain ⟨y, hroot, hle⟩ := hroots'
    rw [eq_of_ge_of_le hle (hroots y hroot)]; rw [hroot]; rw [mul_zero]
...
Depends on / 依赖: IsRoot, P.IsRoot, eq_of_ge_of_le, hroots, mul_zero, zero_lt_negOnePow_mul_eval_of_lt_roots_of_leadingCoeff_nonneg
-/
theorem zero_le_negOnePow_mul_eval_of_le_roots_of_leadingCoeff_nonneg
    (hroots : forall y, P.IsRoot y -> x <= y) (hlc : 0 <= P.leadingCoeff) :
      0 <= Int.negOnePow P.natDegree * P.eval x := by
...
/--
theorem `negOnePow_mul_eval_lt_zero_of_lt_roots_of_leadingCoeff_nonpos` / 定理 `negOnePow_mul_eval_lt_zero_of_lt_roots_of_leadingCoeff_nonpos`
...
中文:
定理 negOnePow_mul_eval_lt_zero_of_lt_roots_of_leadingCoeff_nonpos
  证明: by
  suffices 0 < Int.negOnePow (-P).natDegree * (-P).eval x by apply neg_pos.mp; simpa
  refine zero_lt_negOnePow_mul_eval_of_lt_roots_of_leadingCoeff_nonneg (fun y hy => hroots y ?_) ?_
  · rwa [IsRoot, ← neg_zero, ← neg_eq_iff_eq_neg, ← eval_neg]
...
Depends on / 依赖: Int.negOnePow, IsRoot, eval_neg, hroots, le_neg, leadingCoeff_neg, natDegree, negOnePow, neg_eq_iff_eq_neg, neg_pos, neg_pos.mp, neg_zero, zero_lt_negOnePow_mul_eval_of_lt_roots_of_leadingCoeff_nonneg
-/
theorem negOnePow_mul_eval_lt_zero_of_lt_roots_of_leadingCoeff_nonpos
    (hroots : forall y, P.IsRoot y -> x < y) (hlc : P.leadingCoeff <= 0) :
...
/--
theorem `negOnePow_mul_eval_le_zero_of_le_roots_of_leadingCoeff_nonpos` / 定理 `negOnePow_mul_eval_le_zero_of_le_roots_of_leadingCoeff_nonpos`
...
中文:
定理 negOnePow_mul_eval_le_zero_of_le_roots_of_leadingCoeff_nonpos
  证明: by
  suffices 0 <= Int.negOnePow (-P).natDegree * (-P).eval x by apply neg_nonneg.mp; simpa
  refine zero_le_negOnePow_mul_eval_of_le_roots_of_leadingCoeff_nonneg (fun y hy => hroots y ?_) ?_
  · rwa [IsRoot, ← neg_zero, ← neg_eq_iff_eq_neg, ← eval_neg]
...
Depends on / 依赖: Int.negOnePow, IsRoot, eval_neg, hroots, leadingCoeff_neg, natDegree, negOnePow, neg_eq_iff_eq_neg, neg_nonneg, neg_nonneg.mp, neg_zero, zero_le_negOnePow_mul_eval_of_le_roots_of_leadingCoeff_nonneg
-/
theorem negOnePow_mul_eval_le_zero_of_le_roots_of_leadingCoeff_nonpos
    (hroots : forall y, P.IsRoot y -> x <= y) (hlc : P.leadingCoeff <= 0) :
      Int.negOnePow P.natDegree * P.eval x <= 0 := by
