...
/--
Definition of `IsJordan` / `IsJordan` 的定义

English:
class IsJordan
  parameters: [Mul A]
  axioms and operations (5):
    - lmul_comm_rmul : forall a b : A, a * b * a = a * (b * a)
    - lmul_lmul_comm_lmul : forall a b : A, a * a * (a * b) = a * (a * a * b)
    - lmul_lmul_comm_rmul : forall a b : A, a * a * (b * a) = a * a * b * a
...
类 IsJordan
  ...
  公理与运算 (5 个):
    ...
    - lmul_lmul_comm_rmul : 对任意 a b : A, a * a * (b * a) = a * a * b * a
    - lmul_comm_rmul_rmul : 对任意 a b : A, a * b * (a * a) = a * (b * (a * a))
    - rmul_comm_rmul_rmul : 对任意 a b : A, b * a * (a * a) = b * (a * a) * a
-/
...
/--
Definition of `IsCommJordan` / `IsCommJordan` 的定义

English:
class IsCommJordan
  parameters: [CommMagma A]
...
instance (priority := 100) IsCommJordan.toIsJordan [CommMagma A] [IsCommJordan A] : IsJordan A where
  ...
  lmul_lmul_comm_lmul a b := by
    rw [mul_comm (a * a) (a * b)]; rw [IsCommJordan.lmul_comm_rmul_rmul]; rw [mul_comm b (a * a)]
  lmul_comm_rmul_rmul := IsCommJordan.lmul_comm_rmul_rmul
  lmul_lmul_comm_rmul a b := by
    rw [mul_comm (a * a) (b * a)]; rw [mul_comm b a]; rw [IsCommJordan.lmul_comm_rmul_rmul]; rw [mul_comm]; rw [mul_comm b (a * a)]
  rmul_comm_rmul_rmul a b := by
    rw [mul_comm b a]; rw [IsCommJordan.lmul_comm_rmul_rmul]; rw [mul_comm]
...
@[simp]
/--
theorem `commute_lmul_rmul` / 定理 `commute_lmul_rmul`

English:
theorem commute_lmul_rmul
  given: (a : A)
  statement: Commute (L a) (R a)
  proof: AddMonoidHom.ext fun _ => (IsJordan.lmul_comm_rmul _ _).symm

@[simp]

中文:
定理 commute_lmul_rmul
  条件: (a : A)
  结论: Commute (L a) (R a)
  证明: AddMonoidHom.ext fun _ => (IsJordan.lmul_comm_rmul _ _).symm

@[simp]

Depends on / 依赖: AddMonoidHom, AddMonoidHom.ext, IsJordan, IsJordan.lmul_comm_rmul, lmul_comm_rmul
-/
...
@[simp]
/--
theorem `commute_lmul_lmul_sq` / 定理 `commute_lmul_lmul_sq`

English:
theorem commute_lmul_lmul_sq
  given: (a : A)
  statement: Commute (L a) (L (a * a))
  proof: AddMonoidHom.ext fun _ => (IsJordan.lmul_lmul_comm_lmul _ _).symm

@[simp]

中文:
定理 commute_lmul_lmul_sq
  条件: (a : A)
  结论: Commute (L a) (L (a * a))
  证明: AddMonoidHom.ext fun _ => (IsJordan.lmul_lmul_comm_lmul _ _).symm

@[simp]

Depends on / 依赖: AddMonoidHom, AddMonoidHom.ext, IsJordan, IsJordan.lmul_lmul_comm_lmul, lmul_lmul_comm_lmul
-/
...
@[simp]
/--
theorem `commute_lmul_rmul_sq` / 定理 `commute_lmul_rmul_sq`

English:
theorem commute_lmul_rmul_sq
  given: (a : A)
  statement: Commute (L a) (R (a * a))
  proof: AddMonoidHom.ext fun _ => (IsJordan.lmul_comm_rmul_rmul _ _).symm

@[simp]

中文:
定理 commute_lmul_rmul_sq
  条件: (a : A)
  结论: Commute (L a) (R (a * a))
  证明: AddMonoidHom.ext fun _ => (IsJordan.lmul_comm_rmul_rmul _ _).symm

@[simp]

Depends on / 依赖: AddMonoidHom, AddMonoidHom.ext, IsJordan, IsJordan.lmul_comm_rmul_rmul, lmul_comm_rmul_rmul
-/
...
@[simp]
/--
theorem `commute_lmul_sq_rmul` / 定理 `commute_lmul_sq_rmul`

English:
theorem commute_lmul_sq_rmul
  given: (a : A)
  statement: Commute (L (a * a)) (R a)
  proof: AddMonoidHom.ext fun _ => IsJordan.lmul_lmul_comm_rmul _ _

@[simp]

中文:
定理 commute_lmul_sq_rmul
  条件: (a : A)
  结论: Commute (L (a * a)) (R a)
  证明: AddMonoidHom.ext fun _ => IsJordan.lmul_lmul_comm_rmul _ _

@[simp]

Depends on / 依赖: AddMonoidHom, AddMonoidHom.ext, IsJordan, IsJordan.lmul_lmul_comm_rmul, lmul_lmul_comm_rmul
-/
...
@[simp]
/--
theorem `commute_rmul_rmul_sq` / 定理 `commute_rmul_rmul_sq`

English:
theorem commute_rmul_rmul_sq
  given: (a : A)
  statement: Commute (R a) (R (a * a))
  proof: AddMonoidHom.ext fun _ => (IsJordan.rmul_comm_rmul_rmul _ _).symm

中文:
定理 commute_rmul_rmul_sq
  条件: (a : A)
  结论: Commute (R a) (R (a * a))
  证明: AddMonoidHom.ext fun _ => (IsJordan.rmul_comm_rmul_rmul _ _).symm

Depends on / 依赖: AddMonoidHom, AddMonoidHom.ext, IsJordan, IsJordan.rmul_comm_rmul_rmul, rmul_comm_rmul_rmul
-/
...
/--
theorem `two_nsmul_lie_lmul_lmul_add_eq_lie_lmul_lmul_add` / 定理 `two_nsmul_lie_lmul_lmul_add_eq_lie_lmul_lmul_add`

English:
theorem two_nsmul_lie_lmul_lmul_add_eq_lie_lmul_lmul_add
  given: [IsCommJordan A] (a b : A)
  proof: by
  ...
  simp only [add_mul, mul_add, map_add, lie_add, ad
...
Depends on / 依赖: add_lie, add_mul, add_zero, commute_lmul_lmul_sq, convert, lie_add, lie_eq, lie_skew, map_add, mul_add, mul_comm, nsmul_add, sub_eq_add_neg, sub_eq_zero, sub_sub, two_smul, zero_add
-/
...
/--
theorem `aux0` / 定理 `aux0`

English:
theorem aux0
  given: {a b c : A}
  statement: ⁅L (a + b + c), L ((a + b + c) * (a + b + c))⁆ =
  proof: by
  rw [add_mul]; rw [add_mul]
  iterate 6 rw [mul_add]
  iterate 10 rw [map_add]
  rw [mul_comm b a]; rw [mul_comm c a]; rw [mul_comm c b]
...
set_option backward.isDefEq.respectTransparency false in
/--
theorem `two_nsmul_lie_lmul_lmul_add_add_eq_zero` / 定理 `two_nsmul_lie_lmul_lmul_add_add_eq_zero`

English:
theorem two_nsmul_lie_lmul_lmul_add_add_eq_zero
  given: (a b c : A)
  proof: by
  symm
  calc
...
中文:
定理 two_nsmul_lie_lmul_lmul_add_add_eq_zero
  条件: (a b c : A)
  证明: by
  symm
  calc
...
Depends on / 依赖: commute_lmul_lmul_sq, lie_eq, nsmul_add
-/
