...
/--
theorem `addCommute_iff_eq_mul_natCast` / 定理 `addCommute_iff_eq_mul_natCast`

English:
theorem addCommute_iff_eq_mul_natCast
  given: {o₁ o₂ : Ordinal}
  proof: by
...
have hcomm' : AddCommute o₁ o₃ := add_left_cancel (a := o₁) by grind
    ...
    use o, n₁, n₁ + n₃, hn₁
    rw [Nat.cast_add]; rw [mul_add]; rw [hn₁]; rw [hn₃]; rw [hsub]
  · rintro ⟨o, n₁, n₂, rfl, rfl⟩
    rw [addCommute_iff_eq]; rw [← mul_add]; rw [← mul_add]; rw [← Nat.cast_add]; rw [add_comm]; rw [Nat.cast_add]
...
Depends on / 依赖: AddCommute, Ordinal, Ordinal.add_sub_cancel_of_le, WellFoundedLT, WellFoundedLT.induction, add_left_cancel, add_sub_cancel_of_le, eq_or_ne, generalizing, hcomm.eq, hcomm.symm
-/
theorem addCommute_iff_eq_mul_natCast {o₁ o₂ : Ordinal} :
    AddCommute o₁ o₂ ↔ exists (o : Ordinal) (n₁ n₂ : Nat), o * n₁ = o₁ ∧ o * n₂ = o₂ := by
  refine ⟨fun hcomm => ?_, ?_⟩
  · induction h : o₁ + o₂ using WellFoundedLT.induction generalizing o₁ o₂ with | ind o ih
    subst h
    wlog hle : o₁ <= o₂
