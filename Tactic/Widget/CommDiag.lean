...
/-
**_root_.Lean.Expr.app7** 是 Mathlib 中的一个定义，位于命名空间 ``。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
If the expression is a function application of `fName` with 7 arguments, return 
those arguments.
Otherwise return `none`.
-/
...
/-
**Mathlib.Tactic.Widget.homType** 是 Mathlib 中的一个定义，位于命名空间 `Mathlib.Tactic.Widget
`。
形式化陈述：homType? (e : Expr) : Option (Expr × Expr)
参数：e : Expr。
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Mathlib.Tactic.Widget.homComp** 是 Mathlib 中的一个定义，位于命名空间 `Mathlib.Tactic.Widget
`。
形式化陈述：homComp? (f : Expr) : Option (Expr × Expr)
参数：f : Expr。
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Mathlib.Tactic.Widget.ExprEmbeds** 是 Mathlib 中的一个缩写定义，位于命名空间 `Mathlib.Tactic.W
idget`。
形式化陈述：ExprEmbeds
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Mathlib.Tactic.Widget.mkCommDiag** 是 Mathlib 中的一个定义，位于命名空间 `Mathlib.Tactic.Wid
get`。
形式化陈述：mkCommDiag (sub : String) (embeds : ExprEmbeds) : MetaM Html
参数：sub : String；embeds : ExprEmbeds。
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
Construct a commutative diagram from a Penrose `sub`stance program and expressio
ns `embeds` to
display as labels in the diagram.
-/
...
-/
/-
**Mathlib.Tactic.Widget.subTriangle** 是 Mathlib 中的一个定义，位于命名空间 `Mathlib.Tactic.Wi
dget`。
形式化陈述：subTriangle
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
Otherwise `none`. -/
/-
**Mathlib.Tactic.Widget.commTriangleM** 是 Mathlib 中的一个定义，位于命名空间 `Mathlib.Tactic.
Widget`。
形式化陈述：commTriangleM? (e : Expr) : MetaM (Option Html)
参数：e : Expr。
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
Given a commutative triangle `f ≫ g = h` or `e ≡ h = f ≫ g`, return a triangle d
iagram.
Otherwise `none`.
-/
...
@[expr_presenter]
/-
**Mathlib.Tactic.Widget.commutativeTrianglePresenter** 是 Mathlib 中的一个定义，位于命名空间 `
Mathlib.Tactic.Widget`。
形式化陈述：commutativeTrianglePresenter : ExprPresenter where userName
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
-/
/-
**Mathlib.Tactic.Widget.subSquare** 是 Mathlib 中的一个定义，位于命名空间 `Mathlib.Tactic.Widg
et`。
形式化陈述：subSquare
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Mathlib.Tactic.Widget.commSquareM** 是 Mathlib 中的一个定义，位于命名空间 `Mathlib.Tactic.Wi
dget`。
形式化陈述：commSquareM? (e : Expr) : MetaM (Option Html)
参数：e : Expr。
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
Given a commutative square `f ≫ g = i ≫ h`, return a square diagram. Otherwise `
none`.
-/
...
@[expr_presenter]
/-
**Mathlib.Tactic.Widget.commutativeSquarePresenter** 是 Mathlib 中的一个定义，位于命名空间 `Ma
thlib.Tactic.Widget`。
形式化陈述：commutativeSquarePresenter : ExprPresenter where userName
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
