...
@[expose]
/--
Definition of `convexCombination` / `convexCombination` 的定义

English:
definition convexCombination
  signature: (s : StdSimplex R P)
  body: s.weights.support.affineCombination R id s.weights
...
/--
theorem `convexCombination_single` / 定理 `convexCombination_single`

English:
theorem convexCombination_single
  given: (x : P)
  proof: by
...
Depends on / 依赖: Finset, Finset.mem_singleton_self, Finsupp, Finsupp.single_eq_of_ne, Finsupp.single_eq_same, Finsupp.support_single, StdSimplex, StdSimplex.single, affineCombination_of_eq_one_of_eq_zero, convexCombination, mem_singleton_self, one_ne_zero, single, single_eq_of_ne, single_eq_same, support_single
-/
...
/--
theorem `convexCombination_assoc` / 定理 `convexCombination_assoc`

English:
theorem convexCombination_assoc
  given: (f : StdSimplex R (StdSimplex R P))
  proof: by
  -- Choose a base point
...
@[implicit_reducible]
/--
Definition of `toConvexSpace` / `toConvexSpace` 的定义

English:
definition toConvexSpace
  signature: : ConvexSpace R P where
  body: convexCombination
...
Depends on / 依赖: convexCombination
-/
...
/--
theorem `sConvexComb_eq_affineCombination` / 定理 `sConvexComb_eq_affineCombination`

English:
theorem sConvexComb_eq_affineCombination
  given: (s : StdSimplex R P)
  proof: by
  rfl
...
/--
theorem `iConvexComb_eq_affineCombination` / 定理 `iConvexComb_eq_affineCombination`

English:
theorem iConvexComb_eq_affineCombination
  given: (s : StdSimplex R I) (f : I -> P)
  proof: by
...
/--
theorem `convexCombPair_eq_lineMap` / 定理 `convexCombPair_eq_lineMap`

English:
theorem convexCombPair_eq_lineMap
  statement: (s t : R) (hs : 0 <= s) (ht : 0 <= t)
  proof: by
