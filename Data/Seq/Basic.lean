...
/-
**Stream.Seq.length'_of_terminates** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
...
theorem length'_of_terminates {s : Seq α} (h : s.Terminates) :
  ...
  simp [length', h]
/-
**Stream.Seq.length'_of_not_terminates** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.length_nil** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.length'_nil** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
theorem length'_nil : length' (nil : Seq α) = 0 := by
  simp -implicitDefEqProofs [length']
/-
**Stream.Seq.length_cons** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.length'_cons** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.length_eq_zero** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.length'_eq_zero_iff_nil** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
theorem length'_eq_zero_iff_nil (s : Seq α) :
  ...
  cases s <;> simp
/-
**Stream.Seq.length'_ne_zero_iff_cons** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.Seq.length_le_iff'** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
The statement of `length_le_iff'` does not assume that the sequence terminates. 
For a
simpler statement of the theorem where the sequence is known to terminate see `l
ength_le_iff`.
-/
...
/-
**Stream.Seq.length'_le_iff** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.Seq.lt_length_iff'** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
The statement of `lt_length_iff'` does not assume that the sequence terminates. 
For a
simpler statement of the theorem where the sequence is known to terminate see `l
t_length_iff`.
-/
...
/-
**Stream.Seq.lt_length'_iff** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.ofStream_cons** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
set_option backward.isDefEq.respectTransparency false in
/-
**Stream.Seq.terminatedAt_ofList** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.Seq.terminates_ofList** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.take_nil** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.take_zero** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.take_succ_cons** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp, grind =]
/-
**Stream.Seq.getElem** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
theorem get?_mem_take {s : Seq α} {m n : ℕ} (h_mn : m < n) {x : α}
  ...
  | succ k ih =>
    ...
    rwa [get?_tail]
/-
**Stream.Seq.length_take_le** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
set_option backward.isDefEq.respectTransparency false in
/-
**Stream.Seq.length_take_of_le_length** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.length_toList** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.ofList_toList** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.toList_ofList** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.toList_nil** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
theorem toList_nil : toList (nil : Seq α) ⟨0, terminatedAt_zero_iff.2 rfl⟩ = [] := by
  ext; simp [nil, toList, const]
/-
**Stream.Seq.getLast** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.cons_append** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.nil_append** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.append_nil** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.append_assoc** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
theorem append_assoc (s t u : Seq α) : append (append s t) u = append s (append t u) := by
  ...
  · exact ⟨s, t, u, rfl, rfl⟩
/-
**Stream.Seq.of_mem_append** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.Seq.mem_append_left** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.ofList_append** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.ofStream_append** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.map_get** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.map_nil** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.map_cons** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.map_id** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.map_tail** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
theorem map_tail (f : α → β) : ∀ s, map f (tail s) = tail (map f s)
  | ⟨s, al⟩ => by apply Subtype.ext; dsimp [tail, map]
/-
**Stream.Seq.map_comp** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.terminatedAt_map_iff** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.terminates_map_iff** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.length_map** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.length'_map** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.Seq.mem_map** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
theorem mem_map (f : α → β) {a : α} : ∀ {s : Seq α}, a ∈ s → f a ∈ map f s
  | ⟨_, _⟩ => Stream'.mem_map (Option.map f)
/-
**Stream.Seq.exists_of_mem_map** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.map_append** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.join_nil** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.Seq.join_cons_nil** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
-- Not a simp lemmas as `join_cons` is more general
/-
**Stream.Seq.join_cons_cons** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.join_cons** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.join_append** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp, grind =]
/-
**Stream.Seq.drop_get** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
theorem drop_get? {n m : ℕ} {s : Seq α} : (s.drop n).get? m = s.get? (n + m) := by
  ...
  | succ k ih =>
    ...
    lia
/-
**Stream.Seq.dropn_add** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.Seq.dropn_tail** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.head_dropn** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.drop_zero** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.drop_succ_cons** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.drop_nil** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.drop_length'** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
theorem drop_length' {n : ℕ} {s : Seq α} :
  ...
  | succ n =>
    ...
    | cons x s =>
      ...
      lia
/-
**Stream.Seq.take_drop** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.nats_get** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.zipWith_nil_left** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.zipWith_nil_right** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.zipWith_cons_cons** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.zip_nil_left** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.zip_nil_right** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.zip_cons_cons** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.enum_nil** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.enum_cons** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.Seq.zipWith_map** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.Seq.zipWith_map_left** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
theorem zipWith_map_left (s₁ : Seq α) (s₂ : Seq β) (f : α → α') (g : α' → β → γ) :
  ...
  simp
/-
**Stream.Seq.zipWith_map_right** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
theorem zipWith_map_right (s₁ : Seq α) (s₂ : Seq β) (f : β → β') (g : α → β' → γ) :
  ...
  simp
/-
**Stream.Seq.zip_map** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
theorem zip_map (s₁ : Seq α) (s₂ : Seq β) (f₁ : α → α') (f₂ : β → β') :
  ...
  cases s₁.get? n <;> cases s₂.get? n <;> simp
/-
**Stream.Seq.zip_map_left** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
theorem zip_map_left (s₁ : Seq α) (s₂ : Seq β) (f : α → α') :
  ...
  simp
/-
**Stream.Seq.zip_map_right** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.fold_nil** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.fold_cons** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.fold_head** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.update_nil** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.set_nil** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.update_cons_zero** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.set_cons_zero** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.update_cons_succ** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.set_cons_succ** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.Seq.drop_set_of_lt** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.Seq.all_cons** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
theorem all_cons {p : α → Prop} {hd : α} {tl : Seq α} (h_hd : p hd) (h_tl : ∀ x ∈ tl, p x) :
  ...
  exact ⟨h_hd, h_tl⟩
/-
**Stream.Seq.all_get** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.Seq.all_of_get** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
theorem all_of_get {p : α → Prop} {s : Seq α} (h : ∀ n x, s.get? n = .some x → p x) :
  ...
  grind
/-
**Stream.Seq.all_coind_drop_motive** 是 Mathlib 中的一个引理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.Seq.all_coind** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Stream.Seq.map_all_iff** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
theorem map_all_iff {β : Type u} {f : α → β} {p : β → Prop} {s : Seq α} :
  ...
  · obtain ⟨_, _, hx'⟩ := exists_of_mem_map hx
    ...
    solve_by_elim
/-
**Stream.Seq.take_all** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.Seq.set_all** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.Pairwise.nil** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
theorem Pairwise.nil {R : α → α → Prop} : Pairwise R (@nil α) := by
  simp [Pairwise]
/-
**Stream.Seq.Pairwise.cons** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.Seq.Pairwise.cons_elim** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq.Pairwise_cons_nil** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
theorem Pairwise_cons_nil {R : α → α → Prop} {hd : α} : Pairwise R (cons hd nil) := by
  apply Pairwise.cons <;> simp
/-
**Stream.Seq.Pairwise_cons_cons_head** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.Seq.Pairwise.cons_cons_of_trans** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.Seq.Pairwise.coind** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
-/
/-
**Stream.Seq.Pairwise.coind_trans** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
Coinductive principle for `Pairwise` that assumes that `R` is transitive. Compar
ed to
`Pairwise.coind`, this allows you to prove `R hd tl.head` instead of `tl.All (R 
hd ·)` in `step`.
-/
...
/-
**Stream.Seq.Pairwise_tail** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.Seq.Pairwise_drop** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.Seq.at_least_as_long_as_coind** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
Coinductive principle for proving `b.length' ≤ a.length'` for two sequences `a` 
and `b`.
-/
...
/-
**Stream.Seq1.toSeq** 是 Mathlib 中的一个定义，位于命名空间 `Stream.Seq1`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
def toSeq : Seq1 α → Seq α
  | (a, s) => Seq.cons a s
/-
**Stream.Seq1.coeSeq** 是 Mathlib 中的一个实例，位于命名空间 `Stream.Seq1`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.Seq1.map** 是 Mathlib 中的一个定义，位于命名空间 `Stream.Seq1`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
def map (f : α → β) : Seq1 α → Seq1 β
  | (a, s) => (f a, Seq.map f s)
/-
**Stream.Seq1.map_pair** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq1`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
set_option backward.isDefEq.respectTransparency false in
/-
**Stream.Seq1.map_id** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq1`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.Seq1.join** 是 Mathlib 中的一个定义，位于命名空间 `Stream.Seq1`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
@[simp]
/-
**Stream.Seq1.join_nil** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq1`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq1.join_cons** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq1`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.Seq1.ret** 是 Mathlib 中的一个定义，位于命名空间 `Stream.Seq1`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
def ret (a : α) : Seq1 α :=
  (a, nil)
/-
**Stream.Seq1.** 是 Mathlib 中的一个实例，位于命名空间 `Stream.Seq1`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.Seq1.bind** 是 Mathlib 中的一个定义，位于命名空间 `Stream.Seq1`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
@[simp]
/-
**Stream.Seq1.join_map_ret** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq1`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq1.bind_ret** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq1`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq1.ret_bind** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq1`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq1.map_join'** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq1`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq1.join_join** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq1`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.Seq1.bind_assoc** 是 Mathlib 中的一个定理，位于命名空间 `Stream.Seq1`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
theorem bind_assoc (s : Seq1 α) (f : α → Seq1 β) (g : β → Seq1 γ) :
  ...
  · obtain ⟨y, t⟩ := x_1; simp
/-
**Stream.Seq1.monad** 是 Mathlib 中的一个实例，位于命名空间 `Stream.Seq1`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
instance monad : Monad Seq1 where
  ...
  bind := @bind
/-
**Stream.Seq1.lawfulMonad** 是 Mathlib 中的一个实例，位于命名空间 `Stream.Seq1`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
