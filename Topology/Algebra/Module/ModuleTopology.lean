...
/--
Definition of `moduleTopology` / `moduleTopology` 的定义

English:
abbreviation moduleTopology
  signature: : TopologicalSpace A
  body: sInf {t | @ContinuousSMul R A _ _ t ∧ @ContinuousAdd A t _}
...
/--
Definition of `IsModuleTopology` / `IsModuleTopology` 的定义

English:
class IsModuleTopology
  parameters: [τA : TopologicalSpace A]
...
/--
theorem `eq_moduleTopology` / 定理 `eq_moduleTopology`

English:
theorem eq_moduleTopology
  given: [τA : TopologicalSpace A] [IsModuleTopology R A]
  proof: IsModuleTopology.eq_moduleTopology' (R := R) (A := A)
...
/--
theorem `ModuleTopology.continuousSMul` / 定理 `ModuleTopology.continuousSMul`

English:
theorem ModuleTopology.continuousSMul
  statement: @ContinuousSMul R A _ _ (moduleTopology R A)
...
/--
theorem `ModuleTopology.continuousAdd` / 定理 `ModuleTopology.continuousAdd`

English:
theorem ModuleTopology.continuousAdd
  statement: @ContinuousAdd A (moduleTopology R A) _
  proof: continuousAdd_sInf fun _ h => h.2
...
/--
Instance `IsModuleTopology.toContinuousSMul` / 实例 `IsModuleTopology.toContinuousSMul`

English:
instance IsModuleTopology.toContinuousSMul
  signature: [TopologicalSpace A] [IsModuleTopology R A]
...
/--
theorem `IsModuleTopology.toContinuousAdd` / 定理 `IsModuleTopology.toContinuousAdd`

English:
theorem IsModuleTopology.toContinuousAdd
  given: [TopologicalSpace A] [IsModuleTopology R A]
...
/--
theorem `moduleTopology_le` / 定理 `moduleTopology_le`

English:
theorem moduleTopology_le
  given: [τA : TopologicalSpace A] [ContinuousSMul R A] [ContinuousAdd A]
  proof: sInf_le ⟨inferInstance, inferInstance⟩
...
/--
theorem `of_continuous_id` / 定理 `of_continuous_id`

English:
theorem of_continuous_id
  statement: [ContinuousAdd A] [ContinuousSMul R A]
  proof: le_antisymm (continuous_id_iff_le.1 h) (moduleTopology_le _ _)
...
/--
theorem `isoₛₗ` / 定理 `isoₛₗ`

English:
theorem isoₛₗ
  given: (hσ : Continuous σ) (hσ' : Continuous σ') (e : A ≃SL[σ] B')
  proof: by
...
theorem iso
  given: (e : A ≃L[R] B)
  statement: IsModuleTopology R B
  proof: IsModuleTopology.isoₛₗ continuous_id continuous_id e
...
instance (priority := 1100) _root_.IsTopologicalSemiring.toIsModuleTopology :
  ...
  -/
  rw [show (id : R -> R) = (fun rs => rs.1 • rs.2) ∘ (fun r => (r]; rw [1)) by ext; simp]
  /-
...
/--
Instance `_root_.IsTopologicalSemiring.toOppositeIsModuleTopology` / 实例 `_root_.IsTopologicalSemiring.toOppositeIsModuleTopology`

English:
instance _root_.IsTopologicalSemiring.toOppositeIsModuleTopology
  signature: : IsModuleTopology Rᵐᵒᵖ R
...
@[continuity]
/--
theorem `continuous_of_distribMulActionHomₑ` / 定理 `continuous_of_distribMulActionHomₑ`

English:
theorem continuous_of_distribMulActionHomₑ
  given: {σ : R ->* S} (hσ : Continuous σ) (φ : A ->ₑ+[σ] B')
  proof: by
...
@[fun_prop]
/--
theorem `continuous_of_distribMulActionHom` / 定理 `continuous_of_distribMulActionHom`

English:
theorem continuous_of_distribMulActionHom
  given: (φ : A ->+[R] B)
  statement: Continuous φ
  proof: continuous_of_distribMulActionHomₑ continuous_id φ
...
@[continuity]
/--
theorem `continuous_of_linearMapₛₗ` / 定理 `continuous_of_linearMapₛₗ`

English:
theorem continuous_of_linearMapₛₗ
  given: {σ : R ->+* S} (hσ : Continuous σ) (φ : A ->ₛₗ[σ] B')
  proof: continuous_of_distribMulActionHomₑ hσ φ.toDistribMulActionHom
...
@[fun_prop]
/--
theorem `continuous_of_linearMap` / 定理 `continuous_of_linearMap`

English:
theorem continuous_of_linearMap
  given: (φ : A ->ₗ[R] B)
  statement: Continuous φ
  proof: continuous_of_distribMulActionHom φ.toDistribMulActionHom
...
variable (R) in
/--
theorem `continuous_neg` / 定理 `continuous_neg`

English:
theorem continuous_neg
  statement: (C : Type*) [AddCommGroup C] [Module R C] [TopologicalSpace C]
  proof: haveI : ContinuousAdd C := IsModuleTopology.toContinuousAdd R C
...
Depends on / 依赖: ContinuousAdd, IsModuleTopology, IsModuleTopology.toContinuousAdd, LinearEquiv, LinearEquiv.neg, continuous_of_linearMap, toContinuousAdd, toLinearMap
-/
...
variable (R) in
/--
theorem `continuousNeg` / 定理 `continuousNeg`

English:
theorem continuousNeg
  statement: (C : Type*) [AddCommGroup C] [Module R C] [TopologicalSpace C]
  proof: continuous_neg R C
...
variable (R) in
/--
theorem `topologicalAddGroup` / 定理 `topologicalAddGroup`

English:
theorem topologicalAddGroup
  statement: (C : Type*) [AddCommGroup C] [Module R C] [TopologicalSpace C]
  proof: (IsModuleTopology.toContinuousAdd R C).1
  continuous_neg := continuous_neg R C
...
Depends on / 依赖: IsModuleTopology, IsModuleTopology.toContinuousAdd, toContinuousAdd
-/
...
@[fun_prop, continuity]
/--
theorem `continuous_of_ringHom` / 定理 `continuous_of_ringHom`

English:
theorem continuous_of_ringHom
  statement: {R A B} [CommSemiring R] [Semiring A] [Algebra R A] [Semiring B]
  proof: by
...
Depends on / 依赖: Algebra, Algebra.smul_def, ContinuousSMul, Module, Module.compHom, algebraMap, compHom, continuous_fst, continuous_of_linearMap, continuous_snd, smul_def
-/
...
open Topology in
/--
theorem `isQuotientMap_of_surjectiveₛₗ` / 定理 `isQuotientMap_of_surjectiveₛₗ`

English:
theorem isQuotientMap_of_surjectiveₛₗ
  statement: [τB : TopologicalSpace B'] [IsModuleTopology S B']
  proof: hφ
  eq_coinduced := by
...
open Topology in
/--
theorem `isQuotientMap_of_surjective` / 定理 `isQuotientMap_of_surjective`

English:
theorem isQuotientMap_of_surjective
  statement: [τB : TopologicalSpace B] [IsModuleTopology R B]
  proof: isQuotientMap_of_surjectiveₛₗ .id φ hφ
...
/--
theorem `isOpenQuotientMap_of_surjectiveₛₗ` / 定理 `isOpenQuotientMap_of_surjectiveₛₗ`

English:
theorem isOpenQuotientMap_of_surjectiveₛₗ
  statement: [TopologicalSpace B'] [IsModuleTopology S B']
  proof: have := toContinuousAdd R A
...
Depends on / 依赖: AddMonoidHom, AddMonoidHom.isOpenQuotientMap_of_isQuotientMap, isOpenQuotientMap_of_isQuotientMap, toContinuousAdd
-/
...
/--
theorem `isOpenQuotientMap_of_surjective` / 定理 `isOpenQuotientMap_of_surjective`

English:
theorem isOpenQuotientMap_of_surjective
  statement: [TopologicalSpace B] [IsModuleTopology R B]
  proof: isOpenQuotientMap_of_surjectiveₛₗ .id φ hφ
...
omit [IsModuleTopology R A] in
/--
theorem `isOpenMap_of_surjectiveₛₗ` / 定理 `isOpenMap_of_surjectiveₛₗ`

English:
theorem isOpenMap_of_surjectiveₛₗ
  statement: [TopologicalSpace B'] [IsModuleTopology S B']
  proof: by
  have hOpenMap :=
    letI : TopologicalSpace A := moduleTopology R A
    have : IsModuleTopology R A := ⟨rfl⟩
.isOpenMap isOpenQuotientMap_of_surjectiveₛₗ hσ φ hφ
  intro U hU
...
Depends on / 依赖: IsModuleTopology, TopologicalSpace, hOpenMap, isOpenMap, moduleTopology, moduleTopology_le
-/
...
omit [IsModuleTopology R A] in
/--
theorem `isOpenMap_of_surjective` / 定理 `isOpenMap_of_surjective`

English:
theorem isOpenMap_of_surjective
  statement: [TopologicalSpace B] [IsModuleTopology R B]
  proof: isOpenMap_of_surjectiveₛₗ .id φ hφ
...
/--
lemma `_root_.ModuleTopology.eq_coinduced_of_surjectiveₛₗ` / 引理 `_root_.ModuleTopology.eq_coinduced_of_surjectiveₛₗ`
...
中文:
引理 _root_.ModuleTopology.eq_coinduced_of_surjectiveₛₗ
  证明: by
  let : TopologicalSpace B' := moduleTopology S B'
  have : IsModuleTopology S B' := ⟨rfl⟩
  exact (isQuotientMap_of_surjectiveₛₗ hσ φ hφ).eq_coinduced

Depends on / 依赖: IsModuleTopology, TopologicalSpace, eq_coinduced, moduleTopology
-/
lemma _root_.ModuleTopology.eq_coinduced_of_surjectiveₛₗ
    {σ : R ->+* S} (hσ : IsOpenQuotientMap σ) (φ : A ->ₛₗ[σ] B') (hφ : Function.Surjective φ) :
...
/--
lemma `_root_.ModuleTopology.eq_coinduced_of_surjective` / 引理 `_root_.ModuleTopology.eq_coinduced_of_surjective`

English:
lemma _root_.ModuleTopology.eq_coinduced_of_surjective
  proof: ModuleTopology.eq_coinduced_of_surjectiveₛₗ .id φ hφ

中文:
引理 _root_.ModuleTopology.eq_coinduced_of_surjective
  证明: ModuleTopology.eq_coinduced_of_surjectiveₛₗ .id φ hφ

Depends on / 依赖: ModuleTopology, ModuleTopology.eq_coinduced_of_surjective
-/
lemma _root_.ModuleTopology.eq_coinduced_of_surjective
    {φ : A ->ₗ[R] B} (hφ : Function.Surjective φ) :
...
/--
Instance `instQuot` / 实例 `instQuot`

English:
instance instQuot
  signature: (S : Submodule R A)
  body: by
  constructor
  have := toContinuousAdd R A
...
Depends on / 依赖: ModuleTopology, ModuleTopology.eq_coinduced_of_surjective, Submodule, Submodule.isOpenQuotientMap_mkQ, Submodule.mkQ_surjective, eq_coinduced, eq_coinduced_of_surjective, isOpenQuotientMap_mkQ, isQuotientMap, isQuotientMap.eq_coinduced, mkQ_surjective, module, toContinuousAdd
-/
...
/--
Instance `instProd` / 实例 `instProd`

English:
instance instProd
  signature: : IsModuleTopology R (M × N)
  body: by
  constructor
...
variable {R : Type*} [TopologicalSpace R] [Semiring R]
variable {ι : Type*} [Finite ι] {A : ι -> Type*} [forall i, AddCommMonoid (A i)]
  [forall i, Module R (A i)] [forall i, TopologicalSpace (A i)]
  [forall i, IsModuleTopology R (A i)]

/--
Instance `instPi` / 实例 `instPi`

English:
instance instPi
  signature: : IsModuleTopology R (forall i, A i)
  body: by
...
/--
theorem `continuous_bilinear_of_pi_fintype` / 定理 `continuous_bilinear_of_pi_fintype`

English:
theorem continuous_bilinear_of_pi_fintype
...
@[continuity, fun_prop]
/--
theorem `continuous_bilinear_of_finite_left` / 定理 `continuous_bilinear_of_finite_left`

English:
theorem continuous_bilinear_of_finite_left
  statement: [Module.Finite R A]
  proof: by
...
@[continuity, fun_prop]
/--
theorem `continuous_bilinear_of_finite_right` / 定理 `continuous_bilinear_of_finite_right`

English:
theorem continuous_bilinear_of_finite_right
  statement: [Module.Finite R B]
  proof: by
...
@[continuity, fun_prop]
/--
theorem `continuous_mul_of_finite` / 定理 `continuous_mul_of_finite`

English:
theorem continuous_mul_of_finite
  statement: Continuous (fun ab => ab.1 * ab.2 : D × D -> D)
  proof: -- Proof: multiplication is bilinear so this follows from previous results.
...
include R in
/--
theorem `isTopologicalRing` / 定理 `isTopologicalRing`

English:
theorem isTopologicalRing
  statement: IsTopologicalRing D where
  proof: (toContinuousAdd R D).1
