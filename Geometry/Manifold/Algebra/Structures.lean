...
variable {𝕜 : Type*} [NontriviallyNormedField 𝕜] {H : Type*} [TopologicalSpace H] {E : Type*}
  [NormedAddCommGroup E] [NormedSpace 𝕜 E] {n : Nat∞ω}

-- See note [Design choices about smooth algebraic structures]
/--
Definition of `ContMDiffRing` / `ContMDiffRing` 的定义

English:
class ContMDiffRing
  parameters: (I : ModelWithCorners 𝕜 E H) (n : Nat∞ω)
...
类 余ntMDiff环
  ...
  公理与运算 (1 个):
    - contMDiff_mul : CMDiff n fun p : R × R => p.1 * p.2
-/
class ContMDiffRing (I : ModelWithCorners 𝕜 E H) (n : Nat∞ω)
...
instance (priority := 100) instFieldContMDiffRing
    {𝕜 : Type*} [NontriviallyNormedField 𝕜] {n : Nat∞ω} :
...
/--
theorem `topologicalSemiring_of_contMDiffRing` / 定理 `topologicalSemiring_of_contMDiffRing`

English:
theorem topologicalSemiring_of_contMDiffRing
  given: [Semiring R] [ContMDiffRing I n R]
  proof: { continuousMul_of_contMDiffMul I n, continuousAdd_of_contMDiffAdd I n with }
