...
/--
theorem `Uncountable.of_not_small` / 定理 `Uncountable.of_not_small`

English:
theorem Uncountable.of_not_small
  given: {α : Type v} (h : ¬ Small.{w} α)
...
Depends on / 依赖: Countable, Countable.toSmall, toSmall, uncountable_iff_not_countable
-/
