...
/--
lemma `preservesLimit_flip_obj` / 引理 `preservesLimit_flip_obj`

English:
lemma preservesLimit_flip_obj
  statement: (P : J ⥤ C₁ᵒᵖ)
  proof: ⟨by
...
lemma preservesLimit_flip_obj (P : J ⥤ C₁ᵒᵖ)
    [forall (X₂ : C₂), PreservesColimit P.leftOp (F.flip.obj X₂)] (X₃ : C₃) :
...
variable (J) in
/--
lemma `preservesLimitsOfShape_flip_obj` / 引理 `preservesLimitsOfShape_flip_obj`

English:
lemma preservesLimitsOfShape_flip_obj
  proof: preservesLimit_flip_obj adj₂ _ _

中文:
引理 preservesLimitsOfShape_flip_obj
  证明: preservesLimit_flip_obj adj₂ _ _

Depends on / 依赖: preservesLimit_flip_obj
-/
lemma preservesLimitsOfShape_flip_obj
    [forall (X₂ : C₂), PreservesColimitsOfShape Jᵒᵖ (F.flip.obj X₂)] (X₃ : C₃) :
