...
/--
lemma `isRegularEpiCategory_sheaf` / 引理 `isRegularEpiCategory_sheaf`

English:
lemma isRegularEpiCategory_sheaf
...
lemma isRegularEpiCategory_sheaf (J : GrothendieckTopology C)
    ...
    (h : forall {F G : Sheaf J D} (f : F ⟶ G) [Epi f], exists (I : Cᵒᵖ ⥤ D) (p : F.obj ⟶ I) (i : I ⟶ G.obj),
