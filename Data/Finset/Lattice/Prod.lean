...
/--
theorem `sup_product_left` / 定理 `sup_product_left`

English:
theorem sup_product_left
  given: (s : Finset β) (t : Finset γ) (f : β × γ -> α)
  proof: eq_of_forall_ge_iff fun a => by simp [@forall_comm _ γ]
...
@[to_dual inf_product_right]
/--
theorem `sup_product_right` / 定理 `sup_product_right`

English:
theorem sup_product_right
  given: (s : Finset β) (t : Finset γ) (f : β × γ -> α)
  proof: by
...
Depends on / 依赖: Finset, Finset.sup_comm, sup_comm, sup_product_left
-/
...
@[to_dual (attr := simp)]
/--
lemma `sup_prodMap` / 引理 `sup_prodMap`

English:
lemma sup_prodMap
  given: (hs : s.Nonempty) (ht : t.Nonempty) (f : ι -> α) (g : κ -> β)
  proof: eq_of_forall_ge_iff fun i => by
    obtain ⟨a, ha⟩ := hs
    obtain ⟨b, hb⟩ := ht
...
Depends on / 依赖: Finset, Finset.sup_le_iff, Prod.forall, Prod.le_def, Prod.map, and_imp, eq_of_forall_ge_iff, le_def, mem_product, sup_le_iff
-/
...
@[to_dual]
/--
theorem `sup_inf_sup` / 定理 `sup_inf_sup`

English:
theorem sup_inf_sup
  given: (s : Finset ι) (t : Finset κ) (f : ι -> α) (g : κ -> α)
  proof: by
...
Depends on / 依赖: Finset, Finset.sup_inf_distrib_left, Finset.sup_inf_distrib_right, simp_rw, sup_inf_distrib_left, sup_inf_distrib_right, sup_product_left
-/
...
/--
theorem `sup'_product_left` / 定理 `sup'_product_left`

English:
theorem sup'_product_left
  given: {t : Finset γ} (h : (s ×ˢ t).Nonempty) (f : β × γ -> α)
  proof: eq_of_forall_ge_iff fun a => by simp [@forall_comm _ γ]
...
@[to_dual inf'_product_right]
/--
theorem `sup'_product_right` / 定理 `sup'_product_right`

English:
theorem sup'_product_right
  given: {t : Finset γ} (h : (s ×ˢ t).Nonempty) (f : β × γ -> α)
  proof: by
...
/--
lemma `prodMk_sup'_sup'` / 引理 `prodMk_sup'_sup'`

English:
lemma prodMk_sup'_sup'
  given: (hs : s.Nonempty) (ht : t.Nonempty) (f : ι -> α) (g : κ -> β)
  proof: eq_of_forall_ge_iff fun i => by
    obtain ⟨a, ha⟩ := hs
    obtain ⟨b, hb⟩ := ht
...
Depends on / 依赖: Prod.forall, Prod.le_def, Prod.map, _le_iff, and_imp, eq_of_forall_ge_iff, le_def, mem_product
-/
...
/--
lemma `sup'_prodMap` / 引理 `sup'_prodMap`

English:
lemma sup'_prodMap
  given: (hst : (s ×ˢ t).Nonempty) (f : ι -> α) (g : κ -> β)
...
@[to_dual]
/--
theorem `sup'_inf_sup'` / 定理 `sup'_inf_sup'`

English:
theorem sup'_inf_sup'
  given: (f : ι -> α) (g : κ -> α)
  proof: by
