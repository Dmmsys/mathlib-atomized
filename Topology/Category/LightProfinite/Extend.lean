...
中文:
定义 functor
  签名: : 自然数ᵒᵖ ⥤ StructuredArrow c.pt toLightProfinite where
...
中文:
缩写 fintypeDiagram'
  签名: : StructuredArrow S toLightProfinite ⥤ FintypeCat
...
中文:
缩写 diagram'
  签名: : StructuredArrow S toLightProfinite ⥤ LightProfinite
