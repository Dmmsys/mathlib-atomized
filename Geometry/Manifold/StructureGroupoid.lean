...
/-
**StructureGroupoid** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：(H : Type u_2) → [TopologicalSpace H] → Type u_2
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
A structure groupoid is a set of open partial homeomorphisms of a topological sp
ace stable under
composition and inverse. They appear in the definition of the smoothness class o
f a manifold.
-/
...
/-
**StructureGroupoid.trans** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：StructureGroupoid.trans (G : StructureGroupoid H) {e e' : OpenPartialHomeo
morph H H} (he : e in G) (he' : e' in G) : e ≫ₕ e' in G
参数：G : StructureGroupoid H；he : e in G；he' : e' in G。
该定理/引理描述了相关对象所满足的性质。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `StructureGroupoid.trans'`：∀ {H : Type u_2} [inst : TopologicalSpace H] (
self : StructureGroupoid H) (e e' : OpenPartialHomeomorph H H),   e ∈ self.membe
rs → e' ∈ self…
-/
theorem StructureGroupoid.trans (G : StructureGroupoid H) {e e' : OpenPartialHomeomorph H H}
  ...
  G.trans' e e' he he'
/-
**StructureGroupoid.symm** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：StructureGroupoid.symm (G : StructureGroupoid H) {e : OpenPartialHomeomorp
h H H} (he : e in G) : e.symm in G
参数：G : StructureGroupoid H；he : e in G。
该定理/引理描述了相关对象所满足的性质。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `StructureGroupoid.symm'`：∀ {H : Type u_2} [inst : TopologicalSpace H] (s
elf : StructureGroupoid H), ∀ e ∈ self.members, e.symm ∈ self.members
-/
theorem StructureGroupoid.symm (G : StructureGroupoid H) {e : OpenPartialHomeomorph H H}
    (he : e ∈ G) : e.symm ∈ G :=
  G.symm' e he
/-
**StructureGroupoid.id_mem** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：StructureGroupoid.id_mem (G : StructureGroupoid H) : OpenPartialHomeomorph
.refl H in G
参数：G : StructureGroupoid H。
该定理/引理描述了相关对象所满足的性质。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `StructureGroupoid.id_mem'`：∀ {H : Type u_2} [inst : TopologicalSpace H] 
(self : StructureGroupoid H), OpenPartialHomeomorph.refl H ∈ self.members
-/
theorem StructureGroupoid.id_mem (G : StructureGroupoid H) : OpenPartialHomeomorph.refl H ∈ G :=
  G.id_mem'
/-
**StructureGroupoid.locality** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：StructureGroupoid.locality (G : StructureGroupoid H) {e : OpenPartialHomeo
morph H H} (h : forall x in e.source, exists s, IsOpen s ∧ x in s ∧ e.restr s in
 G) : e in G
参数：G : StructureGroupoid H；h : forall x in e.source, exists s, IsOpen s ∧ x in s
 ∧ e.restr s in G。
该定理/引理描述了相关对象所满足的性质。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `StructureGroupoid.locality'`：∀ {H : Type u_2} [inst : TopologicalSpace H
] (self : StructureGroupoid H) (e : OpenPartialHomeomorph H H),   (∀ x ∈ e.sourc
e, ∃ s, IsOpen s …
-/
theorem StructureGroupoid.locality (G : StructureGroupoid H) {e : OpenPartialHomeomorph H H}
  ...
  G.locality' e h
/-
**StructureGroupoid.mem_of_eqOnSource** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：StructureGroupoid.mem_of_eqOnSource (G : StructureGroupoid H) {e e' : Open
PartialHomeomorph H H} (he : e in G) (h : e' ≈ e) : e' in G
参数：G : StructureGroupoid H；he : e in G；h : e' ≈ e。
该定理/引理描述了相关对象所满足的性质。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `StructureGroupoid.mem_of_eqOnSource'`：∀ {H : Type u_2} [inst : Topologic
alSpace H] (self : StructureGroupoid H) (e e' : OpenPartialHomeomorph H H),   e 
∈ self.members → e' ≈ e → …
-/
...
/-
**StructureGroupoid.mem_iff_of_eqOnSource** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：StructureGroupoid.mem_iff_of_eqOnSource {G : StructureGroupoid H} {e e' : 
OpenPartialHomeomorph H H} (h : e ≈ e') : e in G ↔ e' in G
参数：h : e ≈ e'。
该定理/引理刻画了左右两侧的等价关系。
黑盒证明引用了以下数学事实（定理与引理）：
...
/-
**StructureGroupoid.partialOrder** 是 Mathlib 中的一个实例，位于命名空间 ``。
形式化陈述：StructureGroupoid.partialOrder : PartialOrder (StructureGroupoid H)
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
Partial order on the set of groupoids, given by inclusion of the members of the 
groupoid.
-/
instance StructureGroupoid.partialOrder : PartialOrder (StructureGroupoid H) :=
  PartialOrder.lift StructureGroupoid.members fun a b h ↦ by
    ...
    rfl
/-
**StructureGroupoid.le_iff** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：StructureGroupoid.le_iff {G₁ G₂ : StructureGroupoid H} : G₁ <= G₂ ↔ forall
 e, e in G₁ -> e in G₂
该定理/引理刻画了左右两侧的等价关系。
黑盒证明引用了以下数学事实（定理与引理）：
...
/-
**idGroupoid** 是 Mathlib 中的一个定义，位于命名空间 ``。
形式化陈述：idGroupoid (H : Type*) [TopologicalSpace H] : StructureGroupoid H where me
mbers
参数：H : Type*。
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
--- 原说明 ---
The trivial groupoid, containing only the identity (and maps with empty source, 
as this is
necessary from the definition).
-/
...
/-
**instStructureGroupoidOrderBot** 是 Mathlib 中的一个实例，位于命名空间 ``。
形式化陈述：instStructureGroupoidOrderBot : OrderBot (StructureGroupoid H) where bot
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Pregroupoid** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：(H : Type u_2) → [TopologicalSpace H] → Type u_2
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
To construct a groupoid, one may consider classes of open partial homeomorphisms
 such that
both the function and its inverse have some property. If this property is stable
 under composition,
one gets a groupoid. `Pregroupoid` bundles the properties needed for this constr
uction, with the
groupoid of smooth functions with smooth inverses as an application.
-/
...
/-
**Pregroupoid.groupoid** 是 Mathlib 中的一个定义，位于命名空间 ``。
形式化陈述：Pregroupoid.groupoid (PG : Pregroupoid H) : StructureGroupoid H where memb
ers
参数：PG : Pregroupoid H。
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
--- 原说明 ---
Construct a groupoid of partial homeos for which the map and its inverse have so
me property,
from a pregroupoid asserting that this property is stable under composition.
-/
...
/-
**mem_groupoid_of_pregroupoid** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：mem_groupoid_of_pregroupoid {PG : Pregroupoid H} {e : OpenPartialHomeomorp
h H H} : e in PG.groupoid ↔ PG.property e e.source ∧ PG.property e.symm e.target
该定理/引理刻画了左右两侧的等价关系。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `Iff.rfl`：∀ {a : Prop}, a ↔ a
-/
theorem mem_groupoid_of_pregroupoid {PG : Pregroupoid H} {e : OpenPartialHomeomorph H H} :
  ...
  Iff.rfl
/-
**groupoid_of_pregroupoid_le** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：groupoid_of_pregroupoid_le (PG₁ PG₂ : Pregroupoid H) (h : forall f s, PG₁.
property f s -> PG₂.property f s) : PG₁.groupoid <= PG₂.groupoid
参数：PG₁ PG₂ : Pregroupoid H；h : forall f s, PG₁.property f s -> PG₂.property f s。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
...
/-
**mem_pregroupoid_of_eqOnSource** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：mem_pregroupoid_of_eqOnSource (PG : Pregroupoid H) {e e' : OpenPartialHome
omorph H H} (he' : e ≈ e') (he : PG.property e e.source) : PG.property e' e'.sou
rce
参数：PG : Pregroupoid H；he' : e ≈ e'；he : PG.property e e.source。
该定理/引理描述了相关对象所满足的性质。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
...
· 使用定理 `And.left`：∀ {a b : Prop}, a ∧ b → a
· 使用定理 `Pregroupoid.congr`：∀ {H : Type u_2} [inst : TopologicalSpace H] (self : 
Pregroupoid H) {f g : H → H} {u : Set H},   IsOpen u → (∀ x ∈ u, g x = f x) → se
lf.prop…
...
/-
**continuousPregroupoid** 是 Mathlib 中的一个缩写定义，位于命名空间 ``。
形式化陈述：continuousPregroupoid (H : Type*) [TopologicalSpace H] : Pregroupoid H whe
re property _ _
参数：H : Type*。
该定义给出了上述对象。
...
/-
**continuousGroupoid** 是 Mathlib 中的一个定义，位于命名空间 ``。
形式化陈述：continuousGroupoid (H : Type*) [TopologicalSpace H] : StructureGroupoid H
参数：H : Type*。
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**instStructureGroupoidOrderTop** 是 Mathlib 中的一个实例，位于命名空间 ``。
形式化陈述：instStructureGroupoidOrderTop : OrderTop (StructureGroupoid H) where top
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
Every structure groupoid is contained in the groupoid of all open partial homeom
orphisms.
-/
...
/-
**ClosedUnderRestriction** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：{H : Type u_1} → [inst : TopologicalSpace H] → StructureGroupoid H → Prop
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
A groupoid is closed under restriction if it contains all restrictions of its el
ement local
homeomorphisms to open subsets of the source.
-/
...
/-
**closedUnderRestriction'** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：closedUnderRestriction' {G : StructureGroupoid H} [ClosedUnderRestriction 
G] {e : OpenPartialHomeomorph H H} (he : e in G) {s : Set H} (hs : IsOpen s) : e
.restr s in G
参数：he : e in G；hs : IsOpen s。
该定理/引理描述了相关对象所满足的性质。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `ClosedUnderRestriction.closedUnderRestriction`：∀ {H : Type u_1} {inst : 
TopologicalSpace H} {G : StructureGroupoid H} [self : ClosedUnderRestriction G] 
...
/-
**StructureGroupoid.restr_mem_of_eqOn** 是 Mathlib 中的一个引理，位于命名空间 ``。
形式化陈述：StructureGroupoid.restr_mem_of_eqOn {G : StructureGroupoid H} [ClosedUnder
Restriction G] {e e' : OpenPartialHomeomorph H H} (he : e in G) {s : Set H} (hs 
: IsOpen s) (heq : EqOn e e' s) (hsub : e'.source inter s subseteq e.source) : e
'.restr s in G
参数：he : e in G；hs : IsOpen s；heq : EqOn e e' s；hsub : e'.source inter s subseteq
 e.source。
该定理/引理描述了相关对象所满足的性质。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `StructureGroupoid.mem_of_eqOnSource`：StructureGroupoid.mem_of_eqOnSource
...
orph X Y), IsOpen self.…
· 使用定理 `Setoid.symm`：∀ {α : Sort u} [inst : Setoid α] {a b : α}, a ≈ b → b ≈ a
· 使用定理 `OpenPartialHomeomorph.restr_eqOnSource_of_eqOn'`：restr_eqOnSource_of_eqO
n' {e e' : OpenPartialHomeomorph X Y} {s : Set X} (hs : IsOpen s) (heq : EqOn e 
e' s) (hsub : e'.source inter s subse…
-/
...
/-
**idRestrGroupoid** 是 Mathlib 中的一个定义，位于命名空间 ``。
形式化陈述：idRestrGroupoid : StructureGroupoid H where members
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
The trivial restriction-closed groupoid, containing only open partial homeomorph
isms equivalent
to the restriction of the identity to the various open subsets.
-/
...
/-
**idRestrGroupoid_mem** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：idRestrGroupoid_mem {s : Set H} (hs : IsOpen s) : ofSet s hs in @idRestrGr
oupoid H _
参数：hs : IsOpen s。
该定理/引理描述了相关对象所满足的性质。
黑盒证明引用了以下数学事实（定理与引理）：
...
/-
**closedUnderRestriction_idRestrGroupoid** 是 Mathlib 中的一个实例，位于命名空间 ``。
形式化陈述：closedUnderRestriction_idRestrGroupoid : ClosedUnderRestriction (@idRestrG
roupoid H _)
该定义给出了上述对象。
本声明引用了以下数学事实（定理与引理）：
· 使用定理 `IsOpen.inter`：IsOpen.inter (s t : Set α) : IsOpen α s -> IsOpen α t -> I
...
c → a ≈ c
· 使用定理 `OpenPartialHomeomorph.EqOnSource.restr`：∀ {X : Type u_1} {Y : Type u_3} 
...
groupoid. -/
/-
**closedUnderRestriction_iff_id_le** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：closedUnderRestriction_iff_id_le (G : StructureGroupoid H) : ClosedUnderRe
striction G ↔ idRestrGroupoid <= G
参数：G : StructureGroupoid H。
该定理/引理刻画了左右两侧的等价关系。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
...
--- 原说明 ---
A groupoid is closed under restriction if and only if it contains the trivial re
striction-closed
groupoid.
-/
