...
/-
**SimplexCategoryGenRel.splitMono** 是 Mathlib 中的一个定义，位于命名空间 `SimplexCategoryGenR
el`。
...
def splitMonoδ {n : ℕ} (i : Fin (n + 2)) : SplitMono (δ i) where
  ...
  id := by
    ...
    · simp only [Fin.lastCases_castSucc]
      exact δ_comp_σ_self
/-
**SimplexCategoryGenRel.** 是 Mathlib 中的一个实例，位于命名空间 `SimplexCategoryGenRel`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**SimplexCategoryGenRel.splitEpi** 是 Mathlib 中的一个定义，位于命名空间 `SimplexCategoryGenRe
l`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**SimplexCategoryGenRel.P_** 是 Mathlib 中的一个缩写定义，位于命名空间 `SimplexCategoryGenRel`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**SimplexCategoryGenRel.P_** 是 Mathlib 中的一个引理，位于命名空间 `SimplexCategoryGenRel`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**SimplexCategoryGenRel.isSplitEpi_P_** 是 Mathlib 中的一个引理，位于命名空间 `SimplexCategory
GenRel`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**SimplexCategoryGenRel.isSplitMono_P_** 是 Mathlib 中的一个引理，位于命名空间 `SimplexCategor
yGenRel`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
lemma isSplitMono_P_δ {x y : SimplexCategoryGenRel} {m : x ⟶ y} (hm : P_δ m) :
  ...
  | comp_of _ _ _ h => cases h; infer_instance
/-
**SimplexCategoryGenRel.isSplitEpi_toSimplexCategory_map_of_P_** 是 Mathlib 中的一个引
理，位于命名空间 `SimplexCategoryGenRel`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**SimplexCategoryGenRel.isSplitMono_toSimplexCategory_map_of_P_** 是 Mathlib 中的一个
引理，位于命名空间 `SimplexCategoryGenRel`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**SimplexCategoryGenRel.eq_or_len_le_of_P_** 是 Mathlib 中的一个引理，位于命名空间 `SimplexCat
egoryGenRel`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**SimplexCategoryGenRel.switch_** 是 Mathlib 中的一个引理，位于命名空间 `SimplexCategoryGenRel
`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
An auxiliary lemma to show that one can always use the simplicial identities to 
simplify a term
in the form `δ ≫ σ` into either an identity, or a term of the form `σ ≫ δ`. This
 is the crucial
special case to induct on to get an epi-mono factorization for all morphisms.
-/
...
private lemma switch_δ_σ₀ (i : Fin 1) (i' : Fin 2) :
  ...
  · exact δ_comp_σ_succ
/-
**SimplexCategoryGenRel.factor_** 是 Mathlib 中的一个引理，位于命名空间 `SimplexCategoryGenRel
`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**SimplexCategoryGenRel.factor_P_** 是 Mathlib 中的一个引理，位于命名空间 `SimplexCategoryGenR
el`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
An auxiliary lemma that shows there exists a factorization as a P_δ followed by 
a P_σ for
morphisms of the form `P_δ ≫ σ`.
-/
...
/-
**SimplexCategoryGenRel.exists_P_** 是 Mathlib 中的一个定理，位于命名空间 `SimplexCategoryGenR
el`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
Any morphism in `SimplexCategoryGenRel` can be decomposed as a `P_σ` followed by
 a `P_δ`.
-/
