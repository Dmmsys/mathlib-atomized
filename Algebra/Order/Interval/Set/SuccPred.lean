...
/-
**Set.Ico_add_one_left_eq_Ioo** 是 Mathlib 中的一个引理，位于命名空间 `Set`。
...
/-
**Set.Icc_add_one_left_eq_Ioc_of_not_isMax** 是 Mathlib 中的一个引理，位于命名空间 `Set`。
...
/-
**Set.Ico_add_one_right_eq_Icc_of_not_isMax** 是 Mathlib 中的一个引理，位于命名空间 `Set`。
...
/-
**Set.Ioo_add_one_right_eq_Ioc_of_not_isMax** 是 Mathlib 中的一个引理，位于命名空间 `Set`。
...
/-
**Set.Ico_add_one_add_one_eq_Ioc_of_not_isMax** 是 Mathlib 中的一个引理，位于命名空间 `Set`。
...
/-
**Set.insert_Icc_add_one_left_eq_Icc** 是 Mathlib 中的一个引理，位于命名空间 `Set`。
...
/-
**Set.insert_Icc_right_eq_Icc_add_one** 是 Mathlib 中的一个引理，位于命名空间 `Set`。
...
/-
**Set.insert_Ico_right_eq_Ico_add_one_of_not_isMax** 是 Mathlib 中的一个引理，位于命名空间 `Se
t`。
...
/-
**Set.insert_Ico_add_one_left_eq_Ico** 是 Mathlib 中的一个引理，位于命名空间 `Set`。
...
/-
**Set.insert_Ioc_right_eq_Ioc_add_one_of_not_isMax** 是 Mathlib 中的一个引理，位于命名空间 `Se
t`。
...
/-
**Set.insert_Ioc_add_one_left_eq_Ioc** 是 Mathlib 中的一个引理，位于命名空间 `Set`。
...
/-
**Set.Icc_add_one_left_eq_Ioc** 是 Mathlib 中的一个引理，位于命名空间 `Set`。
...
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
· 使用定理 `Order.succ_eq_add_one`：succ_eq_add_one (x : α) : succ x = x + 1
· 使用引理 `Set.Icc_succ_left_eq_Ioc`：Icc_succ_left_eq_Ioc (a b : α) : Icc (succ a) 
b = Ioc a b
-/
lemma Icc_add_one_left_eq_Ioc (a b : α) : Icc (a + 1) b = Ioc a b := by
  simpa [succ_eq_add_one] using Icc_succ_left_eq_Ioc a b
/-
**Set.Ico_add_one_right_eq_Icc** 是 Mathlib 中的一个引理，位于命名空间 `Set`。
...
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
· 使用定理 `Order.succ_eq_add_one`：succ_eq_add_one (x : α) : succ x = x + 1
· 使用引理 `Set.Ico_succ_right_eq_Icc`：Ico_succ_right_eq_Icc (a b : α) : Ico a (succ
 b) = Icc a b
-/
lemma Ico_add_one_right_eq_Icc (a b : α) : Ico a (b + 1) = Icc a b := by
  simpa [succ_eq_add_one] using Ico_succ_right_eq_Icc a b
/-
**Set.Ioo_add_one_right_eq_Ioc** 是 Mathlib 中的一个引理，位于命名空间 `Set`。
...
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
· 使用定理 `Order.succ_eq_add_one`：succ_eq_add_one (x : α) : succ x = x + 1
· 使用引理 `Set.Ioo_succ_right_eq_Ioc`：Ioo_succ_right_eq_Ioc (a b : α) : Ioo a (succ
 b) = Ioc a b
-/
lemma Ioo_add_one_right_eq_Ioc (a b : α) : Ioo a (b + 1) = Ioc a b := by
  simpa [succ_eq_add_one] using Ioo_succ_right_eq_Ioc a b
/-
**Set.Ico_add_one_add_one_eq_Ioc** 是 Mathlib 中的一个引理，位于命名空间 `Set`。
...
→ a₁ = a₂ → f₁ a₁ = f₂ a₂
· 使用定理 `Order.succ_eq_add_one`：succ_eq_add_one (x : α) : succ x = x + 1
· 使用引理 `Set.Ico_succ_succ_eq_Ioc`：Ico_succ_succ_eq_Ioc (a b : α) : Ico (succ a) 
(succ b) = Ioc a b
-/
...
/-
**Set.insert_Ico_right_eq_Ico_add_one** 是 Mathlib 中的一个引理，位于命名空间 `Set`。
...
/-
**Set.insert_Ioc_right_eq_Ioc_add_one** 是 Mathlib 中的一个引理，位于命名空间 `Set`。
形式化陈述：insert_Ioc_right_eq_Ioc_add_one (h : a <= b) : insert (b + 1) (Ioc a b) = 
Ioc a (b + 1)
参数：h : a <= b。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用引理 `Set.insert_Ioc_right_eq_Ioc_add_one_of_not_isMax`：insert_Ioc_right_eq_Io
c_add_one_of_not_isMax (h : a <= b) (hb : ¬ IsMax b) : insert (b + 1) (Ioc a b) 
= Ioc a (b + 1)
...
/-
**Set.Ioc_sub_one_right_eq_Ioo** 是 Mathlib 中的一个引理，位于命名空间 `Set`。
...
/-
**Set.Icc_sub_one_right_eq_Ico_of_not_isMin** 是 Mathlib 中的一个引理，位于命名空间 `Set`。
...
/-
**Set.Ioc_sub_one_left_eq_Icc_of_not_isMin** 是 Mathlib 中的一个引理，位于命名空间 `Set`。
...
/-
**Set.Ioo_sub_one_left_eq_Ioc_of_not_isMin** 是 Mathlib 中的一个引理，位于命名空间 `Set`。
...
/-
**Set.Ioc_sub_one_sub_one_eq_Ico_of_not_isMin** 是 Mathlib 中的一个引理，位于命名空间 `Set`。
...
/-
**Set.insert_Icc_sub_one_right_eq_Icc** 是 Mathlib 中的一个引理，位于命名空间 `Set`。
...
/-
**Set.insert_Icc_left_eq_Icc_sub_one** 是 Mathlib 中的一个引理，位于命名空间 `Set`。
...
/-
**Set.insert_Ioc_left_eq_Ioc_sub_one_of_not_isMin** 是 Mathlib 中的一个引理，位于命名空间 `Set
`。
...
/-
**Set.insert_Ioc_sub_one_right_eq_Ioc** 是 Mathlib 中的一个引理，位于命名空间 `Set`。
...
/-
**Set.insert_Ico_left_eq_Ico_sub_one_of_not_isMin** 是 Mathlib 中的一个引理，位于命名空间 `Set
`。
...
/-
**Set.insert_Ico_sub_one_right_eq_Ico** 是 Mathlib 中的一个引理，位于命名空间 `Set`。
...
/-
**Set.Icc_sub_one_right_eq_Ico** 是 Mathlib 中的一个引理，位于命名空间 `Set`。
...
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
· 使用定理 `Order.pred_eq_sub_one`：pred_eq_sub_one (x : α) : pred x = x - 1
· 使用引理 `Set.Icc_pred_right_eq_Ico`：Icc_pred_right_eq_Ico (a b : α) : Icc a (pred
 b) = Ico a b
-/
lemma Icc_sub_one_right_eq_Ico (a b : α) : Icc a (b - 1) = Ico a b := by
  simpa [pred_eq_sub_one] using Icc_pred_right_eq_Ico a b
/-
**Set.Ioc_sub_one_left_eq_Icc** 是 Mathlib 中的一个引理，位于命名空间 `Set`。
...
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
· 使用定理 `Order.pred_eq_sub_one`：pred_eq_sub_one (x : α) : pred x = x - 1
· 使用引理 `Set.Ioc_pred_left_eq_Icc`：Ioc_pred_left_eq_Icc (a b : α) : Ioc (pred a) 
b = Icc a b
-/
lemma Ioc_sub_one_left_eq_Icc (a b : α) : Ioc (a - 1) b = Icc a b := by
  simpa [pred_eq_sub_one] using Ioc_pred_left_eq_Icc a b
/-
**Set.Ioo_sub_one_left_eq_Ioc** 是 Mathlib 中的一个引理，位于命名空间 `Set`。
...
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
· 使用定理 `Order.pred_eq_sub_one`：pred_eq_sub_one (x : α) : pred x = x - 1
· 使用引理 `Set.Ioo_pred_left_eq_Ioc`：Ioo_pred_left_eq_Ioc (a b : α) : Ioo (pred a) 
b = Ico a b
-/
lemma Ioo_sub_one_left_eq_Ioc (a b : α) : Ioo (a - 1) b = Ico a b := by
  simpa [pred_eq_sub_one] using Ioo_pred_left_eq_Ioc a b
/-
**Set.Ioc_sub_one_sub_one_eq_Ico** 是 Mathlib 中的一个引理，位于命名空间 `Set`。
...
→ a₁ = a₂ → f₁ a₁ = f₂ a₂
· 使用定理 `Order.pred_eq_sub_one`：pred_eq_sub_one (x : α) : pred x = x - 1
· 使用引理 `Set.Ioc_pred_pred_eq_Ico`：Ioc_pred_pred_eq_Ico (a b : α) : Ioc (pred a) 
(pred b) = Ico a b
-/
...
/-
**Set.insert_Ioc_left_eq_Ioc_sub_one** 是 Mathlib 中的一个引理，位于命名空间 `Set`。
...
/-
**Set.insert_Ico_left_eq_Ico_sub_one** 是 Mathlib 中的一个引理，位于命名空间 `Set`。
形式化陈述：insert_Ico_left_eq_Ico_sub_one (h : a <= b) : insert (a - 1) (Ico a b) = I
co (a - 1) b
参数：h : a <= b。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用引理 `Set.insert_Ico_left_eq_Ico_sub_one_of_not_isMin`：insert_Ico_left_eq_Ico_
sub_one_of_not_isMin (h : a <= b) (ha : ¬ IsMin a) : insert (a - 1) (Ico a b) = 
Ico (a - 1) b
...
/-
**Set.Icc_add_one_sub_one_eq_Ioo** 是 Mathlib 中的一个引理，位于命名空间 `Set`。
...
/-
**Set.Iio_add_one_eq_Iic_of_not_isMax** 是 Mathlib 中的一个引理，位于命名空间 `Set`。
...
variable [NoMaxOrder α]
/-
**Set.Iio_add_one_eq_Iic** 是 Mathlib 中的一个引理，位于命名空间 `Set`。
...
/-
**Set.Iic_sub_one_eq_Iio_of_not_isMin** 是 Mathlib 中的一个引理，位于命名空间 `Set`。
...
variable [NoMinOrder α]
/-
**Set.Iic_sub_one_eq_Iio** 是 Mathlib 中的一个引理，位于命名空间 `Set`。
...
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
· 使用定理 `Order.pred_eq_sub_one`：pred_eq_sub_one (x : α) : pred x = x - 1
· 使用引理 `Set.Iic_pred_eq_Iio`：Iic_pred_eq_Iio (b : α) : Iic (pred b) = Iio b
-/
...
/-
**Set.Ici_add_one_eq_Ioi_of_not_isMax** 是 Mathlib 中的一个引理，位于命名空间 `Set`。
...
variable [NoMaxOrder α]
/-
**Set.Ici_add_one_eq_Ioi** 是 Mathlib 中的一个引理，位于命名空间 `Set`。
...
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
· 使用定理 `Order.succ_eq_add_one`：succ_eq_add_one (x : α) : succ x = x + 1
· 使用引理 `Set.Ici_succ_eq_Ioi`：Ici_succ_eq_Ioi (a : α) : Ici (succ a) = Ioi a
-/
...
/-
**Set.Ioi_sub_one_eq_Ici_of_not_isMin** 是 Mathlib 中的一个引理，位于命名空间 `Set`。
...
variable [NoMinOrder α]
/-
**Set.Ioi_sub_one_eq_Ici** 是 Mathlib 中的一个引理，位于命名空间 `Set`。
...
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
· 使用定理 `Order.pred_eq_sub_one`：pred_eq_sub_one (x : α) : pred x = x - 1
· 使用引理 `Set.Ioi_pred_eq_Ici`：Ioi_pred_eq_Ici (a : α) : Ioi (pred a) = Ici a
-/
