...
/--
lemma `exists_isClosed_singleton_of_isJacobsonRing` / 引理 `exists_isClosed_singleton_of_isJacobsonRing`

English:
lemma exists_isClosed_singleton_of_isJacobsonRing
  statement: [IsJacobsonRing R]
  proof: by
...
instance [IsJacobsonRing
  signature: R] : JacobsonSpace (PrimeSpectrum R)
  body: by
...
/--
lemma `isJacobsonRing_iff_jacobsonSpace` / 引理 `isJacobsonRing_iff_jacobsonSpace`
...
/--
lemma `isOpen_singleton_tfae_of_isNoetherian_of_isJacobsonRing` / 引理 `isOpen_singleton_tfae_of_isNoetherian_of_isJacobsonRing`
