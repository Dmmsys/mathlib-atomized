...
/-
**Stream.length** 是 Mathlib 中的一个定义，位于命名空间 `Stream`。
...
/-
**Stream.IsFinite** 是 Mathlib 中的一个类，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Stream.toList_terminates** 是 Mathlib 中的一个实例，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.updateNth** 是 Mathlib 中的一个定义，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Stream.removeNth** 是 Mathlib 中的一个定义，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Stream.filterMap** 是 Mathlib 中的一个定义，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Stream.filter** 是 Mathlib 中的一个定义，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Stream.find** 是 Mathlib 中的一个定义，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Stream.zipWith** 是 Mathlib 中的一个定义，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Stream.findIndexes** 是 Mathlib 中的一个定义，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Stream.findIndex** 是 Mathlib 中的一个定义，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Stream.indexOf** 是 Mathlib 中的一个定义，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Stream.indexesOf** 是 Mathlib 中的一个定义，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Stream.union** 是 Mathlib 中的一个定义，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Stream.isEmpty** 是 Mathlib 中的一个定义，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Stream.compute** 是 Mathlib 中的一个定义，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Stream.splitAt** 是 Mathlib 中的一个定义，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Stream.scanl** 是 Mathlib 中的一个定义，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Stream.collect** 是 Mathlib 中的一个定义，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Stream.length_eq_map** 是 Mathlib 中的一个定理，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
