...
/--
lemma `iIndepFun_of_covariance_strongDual` / 引理 `iIndepFun_of_covariance_strongDual`

English:
lemma iIndepFun_of_covariance_strongDual
...
-/
lemma iIndepFun_of_covariance_strongDual [NormedSpace Real E]
    (hX : IsGaussianProcess (fun (p : (t : T) × S t) ω => X p.1 p.2 ω) P)
    (mX : forall t s, AEMeasurable (X t s) P)
    (h : forall t₁ t₂, t₁ != t₂ -> forall (s₁ : S t₁) (s₂ : S t₂) (L₁ L₂ : StrongDual Real E),
...
/--
lemma `iIndepFun_of_covariance_inner` / 引理 `iIndepFun_of_covariance_inner`

English:
lemma iIndepFun_of_covariance_inner
  statement: [InnerProductSpace Real E]
  proof: hX.iIndepFun_of_covariance_strongDual mX fun t₁ t₂ ht s₁ s₂ L₁ L₂ => by
...
-/
lemma iIndepFun_of_covariance_inner [InnerProductSpace Real E]
    (hX : IsGaussianProcess (fun (p : (t : T) × S t) ω => X p.1 p.2 ω) P)
    (mX : forall t s, AEMeasurable (X t s) P)
    (h : forall t₁ t₂, t₁ != t₂ -> forall (s₁ : S t₁) (s₂ : S t₂) (x y : E),
...
/--
lemma `iIndepFun_of_covariance_eq_zero` / 引理 `iIndepFun_of_covariance_eq_zero`

English:
lemma iIndepFun_of_covariance_eq_zero
  statement: {X : (t : T) -> (s : S t) -> Ω -> Real}
  proof: hX.iIndepFun_of_covariance_inner mX fun _ _ h' _ _ _ _ => by
    simp [covariance_mul_const_left, covariance_mul_const_right, h _ _ h']

中文:
引理 iIndepFun_of_covariance_eq_zero
  结论: {X : (t : T) -> (s : S t) -> Ω -> 实数}
  证明: hX.iIndepFun_of_covariance_inner mX fun _ _ h' _ _ _ _ => by
    simp [covariance_mul_const_left, covariance_mul_const_right, h _ _ h']

Depends on / 依赖: covariance_mul_const_left, covariance_mul_const_right, hX.iIndepFun_of_covariance_inner, iIndepFun_of_covariance_inner
-/
lemma iIndepFun_of_covariance_eq_zero {X : (t : T) -> (s : S t) -> Ω -> Real}
    (hX : IsGaussianProcess (fun (p : (t : T) × S t) ω => X p.1 p.2 ω) P)
    (mX : forall t s, AEMeasurable (X t s) P)
    (h : forall t₁ t₂, t₁ != t₂ -> forall (s₁ : S t₁) (s₂ : S t₂), cov[X t₁ s₁, X t₂ s₂; P] = 0) :
    ProbabilityTheory.iIndepFun (fun t ω s => X t s ω) P :=
...
/--
lemma `indepFun_of_covariance_strongDual` / 引理 `indepFun_of_covariance_strongDual`

English:
lemma indepFun_of_covariance_strongDual
  statement: [NormedSpace Real E]
  proof: by
...
-/
lemma indepFun_of_covariance_strongDual [NormedSpace Real E]
    (hXY : IsGaussianProcess (Sum.elim X Y) P)
    (mX : forall s, AEMeasurable (X s) P) (mY : forall t, AEMeasurable (Y t) P)
    (h : forall s t (L₁ L₂ : StrongDual Real E), cov[L₁ ∘ X s, L₂ ∘ Y t; P] = 0) :
...
/--
lemma `indepFun_of_covariance_inner` / 引理 `indepFun_of_covariance_inner`

English:
lemma indepFun_of_covariance_inner
  statement: [InnerProductSpace Real E]
  proof: hXY.indepFun_of_covariance_strongDual mX mY fun s t L₁ L₂ => by
...
-/
lemma indepFun_of_covariance_inner [InnerProductSpace Real E]
    (hXY : IsGaussianProcess (Sum.elim X Y) P)
    (mX : forall s, AEMeasurable (X s) P) (mY : forall t, AEMeasurable (Y t) P)
    (h : forall s t x y, cov[fun ω => ⟪x, X s ω⟫, fun ω => ⟪y, Y t ω⟫; P] = 0) :
    IndepFun (fun ω s => X s ω) (fun ω t => Y t ω) P :=
  hXY.indepFun_of_covariance_strongDual mX mY fun s t L₁ L₂ => by
    simpa using! h s t ((toDual Real E).symm L₁) ((toDual Real E).symm L₂)

/--
lemma `indepFun_of_covariance_eq_zero` / 引理 `indepFun_of_covariance_eq_zero`

English:
lemma indepFun_of_covariance_eq_zero
  statement: {X : S -> Ω -> Real} {Y : T -> Ω -> Real}
  proof: hXY.indepFun_of_covariance_inner mX mY fun _ _ _ _ => by
    simp [covariance_mul_const_left, covariance_mul_const_right, h]

中文:
引理 indepFun_of_covariance_eq_zero
  结论: {X : S -> Ω -> 实数} {Y : T -> Ω -> 实数}
  证明: hXY.indepFun_of_covariance_inner mX mY fun _ _ _ _ => by
    simp [covariance_mul_const_left, covariance_mul_const_right, h]

Depends on / 依赖: covariance_mul_const_left, covariance_mul_const_right, hXY.indepFun_of_covariance_inner, indepFun_of_covariance_inner
-/
lemma indepFun_of_covariance_eq_zero {X : S -> Ω -> Real} {Y : T -> Ω -> Real}
