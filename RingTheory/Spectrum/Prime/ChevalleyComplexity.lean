...
/-
**ChevalleyThm.PolynomialC.DegreeType** 是 Mathlib 中的一个缩写定义，位于命名空间 `ChevalleyThm.
PolynomialC`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
The codomain of the measure that will decrease during the induction in the `C : 
R → R[X]` case
of Chevalley's theorem with complexity bound.
-/
...
@[ext]
/-
**ChevalleyThm.PolynomialC.InductionObj** 是 Mathlib 中的一个结构，位于命名空间 `ChevalleyThm.
PolynomialC`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
A type synonym for families of polynomials. This is used in the induction for th
e case of
`C : R → R[X]` of Chevalley's theorem with complexity bound.
-/
...
/-
**ChevalleyThm.PolynomialC.InductionObj.** 是 Mathlib 中的一个实例，位于命名空间 `ChevalleyThm
.PolynomialC.InductionObj`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
increasing. -/
/-
**ChevalleyThm.PolynomialC.InductionObj.coeffSubmodule** 是 Mathlib 中的一个定义，位于命名空间
 `ChevalleyThm.PolynomialC.InductionObj`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
A subgroup containing all coefficients of all polynomials of a given induction o
bject for
Chevalley's theorem with complexity.

Note that we force `1` to lie in that subgroup so that `fun n ↦ e.coeffSubmodule
 ^ n` is
increasing.
-/
...
/-
**ChevalleyThm.PolynomialC.InductionObj.coeffSubmodule_mapRingHom_comp** 是 Mathl
ib 中的一个引理，位于命名空间 `ChevalleyThm.PolynomialC.InductionObj`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**ChevalleyThm.PolynomialC.InductionObj.coeff_mem_coeffSubmodule** 是 Mathlib 中的一
个引理，位于命名空间 `ChevalleyThm.PolynomialC.InductionObj`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
set_option backward.privateInPublic true in
/-
**ChevalleyThm.PolynomialC.InductionObj.one_mem_coeffSubmodule** 是 Mathlib 中的一个引
理，位于命名空间 `ChevalleyThm.PolynomialC.InductionObj`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
set_option backward.privateInPublic true in
/-
**ChevalleyThm.PolynomialC.InductionObj.one_le_coeffSubmodule** 是 Mathlib 中的一个引理
，位于命名空间 `ChevalleyThm.PolynomialC.InductionObj`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
Chevalley's theorem with complexity bound. -/
/-
**ChevalleyThm.PolynomialC.InductionObj.degree** 是 Mathlib 中的一个定义，位于命名空间 `Cheval
leyThm.PolynomialC.InductionObj`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
The measure that will decrease during the induction in the `C : R → R[X]` case o
f
Chevalley's theorem with complexity bound.
-/
...
set_option backward.privateInPublic true in
/-
**ChevalleyThm.PolynomialC.InductionObj.ofLex_degree_fst** 是 Mathlib 中的一个引理，位于命名
空间 `ChevalleyThm.PolynomialC.InductionObj`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
set_option backward.privateInPublic true in
/-
**ChevalleyThm.PolynomialC.InductionObj.ofLex_degree_snd** 是 Mathlib 中的一个引理，位于命名
空间 `ChevalleyThm.PolynomialC.InductionObj`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**ChevalleyThm.PolynomialC.InductionObj.degBound** 是 Mathlib 中的一个定义，位于命名空间 `Chev
alleyThm.PolynomialC.InductionObj`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
The bound on the degree of the polynomials used to describe the constructible se
t appearing in
the case of `C : R → R[X]` of Chevalley's theorem with complexity bound.
-/
...
complexity bound. -/
/-
**ChevalleyThm.PolynomialC.InductionObj.powBound** 是 Mathlib 中的一个定义，位于命名空间 `Chev
alleyThm.PolynomialC.InductionObj`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
The bound on the power of the subgroup generated by the coefficients of the poly
nomials used to
describe the constructible set appearing in the case of `C : R → R[X]` of Cheval
ley's theorem with
complexity bound.
-/
...
set_option backward.privateInPublic true in
/-
**ChevalleyThm.PolynomialC.InductionObj.powBound_ne_zero** 是 Mathlib 中的一个引理，位于命名
空间 `ChevalleyThm.PolynomialC.InductionObj`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
bound. -/
/-
**ChevalleyThm.PolynomialC.InductionObj.Statement** 是 Mathlib 中的一个定义，位于命名空间 `Che
valleyThm.PolynomialC.InductionObj`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
The statement we induct on in the `C : R → R[X]` case of Chevalley's theorem wit
h complexity
bound.
-/
...
-/
/-
**ChevalleyThm.PolynomialC.induction_structure** 是 Mathlib 中的一个引理，位于命名空间 `Cheval
leyThm.PolynomialC`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
The structure of the induction in the proof of Chevalley's theorem:
Consider a property on a vector `e` of polynomials. Suppose that it holds for th
e following cases:
1. The vector contains zeroes only.
2. The vector contains a single monic polynomial (and zero otherwise).
3. Suppose `eᵢ` has the lowest degree among all monic polynomials and `eⱼ` is so
me other polynomial.
  If the property holds when `eⱼ` is replaced by `eⱼ % eᵢ`, then it holds for `e
`.
4. Suppose the property holds for both the localization at some leading coeffici
ent of `eᵢ` and
  the localization at the leading coefficient of `eᵢ`, then the property holds f
or `e`.
...
`induction_structure`. -/
/-
**ChevalleyThm.PolynomialC.induction_aux** 是 Mathlib 中的一个引理，位于命名空间 `ChevalleyThm
.PolynomialC`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
Part 4 of the induction structure applied to `Statement R₀ R n`. See the docstri
ng of
`induction_structure`.
-/
...
/-
**ChevalleyThm.PolynomialC.statement** 是 Mathlib 中的一个引理，位于命名空间 `ChevalleyThm.Pol
ynomialC`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**ChevalleyThm.chevalley_polynomialC** 是 Mathlib 中的一个引理，位于命名空间 `ChevalleyThm`。
形式化陈述：chevalley_polynomialC {R : Type*} [CommRing R] (M : Submodule Int R) (hM :
 1 in M) (S : ConstructibleSetData R[X]) (hS : forall C in S, forall j k, (C.g j
).coeff k in M) : exists T : ConstructibleSetData R, comap Polynomial.C '' S.toS
et = T.toSet ∧ forall C in T, C.n <= S.degBound ∧ forall i, C.g i in M ^ S.degBo
und ^ S.degBound
参数：M : Submodule Int R；hM : 1 in M；S : ConstructibleSetData R[X]；hS : forall C i
n S, forall j k, (C.g j).coeff k in M。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
...
IsConcreteLE A B
· 使用引理 `pow_le_pow`：pow_le_pow {a b : M} (hab : a <= b) (ht : 1 <= b) {m n : Nat
} (hmn : m <= n) : a ^ m <= b ^ n
...
/-
**ChevalleyThm.MvPolynomialC.numBound** 是 Mathlib 中的一个定义，位于命名空间 `ChevalleyThm.Mv
PolynomialC`。
形式化陈述：ℕ → (ℕ → ℕ) → ℕ → ℕ
参数：ℕ → ℕ。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
--- 原说明 ---
The bound on the number of polynomials used to describe the constructible set ap
pearing in the
case of `C : R → R[X₁, ..., Xₘ]` of Chevalley's theorem with complexity bound.
-/
...
/-
**ChevalleyThm.MvPolynomialC.degBound** 是 Mathlib 中的一个定义，位于命名空间 `ChevalleyThm.Mv
PolynomialC`。
形式化陈述：ℕ → (ℕ → ℕ) → ℕ → ℕ
参数：ℕ → ℕ。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
The bound on the degree of the polynomials used to describe the constructible se
t appearing in
the case of `C : R → R[X₁, ..., Xₘ]` of Chevalley's theorem with complexity boun
d.
-/
...
/-
**ChevalleyThm.MvPolynomialC.degBound_zero** 是 Mathlib 中的一个定理，位于命名空间 `ChevalleyT
hm.MvPolynomialC`。
形式化陈述：∀ (k : ℕ) (D : ℕ → ℕ), ChevalleyThm.MvPolynomialC.degBound k D 0 = 1
参数：k : ℕ；D : ℕ → ℕ。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
· 使用定理 `ChevalleyThm.MvPolynomialC.degBound.eq_1`：∀ (k : ℕ) (D : ℕ → ℕ), Chevall
eyThm.MvPolynomialC.degBound k D 0 = 1
-/
@[simp] lemma degBound_zero (k : ℕ) (D : ℕ → ℕ) : degBound k D 0 = 1 := by rw [degBound]
/-
**ChevalleyThm.MvPolynomialC.numBound_zero** 是 Mathlib 中的一个定理，位于命名空间 `ChevalleyT
hm.MvPolynomialC`。
形式化陈述：∀ (k : ℕ) (D : ℕ → ℕ), ChevalleyThm.MvPolynomialC.numBound k D 0 = k
参数：k : ℕ；D : ℕ → ℕ。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
· 使用定理 `ChevalleyThm.MvPolynomialC.numBound.eq_1`：∀ (k : ℕ) (D : ℕ → ℕ), Chevall
eyThm.MvPolynomialC.numBound k D 0 = k
-/
@[simp] lemma numBound_zero (k : ℕ) (D : ℕ → ℕ) : numBound k D 0 = k := by rw [numBound]

@[simp]
/-
**ChevalleyThm.MvPolynomialC.degBound_succ** 是 Mathlib 中的一个定理，位于命名空间 `ChevalleyT
hm.MvPolynomialC`。
形式化陈述：∀ (k : ℕ) (D : ℕ → ℕ) (n : ℕ),   ChevalleyThm.MvPolynomialC.degBound k D (
n + 1) =     ChevalleyThm.MvPolynomialC.numBound k D (n + 1) ^ ChevalleyThm.MvPo
lynomialC.numBound k D (n + 1) *       ChevalleyThm.MvPolynomialC.degBound k D n
参数：k : ℕ；D : ℕ → ℕ；n : ℕ；n + 1；n + 1；n + 1。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
· 使用定理 `ChevalleyThm.MvPolynomialC.degBound.eq_2`：∀ (k : ℕ) (D : ℕ → ℕ) (n : ℕ),
   ChevalleyThm.MvPolynomialC.degBound k D n.succ =     ChevalleyThm.MvPolynomia
lC.numBound k D (n + 1) ^ Chev…
-/
...
@[simp]
/-
**ChevalleyThm.MvPolynomialC.numBound_succ** 是 Mathlib 中的一个定理，位于命名空间 `ChevalleyT
hm.MvPolynomialC`。
形式化陈述：∀ (k : ℕ) (D : ℕ → ℕ) (n : ℕ),   ChevalleyThm.MvPolynomialC.numBound k D (
n + 1) =     ChevalleyThm.MvPolynomialC.numBound k D n * ChevalleyThm.MvPolynomi
alC.degBound k D n * D n
参数：k : ℕ；D : ℕ → ℕ；n : ℕ；n + 1。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
· 使用定理 `ChevalleyThm.MvPolynomialC.numBound.eq_2`：∀ (k : ℕ) (D : ℕ → ℕ) (n : ℕ),
   ChevalleyThm.MvPolynomialC.numBound k D n.succ =     ChevalleyThm.MvPolynomia
lC.numBound k D n * ChevalleyT…
-/
...
mutual
/-
**ChevalleyThm.MvPolynomialC.degBound_casesOn_succ** 是 Mathlib 中的一个定理，位于命名空间 `Ch
evalleyThm.MvPolynomialC`。
形式化陈述：∀ (k₀ k : ℕ) (D : ℕ → ℕ) (n : ℕ),   ChevalleyThm.MvPolynomialC.degBound k₀
 (fun t => Nat.casesOn t k D) (n + 1) =     (k₀ * k) ^ (k₀ * k) * ChevalleyThm.M
vPolynomialC.degBound (k₀ * k) ((k₀ * k) ^ (k₀ * k) • D) n
参数：k₀ k : ℕ；D : ℕ → ℕ；n : ℕ；fun t => Nat.casesOn t k D；n + 1；k₀ * k；k₀ * k；k₀ * 
k；(k₀ * k) ^ (k₀ * k) • D。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `ChevalleyThm.MvPolynomialC.degBound_casesOn_succ._mutual`：∀ (k₀ k : ℕ) (
D : ℕ → ℕ) (x : ℕ ⊕' ℕ),   PSum.casesOn x     (fun _x =>       ChevalleyThm.MvPo
lynomialC.degBound k₀ (fun t => Nat.casesOn t …
-/
lemma degBound_casesOn_succ (k₀ k : ℕ) (D : ℕ → ℕ) :
  ...
  | n + 1 => by
    ...
    ring
/-
**ChevalleyThm.MvPolynomialC.numBound_casesOn_succ** 是 Mathlib 中的一个定理，位于命名空间 `Ch
evalleyThm.MvPolynomialC`。
形式化陈述：∀ (k₀ k : ℕ) (D : ℕ → ℕ) (n : ℕ),   ChevalleyThm.MvPolynomialC.numBound k₀
 (fun x => Nat.casesOn x k D) (n + 1) =     ChevalleyThm.MvPolynomialC.numBound 
(k₀ * k) ((k₀ * k) ^ (k₀ * k) • D) n
参数：k₀ k : ℕ；D : ℕ → ℕ；n : ℕ；fun x => Nat.casesOn x k D；n + 1；k₀ * k；(k₀ * k) ^ (
k₀ * k) • D。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `ChevalleyThm.MvPolynomialC.degBound_casesOn_succ._mutual`：∀ (k₀ k : ℕ) (
D : ℕ → ℕ) (x : ℕ ⊕' ℕ),   PSum.casesOn x     (fun _x =>       ChevalleyThm.MvPo
...
/-
**ChevalleyThm.MvPolynomialC.degBound_le_degBound** 是 Mathlib 中的一个定理，位于命名空间 `Che
valleyThm.MvPolynomialC`。
形式化陈述：∀ {k₁ k₂ : ℕ} {D₁ D₂ : ℕ → ℕ},   k₁ ≤ k₂ →     ∀ (n : ℕ),       (∀ i < n, 
D₁ i ≤ D₂ i) → ChevalleyThm.MvPolynomialC.degBound k₁ D₁ n ≤ ChevalleyThm.MvPoly
nomialC.degBound k₂ D₂ n
参数：n : ℕ；∀ i < n, D₁ i ≤ D₂ i。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `ChevalleyThm.MvPolynomialC.degBound_le_degBound._mutual`：∀ {k₁ k₂ : ℕ} {
D₁ D₂ : ℕ → ℕ},   k₁ ≤ k₂ →     ∀ (x : ((n : ℕ) ×' ∀ i < n, D₁ i ≤ D₂ i) ⊕' (n :
 ℕ) ×' ∀ i < n, D₁ i ≤ D₂ i),       PSum.case…
-/
...
/-
**ChevalleyThm.MvPolynomialC.numBound_mono** 是 Mathlib 中的一个定理，位于命名空间 `ChevalleyT
hm.MvPolynomialC`。
形式化陈述：∀ {k₁ k₂ : ℕ} {D₁ D₂ : ℕ → ℕ},   k₁ ≤ k₂ →     ∀ (n : ℕ),       (∀ i < n, 
D₁ i ≤ D₂ i) → ChevalleyThm.MvPolynomialC.numBound k₁ D₁ n ≤ ChevalleyThm.MvPoly
nomialC.numBound k₂ D₂ n
参数：n : ℕ；∀ i < n, D₁ i ≤ D₂ i。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `ChevalleyThm.MvPolynomialC.degBound_le_degBound._mutual`：∀ {k₁ k₂ : ℕ} {
D₁ D₂ : ℕ → ℕ},   k₁ ≤ k₂ →     ∀ (x : ((n : ℕ) ×' ∀ i < n, D₁ i ≤ D₂ i) ⊕' (n :
...
/-
**ChevalleyThm.MvPolynomialC.degBound_pos** 是 Mathlib 中的一个定理，位于命名空间 `ChevalleyTh
m.MvPolynomialC`。
形式化陈述：∀ (k : ℕ) (D : ℕ → ℕ) (n : ℕ), 0 < ChevalleyThm.MvPolynomialC.degBound k D
 n
参数：k : ℕ；D : ℕ → ℕ；n : ℕ。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**ChevalleyThm.chevalley_mvPolynomialC** 是 Mathlib 中的一个定理，位于命名空间 `ChevalleyThm`。
形式化陈述：∀ {R : Type u_2} [inst : CommRing R] {n : ℕ} {M : Submodule ℤ R},   1 ∈ M 
→     ∀ (k : ℕ) (d : Multiset (Fin n)) (S : PrimeSpectrum.ConstructibleSetData (
MvPolynomial (Fin n) R)),       (∀ C ∈ S, C.n ≤ k) →         (∀ C ∈ S,          
   ∀ (j : Fin C.n),               C.g j ∈                 MvPolynomial.coeffsIn 
(Fin n) M ⊓ Submodule.restrictScalars ℤ (MvPolynomial.degreesLE R (Fin n) d)) → 
          ∃ T,             PrimeSpectrum.comap MvPolynomial.C '' S.toSet = T.toS
et ∧               ∀ C ∈ T,                 C.n ≤ ChevalleyThm.MvPolynomialC.num
Bound k (fun i => 1 + Multiset.count i (Multiset.map Fin.val d)) n ∧            
       ∀ (i : Fin C.n),                     C.g i ∈                       M ^   
                      ChevalleyThm.MvPolynomialC.degBound k (fun i => 1 + Multis
et.count i (Multiset.map Fin.val d)) n
参数：k : ℕ；d : Multiset (Fin n)；S : PrimeSpectrum.ConstructibleSetData (MvPolynomi
al (Fin n) R)；∀ C ∈ S, C.n ≤ k；∀ C ∈ S,             ∀ (j : Fin C.n),            
   C.g j ∈                 MvPolynomial.coeffsIn (Fin n) M ⊓ Submodule.restrictS
calars ℤ (MvPolynomial.degreesLE R (Fin n) d)；fun i => 1 + Multiset.count i (Mul
tiset.map Fin.val d)；i : Fin C.n；fun i => 1 + Multiset.count i (Multiset.map Fin
.val d)。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `IsScalarTower.right`：∀ {R : Type u} {A : Type w} [inst : CommSemiring R]
 [inst_1 : Semiring A] [inst_2 : Algebra R A], IsScalarTower R A A
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
· 使用引理 `PrimeSpectrum.ConstructibleSetData.toSet_map`：toSet_map (f : R ->+* S) (
s : ConstructibleSetData R) : (s.map f).toSet = comap f ⁻¹' s.toSet
...
· 使用定理 `congr`：∀ {α : Sort u} {β : Sort v} {f₁ f₂ : α → β} {a₁ a₂ : α}, f₁ = f₂ 
→ a₁ = a₂ → f₁ a₁ = f₂ a₂
· 使用定理 `ChevalleyThm.MvPolynomialC.numBound_zero`：∀ (k : ℕ) (D : ℕ → ℕ), Chevall
eyThm.MvPolynomialC.numBound k D 0 = k
· 使用定理 `congrFun'`：∀ {α : Sort u} {β : Sort v} {f g : α → β}, f = g → ∀ (a : α),
 f a = g a
· 使用定理 `ChevalleyThm.MvPolynomialC.degBound_zero`：∀ (k : ℕ) (D : ℕ → ℕ), Chevall
eyThm.MvPolynomialC.degBound k D 0 = 1
...
t_3 : Algebra R …
· 使用定理 `PrimeSpectrum.ConstructibleSetData.map.eq_1`：∀ {R : Type u_1} {S : Type 
u_2} [inst : CommSemiring R] [inst_1 : CommSemiring S] (φ : R →+* S)   (s : Prim
eSpectrum.ConstructibleSetData R)…
...
--- 原说明 ---
The `C : R → R[X₁, ..., Xₘ]` case of **Chevalley's theorem** with complexity bou
nd.
-/
...
Chevalley's theorem with complexity bound. -/
/-
**ChevalleyThm.numBound** 是 Mathlib 中的一个定义，位于命名空间 `ChevalleyThm`。
形式化陈述：ℕ → (m : ℕ) → ℕ → Multiset (Fin m) → ℕ
参数：m : ℕ；Fin m。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
Chevalley's theorem with complexity bound. -/
/-
**ChevalleyThm.degBound** 是 Mathlib 中的一个定义，位于命名空间 `ChevalleyThm`。
形式化陈述：ℕ → (m : ℕ) → ℕ → Multiset (Fin m) → ℕ
参数：m : ℕ；Fin m。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**chevalley_mvPolynomial_mvPolynomial** 是 Mathlib 中的一个引理，位于命名空间 ``。
形式化陈述：chevalley_mvPolynomial_mvPolynomial {m n : Nat} (f : MvPolynomial (Fin n) 
R ->ₐ[R] MvPolynomial (Fin m) R) (k : Nat) (d : Multiset (Fin m)) (S : Construct
ibleSetData (MvPolynomial (Fin m) R)) (hSn : forall C in S, C.n <= k) (hS : fora
ll C in S, forall j, (C.g j).degrees <= d) (hf : forall i, (f (.X i)).degrees <=
 d) : exists T : ConstructibleSetData (MvPolynomial (Fin n) R), comap f '' S.toS
et = T.toSet ∧ forall C in T, C.n <= numBound k m n d ∧ forall i j, (C.g i).degr
eeOf j <= degBound k m n d
参数：f : MvPolynomial (Fin n) R ->ₐ[R] MvPolynomial (Fin m) R；k : Nat；d : Multiset
 (Fin m)；S : ConstructibleSetData (MvPolynomial (Fin m) R)；hSn : forall C in S, 
C.n <= k；hS : forall C in S, forall j, (C.g j).degrees <= d；hf : forall i, (f (.
X i)).degrees <= d。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `AlgHomClass.toRingHomClass`：∀ {F : Type u_1} {R : outParam (Type u_2)} {
...
A constructible set of complexity at most `M` in `Spec R[X₁, ..., Xₘ]` gets mapp
ed under
`f : R[Y₁, ..., Yₙ] → R[X₁, ..., Xₘ]` to a constructible set of complexity `O_{M
, m, n}(1)` in
`Spec R[Y₁, ..., Yₙ]`.

See the module doc of `Mathlib/RingTheory/Spectrum/Prime/ChevalleyComplexity.lea
n` for an
explanation of this notion of complexity.
-/
