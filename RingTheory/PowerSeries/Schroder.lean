...
lemma coeff_X_mul_largeSchroderSeriesSeries_sq
  ...
  simp only [coeff_largeSchroderSeries, coeff_X_mul_largeSchroderSer
...
theorem largeSchroderSeries_eq_one_add_X_mul_largeSchroderSeries_add_X_mul_largeSchroderSeries_sq
  ...
  · have hn' : 0 < n := by omega
    ...
    rw [coeff_X_mul_largeSchroderSeriesSeries_sq _ hn']; rw [coeff_X_mul_largeSchroderSeries _ hn']; rw [show n = n - 1 + 1 by omega]; r
