...
/-
**HomologicalComplex₂.shiftFunctor** 是 Mathlib 中的一个缩写定义，位于命名空间 `HomologicalCompl
ex₂`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
The shift on bicomplexes obtained by shifting the first indices (and changing th
e
sign of differentials).
-/
...
--- 原说明 ---
The shift on bicomplexes obtained by shifting the second indices (and changing t
he
sign of differentials).
-/
...
/-
**HomologicalComplex₂.shiftFunctor** 是 Mathlib 中的一个定义，位于命名空间 `HomologicalComplex
₂`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
The isomorphism `(((shiftFunctor₁ C x).obj K).X a).X b ≅ (K.X a').X b` when `a' 
= a + x`.
-/
...
--- 原说明 ---
The isomorphism `(((shiftFunctor₂ C y).obj K).X a).X b ≅ (K.X a).X b'` when `b' 
= b + y`.
-/
...
@[simp]
/-
**HomologicalComplex₂.shiftFunctor** 是 Mathlib 中的一个引理，位于命名空间 `HomologicalComplex
₂`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**HomologicalComplex₂.totalShift** 是 Mathlib 中的一个定义，位于命名空间 `HomologicalComplex₂`
。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
--- 原说明 ---
The isomorphism `((shiftFunctor₁ C x).obj K).total (up ℤ) ≅ (K.total (up ℤ))⟦x⟧`
expressing the compatibility of the total complex with the shift on the first in
dices.
This isomorphism does not involve signs.
-/
...
@[reassoc]
/-
**HomologicalComplex₂.totalShift** 是 Mathlib 中的一个引理，位于命名空间 `HomologicalComplex₂`
。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
--- 原说明 ---
The isomorphism `((shiftFunctor₂ C y).obj K).total (up ℤ) ≅ (K.total (up ℤ))⟦y⟧`
expressing the compatibility of the total complex with the shift on the second i
ndices.
This isomorphism involves signs: on the summand in degree `(p, q)` of `K`, it is
 given by the
multiplication by `(p * y).negOnePow`.
-/
noncomputable def totalShift₂Iso :
