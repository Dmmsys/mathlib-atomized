...
/--
Definition of `ASCII.allowedWhitespace` / `ASCII.allowedWhitespace` 的定义

English:
definition ASCII.allowedWhitespace
  signature: (c : Char)
  body: #[' ', '\n'].contains c

中文:
定义 ASCII.allowedWhitespace
  签名: (c : Char)
  定义体: #[' ', '\n'].contains c

Depends on / 依赖: contains
-/
def ASCII.allowedWhitespace (c : Char) : Bool := #[' ', '\n'].contains c

/--
Definition of `ASCII.printable` / `ASCII.printable` 的定义

English:
definition ASCII.printable
  signature: (c : Char)
  body: 0x21 <= c.toNat && c.toNat <= 0x7e

中文:
定义 ASCII.printable
  签名: (c : Char)
  定义体: 0x21 <= c.toNat && c.toNat <= 0x7e
...
/--
Definition of `ASCII.allowed` / `ASCII.allowed` 的定义

English:
definition ASCII.allowed
  signature: (c : Char)
  body: ASCII.allowedWhitespace c || ASCII.printable c

中文:
定义 ASCII.allowed
  签名: (c : Char)
  定义体: ASCII.allowedWhitespace c || ASCII.printable c

Depends on / 依赖: ASCII.allowedWhitespace, ASCII.printable, allowedWhitespace, printable
-/
def ASCII.allowed (c : Char) : Bool := ASCII.allowedWhitespace c || ASCII.printable c

/--
Definition of `withVSCodeAbbrev` / `withVSCodeAbbrev` 的定义

English:
definition withVSCodeAbbrev
...
def withVSCodeAbbrev : Array Char := #[
  ...
  '∘', 'Π', '▸', '->', '↑', '∨', '×', '⁻', '¹', '∼', '·', '⋆', '¬', '¿', '₁', '₂',
  '₃', '₄', '₅', '₆', '₇', '₈', '₉', '₀', '←', 'Ø', '⅋', '𝔸', 'Complex', 'Δ', '𝔽', 'Γ',
  'ℍ', '⋂', '𝕂', 'Λ', 'Nat', 'Rat', 'Real', 'Σ', '⋃', 'Int', '♯', '∶', '∣', 'δ', 'ζ', 'η',
  'θ', 'ι', 'κ', 'fun', 'ν', 'ξ', 'π', 'ρ', 'ς', 'σ', 'τ', 'φ', 'ψ', 'ω', 'À', 'Á',
...
/--
Definition of `othersInMathlib` / `othersInMathlib` 的定义

English:
definition othersInMathlib
  signature: : Array Char
  body: #[
  '✔', '⟍', 'ł', 'ń', '⎯', '⏐', 'ć', 'š', '̂', 'ᘁ', '𝖣', 'ß', 'ỳ', '⤏',
