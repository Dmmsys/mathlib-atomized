...
/-
**HomologicalComplex.mapBifunctorMapHomotopy.hom** 是 Mathlib 中的一个定义，位于命名空间 `Homo
logicalComplex.mapBifunctorMapHomotopy`。
...
@[reassoc]
/-
**HomologicalComplex.mapBifunctorMapHomotopy.** 是 Mathlib 中的一个引理，位于命名空间 `Homolog
icalComplex.mapBifunctorMapHomotopy`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
set_option backward.isDefEq.respectTransparency false in
/-
**HomologicalComplex.mapBifunctorMapHomotopy.zero** 是 Mathlib 中的一个引理，位于命名空间 `Hom
ologicalComplex.mapBifunctorMapHomotopy`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
set_option backward.isDefEq.respectTransparency false in
/-
**HomologicalComplex.mapBifunctorMapHomotopy.comm** 是 Mathlib 中的一个引理，位于命名空间 `Hom
ologicalComplex.mapBifunctorMapHomotopy`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**HomologicalComplex.mapBifunctorMapHomotopy** 是 Mathlib 中的一个定义，位于命名空间 `Homologi
calComplex`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
The homotopy between `mapBifunctorMap f₁ f₂ F c` and `mapBifunctorMap f₁' f₂ F c
` that
is induced by a homotopy between `f₁` and `f₁'`.
-/
