...
/--
Definition of `GroupLieAlgebra` / `GroupLieAlgebra` 的定义

English:
abbreviation GroupLieAlgebra
  signature: : Type _
  body: TangentSpace% (1 : G)
...
/--
Definition of `mulInvariantVectorField` / `mulInvariantVectorField` 的定义

English:
definition mulInvariantVectorField
  signature: (v : GroupLieAlgebra I G) (g : G)
  body: mfderiv% (g * ·) (1 : G) v

中文:
定义 mulInvariantVectorField
  签名: (v : GroupLieAlgebra I G) (g : G)
  定义体: mfderiv% (g * ·) (1 : G) v

Depends on / 依赖: mfderiv
-/
...
@[to_additive]
/--
lemma `mulInvariantVectorField_add` / 引理 `mulInvariantVectorField_add`

English:
lemma mulInvariantVectorField_add
  given: (v w : GroupLieAlgebra I G)
  proof: by
  ext g
  simp [mulInvariantVectorField]

中文:
引理 mulInvariantVectorField_add
  条件: (v w : GroupLieAlgebra I G)
  证明: by
  ext g
  simp [mulInvariantVectorField]

Depends on / 依赖: mulInvariantVectorField
-/
...
set_option backward.isDefEq.respectTransparency false in
/--
lemma `addInvariantVectorField_smul` / 引理 `addInvariantVectorField_smul`

English:
lemma addInvariantVectorField_smul
  statement: {G : Type*} [TopologicalSpace G] [ChartedSpace H G] [AddGroup G]
  proof: by
  ext g
...
Depends on / 依赖: addInvariantVectorField
-/
...
set_option backward.isDefEq.respectTransparency false in
/--
lemma `mulInvariantVectorField_smul` / 引理 `mulInvariantVectorField_smul`

English:
lemma mulInvariantVectorField_smul
  given: (c : 𝕜) (v : GroupLieAlgebra I G)
  proof: by
  ext g
  simp [mulInvariantVectorField]

中文:
引理 mulInvariantVectorField_smul
  条件: (c : 𝕜) (v : GroupLieAlgebra I G)
  证明: by
  ext g
  simp [mulInvariantVectorField]
...
English:
instance :
  signature: Bracket (GroupLieAlgebra I G) (GroupLieAlgebra I G)
  body: mlieBracket I (mulInvariantVectorField v) (mulInvariantVectorField w) (1 : G)

@[to_additive]

中文:
实例 :
  签名: Bracket (GroupLieAlgebra I G) (GroupLieAlgebra I G)
  定义体: mlieBracket I (mulInvariantVectorField v) (mulInvariantVectorField w) (1 : G)

@[to_additive]

Depends on / 依赖: mlieBracket, mulInvariantVectorField
-/
...
@[to_additive]
/--
lemma `GroupLieAlgebra.bracket_def` / 引理 `GroupLieAlgebra.bracket_def`

English:
lemma GroupLieAlgebra.bracket_def
  given: (v w : GroupLieAlgebra I G)
  proof: rfl

中文:
引理 GroupLieAlgebra.bracket_def
  条件: (v w : GroupLieAlgebra I G)
  证明: rfl
-/
...
/--
lemma `inverse_mfderiv_mul_left` / 引理 `inverse_mfderiv_mul_left`

English:
lemma inverse_mfderiv_mul_left
  given: {g h : G}
  proof: by
...
/--
lemma `mpullback_mulInvariantVectorField` / 引理 `mpullback_mulInvariantVectorField`

English:
lemma mpullback_mulInvariantVectorField
  given: (g : G) (v : GroupLieAlgebra I G)
  proof: by
.ne' have M : minSmoothness 𝕜 3 != 0 := lt_of_lt_of_le (by simp) le_minSmoothness
  ext h
...
@[to_additive]
/--
lemma `mulInvariantVectorField_eq_mpullback` / 引理 `mulInvariantVectorField_eq_mpullback`

English:
lemma mulInvariantVectorField_eq_mpullback
  given: (g : G) (V : Π (g : G), TangentSpace% g)
  proof: by
...
中文:
引理 mulInvariantVectorField_eq_mpullback
  条件: (g : G) (V : Π (g : G), TangentSpace% g)
  证明: by
  have A : 1 = g⁻¹ * g := by simp
  simp only [mulInvariantVectorField, mpullback, inverse_mfderiv_mul_left]
  congr
...
Depends on / 依赖: inverse_mfderiv_mul_left, mpullback, mulInvariantVectorField
-/
...
@[to_additive]
/--
theorem `contMDiff_mulInvariantVectorField` / 定理 `contMDiff_mulInvariantVectorField`

English:
theorem contMDiff_mulInvariantVectorField
  given: (v : GroupLieAlgebra I G)
  proof: by
...
@[to_additive]
/--
theorem `contMDiffAt_mulInvariantVectorField` / 定理 `contMDiffAt_mulInvariantVectorField`

English:
theorem contMDiffAt_mulInvariantVectorField
  given: (v : GroupLieAlgebra I G) {g : G}
  proof: (contMDiff_mulInvariantVectorField v).contMDiffAt

@[to_additive]

中文:
定理 contMDiffAt_mulInvariantVectorField
  条件: (v : GroupLieAlgebra I G) {g : G}
  证明: (contMDiff_mulInvariantVectorField v).contMDiffAt

@[to_additive]

Depends on / 依赖: contMDiffAt, contMDiff_mulInvariantVectorField
-/
...
@[to_additive]
/--
theorem `mdifferentiable_mulInvariantVectorField` / 定理 `mdifferentiable_mulInvariantVectorField`

English:
theorem mdifferentiable_mulInvariantVectorField
  given: (v : GroupLieAlgebra I G)
  proof: (contMDiff_mulInvariantVectorField v).mdifferentiable
    (lt_of_lt_of_le (by simp) le_minSmoothness).ne'

@[to_additive]

中文:
定理 mdifferentiable_mulInvariantVectorField
  条件: (v : GroupLieAlgebra I G)
  证明: (contMDiff_mulInvariantVectorField v).mdifferentiable
    (lt_of_lt_of_le (by simp) le_minSmoothness).ne'

@[to_additive]

Depends on / 依赖: contMDiff_mulInvariantVectorField, le_minSmoothness, lt_of_lt_of_le, mdifferentiable
-/
...
@[to_additive]
/--
theorem `mdifferentiableAt_mulInvariantVectorField` / 定理 `mdifferentiableAt_mulInvariantVectorField`

English:
theorem mdifferentiableAt_mulInvariantVectorField
  given: (v : GroupLieAlgebra I G) {g : G}
  proof: (contMDiffAt_mulInvariantVectorField v).mdifferentiableAt
    (lt_of_lt_of_le (by simp) le_minSmoothness).ne'

中文:
定理 mdifferentiableAt_mulInvariantVectorField
  条件: (v : GroupLieAlgebra I G) {g : G}
  证明: (contMDiffAt_mulInvariantVectorField v).mdifferentiableAt
    (lt_of_lt_of_le (by simp) le_minSmoothness).ne'

Depends on / 依赖: contMDiffAt_mulInvariantVectorField, le_minSmoothness, lt_of_lt_of_le, mdifferentiableAt
-/
...
fields. -/]
/--
lemma `mulInvariantVector_mlieBracket` / 引理 `mulInvariantVector_mlieBracket`

English:
lemma mulInvariantVector_mlieBracket
  given: (v w : GroupLieAlgebra I G)
  proof: by
  ext g
...
English:
instance :
  signature: LieRing (GroupLieAlgebra I G)
  body: by
...
/--
Instance `instLieAlgebraAddGroupLieAlgebra` / 实例 `instLieAlgebraAddGroupLieAlgebra`
...
中文:
实例 instLieAlgebraAddGroupLieAlgebra
  定义体: by
    simp only [AddGroupLieAlgebra.bracket_def, addInvariantVectorField_smul]
    rw [mlieBracket_const_smul_right]
    exact mdifferentiableAt_addInvariantVectorField _

Depends on / 依赖: AddGroupLieAlgebra, AddGroupLieAlgebra.bracket_def, addInvariantVectorField_smul, bracket_def, mdifferentiableAt_addInvariantVectorField, mlieBracket_const_smul_right
-/
...
/--
Instance `instLieAlgebraGroupLieAlgebra` / 实例 `instLieAlgebraGroupLieAlgebra`

English:
instance instLieAlgebraGroupLieAlgebra
  signature: : LieAlgebra 𝕜 (GroupLieAlgebra I G) where
  body: by
...
Depends on / 依赖: GroupLieAlgebra, GroupLieAlgebra.bracket_def, bracket_def, mdifferentiableAt_mulInvariantVectorField, mlieBracket_const_smul_right, mulInvariantVectorField_smul
-/
