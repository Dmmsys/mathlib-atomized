...
instance enoughInjectives
  signature: : EnoughInjectives AddCommGrpCat.{u} where
  body: Nonempty.intro
...
English:
instance enoughInjectives
  signature: : EnoughInjectives CommGrpCat.{u}
  body: EnoughInjectives.of_equivalence commGroupAddCommGroupEquivalence.functor
