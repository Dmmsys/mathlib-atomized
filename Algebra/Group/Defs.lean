...
/-
**IsLeftCancelMul** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：(G : Type u) → [Mul G] → Prop
...
/-
**IsRightCancelMul** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：(G : Type u) → [Mul G] → Prop
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
@[mk_iff]
/-
**IsCancelMul** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：(G : Type u) → [Mul G] → Prop
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**IsLeftCancelAdd** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：(G : Type u) → [Add G] → Prop
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**IsRightCancelAdd** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：(G : Type u) → [Add G] → Prop
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
@[mk_iff]
/-
**IsCancelAdd** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：(G : Type u) → [Add G] → Prop
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**isCancelMul_iff_forall_isRegular** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：∀ {R : Type u_2} [inst : Mul R], IsCancelMul R ↔ ∀ (r : R), IsRegular r
参数：r : R。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
· 使用定理 `isCancelMul_iff`：∀ (G : Type u) [inst : Mul G], IsCancelMul G ↔ IsLeftCa
ncelMul G ∧ IsRightCancelMul G
· 使用定理 `isLeftCancelMul_iff`：∀ (G : Type u) [inst : Mul G], IsLeftCancelMul G ↔ 
∀ (a : G), IsLeftRegular a
· 使用定理 `isRightCancelMul_iff`：∀ (G : Type u) [inst : Mul G], IsRightCancelMul G 
↔ ∀ (a : G), IsRightRegular a
...
/-
**IsLeftRegular.all** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：IsLeftRegular.all [Mul R] [IsLeftCancelMul R] (g : R) : IsLeftRegular g
参数：g : R。
该定理/引理描述了相关对象所满足的性质。
黑盒证明引用了以下数学事实（定理与引理）：
...
/-
**IsRightRegular.all** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：IsRightRegular.all [Mul R] [IsRightCancelMul R] (g : R) : IsRightRegular g
参数：g : R。
该定理/引理描述了相关对象所满足的性质。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `Iff.mp`：∀ {a b : Prop}, (a ↔ b) → a → b
...
/-
**IsRegular.all** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：IsRegular.all [Mul R] [IsCancelMul R] (g : R) : IsRegular g
参数：g : R。
该定理/引理描述了相关对象所满足的性质。
黑盒证明引用了以下数学事实（定理与引理）：
...
@[to_additive]
/-
**mul_left_cancel_iff** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：mul_left_cancel_iff : a * b = a * c ↔ b = c
该定理/引理刻画了左右两侧的等价关系。
黑盒证明引用了以下数学事实（定理与引理）：
...
/-
**mul_right_inj** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：mul_right_inj (a : G) {b c : G} : a * b = a * c ↔ b = c
参数：a : G。
该定理/引理刻画了左右两侧的等价关系。
黑盒证明引用了以下数学事实（定理与引理）：
...
@[to_additive]
/-
**mul_ne_mul_right** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：mul_ne_mul_right (a : G) {b c : G} : a * b != a * c ↔ b != c
参数：a : G。
该定理/引理刻画了左右两侧的等价关系。
黑盒证明引用了以下数学事实（定理与引理）：
...
@[to_additive]
/-
**mul_right_cancel_iff** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：mul_right_cancel_iff : b * a = c * a ↔ b = c
该定理/引理刻画了左右两侧的等价关系。
黑盒证明引用了以下数学事实（定理与引理）：
...
@[to_additive (attr := simp)]
/-
**mul_left_inj** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：mul_left_inj (a : G) {b c : G} : b * a = c * a ↔ b = c
参数：a : G。
该定理/引理刻画了左右两侧的等价关系。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `Function.Injective.eq_iff`：∀ {α : Sort u_1} {β : Sort u_2} {f : α → β}, 
...
@[to_additive]
/-
**mul_ne_mul_left** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：mul_ne_mul_left (a : G) {b c : G} : b * a != c * a ↔ b != c
参数：a : G。
该定理/引理刻画了左右两侧的等价关系。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `Function.Injective.ne_iff`：∀ {α : Sort u_1} {β : Sort u_2} {f : α → β}, 
...
@[ext]
/-
**Semigroup** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：Type u → Type u
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
@[ext]
/-
**AddSemigroup** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：Type u → Type u
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
@[to_additive]
/-
**mul_assoc** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：mul_assoc : forall a b c : G, a * b * c = a * (b * c)
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
...
/-
**IsAddCommutative** 是 Mathlib 中的一个类，位于命名空间 ``。
形式化陈述：IsAddCommutative (M : Type*) [Add M] : Prop where is_comm : Std.Commutativ
e (α
参数：M : Type*。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**IsMulCommutative** 是 Mathlib 中的一个类，位于命名空间 ``。
形式化陈述：IsMulCommutative (M : Type*) [Mul M] : Prop where is_comm : Std.Commutativ
e (α
参数：M : Type*。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
@[to_additive]
/-
**isMulCommutative_iff** 是 Mathlib 中的一个引理，位于命名空间 ``。
形式化陈述：isMulCommutative_iff {M : Type*} [Mul M] : IsMulCommutative M ↔ forall a b
 : M, a * b = b * a
该定理/引理刻画了左右两侧的等价关系。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
with commutative subobjects in a noncommutative algebraic structure. -/ ]
/-
**mul_comm'** 是 Mathlib 中的一个引理，位于命名空间 ``。
形式化陈述：mul_comm' {M : Type*} [Mul M] [IsMulCommutative M] (a b : M) : a * b = b *
 a
参数：a b : M。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
...
@[ext]
/-
**AddCommMagma** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：Type u → Type u
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
@[ext]
/-
**CommMagma** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：Type u → Type u
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
A commutative multiplicative magma is a type with a multiplication which commute
s.
-/
...
@[ext]
/-
**CommSemigroup** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：Type u → Type u
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
@[ext]
/-
**AddCommSemigroup** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：Type u → Type u
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
@[to_additive]
/-
**mul_comm** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：mul_comm : forall a b : G, a * b = b * a
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
...
@[to_additive]
/-
**CommMagma.to_isCommutative** 是 Mathlib 中的一个实例，位于命名空间 ``。
形式化陈述：CommMagma.to_isCommutative : IsMulCommutative G
该定义给出了上述对象。
本声明引用了以下数学事实（定理与引理）：
...
@[to_additive (attr := simp)]
/-
**isLeftRegular_iff_isRegular** 是 Mathlib 中的一个引理，位于命名空间 ``。
形式化陈述：isLeftRegular_iff_isRegular : IsLeftRegular a ↔ IsRegular a
该定理/引理刻画了左右两侧的等价关系。
黑盒证明引用了以下数学事实（定理与引理）：
...
@[to_additive (attr := simp)]
/-
**isRightRegular_iff_isRegular** 是 Mathlib 中的一个引理，位于命名空间 ``。
形式化陈述：isRightRegular_iff_isRegular : IsRightRegular a ↔ IsRegular a
该定理/引理刻画了左右两侧的等价关系。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `of_eq_true`：∀ {p : Prop}, p = True → p
· 使用定理 `Eq.trans`：∀ {α : Sort u} {a b c : α}, a = b → b = c → a = c
...
/-
**CommMagma.IsRightCancelMul.toIsLeftCancelMul** 是 Mathlib 中的一个引理，位于命名空间 ``。
形式化陈述：CommMagma.IsRightCancelMul.toIsLeftCancelMul (G : Type u) [CommMagma G] [I
sRightCancelMul G] : IsLeftCancelMul G
参数：G : Type u。
该定理/引理描述了相关对象所满足的性质。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `mul_right_cancel`：mul_right_cancel : a * b = c * b -> a = c
...
/-
**CommMagma.IsLeftCancelMul.toIsRightCancelMul** 是 Mathlib 中的一个引理，位于命名空间 ``。
形式化陈述：CommMagma.IsLeftCancelMul.toIsRightCancelMul (G : Type u) [CommMagma G] [I
sLeftCancelMul G] : IsRightCancelMul G
参数：G : Type u。
该定理/引理描述了相关对象所满足的性质。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `mul_left_cancel`：mul_left_cancel : a * b = a * c -> b = c
...
/-
**CommMagma.IsLeftCancelMul.toIsCancelMul** 是 Mathlib 中的一个引理，位于命名空间 ``。
形式化陈述：CommMagma.IsLeftCancelMul.toIsCancelMul (G : Type u) [CommMagma G] [IsLeft
CancelMul G] : IsCancelMul G
参数：G : Type u。
该定理/引理描述了相关对象所满足的性质。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用引理 `CommMagma.IsLeftCancelMul.toIsRightCancelMul`：CommMagma.IsLeftCancelMul.
toIsRightCancelMul (G : Type u) [CommMagma G] [IsLeftCancelMul G] : IsRightCance
lMul G
-/
...
/-
**CommMagma.IsRightCancelMul.toIsCancelMul** 是 Mathlib 中的一个引理，位于命名空间 ``。
形式化陈述：CommMagma.IsRightCancelMul.toIsCancelMul (G : Type u) [CommMagma G] [IsRig
htCancelMul G] : IsCancelMul G
参数：G : Type u。
该定理/引理描述了相关对象所满足的性质。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用引理 `CommMagma.IsRightCancelMul.toIsLeftCancelMul`：CommMagma.IsRightCancelMul
.toIsLeftCancelMul (G : Type u) [CommMagma G] [IsRightCancelMul G] : IsLeftCance
lMul G
-/
...
@[ext]
/-
**LeftCancelSemigroup** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：Type u → Type u
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
@[ext]
/-
**AddLeftCancelSemigroup** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：Type u → Type u
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
@[ext]
/-
**RightCancelSemigroup** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：Type u → Type u
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
@[ext]
/-
**AddRightCancelSemigroup** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：Type u → Type u
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**AddZero** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：Type u_2 → Type u_2
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
Bundling an `Add` and `Zero` structure together without any axioms about their
compatibility. See `AddZeroClass` for the additional assumption that 0 is an ide
ntity.
-/
...
/-
**MulOne** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：Type u_2 → Type u_2
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
Bundling a `Mul` and `One` structure together without any axioms about their
compatibility. See `MulOneClass` for the additional assumption that 1 is an iden
tity.
-/
...
/-
**IsDedekindFiniteAddMonoid** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：(M : Type u_2) → [AddZero M] → Prop
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
An additive monoid is Dedekind-finite if every left inverse is also a right inve
rse.
Also called von Neumann-finite or directly finite.
-/
...
/-
**IsDedekindFiniteMonoid** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：(M : Type u_2) → [MulOne M] → Prop
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
A monoid is Dedekind-finite if every left inverse is also a right inverse.
It is more common to talk about Dedekind-finite rings, but https://arxiv.org/abs
/2102.01598
does define Dedekind-finite monoids in §2.2.
-/
...
/-
**mul_eq_one_comm** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：∀ {M : Type u_2} [inst : MulOne M] [IsDedekindFiniteMonoid M] {a b : M}, a
 * b = 1 ↔ b * a = 1
黑盒证明引用了以下数学事实（定理与引理）：
...
/-
**AddZeroClass** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：Type u → Type u
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
@[to_additive]
/-
**MulOneClass** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：Type u → Type u
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
@[to_additive (attr := ext)]
/-
**MulOneClass.ext** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：MulOneClass.ext {M : Type u} : forall ⦃m₁ m₂ : MulOneClass M⦄, m₁.mul = m₂
.mul -> m₁ = m₂
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `Eq.trans`：∀ {α : Sort u} {a b c : α}, a = b → b = c → a = c
...
@[to_additive (attr := simp)]
/-
**one_mul** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：one_mul : forall a : M, 1 * a = a
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
...
@[to_additive (attr := simp)]
/-
**mul_one** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：mul_one : forall a : M, a * 1 = a
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
...
/-
**npowRec_add** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：∀ {M : Type u} [inst : One M] [inst_1 : Semigroup M] (m n : ℕ),   n ≠ 0 → 
∀ (a : M), 1 * a = a → npowRec (m + n) a = npowRec m a * npowRec n a
参数：m n : ℕ；a : M；m + n。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `of_eq_true`：∀ {p : Prop}, p = True → p
· 使用定理 `Eq.trans`：∀ {α : Sort u} {a b c : α}, a = b → b = c → a = c
...
/-
**npowRec_succ** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：∀ {M : Type u} [inst : One M] [inst_1 : Semigroup M] (n : ℕ),   n ≠ 0 → ∀ 
(a : M), 1 * a = a → npowRec (n + 1) a = a * npowRec n a
参数：n : ℕ；a : M；n + 1。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
...
/-
**npowBinRec** 是 Mathlib 中的一个定义，位于命名空间 ``。
形式化陈述：npowBinRec {M : Type*} [One M] [Mul M] (k : Nat) : M -> M
参数：k : Nat。
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
-/
/-
**npowRec'** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：npowRec'_succ {M : Type*} [Mul M] [One M] {k : Nat} (_ : k != 0) (m : M) :
...
-/
/-
**nsmulRec'** 是 Mathlib 中的一个定义，位于命名空间 ``。
形式化陈述：{M : Type u_2} → [Zero M] → [Add M] → ℕ → M → M
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
@[to_additive]
/-
**npowRec'_succ** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：∀ {M : Type u_2} [inst : Mul M] [inst_1 : One M] {k : ℕ}, k ≠ 0 → ∀ (m : M
), npowRec' (k + 1) m = npowRec' k m * m
参数：m : M；k + 1。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `npowRec'`：npowRec'_succ {M : Type*} [Mul M] [One M] {k : Nat} (_ : k != 
0) (m : M) : npowRec' (k + 1) m = npowRec' k m * m
-/
...
@[to_additive]
/-
**npowRec'_two_mul** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：∀ {M : Type u_2} [inst : Semigroup M] [inst_1 : One M] (k : ℕ) (m : M), np
owRec' (2 * k) m = npowRec' k (m * m)
参数：k : ℕ；m : M；2 * k；m * m。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `npowRec'`：npowRec'_succ {M : Type*} [Mul M] [One M] {k : Nat} (_ : k != 
0) (m : M) : npowRec' (k + 1) m = npowRec' k m * m
...
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
· 使用定理 `npowRec'.eq_3`：∀ {M : Type u_2} [inst : One M] [inst_1 : Mul M] (x : M) 
(k : ℕ), npowRec' k.succ.succ x = npowRec' (k + 1) x * x
...
@[to_additive]
/-
**npowRec'_mul_comm** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：∀ {M : Type u_2} [inst : Semigroup M] [inst_1 : One M] {k : ℕ}, k ≠ 0 → ∀ 
(m : M), m * npowRec' k m = npowRec' k m * m
参数：m : M。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `npowRec'`：npowRec'_succ {M : Type*} [Mul M] [One M] {k : Nat} (_ : k != 
0) (m : M) : npowRec' (k + 1) m = npowRec' k m * m
...
@[to_additive]
/-
**npowRec_eq** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：npowRec_eq {M : Type*} [Semigroup M] [One M] (k : Nat) (m : M) : npowRec (
k + 1) m = 1 * npowRec' (k + 1) m
参数：k : Nat；m : M。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `npowRec'`：npowRec'_succ {M : Type*} [Mul M] [One M] {k : Nat} (_ : k != 
...
· 使用定理 `npowRec.eq_2`：∀ {M : Type u_1} [inst : One M] [inst_1 : Mul M] (x : M) (
n : ℕ), npowRec n.succ x = npowRec n x * x
· 使用定理 `npowRec'_succ`：∀ {M : Type u_2} [inst : Mul M] [inst_1 : One M] {k : ℕ},
...
@[to_additive]
/-
**npowBinRec.go_spec** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：npowBinRec.go_spec {M : Type*} [Semigroup M] [One M] (k : Nat) (m n : M) :
...
e)) : …
· 使用定理 `npowRec'_two_mul`：∀ {M : Type u_2} [inst : Semigroup M] [inst_1 : One M]
 (k : ℕ) (m : M), npowRec' (2 * k) m = npowRec' k (m * m)
· 使用定理 `Eq.symm`：∀ {α : Sort u} {a b : α}, a = b → b = a
· 使用定理 `npowRec'_succ`：∀ {M : Type u_2} [inst : Mul M] [inst_1 : One M] {k : ℕ},
 k ≠ 0 → ∀ (m : M), npowRec' (k + 1) m = npowRec' k m * m
· 使用定理 `npowRec'_mul_comm`：∀ {M : Type u_2} [inst : Semigroup M] [inst_1 : One M
] {k : ℕ}, k ≠ 0 → ∀ (m : M), m * npowRec' k m = npowRec' k m * m
· 使用定理 `mul_assoc`：mul_assoc : forall a b c : G, a * b * c = a * (b * c)
-/
...
/-
**npowRecAuto** 是 Mathlib 中的一个缩写定义，位于命名空间 ``。
形式化陈述：npowRecAuto {M : Type*} [Semigroup M] [One M] (k : Nat) (m : M) : M
参数：k : Nat；m : M。
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**npowBinRecAuto** 是 Mathlib 中的一个缩写定义，位于命名空间 ``。
形式化陈述：npowBinRecAuto {M : Type*} [Semigroup M] [One M] (k : Nat) (m : M) : M
参数：k : Nat；m : M。
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**npowRec_eq_npowBinRec** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：npowRec_eq_npowBinRec : @npowRecAuto = @npowBinRecAuto
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `funext`：∀ {α : Sort u} {β : α → Sort v} {f g : (x : α) → β x}, (∀ (x : α
), f x = g x) → f = g
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
· 使用定理 `npowBinRecAuto.eq_1`：∀ {M : Type u_2} [inst : Semigroup M] [inst_1 : One
 M] (k : ℕ) (m : M), npowBinRecAuto k m = npowBinRec k m
· 使用定理 `npowRecAuto.eq_1`：∀ {M : Type u_2} [inst : Semigroup M] [inst_1 : One M]
 (k : ℕ) (m : M), npowRecAuto k m = npowRec k m
· 使用定理 `npowBinRec.eq_1`：∀ {M : Type u_2} [inst : One M] [inst_1 : Mul M] (k : ℕ
), npowBinRec k = npowBinRec.go k 1
· 使用定理 `npowRec.eq_1`：∀ {M : Type u_1} [inst : One M] [inst_1 : Mul M] (x : M), 
npowRec 0 x = 1
· 使用定理 `npowBinRec.go.eq_1`：∀ {M : Type u_2} [inst : Mul M] (k : ℕ),   npowBinRe
c.go k =     Nat.binaryRec (motive := fun x => M → M → M) (fun y x => y)       (
fun bn _…
· 使用定理 `Nat.binaryRec_zero`：binaryRec_zero (zero : motive 0) (bit : forall b n, 
motive n -> motive (bit b n)) : binaryRec zero bit 0 = zero
· 使用定理 `npowRec'`：npowRec'_succ {M : Type*} [Mul M] [One M] {k : Nat} (_ : k != 
0) (m : M) : npowRec' (k + 1) m = npowRec' k m * m
· 使用定理 `npowBinRec.go_spec`：npowBinRec.go_spec {M : Type*} [Semigroup M] [One M]
 (k : Nat) (m n : M) : npowBinRec.go (k + 1) m n = m * npowRec' (k + 1) n
· 使用定理 `npowRec_eq`：npowRec_eq {M : Type*} [Semigroup M] [One M] (k : Nat) (m : 
M) : npowRec (k + 1) m = 1 * npowRec' (k + 1) m
-/
...
/-
**npowBinRec_zero** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：∀ {M : Type u_2} [inst : Mul M] [inst_1 : One M] (m : M), npowBinRec 0 m =
 1
参数：m : M。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**npowBinRec_succ** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：∀ {M : Type u_2} [inst : Semigroup M] [inst_1 : One M] (n : ℕ) (m : M), np
owBinRec (n + 1) m = npowBinRec n m * m
参数：n : ℕ；m : M；n + 1。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
...
· 使用定理 `npowBinRecAuto.eq_1`：∀ {M : Type u_2} [inst : Semigroup M] [inst_1 : One
 M] (k : ℕ) (m : M), npowBinRecAuto k m = npowBinRec k m
· 使用定理 `npowRec_eq_npowBinRec`：npowRec_eq_npowBinRec : @npowRecAuto = @npowBinRe
cAuto
-/
...
/-
**NSMul** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：Type u → Type u
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
@[to_additive]
/-
**NPow** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：Type u → Type u
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**NPow.toPow** 是 Mathlib 中的一个实例，位于命名空间 ``。
形式化陈述：NPow.toPow {M : Type*} [NPow M] : Pow M Nat
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[to_additive ofSMul]
/-
**NPow.ofPow** 是 Mathlib 中的一个实例，位于命名空间 ``。
形式化陈述：NPow.ofPow {M : Type*} [Pow M Nat] : NPow M
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**AddMonoid** 是 Mathlib 中的一个类，位于命名空间 ``。
形式化陈述：AddMonoid (M : Type u) extends AddSemigroup M, AddZeroClass M, NSMul M whe
re /-- Multiplication by `(0 : ℕ)` gives `0`. -/ protected nsmul_zero (x : M) : 
0 • x = 0
参数：M : Type u；0 : ℕ；x : M。
继承自：AddSemigroup M, AddZeroClass M, NSMul M。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
An `AddMonoid` is an `AddSemigroup` with an element `0` such that `0 + a = a + 0
 = a`.
-/
...
@[to_additive]
/-
**Monoid** 是 Mathlib 中的一个类，位于命名空间 ``。
形式化陈述：Monoid (M : Type u) extends Semigroup M, MulOneClass M, NPow M where npow
参数：M : Type u。
继承自：Semigroup M, MulOneClass M, NPow M。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**npow_eq_pow** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：npow_eq_pow (n : Nat) (x : M) : NPow.npow n x = x ^ n
参数：n : Nat；x : M。
该定理/引理给出了一组等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
theorem npow_eq_pow (n : ℕ) (x : M) : NPow.npow n x = x ^ n :=
  rfl
/-
**left_inv_eq_right_inv** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：∀ {M : Type u_2} [inst : Monoid M] {a b c : M}, b * a = 1 → a * c = 1 → b 
= c
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
...
/-
**pow_zero** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：pow_zero (a : M) : a ^ 0 = 1
参数：a : M。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
...
/-
**pow_succ** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：pow_succ (a : M) (n : Nat) : a ^ (n + 1) = a ^ n * a
参数：a : M；n : Nat。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
...
/-
**pow_one** 是 Mathlib 中的一个引理，位于命名空间 ``。
形式化陈述：pow_one (a : M) : a ^ 1 = a
参数：a : M。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
...
/-
**pow_succ'** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：∀ {M : Type u_2} [inst : Monoid M] (a : M) (n : ℕ), a ^ (n + 1) = a * a ^ 
n
参数：a : M；n : ℕ；n + 1。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**mul_pow_mul** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：mul_pow_mul {ea₁ b c₁ : Nat} {xa₁ c₃ d : R} (_ : ea₁ * b = c₁) (_ : a₂ ^ b
 = c₂) (_ : xa₁ ^ c₁ * (nat_lit 1).rawCast = c₃) (_ : c₃ * c₂ = d) : (xa₁ ^ ea₁ 
* a₂ : R) ^ b = d
参数：_ : ea₁ * b = c₁；_ : a₂ ^ b = c₂；_ : xa₁ ^ c₁ * (nat_lit 1).rawCast = c₃；_ : 
c₃ * c₂ = d。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `of_eq_true`：∀ {p : Prop}, p = True → p
...
@[to_additive]
/-
**pow_mul_comm'** 是 Mathlib 中的一个引理，位于命名空间 ``。
形式化陈述：pow_mul_comm' (a : M) (n : Nat) : a ^ n * a = a * a ^ n
参数：a : M；n : Nat。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
...
/-
**pow_two** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：∀ {M : Type u_2} [inst : Monoid M] (a : M), a ^ 2 = a * a
参数：a : M。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
...
/-
**pow_three'** 是 Mathlib 中的一个引理，位于命名空间 ``。
形式化陈述：pow_three' (a : M) : a ^ 3 = a * a * a
参数：a : M。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
...
/-
**one_pow** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：one_pow {a : R} (b : Nat) (ha : IsNat a 1) : a ^ b = a
参数：b : Nat；ha : IsNat a 1。
该定理/引理给出了一组等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**pow_add** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：pow_add {b₁ b₂ : Nat} {d : R} (_ : a ^ b₁ = c₁) (_ : a ^ b₂ = c₂) (_ : c₁ 
* c₂ = d) : (a : R) ^ (b₁ + b₂) = d
参数：_ : a ^ b₁ = c₁；_ : a ^ b₂ = c₂；_ : c₁ * c₂ = d。
该定理/引理给出了一组等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**pow_mul_comm** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：∀ {M : Type u_2} [inst : Monoid M] (a : M) (m n : ℕ), a ^ m * a ^ n = a ^ 
n * a ^ m
参数：a : M；m n : ℕ。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
...
/-
**pow_mul** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：∀ {M : Type u_2} [inst : Monoid M] (a : M) (m n : ℕ), a ^ (m * n) = (a ^ m
) ^ n
参数：a : M；m n : ℕ；m * n；a ^ m。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**pow_mul'** 是 Mathlib 中的一个引理，位于命名空间 ``。
形式化陈述：pow_mul' (a : M) (m n : Nat) : a ^ (m * n) = (a ^ n) ^ m
参数：a : M；m n : Nat。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
...
/-
**pow_right_comm** 是 Mathlib 中的一个引理，位于命名空间 ``。
形式化陈述：pow_right_comm (a : M) (m n : Nat) : (a ^ m) ^ n = (a ^ n) ^ m
参数：a : M；m n : Nat。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
...
/-
**IsLeftRegular.mul_eq_one_symm** 是 Mathlib 中的一个定理，位于命名空间 `IsLeftRegular`。
形式化陈述：∀ {M : Type u_2} [inst : Monoid M] {a b : M}, IsLeftRegular a → a * b = 1 
→ b * a = 1
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `of_eq_true`：∀ {p : Prop}, p = True → p
· 使用定理 `Eq.trans`：∀ {α : Sort u} {a b c : α}, a = b → b = c → a = c
...
/-
**IsRightRegular.mul_eq_one_symm** 是 Mathlib 中的一个定理，位于命名空间 `IsRightRegular`。
形式化陈述：∀ {M : Type u_2} [inst : Monoid M] {a b : M}, IsRightRegular a → b * a = 1
 → a * b = 1
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `of_eq_true`：∀ {p : Prop}, p = True → p
· 使用定理 `Eq.trans`：∀ {α : Sort u} {a b c : α}, a = b → b = c → a = c
...
/-
**IsDedekindFiniteMonoid.of_exists_self_mul_eq_one** 是 Mathlib 中的一个定理，位于命名空间 `Is
DedekindFiniteMonoid`。
形式化陈述：∀ (M : Type u_2) [inst : Monoid M], (∀ (x y : M), x * y = 1 → ∃ z, y * z =
 1) → IsDedekindFiniteMonoid M
参数：M : Type u_2；∀ (x y : M), x * y = 1 → ∃ z, y * z = 1。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
· 使用定理 `congr`：∀ {α : Sort u} {β : Sort v} {f₁ f₂ : α → β} {a₁ a₂ : α}, f₁ = f₂ 
...
--- 原说明 ---
A monoid is Dedekind-finite if every element with a left inverse also has a righ
t inverse.
-/
...
/-
**IsDedekindFiniteMonoid.of_exists_mul_self_eq_one** 是 Mathlib 中的一个定理，位于命名空间 `Is
DedekindFiniteMonoid`。
形式化陈述：∀ (M : Type u_2) [inst : Monoid M], (∀ (x y : M), x * y = 1 → ∃ z, z * x =
 1) → IsDedekindFiniteMonoid M
参数：M : Type u_2；∀ (x y : M), x * y = 1 → ∃ z, z * x = 1。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
· 使用定理 `congr`：∀ {α : Sort u} {β : Sort v} {f₁ f₂ : α → β} {a₁ a₂ : α}, f₁ = f₂ 
...
--- 原说明 ---
A monoid is Dedekind-finite if every element with a right inverse also has a lef
t inverse.
-/
...
@[mk_iff]
/-
**IsAddTorsionFree** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：(M : Type u_2) → [AddMonoid M] → Prop
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
An additive monoid is torsion-free if scalar multiplication by every non-zero el
ement `n : ℕ` is
injective.
-/
...
@[to_additive, mk_iff]
/-
**IsMulTorsionFree** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：(M : Type u_2) → [Monoid M] → Prop
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**AddCommMonoid** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：Type u → Type u
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
@[to_additive]
/-
**CommMonoid** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：Type u → Type u
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
This is assigned default rather than low priority because it gives the most comm
on examples
of Dedekind-finite monoids and is used the most often. Benchmark results indicat
e default
priority performs better than low or high priority.
-/
...
/-
**AddLeftCancelMonoid** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：Type u → Type u
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
An additive monoid in which addition is left-cancellative.
Main examples are `ℕ` and groups. This is the right typeclass for many sum lemma
s, as having a zero
is useful to define the sum over the empty set, so `AddLeftCancelSemigroup` is n
ot enough.
-/
...
@[to_additive]
/-
**LeftCancelMonoid** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：Type u → Type u
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**AddRightCancelMonoid** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：Type u → Type u
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
Main examples are `ℕ` and groups. This is the right typeclass for many sum lemma
s, as having a zero
is useful to define the sum over the empty set, so `AddRightCancelSemigroup` is 
not enough.
-/
...
@[to_additive]
/-
**RightCancelMonoid** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：Type u → Type u
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**AddCancelMonoid** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：Type u → Type u
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
Main examples are `ℕ` and groups. This is the right typeclass for many sum lemma
s, as having a zero
is useful to define the sum over the empty set, so `AddRightCancelMonoid` is not
 enough.
-/
...
@[to_additive]
/-
**CancelMonoid** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：Type u → Type u
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**AddCancelCommMonoid** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：Type u → Type u
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
@[to_additive]
/-
**CancelCommMonoid** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：Type u → Type u
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**zpowRec** 是 Mathlib 中的一个定义，位于命名空间 ``。
形式化陈述：zpowRec [One G] [Mul G] [Inv G] (npow : Nat -> G -> G
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
The fundamental power operation in a group. `zpowRec n a = a*a*...*a` n times, f
or integer `n`.
Use instead `a ^ n`, which has better definitional behavior.
-/
...
/-
**zsmulRec** 是 Mathlib 中的一个定义，位于命名空间 ``。
形式化陈述：zsmulRec [Zero G] [Add G] [Neg G] (nsmul : Nat -> G -> G
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
The fundamental scalar multiplication in an additive group. `zpowRec n a = a+a+.
..+a` n
times, for integer `n`. Use instead `n • a`, which has better definitional behav
ior.
-/
...
/-
**InvolutiveNeg** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：Type u_2 → Type u_2
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
@[to_additive]
/-
**InvolutiveInv** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：Type u_2 → Type u_2
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
@[to_additive (attr := simp)]
/-
**inv_inv** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：inv_inv (a : G) : a⁻¹⁻¹ = a
参数：a : G。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `InvolutiveInv.inv_inv`：∀ {G : Type u_2} [self : InvolutiveInv G] (x : G)
, x⁻¹⁻¹ = x
-/
...
/-
**DivInvMonoid.div'** 是 Mathlib 中的一个定义，位于命名空间 ``。
形式化陈述：DivInvMonoid.div' {G : Type u} [Monoid G] [Inv G] (a b : G) : G
参数：a b : G。
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
In a class equipped with instances of both `Monoid` and `Inv`, this definition r
ecords what the
default definition for `Div` would be: `a * b⁻¹`.  This is later provided as the
 default value for
the `Div` instance in `DivInvMonoid`.

We keep it as a separate definition rather than inlining it in `DivInvMonoid` so
 that the `Div`
field of individual `DivInvMonoid`s constructed using that default value will no
t be unfolded at
`.instance` transparency.
-/
...
impossible to extend `SMUl ℕ M` and `SMul ℤ M` at the same time. -/
/-
**ZSMul** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：Type u → Type u
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
`ZSMul` is an implementation detail of `SubNegMonoid`. It is needed because it i
s
impossible to extend `SMUl ℕ M` and `SMul ℤ M` at the same time.
-/
...
@[to_additive]
/-
**ZPow** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：Type u → Type u
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
@[to_additive toSMul]
/-
**ZPow.toPow** 是 Mathlib 中的一个实例，位于命名空间 ``。
形式化陈述：ZPow.toPow {M : Type*} [ZPow M] : Pow M Int
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[to_additive ofSMul]
/-
**ZPow.ofPow** 是 Mathlib 中的一个实例，位于命名空间 ``。
形式化陈述：ZPow.ofPow {M : Type*} [Pow M Int] : ZPow M
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
-/
/-
**DivInvMonoid** 是 Mathlib 中的一个类，位于命名空间 ``。
形式化陈述：DivInvMonoid (G : Type u) extends Monoid G, Inv G, Div G, ZPow G where pro
tected div
参数：G : Type u。
继承自：Monoid G, Inv G, Div G, ZPow G。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
In the same way, adding a `zpow` field makes it possible to avoid definitional f
ailures
in diamonds. See the definition of `Monoid` and Note [forgetful inheritance] for
 more
explanations on this.
-/
...
`.instance` transparency. -/
/-
**SubNegMonoid.sub'** 是 Mathlib 中的一个定义，位于命名空间 ``。
形式化陈述：SubNegMonoid.sub' {G : Type u} [AddMonoid G] [Neg G] (a b : G) : G
参数：a b : G。
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
In a class equipped with instances of both `AddMonoid` and `Neg`, this definitio
n records what
the default definition for `Sub` would be: `a + -b`.  This is later provided as 
the default value
for the `Sub` instance in `SubNegMonoid`.

We keep it as a separate definition rather than inlining it in `SubNegMonoid` so
 that the `Sub`
field of individual `SubNegMonoid`s constructed using that default value will no
t be unfolded at
`.instance` transparency.
-/
...
-/
/-
**SubNegMonoid** 是 Mathlib 中的一个类，位于命名空间 ``。
形式化陈述：SubNegMonoid (G : Type u) extends AddMonoid G, Neg G, Sub G, ZSMul G where
 protected sub
参数：G : Type u。
继承自：AddMonoid G, Neg G, Sub G, ZSMul G。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
In the same way, adding a `zsmul` field makes it possible to avoid definitional 
failures
in diamonds. See the definition of `AddMonoid` and Note [forgetful inheritance] 
for more
explanations on this.
-/
...
/-
**IsAddCyclic** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：(G : Type u) → [SMul ℤ G] → Prop
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**IsCyclic** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：(G : Type u) → [Pow G ℤ] → Prop
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
@[to_additive]
/-
**exists_zpow_surjective** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：exists_zpow_surjective (G : Type*) [Pow G Int] [IsCyclic G] : exists g : G
, Function.Surjective (g ^ · : Int -> G)
参数：G : Type*。
该定理/引理描述了相关对象所满足的性质。
黑盒证明引用了以下数学事实（定理与引理）：
...
/-
**zpow_eq_pow** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：∀ {G : Type u_1} [inst : DivInvMonoid G] (n : ℤ) (x : G), ZPow.zpow n x = 
x ^ n
参数：n : ℤ；x : G。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
@[to_additive (attr := simp) zsmul_eq_smul] theorem zpow_eq_pow (n : ℤ) (x : G) :
  ...
  rfl
/-
**zpow_zero** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：∀ {G : Type u_1} [inst : DivInvMonoid G] (a : G), a ^ 0 = 1
参数：a : G。
黑盒证明引用了以下数学事实（定理与引理）：
...
/-
**zpow_natCast** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：zpow_natCast (a : G) : forall n : Nat, a ^ (n : Int) = a ^ n | 0 => (zpow_
zero _).trans (pow_zero _).symm | n + 1 => calc a ^ (↑(n + 1) : Int) = a ^ (n : 
Int) * a
参数：a : G。
该定理/引理给出了一组等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**zpow_ofNat** 是 Mathlib 中的一个引理，位于命名空间 ``。
形式化陈述：zpow_ofNat (a : G) (n : Nat) : a ^ (ofNat(n) : Int) = a ^ OfNat.ofNat n
参数：a : G；n : Nat。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
...
lemma zpow_ofNat (a : G) (n : ℕ) : a ^ (ofNat(n) : ℤ) = a ^ OfNat.ofNat n :=
  zpow_natCast ..
/-
**zpow_negSucc** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：zpow_negSucc (a : G) (n : Nat) : a ^ (Int.negSucc n) = (a ^ (n + 1))⁻¹
参数：a : G；n : Nat。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
...
/-
**negSucc_zsmul** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：negSucc_zsmul {G} [SubNegMonoid G] (a : G) (n : Nat) : Int.negSucc n • a =
 -((n + 1) • a)
参数：a : G；n : Nat。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
...
/-
**div_eq_mul_inv** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：div_eq_mul_inv (a b : G) : a / b = a * b⁻¹
参数：a b : G。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
...
@[to_additive]
/-
**inv_eq_one_div** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：inv_eq_one_div (x : G) : x⁻¹ = 1 / x
参数：x : G。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
...
@[to_additive (attr := simp)]
/-
**one_div** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：one_div (a : G) : 1 / a = a⁻¹
参数：a : G。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `Eq.symm`：∀ {α : Sort u} {a b : α}, a = b → b = a
...
/-
**zpow_one** 是 Mathlib 中的一个引理，位于命名空间 ``。
形式化陈述：zpow_one (a : G) : a ^ (1 : Int) = a
参数：a : G。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
...
/-
**zpow_two** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：∀ {G : Type u_1} [inst : DivInvMonoid G] (a : G), a ^ 2 = a * a
参数：a : G。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
...
/-
**zpow_neg_one** 是 Mathlib 中的一个引理，位于命名空间 ``。
形式化陈述：zpow_neg_one (x : G) : x ^ (-1 : Int) = x⁻¹
参数：x : G。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `Eq.trans`：∀ {α : Sort u} {a b c : α}, a = b → b = c → a = c
...
@[to_additive]
/-
**zpow_neg_coe_of_pos** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：∀ {G : Type u_1} [inst : DivInvMonoid G] (a : G) {n : ℕ}, 0 < n → a ^ (-↑n
) = (a ^ n)⁻¹
参数：a : G；-↑n；a ^ n。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `zpow_negSucc`：zpow_negSucc (a : G) (n : Nat) : a ^ (Int.negSucc n) = (a 
...
/-
**NegZeroClass** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：Type u_2 → Type u_2
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**SubNegZeroMonoid** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：Type u_2 → Type u_2
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
@[to_additive]
/-
**InvOneClass** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：Type u_2 → Type u_2
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
@[to_additive]
/-
**DivInvOneMonoid** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：Type u_2 → Type u_2
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
@[to_additive (attr := simp)]
/-
**inv_one** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：inv_one : (1 : G)⁻¹ = 1
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `InvOneClass.inv_one`：∀ {G : Type u_2} [self : InvOneClass G], 1⁻¹ = 1
-/
...
/-
**SubtractionMonoid** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：Type u → Type u
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
@[to_additive]
/-
**DivisionMonoid** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：Type u → Type u
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**mul_inv_rev** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：mul_inv_rev (a b : G) : (a * b)⁻¹ = b⁻¹ * a⁻¹
参数：a b : G。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `DivisionMonoid.mul_inv_rev`：∀ {G : Type u} [self : DivisionMonoid G] (a 
b : G), (a * b)⁻¹ = b⁻¹ * a⁻¹
-/
...
@[to_additive]
/-
**inv_eq_of_mul_eq_one_right** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：inv_eq_of_mul_eq_one_right : a * b = 1 -> a⁻¹ = b
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
...
@[to_additive]
/-
**inv_eq_of_mul_eq_one_left** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：inv_eq_of_mul_eq_one_left (h : a * b = 1) : b⁻¹ = a
参数：h : a * b = 1。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
...
@[to_additive]
/-
**eq_inv_of_mul_eq_one_left** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：eq_inv_of_mul_eq_one_left (h : a * b = 1) : a = b⁻¹
参数：h : a * b = 1。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `Eq.symm`：∀ {α : Sort u} {a b : α}, a = b → b = a
...
/-
**SubtractionCommMonoid** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：Type u → Type u
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**DivisionCommMonoid** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：Type u → Type u
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
-/
/-
**Group** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：Type u → Type u
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
-/
/-
**AddGroup** 是 Mathlib 中的一个类，位于命名空间 ``。
形式化陈述：AddGroup (A : Type u) extends SubNegMonoid A where protected neg_add_cance
l : forall a : A, -a + a = 0  attribute [to_additive (attr
参数：A : Type u。
继承自：SubNegMonoid A。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**AddCommGroup** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：Type u → Type u
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**CommGroup** 是 Mathlib 中的一个归纳类型，位于命名空间 ``。
形式化陈述：Type u → Type u
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**inv_mul_cancel_comm** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：∀ {G : Type u_1} [inst : CommGroup G] (a b : G), a⁻¹ * b * a = b
参数：a b : G。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
...
@[to_additive (attr := simp)]
/-
**mul_inv_cancel_comm** 是 Mathlib 中的一个引理，位于命名空间 ``。
形式化陈述：mul_inv_cancel_comm (a b : G) : a * b * a⁻¹ = b
参数：a b : G。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
...
/-
**inv_mul_cancel_comm_assoc** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：∀ {G : Type u_1} [inst : CommGroup G] (a b : G), a⁻¹ * (b * a) = b
参数：a b : G；b * a。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
...
/-
**mul_inv_cancel_comm_assoc** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：∀ {G : Type u_1} [inst : CommGroup G] (a b : G), a * (b * a⁻¹) = b
参数：a b : G；b * a⁻¹。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
