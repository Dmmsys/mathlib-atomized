...
/--
Definition of `ParametrizedAdjunction` / `ParametrizedAdjunction` 的定义

English:
structure ParametrizedAdjunction
  parameters: where
  axioms and operations (2):
    - adj((X₁ : C₁)) : F.obj X₁ ⊣ G.obj (op X₁)
    - unit_whiskerRight_map({X₁ Y₁ : C₁} (f : X₁ ⟶ Y₁)) : (adj X₁).unit ≫ whiskerRight (F.map f) _ = (adj Y₁).unit ≫ whiskerLeft _ (G.map f.op)  [default: by cat_disch]

中文:
结构 ParametrizedAdjunction
  参数: where
  公理与运算 (2 个):
    - adj((X₁ : C₁)) : F.obj X₁ ⊣ G.obj (op X₁)
    - unit_whiskerRight_map({X₁ Y₁ : C₁} (f : X₁ ⟶ Y₁)) : (adj X₁).unit ≫ whiskerRight (F.map f) _ = (adj Y₁).unit ≫ whiskerLeft _ (G.map f.op)  [默认: by cat_disch]
...
English:
definition mk'
  signature: (adj : forall (X₁ : C₁), F.obj X₁ ⊣ G.obj (op X₁))
  body: adj
...
中文:
定义 mk'
  签名: (adj : 对任意 (X₁ : C₁), F.obj X₁ ⊣ G.obj (op X₁))
  定义体: adj
  unit_whiskerRight_map {X₁ Y₁} f := by
    ext X₂
    simpa [Adjunction.homEquiv_unit] using h f (X₂ := X₂) (𝟙 _)

Depends on / 依赖: Adjunction, Adjunction.homEquiv_unit, cat_disch, homEquiv_unit, unit_whiskerRight_map
-/
def mk' (adj : forall (X₁ : C₁), F.obj X₁ ⊣ G.obj (op X₁))
    (h : forall {X₁ Y₁ : C₁} (f : X₁ ⟶ Y₁) {X₂ : C₂} {X₃ : C₃} (g : (F.obj Y₁).obj X₂ ⟶ X₃),
...
English:
definition homEquiv
  signature: : ((F.obj X₁).obj X₂ ⟶ X₃) ≃ (X₂ ⟶ (G.obj (op X₁)).obj X₃)
  body: (adj₂.adj X₁).homEquiv _ _

中文:
定义 homEquiv
  签名: : ((F.obj X₁).obj X₂ ⟶ X₃) ≃ (X₂ ⟶ (G.obj (op X₁)).obj X₃)
  定义体: (adj₂.adj X₁).homEquiv _ _
...
English:
lemma homEquiv_eq
  statement: adj₂.homEquiv = (adj₂.adj X₁).homEquiv X₂ X₃
  proof: rfl

中文:
引理 homEquiv_eq
  结论: adj₂.homEquiv = (adj₂.adj X₁).homEquiv X₂ X₃
  证明: rfl
-/
...
@[reassoc]
/--
lemma `homEquiv_naturality_one` / 引理 `homEquiv_naturality_one`

English:
lemma homEquiv_naturality_one
  given: (f₁ : X₁ ⟶ Y₁) (g : (F.obj Y₁).obj X₂ ⟶ X₃)
  proof: by
...
中文:
引理 homEquiv_naturality_one
  条件: (f₁ : X₁ ⟶ Y₁) (g : (F.obj Y₁).obj X₂ ⟶ X₃)
  证明: by
  have := NatTrans.congr_app (adj₂.unit_whiskerRight_map f₁) X₂
  dsimp at this
  simp only [homEquiv_eq, Adjunction.homEquiv_unit, Functor.comp_obj, Functor.map_comp,
...
Depends on / 依赖: Adjunction, Adjunction.homEquiv_unit, Category, Category.assoc, Functor, Functor.comp_obj, Functor.map_comp, NatTrans, NatTrans.congr_app, NatTrans.naturality, comp_obj, congr_app, homEquiv_eq, homEquiv_unit, map_comp, naturality, reassoc_of, unit_whiskerRight_map
-/
...
@[reassoc]
/--
lemma `homEquiv_naturality_two` / 引理 `homEquiv_naturality_two`

English:
lemma homEquiv_naturality_two
  given: (f₂ : X₂ ⟶ Y₂) (g : (F.obj X₁).obj Y₂ ⟶ X₃)
  proof: (adj₂.adj X₁).homEquiv_naturality_left _ _

@[reassoc]

中文:
引理 homEquiv_naturality_two
  条件: (f₂ : X₂ ⟶ Y₂) (g : (F.obj X₁).obj Y₂ ⟶ X₃)
  证明: (adj₂.adj X₁).homEquiv_naturality_left _ _

@[reassoc]

Depends on / 依赖: homEquiv_naturality_left
-/
...
lemma homEquiv_naturality_three
  given: (f₃ : X₃ ⟶ Y₃) (g : (F.obj X₁).obj X₂ ⟶ X₃)
  proof: (adj₂.adj X₁).homEquiv_naturality_right _ _

@[reassoc]

中文:
引理 homEquiv_naturality_three
  条件: (f₃ : X₃ ⟶ Y₃) (g : (F.obj X₁).obj X₂ ⟶ X₃)
  证明: (adj₂.adj X₁).homEquiv_naturality_right _ _

@[reassoc]

Depends on / 依赖: homEquiv_naturality_right
-/
...
@[reassoc]
/--
lemma `homEquiv_symm_naturality_one` / 引理 `homEquiv_symm_naturality_one`

English:
lemma homEquiv_symm_naturality_one
  proof: adj₂.homEquiv.injective (by simp [homEquiv_naturality_one])

@[reassoc]

中文:
引理 homEquiv_symm_naturality_one
  证明: adj₂.homEquiv.injective (by simp [homEquiv_naturality_one])

@[reassoc]

Depends on / 依赖: homEquiv, homEquiv.injective, homEquiv_naturality_one, injective
-/
lemma homEquiv_symm_naturality_one
...
@[reassoc]
/--
lemma `homEquiv_symm_naturality_two` / 引理 `homEquiv_symm_naturality_two`

English:
lemma homEquiv_symm_naturality_two
  proof: adj₂.homEquiv.injective (by simp [homEquiv_naturality_two])

@[reassoc]

中文:
引理 homEquiv_symm_naturality_two
  证明: adj₂.homEquiv.injective (by simp [homEquiv_naturality_two])

@[reassoc]

Depends on / 依赖: homEquiv, homEquiv.injective, homEquiv_naturality_two, injective
-/
lemma homEquiv_symm_naturality_two
...
@[reassoc]
/--
lemma `homEquiv_symm_naturality_three` / 引理 `homEquiv_symm_naturality_three`

English:
lemma homEquiv_symm_naturality_three
  proof: adj₂.homEquiv.injective (by simp [homEquiv_naturality_three])

中文:
引理 homEquiv_symm_naturality_three
  证明: adj₂.homEquiv.injective (by simp [homEquiv_naturality_three])

Depends on / 依赖: homEquiv, homEquiv.injective, homEquiv_naturality_three, injective
-/
lemma homEquiv_symm_naturality_three
...
@[reassoc]
/--
lemma `whiskerLeft_map_counit` / 引理 `whiskerLeft_map_counit`

English:
lemma whiskerLeft_map_counit
  given: {X₁ Y₁ : C₁} (f : X₁ ⟶ Y₁)
  proof: by
  ext X₃
  dsimp
  apply adj₂.homEquiv.injective
  rw [homEquiv_naturality_one]; rw [homEquiv_naturality_two]
  simp [homEquiv_eq, Adjunction.homEquiv_unit]

中文:
引理 whiskerLeft_map_counit
  条件: {X₁ Y₁ : C₁} (f : X₁ ⟶ Y₁)
  证明: by
  ext X₃
  dsimp
...
Depends on / 依赖: Adjunction, Adjunction.homEquiv_unit, homEquiv, homEquiv.injective, homEquiv_eq, homEquiv_naturality_one, homEquiv_naturality_two, homEquiv_unit, injective
-/
