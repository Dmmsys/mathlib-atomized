...
/--
theorem `cauchySeq_prod_of_tendsto_cofinite_one` / 定理 `cauchySeq_prod_of_tendsto_cofinite_one`

English:
theorem cauchySeq_prod_of_tendsto_cofinite_one
  given: {f : α -> G} (hf : Tendsto f cofinite (𝓝 1))
  proof: by
...
/--
lemma `cauchySeq_of_tendsto_div_nhds_one` / 引理 `cauchySeq_of_tendsto_div_nhds_one`

English:
lemma cauchySeq_of_tendsto_div_nhds_one
  statement: {f : Nat -> G}
  proof: by
  suffices Tendsto (fun p : Nat × Nat => f p.2 / f p.1) atTop (𝓝 1) by simpa [CauchySeq,
...
-/
lemma cauchySeq_of_tendsto_div_nhds_one {f : Nat -> G}
...
summable. -/]
/--
theorem `multipliable_of_tendsto_cofinite_one` / 定理 `multipliable_of_tendsto_cofinite_one`

English:
theorem multipliable_of_tendsto_cofinite_one
  statement: [CompleteSpace G] {f : α -> G}
  proof: CompleteSpace.complete (cauchySeq_prod_of_tendsto_cofinite_one hf)
...
sets. -/]
/--
theorem `multipliable_iff_tendsto_cofinite_one` / 定理 `multipliable_iff_tendsto_cofinite_one`

English:
theorem multipliable_iff_tendsto_cofinite_one
  given: [CompleteSpace G] (f : α -> G)
  proof: ⟨Multipliable.tendsto_cofinite_one, multipliable_of_tendsto_cofinite_one⟩
...
/--
theorem `Summable.mul_of_complete_nonarchimedean` / 定理 `Summable.mul_of_complete_nonarchimedean`

English:
theorem Summable.mul_of_complete_nonarchimedean
  statement: [CompleteSpace R] {f : α -> R} {g : β -> R}
  proof: by
...
/--
theorem `HasSum.mul_of_nonarchimedean` / 定理 `HasSum.mul_of_nonarchimedean`

English:
theorem HasSum.mul_of_nonarchimedean
  statement: {f : α -> R} {g : β -> R} {a b : R} (hf : HasSum f a)
  proof: by
...
中文:
定理 HasSum.mul_of_nonarchimedean
  结论: {f : α -> R} {g : β -> R} {a b : R} (hf : HasSum f a)
  证明: by
  rw [← hasSum_iff_hasSum_compl] at *
  simp only [Function.comp_def, UniformSpace.Completion.toCompl_apply,
    UniformSpace.Completion.coe_mul]
...
Depends on / 依赖: Completion, Function, Function.comp_def, UniformSpace, UniformSpace.Completion.coe_mul, UniformSpace.Completion.toCompl_apply, coe_mul, comp_def, hasSum_iff_hasSum_compl, hf.mul, hf.summable.mul_of_complete_nonarchimedean, hg.summable, mul_of_complete_nonarchimedean, summable, toCompl_apply
-/
...
/--
theorem `Summable.mul_of_nonarchimedean` / 定理 `Summable.mul_of_nonarchimedean`

English:
theorem Summable.mul_of_nonarchimedean
  statement: {f : α -> R} {g : β -> R} (hf : Summable f)
  proof: (hf.hasSum.mul_of_nonarchimedean hg.hasSum).summable

中文:
定理 Summable.mul_of_nonarchimedean
  结论: {f : α -> R} {g : β -> R} (hf : Summable f)
  证明: (hf.hasSum.mul_of_nonarchimedean hg.hasSum).summable

Depends on / 依赖: hasSum, hf.hasSum.mul_of_nonarchimedean, hg.hasSum, mul_of_nonarchimedean, summable
-/
...
/--
theorem `tsum_mul_tsum_of_nonarchimedean` / 定理 `tsum_mul_tsum_of_nonarchimedean`

English:
theorem tsum_mul_tsum_of_nonarchimedean
  statement: [T0Space R] {f : α -> R} {g : β -> R} (hf : Summable f)
  proof: (hf.hasSum.mul_of_nonarchimedean hg.hasSum).tsum_eq.symm
