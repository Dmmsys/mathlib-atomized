...
/-
**CategoryTheory.ShortComplex.SnakeInput** 是 Mathlib 中的一个结构，位于命名空间 `CategoryTheo
ry.ShortComplex`。
形式化陈述：SnakeInput where /-- the zeroth row -/ L₀ : ShortComplex C /-- the first r
ow -/ L₁ : ShortComplex C /-- the second row -/ L₂ : ShortComplex C /-- the thir
d row -/ L₃ : ShortComplex C /-- the morphism from the zeroth row to the first r
ow -/ v₀₁ : L₀ ⟶ L₁ /-- the morphism from the first row to the second row -/ v₁₂
 : L₁ ⟶ L₂ /-- the morphism from the second row to the third row -/ v₂₃ : L₂ ⟶ L
₃ w₀₂ : v₀₁ ≫ v₁₂ = 0
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
A snake input in an abelian category `C` consists of morphisms
of short complexes `L₀ ⟶ L₁ ⟶ L₂ ⟶ L₃` (which should be visualized vertically) s
uch
that `L₀` and `L₃` are respectively the kernel and the cokernel of `L₁ ⟶ L₂`,
`L₁` and `L₂` are exact, `L₁.g` is epi and `L₂.f` is mono.
-/
...
@[simps]
/-
**CategoryTheory.ShortComplex.SnakeInput.op** 是 Mathlib 中的一个定义，位于命名空间 `CategoryT
heory.ShortComplex.SnakeInput`。
形式化陈述：op : SnakeInput Cᵒᵖ where L₀
该定义给出了上述对象。
本定义的构造引用了以下数学事实（定理与引理）：
· 使用定理 `CategoryTheory.ShortComplex.SnakeInput.w₁₃`：∀ {C : Type u_1} [inst : Cat
egoryTheory.Category.{v_1, u_1} C] [inst_1 : CategoryTheory.Abelian C]   (self :
 CategoryTheory.ShortComplex.Sna…
· 使用定理 `CategoryTheory.ShortComplex.SnakeInput.w₀₂`：∀ {C : Type u_1} [inst : Cat
egoryTheory.Category.{v_1, u_1} C] [inst_1 : CategoryTheory.Abelian C]   (self :
 CategoryTheory.ShortComplex.Sna…
...
noncomputable def op : SnakeInput Cᵒᵖ where
  ...
  L₂_exact := S.L₁_exact.op
/-
**CategoryTheory.ShortComplex.SnakeInput.w** 是 Mathlib 中的一个引理，位于命名空间 `CategoryTh
eory.ShortComplex.SnakeInput`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**CategoryTheory.ShortComplex.SnakeInput.h** 是 Mathlib 中的一个定义，位于命名空间 `CategoryTh
eory.ShortComplex.SnakeInput`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
noncomputable def h₀τ₃ : IsLimit (KernelFork.ofι S.v₀₁.τ₃ S.w₀₂_τ₃) :=
  isLimitForkMapOfIsLimit' π₃ S.w₀₂ S.h₀
/-
**CategoryTheory.ShortComplex.SnakeInput.mono_v** 是 Mathlib 中的一个实例，位于命名空间 `Categ
oryTheory.ShortComplex.SnakeInput`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**CategoryTheory.ShortComplex.SnakeInput.exact_C** 是 Mathlib 中的一个引理，位于命名空间 `Cate
goryTheory.ShortComplex.SnakeInput`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
lemma exact_C₃_up : (ShortComplex.mk S.v₀₁.τ₃ S.v₁₂.τ₃
  ...
  exact_of_f_is_kernel _ S.h₀τ₃
/-
**CategoryTheory.ShortComplex.SnakeInput.mono_L** 是 Mathlib 中的一个实例，位于命名空间 `Categ
oryTheory.ShortComplex.SnakeInput`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
noncomputable def h₃τ₃ : IsColimit (CokernelCofork.ofπ S.v₂₃.τ₃ S.w₁₃_τ₃) :=
  isColimitCoforkMapOfIsColimit' π₃ S.w₁₃ S.h₃
/-
**CategoryTheory.ShortComplex.SnakeInput.epi_v** 是 Mathlib 中的一个实例，位于命名空间 `Catego
ryTheory.ShortComplex.SnakeInput`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
lemma exact_C₃_down : (ShortComplex.mk S.v₁₂.τ₃ S.v₂₃.τ₃
  ...
  exact_of_g_is_cokernel _ S.h₃τ₃
/-
**CategoryTheory.ShortComplex.SnakeInput.epi_L** 是 Mathlib 中的一个实例，位于命名空间 `Catego
ryTheory.ShortComplex.SnakeInput`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**CategoryTheory.ShortComplex.SnakeInput.L** 是 Mathlib 中的一个引理，位于命名空间 `CategoryTh
eory.ShortComplex.SnakeInput`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**CategoryTheory.ShortComplex.SnakeInput.P** 是 Mathlib 中的一个定义，位于命名空间 `CategoryTh
eory.ShortComplex.SnakeInput`。
形式化陈述：P
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**CategoryTheory.ShortComplex.SnakeInput.** 是 Mathlib 中的一个定义，位于命名空间 `CategoryThe
...
@[reassoc (attr := simp)]
/-
**CategoryTheory.ShortComplex.SnakeInput.lift_** 是 Mathlib 中的一个引理，位于命名空间 `Catego
ryTheory.ShortComplex.SnakeInput`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**CategoryTheory.ShortComplex.SnakeInput.L** 是 Mathlib 中的一个定义，位于命名空间 `CategoryTh
eory.ShortComplex.SnakeInput`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
set_option backward.isDefEq.respectTransparency false in
/-
**CategoryTheory.ShortComplex.SnakeInput.** 是 Mathlib 中的一个实例，位于命名空间 `CategoryThe
ory.ShortComplex.SnakeInput`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[reassoc (attr := simp)]
/-
**CategoryTheory.ShortComplex.SnakeInput.snd_** 是 Mathlib 中的一个引理，位于命名空间 `Categor
yTheory.ShortComplex.SnakeInput`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**CategoryTheory.ShortComplex.SnakeInput.P'** 是 Mathlib 中的一个定义，位于命名空间 `CategoryT
heory.ShortComplex.SnakeInput`。
形式化陈述：P'
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**CategoryTheory.ShortComplex.SnakeInput.PIsoUnopOpP'** 是 Mathlib 中的一个定义，位于命名空间 
`CategoryTheory.ShortComplex.SnakeInput`。
形式化陈述：PIsoUnopOpP' : S.P ≅ Opposite.unop S.op.P'
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-- The duality isomorphism `S.P' ≅ Opposite.unop S.op.P`. -/
/-
**CategoryTheory.ShortComplex.SnakeInput.P'IsoUnopOpP** 是 Mathlib 中的一个定义，位于命名空间 
`CategoryTheory.ShortComplex.SnakeInput`。
形式化陈述：{C : Type u_1} →   [inst : CategoryTheory.Category.{v_1, u_1} C] →     [in
st_1 : CategoryTheory.Abelian C] → (S : CategoryTheory.ShortComplex.SnakeInput C
) → S.P' ≅ Opposite.unop S.op.P
参数：S : CategoryTheory.ShortComplex.SnakeInput C。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
set_option backward.isDefEq.respectTransparency false in
/-
**CategoryTheory.ShortComplex.SnakeInput.op_** 是 Mathlib 中的一个引理，位于命名空间 `Category
Theory.ShortComplex.SnakeInput`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
`S : SnakeInput C`. -/
/-
**CategoryTheory.ShortComplex.SnakeInput.composableArrows** 是 Mathlib 中的一个缩写定义，位
于命名空间 `CategoryTheory.ShortComplex.SnakeInput`。
形式化陈述：composableArrows : ComposableArrows C 5
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**CategoryTheory.ShortComplex.SnakeInput.snake_lemma** 是 Mathlib 中的一个引理，位于命名空间 `
CategoryTheory.ShortComplex.SnakeInput`。
形式化陈述：snake_lemma : S.composableArrows.Exact
该定理/引理描述了相关对象所满足的性质。
黑盒证明引用了以下数学事实（定理与引理）：
...
· 使用引理 `CategoryTheory.ShortComplex.SnakeInput.L₀_exact`：L₀_exact : S.L₀.Exact
· 使用定理 `CategoryTheory.ShortComplex.SnakeInput.L₁'_exact`：∀ {C : Type u_1} [inst
 : CategoryTheory.Category.{v_1, u_1} C] [inst_1 : CategoryTheory.Abelian C]   (
S : CategoryTheory.ShortComplex.SnakeI…
· 使用定理 `CategoryTheory.ShortComplex.SnakeInput.L₂'_exact`：∀ {C : Type u_1} [inst
 : CategoryTheory.Category.{v_1, u_1} C] [inst_1 : CategoryTheory.Abelian C]   (
S : CategoryTheory.ShortComplex.SnakeI…
· 使用引理 `CategoryTheory.ShortComplex.SnakeInput.L₃_exact`：L₃_exact : S.L₃.Exact
...
/-
**CategoryTheory.ShortComplex.SnakeInput.mono_** 是 Mathlib 中的一个定理，位于命名空间 `Catego
ryTheory.ShortComplex.SnakeInput`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**CategoryTheory.ShortComplex.SnakeInput.epi_** 是 Mathlib 中的一个定理，位于命名空间 `Categor
yTheory.ShortComplex.SnakeInput`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**CategoryTheory.ShortComplex.SnakeInput.isIso_** 是 Mathlib 中的一个定理，位于命名空间 `Categ
oryTheory.ShortComplex.SnakeInput`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[ext]
/-
**CategoryTheory.ShortComplex.SnakeInput.Hom** 是 Mathlib 中的一个结构，位于命名空间 `Category
Theory.ShortComplex.SnakeInput`。
形式化陈述：Hom where /-- a morphism between the zeroth lines -/ f₀ : S₁.L₀ ⟶ S₂.L₀ /-
- a morphism between the first lines -/ f₁ : S₁.L₁ ⟶ S₂.L₁ /-- a morphism betwee
n the second lines -/ f₂ : S₁.L₂ ⟶ S₂.L₂ /-- a morphism between the third lines 
-/ f₃ : S₁.L₃ ⟶ S₂.L₃ comm₀₁ : f₀ ≫ S₂.v₀₁ = S₁.v₀₁ ≫ f₁
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
@[simps]
/-
**CategoryTheory.ShortComplex.SnakeInput.Hom.id** 是 Mathlib 中的一个定义，位于命名空间 `Categ
oryTheory.ShortComplex.SnakeInput.Hom`。
形式化陈述：id : Hom S S where f₀
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
@[simps]
/-
**CategoryTheory.ShortComplex.SnakeInput.Hom.comp** 是 Mathlib 中的一个定义，位于命名空间 `Cat
egoryTheory.ShortComplex.SnakeInput.Hom`。
形式化陈述：comp (f : Hom S₁ S₂) (g : Hom S₂ S₃) : Hom S₁ S₃ where f₀
参数：f : Hom S₁ S₂；g : Hom S₂ S₃。
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
variable {S₁ S₂ S₃}
/-
**CategoryTheory.ShortComplex.SnakeInput.id_f** 是 Mathlib 中的一个引理，位于命名空间 `Categor
yTheory.ShortComplex.SnakeInput`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**CategoryTheory.ShortComplex.SnakeInput.comp_f** 是 Mathlib 中的一个引理，位于命名空间 `Categ
oryTheory.ShortComplex.SnakeInput`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simps]
/-
**CategoryTheory.ShortComplex.SnakeInput.functorL** 是 Mathlib 中的一个定义，位于命名空间 `Cat
egoryTheory.ShortComplex.SnakeInput`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
@[simps]
/-
**CategoryTheory.ShortComplex.SnakeInput.functorP** 是 Mathlib 中的一个定义，位于命名空间 `Cat
egoryTheory.ShortComplex.SnakeInput`。
形式化陈述：functorP : SnakeInput C ⥤ C where obj S
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
@[reassoc]
/-
**CategoryTheory.ShortComplex.SnakeInput.naturality_** 是 Mathlib 中的一个引理，位于命名空间 `
CategoryTheory.ShortComplex.SnakeInput`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simps]
/-
**CategoryTheory.ShortComplex.SnakeInput.composableArrowsFunctor** 是 Mathlib 中的一
个定义，位于命名空间 `CategoryTheory.ShortComplex.SnakeInput`。
形式化陈述：composableArrowsFunctor : SnakeInput C ⥤ ComposableArrows C 5 where obj S
该定义给出了上述对象。
本定义的构造引用了以下数学事实（定理与引理）：
· 使用引理 `CategoryTheory.ShortComplex.SnakeInput.naturality_δ`：naturality_δ (f : S
₁ ⟶ S₂) : S₁.δ ≫ f.f₃.τ₁ = f.f₀.τ₃ ≫ S₂.δ
