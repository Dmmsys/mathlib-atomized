...
/-
**Real.goldenRatio** 是 Mathlib 中的一个缩写定义，位于命名空间 `Real`。
形式化陈述：goldenRatio : Real
该定义给出了上述对象。
...
/-
**Real.goldenConj** 是 Mathlib 中的一个缩写定义，位于命名空间 `Real`。
形式化陈述：goldenConj : Real
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Real.inv_goldenRatio** 是 Mathlib 中的一个定理，位于命名空间 `Real`。
形式化陈述：inv_goldenRatio : φ⁻¹ = -ψ
该定理/引理给出了一组等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Real.inv_goldenConj** 是 Mathlib 中的一个定理，位于命名空间 `Real`。
形式化陈述：inv_goldenConj : ψ⁻¹ = -φ
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
...
-a = b ↔ a = -b
· 使用定理 `Real.inv_goldenRatio`：inv_goldenRatio : φ⁻¹ = -ψ
...
@[simp]
/-
**Real.goldenRatio_mul_goldenConj** 是 Mathlib 中的一个定理，位于命名空间 `Real`。
形式化陈述：goldenRatio_mul_goldenConj : φ * ψ = -1
该定理/引理给出了一组等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Real.goldenConj_mul_goldenRatio** 是 Mathlib 中的一个定理，位于命名空间 `Real`。
形式化陈述：goldenConj_mul_goldenRatio : ψ * φ = -1
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
· 使用定理 `mul_comm`：mul_comm : forall a b : G, a * b = b * a
· 使用定理 `Real.goldenRatio_mul_goldenConj`：goldenRatio_mul_goldenConj : φ * ψ = -1
-/
...
@[simp]
/-
**Real.goldenRatio_add_goldenConj** 是 Mathlib 中的一个定理，位于命名空间 `Real`。
形式化陈述：goldenRatio_add_goldenConj : φ + ψ = 1
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
· 使用定理 `Real.goldenRatio.eq_1`：Real.goldenRatio = (1 + √5) / 2
· 使用定理 `Real.goldenConj.eq_1`：Real.goldenConj = (1 - √5) / 2
...
theorem goldenRatio_add_goldenConj : φ + ψ = 1 := by
  ...
  ring
/-
**Real.one_sub_goldenConj** 是 Mathlib 中的一个定理，位于命名空间 `Real`。
形式化陈述：one_sub_goldenConj : 1 - φ = ψ
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
...
/-
**Real.one_sub_goldenRatio** 是 Mathlib 中的一个定理，位于命名空间 `Real`。
形式化陈述：one_sub_goldenRatio : 1 - ψ = φ
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用引理 `Mathlib.Tactic.Linarith.eq_of_not_lt_of_not_gt`：eq_of_not_lt_of_not_gt {
α} [LinearOrder α] (a b : α) (h1 : ¬ a < b) (h2 : ¬ b < a) : a = b
...
@[simp]
/-
**Real.goldenRatio_sub_goldenConj** 是 Mathlib 中的一个定理，位于命名空间 `Real`。
形式化陈述：goldenRatio_sub_goldenConj : φ - ψ = √5
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `Mathlib.Tactic.Ring.of_eq`：∀ {α : Sort u_2} {a b c : α}, a = c → b = c →
 a = b
...
/-
**Real.goldenRatio_pow_sub_goldenRatio_pow** 是 Mathlib 中的一个定理，位于命名空间 `Real`。
形式化陈述：goldenRatio_pow_sub_goldenRatio_pow (n : Nat) : φ ^ (n + 2) - φ ^ (n + 1) 
= φ ^ n
参数：n : Nat。
该定理/引理给出了一组等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
@[simp 1200]
/-
**Real.goldenRatio_sq** 是 Mathlib 中的一个定理，位于命名空间 `Real`。
形式化陈述：goldenRatio_sq : φ ^ 2 = φ + 1
该定理/引理给出了一组等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp 1200]
/-
**Real.goldenConj_sq** 是 Mathlib 中的一个定理，位于命名空间 `Real`。
形式化陈述：goldenConj_sq : ψ ^ 2 = ψ + 1
该定理/引理给出了一组等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
theorem goldenConj_sq : ψ ^ 2 = ψ + 1 := by
  grind
/-
**Real.goldenRatio_pos** 是 Mathlib 中的一个定理，位于命名空间 `Real`。
形式化陈述：goldenRatio_pos : 0 < φ
该定理/引理描述了相关对象所满足的性质。
黑盒证明引用了以下数学事实（定理与引理）：
...
/-
**Real.goldenRatio_ne_zero** 是 Mathlib 中的一个定理，位于命名空间 `Real`。
形式化陈述：goldenRatio_ne_zero : φ != 0
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `ne_of_gt`：∀ {α : Type u_1} [inst : Preorder α] {a b : α}, b < a → a ≠ b
· 使用定理 `Real.goldenRatio_pos`：goldenRatio_pos : 0 < φ
-/
theorem goldenRatio_ne_zero : φ ≠ 0 :=
  ne_of_gt goldenRatio_pos
/-
**Real.one_lt_goldenRatio** 是 Mathlib 中的一个定理，位于命名空间 `Real`。
形式化陈述：one_lt_goldenRatio : 1 < φ
该定理/引理描述了相关对象所满足的性质。
黑盒证明引用了以下数学事实（定理与引理）：
...
· 使用定理 `Real.goldenRatio_sq`：goldenRatio_sq : φ ^ 2 = φ + 1
· 使用定理 `IsLeftCancelAdd.addLeftStrictMono_of_addLeftMono`：∀ (N : Type u_2) [inst
 : Add N] [IsLeftCancelAdd N] [inst_2 : PartialOrder N] [AddLeftMono N], AddLeft
StrictMono N
· 使用定理 `instIsLeftCancelAddOfAddLeftReflectLE`：∀ {α : Type u_1} [inst : Add α] [
...
theorem one_lt_goldenRatio : 1 < φ := by
  ...
  simp [← sq, zero_lt_one]
/-
**Real.goldenRatio_lt_two** 是 Mathlib 中的一个定理，位于命名空间 `Real`。
形式化陈述：goldenRatio_lt_two : φ < 2
该定理/引理描述了相关对象所满足的性质。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `Nat.instAtLeastTwoHAddOfNat`：∀ (n : ℕ) [NeZero n], (n + 1).AtLeastTwo
· 使用定理 `Nat.instNeZeroSucc`：∀ {n : ℕ}, NeZero (n + 1)
...
theorem goldenRatio_lt_two : φ < 2 := by calc
  ...
  _ = 2 := by norm_num
/-
**Real.goldenConj_neg** 是 Mathlib 中的一个定理，位于命名空间 `Real`。
形式化陈述：goldenConj_neg : ψ < 0
该定理/引理描述了相关对象所满足的性质。
黑盒证明引用了以下数学事实（定理与引理）：
...
/-
**Real.goldenConj_ne_zero** 是 Mathlib 中的一个定理，位于命名空间 `Real`。
形式化陈述：goldenConj_ne_zero : ψ != 0
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用引理 `ne_of_lt`：ne_of_lt (h : a < b) : a != b
· 使用定理 `Real.goldenConj_neg`：goldenConj_neg : ψ < 0
-/
theorem goldenConj_ne_zero : ψ ≠ 0 :=
  ne_of_lt goldenConj_neg
/-
**Real.neg_one_lt_goldenConj** 是 Mathlib 中的一个定理，位于命名空间 `Real`。
形式化陈述：neg_one_lt_goldenConj : -1 < ψ
该定理/引理描述了相关对象所满足的性质。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
...
g R} {inst_1 : PartialOrder R} [self : IsStrictOrderedRing R], PosMulStrictMono 
R
· 使用定理 `Real.one_lt_goldenRatio`：one_lt_goldenRatio : 1 < φ
-/
...
/-
**Real.goldenRatio_irrational** 是 Mathlib 中的一个定理，位于命名空间 `Real`。
形式化陈述：goldenRatio_irrational : Irrational φ
该定理/引理描述了相关对象所满足的性质。
黑盒证明引用了以下数学事实（定理与引理）：
...
/-
**Real.goldenConj_irrational** 是 Mathlib 中的一个定理，位于命名空间 `Real`。
形式化陈述：goldenConj_irrational : Irrational ψ
该定理/引理描述了相关对象所满足的性质。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `Nat.Prime.irrational_sqrt`：Nat.Prime.irrational_sqrt {p : Nat} (hp : Nat
.Prime p) : Irrational (√p)
...
/-
**Real.fibRec** 是 Mathlib 中的一个定义，位于命名空间 `Real`。
形式化陈述：fibRec : LinearRecurrence α where order
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Real.fibRec_charPoly_eq** 是 Mathlib 中的一个定理，位于命名空间 `Real`。
形式化陈述：fibRec_charPoly_eq {β : Type*} [CommRing β] : fibRec.charPoly = X ^ 2 - (X
 + (1 : β[X]))
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
· 使用定理 `Real.fibRec.eq_1`：∀ {α : Type u_1} [inst : CommSemiring α], Real.fibRec 
= { order := 2, coeffs := ![1, 1] }
...
/-
**Real.fib_isSol_fibRec** 是 Mathlib 中的一个定理，位于命名空间 `Real`。
形式化陈述：fib_isSol_fibRec : fibRec.IsSolution (fun x => x.fib : Nat -> α)
该定理/引理描述了相关对象所满足的性质。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
...
/-
**Real.geom_goldenRatio_isSol_fibRec** 是 Mathlib 中的一个定理，位于命名空间 `Real`。
形式化陈述：geom_goldenRatio_isSol_fibRec : fibRec.IsSolution (φ ^ ·)
该定理/引理描述了相关对象所满足的性质。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
· 使用定理 `LinearRecurrence.geom_sol_iff_root_charPoly`：geom_sol_iff_root_charPoly 
(q : R) : (E.IsSolution fun n => q ^ n) ↔ E.charPoly.IsRoot q
· 使用定理 `Real.fibRec_charPoly_eq`：fibRec_charPoly_eq {β : Type*} [CommRing β] : f
ibRec.charPoly = X ^ 2 - (X + (1 : β[X]))
· 使用定理 `of_eq_true`：∀ {p : Prop}, p = True → p
· 使用定理 `Eq.trans`：∀ {α : Sort u} {a b c : α}, a = b → b = c → a = c
· 使用定理 `congrFun'`：∀ {α : Sort u} {β : Sort v} {f g : α → β}, f = g → ∀ (a : α),
 f a = g a
...
/-
**Real.geom_goldenConj_isSol_fibRec** 是 Mathlib 中的一个定理，位于命名空间 `Real`。
形式化陈述：geom_goldenConj_isSol_fibRec : fibRec.IsSolution (ψ ^ ·)
该定理/引理描述了相关对象所满足的性质。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
...
· 使用定理 `Polynomial.eval_pow`：eval_pow (n : Nat) : (p ^ n).eval x = p.eval x ^ n
· 使用定理 `Polynomial.eval_X`：eval_X : X.eval x = x
· 使用定理 `Real.goldenConj_sq`：goldenConj_sq : ψ ^ 2 = ψ + 1
· 使用定理 `Polynomial.eval_add`：eval_add : (p + q).eval x = p.eval x + q.eval x
· 使用定理 `Polynomial.eval_one`：eval_one : (1 : R[X]).eval x = 1
· 使用定理 `sub_self`：∀ {G : Type u_1} [inst : AddGroup G] (a : G), a - a = 0
· 使用定理 `eq_self`：∀ {α : Sort u_1} (a : α), (a = a) = True
...
/-
**Real.coe_fib_eq'** 是 Mathlib 中的一个定理，位于命名空间 `Real`。
形式化陈述：coe_fib_eq' : (fun n => Nat.fib n : Nat -> Real) = fun n => (φ ^ n - ψ ^ n
) / √5
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `Nat.instAtLeastTwoHAddOfNat`：∀ (n : ℕ) [NeZero n], (n + 1).AtLeastTwo
...
· 使用定理 `congrArg`：∀ {α : Sort u} {β : Sort v} {a₁ a₂ : α} (f : α → β), a₁ = a₂ →
 f a₁ = f a₂
· 使用定理 `LinearRecurrence.eq_iff_eqOn_range_order`：eq_iff_eqOn_range_order (u v :
 Nat -> R) (hu : E.IsSolution u) (hv : E.IsSolution v) : u = v ↔ Set.EqOn u v ↑(
range E.order)
· 使用定理 `Real.fib_isSol_fibRec`：fib_isSol_fibRec : fibRec.IsSolution (fun x => x.
fib : Nat -> α)
...
· 使用定理 `Real.geom_goldenRatio_isSol_fibRec`：geom_goldenRatio_isSol_fibRec : fibR
ec.IsSolution (φ ^ ·)
· 使用定理 `Real.geom_goldenConj_isSol_fibRec`：geom_goldenConj_isSol_fibRec : fibRec
.IsSolution (ψ ^ ·)
· 使用定理 `eq_of_heq`：∀ {α : Sort u} {a a' : α}, a ≍ a' → a = a'
· 使用定理 `Eq.symm`：∀ {α : Sort u} {a b : α}, a = b → b = a
· 使用定理 `funext`：∀ {α : Sort u} {β : α → Sort v} {f g : (x : α) → β x}, (∀ (x : α
...
/-
**Real.coe_fib_eq** 是 Mathlib 中的一个定理，位于命名空间 `Real`。
形式化陈述：coe_fib_eq : forall n, (Nat.fib n : Real) = (φ ^ n - ψ ^ n) / √5
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `Nat.instAtLeastTwoHAddOfNat`：∀ (n : ℕ) [NeZero n], (n + 1).AtLeastTwo
· 使用定理 `Nat.instNeZeroSucc`：∀ {n : ℕ}, NeZero (n + 1)
...
· 使用定理 `funext_iff`：∀ {α : Sort u} {β : α → Sort v} {f g : (x : α) → β x}, f = g
 ↔ ∀ (x : α), f x = g x
· 使用定理 `Real.coe_fib_eq'`：coe_fib_eq' : (fun n => Nat.fib n : Nat -> Real) = fun
 n => (φ ^ n - ψ ^ n) / √5
...
/-
**Real.coe_intFib_eq** 是 Mathlib 中的一个定理，位于命名空间 `Real`。
形式化陈述：coe_intFib_eq (n : Int) : (Int.fib n : Real) = (φ ^ n - ψ ^ n) / √5
参数：n : Int。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
· 使用定理 `Nat.instAtLeastTwoHAddOfNat`：∀ (n : ℕ) [NeZero n], (n + 1).AtLeastTwo
...
· 使用定理 `Real.coe_fib_eq`：coe_fib_eq : forall n, (Nat.fib n : Real) = (φ ^ n - ψ 
^ n) / √5
· 使用定理 `Eq.symm`：∀ {α : Sort u} {a b : α}, a = b → b = a
· 使用定理 `congr`：∀ {α : Sort u} {β : Sort v} {f₁ f₂ : α → β} {a₁ a₂ : α}, f₁ = f₂ 
→ a₁ = a₂ → f₁ a₁ = f₂ a₂
...
· 使用定理 `Real.inv_goldenConj`：inv_goldenConj : ψ⁻¹ = -φ
...
/-
**Real.fib_succ_sub_goldenRatio_mul_fib** 是 Mathlib 中的一个定理，位于命名空间 `Real`。
形式化陈述：fib_succ_sub_goldenRatio_mul_fib (n : Nat) : Nat.fib (n + 1) - φ * Nat.fib
 n = ψ ^ n
参数：n : Nat。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
...
--- 原说明 ---
Relationship between the Fibonacci Sequence, the golden ratio, and its conjugate
's exponents.
-/
...
and its exponents. -/
/-
**Real.goldenConj_mul_fib_succ_add_fib** 是 Mathlib 中的一个引理，位于命名空间 `Real`。
形式化陈述：goldenConj_mul_fib_succ_add_fib (n : Nat) : ψ * Nat.fib (n + 1) + Nat.fib 
n = ψ ^ (n + 1)
参数：n : Nat。
该定理/引理给出了一组等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Real.goldenRatio_mul_fib_succ_add_fib** 是 Mathlib 中的一个引理，位于命名空间 `Real`。
形式化陈述：goldenRatio_mul_fib_succ_add_fib (n : Nat) : φ * Nat.fib (n + 1) + Nat.fib
 n = φ ^ (n + 1)
参数：n : Nat。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
...
and its conjugate. -/
/-
**Real.fib_succ_sub_goldenConj_mul_fib** 是 Mathlib 中的一个定理，位于命名空间 `Real`。
形式化陈述：fib_succ_sub_goldenConj_mul_fib (n : Nat) : Nat.fib (n + 1) - ψ * Nat.fib 
n = φ ^ n
参数：n : Nat。
该定理/引理给出了一组等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
