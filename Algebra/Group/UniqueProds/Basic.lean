...
/--
Definition of `UniqueMul` / `UniqueMul` 的定义

English:
definition UniqueMul
  signature: {G} [Mul G] (A B : Finset G) (a0 b0 : G)
  body: forall ⦃a b⦄, a in A -> b in B -> a * b = a0 * b0 -> a = a0 ∧ b = b0
...
def UniqueMul {G} [Mul G] (A B : Finset G) (a0 b0 : G) : Prop :=
  forall ⦃a b⦄, a in A -> b in B -> a * b = a0 * b0 -> a = a0 ∧ b = b0
...
English:
theorem mono
  given: {A' B' : Finset G} (hA : A subseteq A') (hB : B subseteq B') (h : UniqueMul A' B' a0 b0)
  proof: fun _ _ ha hb he => h (hA ha) (hB hb) he
...
@[to_additive (attr := nontriviality, simp)]
-/
theorem mono {A' B' : Finset G} (hA : A subseteq A') (hB : B subseteq B') (h : UniqueMul A' B' a0 b0) :
...
Depends on / 依赖: UniqueMul, eq_iff_true_of_subsingleton
-/
...
@[to_additive of_card_le_one]
/--
theorem `of_card_le_one` / 定理 `of_card_le_one`

English:
theorem of_card_le_one
  given: (hA : A.Nonempty) (hB : B.Nonempty) (hA1 : #A <= 1) (hB1 : #B <= 1)
  proof: by
...
Depends on / 依赖: Finset, Finset.card_le_one_iff, MonoidWithZeroHom, MonoidWithZeroHom.ext, _map, card_le_one_iff
-/
theorem of_card_le_one (hA : A.Nonempty) (hB : B.Nonempty) (hA1 : #A <= 1) (hB1 : #B <= 1) :
    exists a in A, exists b in B, UniqueMul A B a b := by
  rw [Finset.card_le_one_iff] at hA1 hB1
  obtain ⟨a, ha⟩ := hA; obtain ⟨b, hb⟩ := hB
  exact ⟨a, ha, b, hb, fun _ _ ha' hb' _ => ⟨hA1 ha' ha, hB1 hb' hb⟩⟩
...
English:
theorem mt
  given: (h : UniqueMul A B a0 b0)
  proof: fun _ _ ha hb k => by
  contrapose! k
  exact h ha hb k
...
中文:
定理 mt
  条件: (h : UniqueMul A B a0 b0)
  证明: fun _ _ ha hb k => by
  contrapose! k
  exact h ha hb k

@[to_additive]

Depends on / 依赖: Injective, WithZero, WithZero.forall, contrapose
-/
theorem mt (h : UniqueMul A B a0 b0) :
    forall ⦃a b⦄, a in A -> b in B -> a != a0 ∨ b != b0 -> a * b != a0 * b0 := fun _ _ ha hb k => by
  contrapose! k
  exact h ha hb k
...
theorem subsingleton
  given: (h : UniqueMul A B a0 b0)
  proof: ⟨fun ⟨⟨_a, _b⟩, ha, hb, ab⟩ ⟨⟨_a', _b'⟩, ha', hb', ab'⟩ =>
Subtype.ext
...
定理 subsingleton
  条件: (h : UniqueMul A B a0 b0)
  证明: ⟨fun ⟨⟨_a, _b⟩, ha, hb, ab⟩ ⟨⟨_a', _b'⟩, ha', hb', ab'⟩ =>
Subtype.ext
Prod.ext ((h ha hb ab).1.trans (h ha' hb' ab').1.symm)
        (h ha hb ab).2.trans (h ha' hb' ab').2.symm⟩
...
Depends on / 依赖: Prod.ext, Subtype, Subtype.ext, Surjective, WithZero, WithZero.recZeroCoe, recZeroCoe
-/
theorem subsingleton (h : UniqueMul A B a0 b0) :
    Subsingleton { ab : G × G // ab.1 in A ∧ ab.2 in B ∧ ab.1 * ab.2 = a0 * b0 } :=
...
@[to_additive]
/--
theorem `set_subsingleton` / 定理 `set_subsingleton`

English:
theorem set_subsingleton
  given: (h : UniqueMul A B a0 b0)
  proof: by
  rintro ⟨x1, y1⟩ (hx : x1 in A ∧ y1 in B ∧ x1 * y1 = a0 * b0) ⟨x2, y2⟩
    (hy : x2 in A ∧ y2 in B ∧ x2 * y2 = a0 * b0)
...
theorem set_subsingleton (h : UniqueMul A B a0 b0) :
    Set.Subsingleton { ab : G × G | ab.1 in A ∧ ab.2 in B ∧ ab.1 * ab.2 = a0 * b0 } := by
  rintro ⟨x1, y1⟩ (hx : x1 in A ∧ y1 in B ∧ x1 * y1 = a0 * b0) ⟨x2, y2⟩
    (hy : x2 in A ∧ y2 in B ∧ x2 * y2 = a0 * b0)
  rcases h hx.1 hx.2.1 hx.2.2 with ⟨rfl, rfl⟩
  rcases h hy.1 hy.2.1 hy.2.2 with ⟨rfl, rfl⟩
...
@[to_additive]
/--
theorem `iff_existsUnique` / 定理 `iff_existsUnique`

English:
theorem iff_existsUnique
  given: (aA : a0 in A) (bB : b0 in B)
  proof: ⟨fun _ => ⟨(a0, b0), ⟨Finset.mk_mem_product aA bB, rfl⟩, by simpa⟩,
    fun h => h.elim
      (by
...
Depends on / 依赖: Finset, Finset.mk_mem_product, Prod.mk_inj.mp, h.elim, mk_inj, mk_mem_product
-/
theorem iff_existsUnique (aA : a0 in A) (bB : b0 in B) :
    UniqueMul A B a0 b0 ↔ exists! ab, ab in A ×ˢ B ∧ ab.1 * ab.2 = a0 * b0 :=
...
/--
theorem `iff_card_le_one` / 定理 `iff_card_le_one`

English:
theorem iff_card_le_one
  given: [DecidableEq G] (ha0 : a0 in A) (hb0 : b0 in B)
  proof: by
...
中文:
定理 iff_card_le_one
  条件: [DecidableEq G] (ha0 : a0 in A) (hb0 : b0 in B)
  证明: by
  simp_rw [card_le_one_iff, mem_filter, mem_product]
  refine ⟨fun h p1 p2 ⟨⟨ha1, hb1⟩, he1⟩ ⟨⟨ha2, hb2⟩, he2⟩ => ?_, fun h a b ha hb he => ?_⟩
  · have h1 := h ha1 hb1 he1; have h2 := h ha2 hb2 he2
...
Depends on / 依赖: Prod.ext_iff, card_le_one_iff, ext_iff, mem_filter, mem_product, simp_rw
-/
theorem iff_card_le_one [DecidableEq G] (ha0 : a0 in A) (hb0 : b0 in B) :
    UniqueMul A B a0 b0 ↔ #{p in A ×ˢ B | p.1 * p.2 = a0 * b0} <= 1 := by
  simp_rw [card_le_one_iff, mem_filter, mem_product]
  refine ⟨fun h p1 p2 ⟨⟨ha1, hb1⟩, he1⟩ ⟨⟨ha2, hb2⟩, he2⟩ => ?_, fun h a b ha hb he => ?_⟩
  · have h1 := h ha1 hb1 he1; have h2 := h ha2 hb2 he2
    grind
...
@[to_additive]
/--
theorem `exists_iff_exists_existsUnique` / 定理 `exists_iff_exists_existsUnique`

English:
theorem exists_iff_exists_existsUnique
  proof: ⟨fun ⟨_, _, hA, hB, h⟩ => ⟨_, (iff_existsUnique hA hB).mp h⟩, fun ⟨g, h⟩ => by
    have h' := h
...
Depends on / 依赖: Finset, Finset.mem_product.mp, iff_existsUnique, mem_product
-/
theorem exists_iff_exists_existsUnique :
    (exists a0 b0 : G, a0 in A ∧ b0 in B ∧ UniqueMul A B a0 b0) ↔
      exists g : G, exists! ab, ab in A ×ˢ B ∧ ab.1 * ab.2 = g :=
...
/--
theorem `mulHom_preimage` / 定理 `mulHom_preimage`

English:
theorem mulHom_preimage
  statement: (f : G ->ₙ* H) (hf : Function.Injective f) (a0 b0 : G) {A B : Finset H}
  proof: by
  intro a b ha hb ab
...
Depends on / 依赖: Finset, Finset.mem_preimage.mp, eq_iff, hf.eq_iff, map_mul, mem_preimage
-/
...
/--
theorem `of_mulHom_image` / 定理 `of_mulHom_image`

English:
theorem of_mulHom_image
  statement: [DecidableEq H] (f : G ->ₙ* H)
  proof: fun a b ha hb ab => hf ab
    (h (Finset.mem_image_of_mem f ha) (Finset.mem_image_of_mem f hb) <| by simp_rw [← map_mul, ab])

中文:
定理 of_mulHom_image
  结论: [DecidableEq H] (f : G ->ₙ* H)
  证明: fun a b ha hb ab => hf ab
    (h (Finset.mem_image_of_mem f ha) (Finset.mem_image_of_mem f hb) <| by simp_rw [← map_mul, ab])
-/
@[to_additive] theorem of_mulHom_image [DecidableEq H] (f : G ->ₙ* H)
    (hf : forall ⦃a b c d : G⦄, a * b = c * d -> f a = f c ∧ f b = f d -> a = c ∧ b = d)
...
/--
theorem `mulHom_image_iff` / 定理 `mulHom_image_iff`

English:
theorem mulHom_image_iff
  given: [DecidableEq H] (f : G ->ₙ* H) (hf : Function.Injective f)
  proof: ⟨of_mulHom_image f fun _ _ _ _ _ => .imp (hf ·) (hf ·), fun h _ _ => by
...
Depends on / 依赖: Finset, Finset.mem_image, eq_iff, hf.eq_iff, map_mul, mem_image, of_mulHom_image, simp_rw
-/
...
/--
theorem `mulHom_map_iff` / 定理 `mulHom_map_iff`

English:
theorem mulHom_map_iff
  given: (f : G ↪ H) (mul : forall x y, f (x * y) = f x * f y)
  proof: by
  classical simp_rw [← mulHom_image_iff ⟨f, mul⟩ f.2, Finset.map_eq_image]; rfl

中文:
定理 mulHom_map_iff
  条件: (f : G ↪ H) (mul : 对任意 x y, f (x * y) = f x * f y)
  证明: by
  classical simp_rw [← mulHom_image_iff ⟨f, mul⟩ f.2, Finset.map_eq_image]; rfl

Depends on / 依赖: Finset, Finset.map_eq_image, classical, map_eq_image, mulHom_image_iff, simp_rw
-/
theorem mulHom_map_iff (f : G ↪ H) (mul : forall x y, f (x * y) = f x * f y) :
...
@[to_additive]
/--
theorem `of_mulOpposite` / 定理 `of_mulOpposite`

English:
theorem of_mulOpposite
  proof: fun a b aA bB ab => by
...
中文:
定理 of_mulOpposite
  证明: fun a b aA bB ab => by
  simpa [and_comm] using h (mem_map_of_mem _ bB) (mem_map_of_mem _ aA) (congr_arg op ab)

@[to_additive]

Depends on / 依赖: and_comm, congr_arg, mem_map_of_mem
-/
theorem of_mulOpposite
...
@[to_additive]
/--
theorem `to_mulOpposite` / 定理 `to_mulOpposite`

English:
theorem to_mulOpposite
  given: (h : UniqueMul A B a0 b0)
  proof: of_mulOpposite (by simp_rw [map_map]; exact (mulHom_map_iff _ fun _ _ => by rfl).mpr h)
...
定理 to_mulOpposite
  条件: (h : UniqueMul A B a0 b0)
  证明: of_mulOpposite (by simp_rw [map_map]; exact (mulHom_map_iff _ fun _ _ => by rfl).mpr h)

@[to_additive]

Depends on / 依赖: map_map, mulHom_map_iff, of_mulOpposite, simp_rw
-/
...
@[to_additive]
/--
theorem `iff_mulOpposite` / 定理 `iff_mulOpposite`

English:
theorem iff_mulOpposite
  proof: ⟨of_mulOpposite, to_mulOpposite⟩

中文:
定理 iff_mulOpposite
  证明: ⟨of_mulOpposite, to_mulOpposite⟩

Depends on / 依赖: of_mulOpposite, to_mulOpposite
-/
theorem iff_mulOpposite :
    UniqueMul (B.map ⟨_, op_injective⟩) (A.map ⟨_, op_injective⟩) (op b0) (op a0) ↔
      UniqueMul A B a0 b0 :=
...
@[to_additive]
/--
theorem `of_image_filter` / 定理 `of_image_filter`

English:
theorem of_image_filter
  statement: [DecidableEq H]
  proof: fun a b ha hb he => by
  specialize huH (mem_image_of_mem _ ha) (mem_image_of_mem _ hb)
  rw [← map_mul]; rw [he]; rw [map_mul]; rw [hae]; rw [hbe] at huH
...
定理 of_image_filter
  结论: [DecidableEq H]
  证明: fun a b ha hb he => by
  specialize huH (mem_image_of_mem _ ha) (mem_image_of_mem _ hb)
  rw [← map_mul]; rw [he]; rw [map_mul]; rw [hae]; rw [hbe] at huH
  refine huG ?_ ?_ he <;> rw [mem_filter]
  exacts [⟨ha, (huH rfl).1⟩, ⟨hb, (huH rfl).2⟩]

Depends on / 依赖: exacts, map_mul, mem_filter, mem_image_of_mem, specialize
-/
theorem of_image_filter [DecidableEq H]
    ...
    (huG : UniqueMul {a in A | f a = aH} {b in B | f b = bH} aG bG) :
...
/--
Definition of `UniqueSums` / `UniqueSums` 的定义
...
`UniqueAdd A B a0 b0` -/
  uniqueAdd_of_nonempty :
    forall {A B : Finset G}, A.Nonempty -> B.Nonempty -> exists a0 in A, exists b0 in B, UniqueAdd A B a0 b0

/--
Definition of `UniqueProds` / `UniqueProds` 的定义
...
`UniqueMul A B a0 b0` -/
  uniqueMul_of_nonempty :
    forall {A B : Finset G}, A.Nonempty -> B.Nonempty -> exists a0 in A, exists b0 in B, UniqueMul A B a0 b0

attribute [to_additive] UniqueProds

/--
Definition of `TwoUniqueSums` / `TwoUniqueSums` 的定义
...
/-- For `A B` two finite sets whose product has cardinality at least 2,
  ...
  uniqueAdd_of_one_lt_card : forall {A B : Finset G}, 1 < #A * #B ->
    exists p1 in A ×ˢ B, exists p2 in A ×ˢ B, p1 != p2 ∧ UniqueAdd A B p1.1 p1.2 ∧ UniqueAdd A B p2.1 p2.2

/--
Definition of `TwoUniqueProds` / `TwoUniqueProds` 的定义

English:
class TwoUniqueProds
  parameters: (G) [Mul G]
  (no additional axioms)
...
/-- For `A B` two finite sets whose product has cardinality at least 2,
  we can find at least two unique pairs. -/
  uniqueMul_of_one_lt_card : forall {A B : Finset G}, 1 < #A * #B ->
    exists p1 in A ×ˢ B, exists p2 in A ×ˢ B, p1 != p2 ∧ UniqueMul A B p1.1 p1.2 ∧ UniqueMul A B p2.1 p2.2

attribute [to_additive] TwoUniqueProds

@[to_additive]
/--
lemma `uniqueMul_of_twoUniqueMul` / 引理 `uniqueMul_of_twoUniqueMul`

English:
lemma uniqueMul_of_twoUniqueMul
  statement: {G} [Mul G] {A B : Finset G} (h : 1 < #A * #B ->
  proof: by
...
Depends on / 依赖: Finset, Finset.card_pos, Finset.mem_product, Nat.one_lt_mul_iff.mpr, UniqueMul, UniqueMul.of_card_le_one, card_pos, distrib, mem_product, of_card_le_one, one_lt_mul_iff
-/
lemma uniqueMul_of_twoUniqueMul {G} [Mul G] {A B : Finset G} (h : 1 < #A * #B ->
    exists p1 in A ×ˢ B, exists p2 in A ×ˢ B, p1 != p2 ∧ UniqueMul A B p1.1 p1.2 ∧ UniqueMul A B p2.1 p2.2)
    (hA : A.Nonempty) (hB : B.Nonempty) : exists a in A, exists b in B, UniqueMul A B a b := by
  by_cases! +distrib hc : #A <= 1 ∧ #B <= 1
  · exact UniqueMul.of_card_le_one hA hB hc.1 hc.2
  rw [← Finset.card_pos] at hA hB
  obtain ⟨p, hp, _, _, _, hu, _⟩ := h (Nat.one_lt_mul_iff.mpr ⟨hA, hB, hc⟩)
...
/--
Instance `TwoUniqueProds.toUniqueProds` / 实例 `TwoUniqueProds.toUniqueProds`

English:
instance TwoUniqueProds.toUniqueProds
  signature: (G) [Mul G] [TwoUniqueProds G]
  body: uniqueMul_of_twoUniqueMul uniqueMul_of_one_lt_card
...
English:
abbreviation I
  signature: : Bool -> Type max u v
  body: Bool.rec (ULift.{v} G) (ULift.{u} H)
...
English:
instance :
  signature: forall b, Mul (I G H b)
  body: Bool.rec ULift.mul ULift.mul
...
/--
Definition of `Prod.upMulHom` / `Prod.upMulHom` 的定义

English:
definition Prod.upMulHom
  signature: : G × H ->ₙ* forall b, I G H b
...
-/
@[to_additive] private def Prod.upMulHom : G × H ->ₙ* forall b, I G H b :=
  ⟨fun x => Bool.rec ⟨x.1⟩ ⟨x.2⟩, fun x y => by ext (_ | _) <;> rfl⟩
/--
Definition of `downMulHom` / `downMulHom` 的定义

English:
definition downMulHom
  signature: : ULift G ->ₙ* G
  body: ⟨ULift.down, fun _ _ => rfl⟩
...
/--
theorem `of_mulHom` / 定理 `of_mulHom`
...
@[to_additive] theorem of_mulHom (f : H ->ₙ* G)
    (hf : forall ⦃a b c d : H⦄, a * b = c * d -> f a = f c ∧ f b = f d -> a = c ∧ b = d)
...
@[to_additive]
/--
theorem `of_injective_mulHom` / 定理 `of_injective_mulHom`

English:
theorem of_injective_mulHom
  given: (f : H ->ₙ* G) (hf : Function.Injective f) (_ : UniqueProds G)
  proof: of_mulHom f (fun _ _ _ _ _ => .imp (hf ·) (hf ·))
...
/--
theorem `_root_.MulEquiv.uniqueProds_iff` / 定理 `_root_.MulEquiv.uniqueProds_iff`

English:
theorem _root_.MulEquiv.uniqueProds_iff
  given: (f : G ≃* H)
  statement: UniqueProds G ↔ UniqueProds H
...
Depends on / 依赖: f.injective, f.symm, f.symm.injective, injective, of_injective_mulHom
-/
...
English:
theorem of_mulOpposite
  given: (h : UniqueProds Gᵐᵒᵖ)
  statement: UniqueProds G where
  proof: let f : G ↪ Gᵐᵒᵖ := ⟨op, op_injective⟩
...
中文:
定理 of_mulOpposite
  条件: (h : UniqueProds Gᵐᵒᵖ)
  结论: UniqueProds G where
  证明: let f : G ↪ Gᵐᵒᵖ := ⟨op, op_injective⟩
    let ⟨y, yB, x, xA, hxy⟩ := h.uniqueMul_of_nonempty (hB.map (f := f)) (hA.map (f := f))
    ⟨unop x, (mem_map' _).mp xA, unop y, (mem_map' _).mp yB, hxy.of_mulOpposite⟩

Depends on / 依赖: h.uniqueMul_of_nonempty, hA.map, hB.map, hxy.of_mulOpposite, mem_map, of_mulOpposite, op_injective, uniqueMul_of_nonempty
-/
...
English:
instance [h
  signature: : UniqueProds G] : UniqueProds Gᵐᵒᵖ
  body: of_mulOpposite (MulEquiv.opOp G).uniqueProds_iff.mp h

中文:
实例 [h
  签名: : UniqueProds G] : UniqueProds Gᵐᵒᵖ
  定义体: of_mulOpposite (MulEquiv.opOp G).uniqueProds_iff.mp h
-/
@[to_additive] instance [h : UniqueProds G] : UniqueProds Gᵐᵒᵖ :=
of_mulOpposite (MulEquiv.opOp G).uniqueProds_iff.mp h

/--
theorem `toIsLeftCancelMul` / 定理 `toIsLeftCancelMul`

English:
theorem toIsLeftCancelMul
  given: [UniqueProds G]
  statement: IsLeftCancelMul G where
  proof: by
    classical
    ...
    obtain rfl | rfl := hb
    · exact (hu ha (mem_insert_of_mem <| mem_singlet
...
open MulOpposite in
/--
theorem `toIsCancelMul` / 定理 `toIsCancelMul`

English:
theorem toIsCancelMul
  given: [UniqueProds G]
  statement: IsCancelMul G where
  proof: toIsLeftCancelMul.mul_left_cancel
...
/--
theorem `of_same` / 定理 `of_same`

English:
theorem of_same
  statement: {G} [Semigroup G] [IsCancelMul G]
  proof: by
    classical
...
@[to_additive] theorem of_same {G} [Semigroup G] [IsCancelMul G]
    (h : forall {A : Finset G}, A.Nonempty -> exists a1 in A, exists a2 in A, UniqueMul A A a1 a2) :
    UniqueProds G where
...
/--
theorem `toTwoUniqueProds_of_group` / 定理 `toTwoUniqueProds_of_group`

English:
theorem toTwoUniqueProds_of_group
  statement: {G}
  proof: by
    ...
    have hcard : 1 < #C ∨ 1 < #D := by simp_rw [C, D, card_map

中文:
定理 toTwoUniqueProds_of_group
  结论: {G}
  证明: by
    simp_rw [Nat.one_lt_mul_iff, card_pos] at hc
    obtain ⟨a, ha, b, hb, hu⟩ := uniqueMul_of_nonempty hc.1 hc.2.1
...
@[to_additive] theorem toTwoUniqueProds_of_group {G}
  ...
  uniqueMul_of_one_lt_card {A B} hc := by
    ...
    have hC : 1 in C := mem_map.mpr ⟨a, ha, inv_mul_cancel a⟩
    have hD : 1 in D := mem_map.mpr ⟨b, hb, mul_inv_cancel b⟩
    suffices exists c in C, exists d in D, (c != 1 ∨ d != 1) ∧ UniqueMul C D c d by
      simp_rw [mem_product]
      ...
      rw [mul_assoc]; rw [← mul_assoc a']; rw [he]; rw [mul_assoc]; rw [mul_assoc] at hu'
      exact hu' rfl
    classical
    ...
    · obtain ⟨e, he, f, hf, hu⟩ := this
      ...
      · refine ⟨c1, hc1, d2, hd2, h12, fun c3 d3 hc3 hd3 he => ?_⟩
        ...
        rw [mul_left_cancel_iff]; rw [mul_right_cancel_iff]; rw [mul_assoc]; rw [← mul_assoc c3]; rw [he]; rw [mul_assoc]; rw [mul_assoc] at hu; exact hu rfl
      obtain ⟨rfl, rfl⟩ := h12
...
open UniqueMul in
/--
Instance `instForall` / 实例 `instForall`

English:
instance instForall
  signature: {ι} (G : ι -> Type*) [forall i, Mul (G i)] [forall i, UniqueProds (G i)]
  body: by
    classical
    ...
    by_cases! +distrib hc : #A <= 1 ∧ #B <= 1
    · exact of_card_le_one hA hB hc.1 hc.
...
实例 instForall
  ...
  定义体: by
    ...
    · exact of_card_le_one hA hB hc.1 hc.
-/
@[to_additive] instance instForall {ι} (G : ι -> Type*) [forall i, Mul (G i)] [forall i, UniqueProds (G i)] :
    UniqueProds (forall i, G i) where
  uniqueMul_of_nonempty {A} := by
    ...
    rw [mem_image]; rw [← filter_nonempty_iff] at hA hB
    let A' := {a in A | a i = ai}; let B' := {b in B | b i = bi}
    obtain ⟨a0, ha0, b0, hb0, hu⟩ : exists a0 in A', exists b0 in B', UniqueMul A' B' a0 b0 := by
...
open ULift in
/--
Instance `_root_.Prod.instUniqueProds` / 实例 `_root_.Prod.instUniqueProds`

English:
instance _root_.Prod.instUniqueProds
  signature: [UniqueProds G] [UniqueProds H]
  body: by
...
instance {ι} (G : ι -> Type*) [forall i, AddZeroClass (G i)] [forall i, UniqueSums (G i)] :
    UniqueSums (Π₀ i, G i) :=
...
English:
theorem of_injective_mulHom
  statement: (f : H ->ₙ* G) (hf : Function.Injective f)
  proof: of_mulHom f (fun _ _ _ _ _ => .imp (hf ·) (hf ·))
...
/--
theorem `_root_.MulEquiv.twoUniqueProds_iff` / 定理 `_root_.MulEquiv.twoUniqueProds_iff`

English:
theorem _root_.MulEquiv.twoUniqueProds_iff
  given: (f : G ≃* H)
  statement: TwoUniqueProds G ↔ TwoUniqueProds H
  proof: ⟨of_injective_mulHom f.symm f.symm.injective, of_injective_mulHom f f.injective⟩
...
English:
instance instForall
  signature: {ι} (G : ι -> Type*) [forall i, Mul (G i)] [forall i, TwoUniqueProds (G i)]
  body: by
    classical
    let _ := isWellFounded_ssubset (α := forall i, G i) -- why need this?
...
Depends on / 依赖: IsWellFounded, IsWellFounded.induction, Nat.one_lt_mul_iff.mp, Nat.one_lt_mul_iff.mpr, card_pos, classical, exists_of_one_lt_card_pi, exists_or, exists_or.mpr, hA.image, hB.image, hc.imp, isWellFounded_ssubset, one_lt_mul_iff, uniqueMul_of_one_lt_card
-/
instance instForall {ι} (G : ι -> Type*) [forall i, Mul (G i)] [forall i, TwoUniqueProds (G i)] :
    TwoUniqueProds (forall i, G i) where
  uniqueMul_of_one_lt_card {A} := by
    ...
    · by_cases hA : {a in A | a i = p2.1} = A
      · rw [hA]
        exact ihB _ (hc.2 _)
      · exact ihA _ ((A.filter_subset _).ssubset_of_ne hA)
    · by_cases hA : {a in A | a i = p1.1} = A
      · rw [hA]
        exact ihB _ (hc.2 _)
      · exact ihA _ ((A.filter_subset _).ssubset_of_ne hA)
...
@[to_additive]
/--
Instance `_root_.Prod.instTwoUniqueProds` / 实例 `_root_.Prod.instTwoUniqueProds`

English:
instance _root_.Prod.instTwoUniqueProds
  signature: [TwoUniqueProds G] [TwoUniqueProds H]
  body: by
...
Depends on / 依赖: Bool.rec, Prod.ext, Prod.upMulHom, TwoUniqueProds, TwoUniqueProds.instForall, congr_fun, downMulHom, down_injective, exacts, instForall, of_injective_mulHom, upMulHom, up_injective
-/
...
English:
theorem of_mulOpposite
  given: (h : TwoUniqueProds Gᵐᵒᵖ)
  statement: TwoUniqueProds G where
  proof: by
    let f : G ↪ Gᵐᵒᵖ := ⟨op, op_injective⟩
    rw [← card_map f]; rw [← card_map f]; rw [mul_comm] at hc
    obtain ⟨p1, h1, p2, h2, hne, hu1, hu2⟩ := h.uniqueMul_of_one_lt_card hc
    simp_rw [mem_product] at h1 h2 ⊢
    refine ⟨(_, _), ⟨?_, ?_⟩, (_, _), ⟨?_, ?_⟩, ?_, hu1.of_mulOpposite, hu2.of_

中文:
定理 of_mulOpposite
  条件: (h : TwoUniqueProds Gᵐᵒᵖ)
  结论: TwoUniqueProds G where
  证明: by
    let f : G ↪ Gᵐᵒᵖ := ⟨op, op_injective⟩
    rw [← card_map f]; rw [← card_map f]; rw [mul_comm] at hc
    obtain ⟨p1, h1, p2, h2, hne, hu1, hu2⟩ := h.uniqueMul_of_one_lt_card hc
...
Depends on / 依赖: Prod.ext_iff, all_goals, card_map, contrapose, exacts, ext_iff, h.uniqueMul_of_one_lt_card, hu1.of_mulOpposite, hu2.of_mulOpposite, mem_map, mem_product, mul_comm, of_mulOpposite, op_injective, pick_goal, simp_rw, uniqueMul_of_one_lt_card, unop_injective
-/
...
English:
instance [h
  signature: : TwoUniqueProds G] : TwoUniqueProds Gᵐᵒᵖ
  body: of_mulOpposite (MulEquiv.opOp G).twoUniqueProds_iff.mp h

中文:
实例 [h
  签名: : TwoUniqueProds G] : TwoUniqueProds Gᵐᵒᵖ
  定义体: of_mulOpposite (MulEquiv.opOp G).twoUniqueProds_iff.mp h
-/
...
instance {ι} (G : ι -> Type*) [forall i, AddZeroClass (G i)] [forall i, TwoUniqueSums (G i)] :
