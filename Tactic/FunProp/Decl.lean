...
-/
/-
**Mathlib.Meta.FunProp.FunPropDecl** 是 Mathlib 中的一个归纳类型，位于命名空间 `Mathlib.Meta.Fun
Prop`。
形式化陈述：Type
...
To use `funProp` to prove a function property `P : (α→β)→Prop` one has to provid
e `FunPropDecl`.
-/
...
/-
**Mathlib.Meta.FunProp.FunPropDecls** 是 Mathlib 中的一个结构，位于命名空间 `Mathlib.Meta.FunP
rop`。
形式化陈述：FunPropDecls where /-- Discrimination tree for function properties. -/ dec
ls : DiscrTree FunPropDecl
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-- -/
/-
**Mathlib.Meta.FunProp.FunPropDeclsExt** 是 Mathlib 中的一个缩写定义，位于命名空间 `Mathlib.Meta
.FunProp`。
形式化陈述：FunPropDeclsExt
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Mathlib.Meta.FunProp.addFunPropDecl** 是 Mathlib 中的一个定义，位于命名空间 `Mathlib.Meta.Fu
nProp`。
形式化陈述：addFunPropDecl (declName : Name) : MetaM Unit
参数：declName : Name。
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Mathlib.Meta.FunProp.getFunProp** 是 Mathlib 中的一个定义，位于命名空间 `Mathlib.Meta.FunPro
p`。
形式化陈述：getFunProp? (e : Expr) : MetaM (Option (FunPropDecl × Expr))
参数：e : Expr。
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
Is `e` a function property statement? If yes return function property declaratio
n and
the function it talks about.
-/
...
/-
**Mathlib.Meta.FunProp.isFunProp** 是 Mathlib 中的一个定义，位于命名空间 `Mathlib.Meta.FunProp
`。
形式化陈述：isFunProp (e : Expr) : MetaM Bool
参数：e : Expr。
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Mathlib.Meta.FunProp.isFunPropGoal** 是 Mathlib 中的一个定义，位于命名空间 `Mathlib.Meta.Fun
Prop`。
形式化陈述：isFunPropGoal (e : Expr) : MetaM Bool
参数：e : Expr。
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Mathlib.Meta.FunProp.getFunPropDecl** 是 Mathlib 中的一个定义，位于命名空间 `Mathlib.Meta.Fu
nProp`。
形式化陈述：getFunPropDecl? (e : Expr) : MetaM (Option FunPropDecl)
参数：e : Expr。
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Mathlib.Meta.FunProp.getFunPropFun** 是 Mathlib 中的一个定义，位于命名空间 `Mathlib.Meta.Fun
Prop`。
形式化陈述：getFunPropFun? (e : Expr) : MetaM (Option Expr)
参数：e : Expr。
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Mathlib.Meta.FunProp.tacticToDischarge** 是 Mathlib 中的一个定义，位于命名空间 `Mathlib.Meta
.FunProp`。
形式化陈述：tacticToDischarge (tacticCode : TSyntax `tactic) : Expr -> MetaM (Option E
xpr)
参数：tacticCode : TSyntax `tactic。
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
