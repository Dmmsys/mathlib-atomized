...
/-
**RatFunc.Luroth.** 是 Mathlib 中的一个缩写定义，位于命名空间 `RatFunc.Luroth`。
...
/-
**RatFunc.Luroth.** 是 Mathlib 中的一个引理，位于命名空间 `RatFunc.Luroth`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**RatFunc.Luroth.exists_** 是 Mathlib 中的一个引理，位于命名空间 `RatFunc.Luroth`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**RatFunc.Luroth.generatorIndex** 是 Mathlib 中的一个定义，位于命名空间 `RatFunc.Luroth`。
形式化陈述：generatorIndex (h : E != ⊥) : Nat
参数：h : E != ⊥。
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**RatFunc.Luroth.generator_eq_coeff** 是 Mathlib 中的一个引理，位于命名空间 `RatFunc.Luroth`。
形式化陈述：generator_eq_coeff (h : E != ⊥) : generator E = (φ E).coeff (generatorInde
x h)
参数：h : E != ⊥。
该定理/引理给出了一组等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**RatFunc.Luroth.f** 是 Mathlib 中的一个缩写定义，位于命名空间 `RatFunc.Luroth`。
形式化陈述：f : K[X]
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**RatFunc.Luroth.g** 是 Mathlib 中的一个缩写定义，位于命名空间 `RatFunc.Luroth`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**RatFunc.Luroth.b** 是 Mathlib 中的一个定义，位于命名空间 `RatFunc.Luroth`。
形式化陈述：b : K[X]
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**RatFunc.Luroth.b_ne_zero** 是 Mathlib 中的一个引理，位于命名空间 `RatFunc.Luroth`。
形式化陈述：b_ne_zero : b E != 0
该定理/引理给出了一组等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**RatFunc.Luroth.c** 是 Mathlib 中的一个缩写定义，位于命名空间 `RatFunc.Luroth`。
形式化陈述：c : K⟮X⟯
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
A rational function `c` that satisfies `c * φ = Φ`. This is `ν₀(x)` in Cohn's no
tation.
-/
abbrev c : K⟮X⟯ :=
...
open scoped Classical in
/-
**RatFunc.Luroth.c_ne_zero** 是 Mathlib 中的一个引理，位于命名空间 `RatFunc.Luroth`。
形式化陈述：c_ne_zero (h : E != ⊥) : c E != 0
参数：h : E != ⊥。
该定理/引理给出了一组等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**RatFunc.Luroth.C_c_mul_** 是 Mathlib 中的一个引理，位于命名空间 `RatFunc.Luroth`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
We have `c * φ = Φ` as polynomials with coefficients in `Ratfunc K`. See Equatio
n
  (11.3.5) in Cohn's proof.
-/
lemma C_c_mul_φ (h : E ≠ ⊥) :
...
lemma Φ_coeff_φ_natDegree (h : E ≠ ⊥) :
  ...
  exact this.symm
/-
**RatFunc.Luroth.c_denom** 是 Mathlib 中的一个引理，位于命名空间 `RatFunc.Luroth`。
形式化陈述：c_denom (h : E != ⊥) : (c E).denom = 1
参数：h : E != ⊥。
该定理/引理给出了一组等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**RatFunc.Luroth.generator_denom_dvd_c_num** 是 Mathlib 中的一个引理，位于命名空间 `RatFunc.Lu
roth`。
形式化陈述：generator_denom_dvd_c_num (h : E != ⊥) : (g E) ∣ (c E).num
参数：h : E != ⊥。
该定理/引理描述了相关对象所满足的性质。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**RatFunc.Luroth.le_** 是 Mathlib 中的一个引理，位于命名空间 `RatFunc.Luroth`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**RatFunc.Luroth.m** 是 Mathlib 中的一个缩写定义，位于命名空间 `RatFunc.Luroth`。
形式化陈述：m : Nat
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**RatFunc.Luroth.m_le_swap_** 是 Mathlib 中的一个引理，位于命名空间 `RatFunc.Luroth`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**RatFunc.Luroth.** 是 Mathlib 中的一个实例，位于命名空间 `RatFunc.Luroth`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**RatFunc.Luroth.q** 是 Mathlib 中的一个缩写定义，位于命名空间 `RatFunc.Luroth`。
形式化陈述：q : E[X]
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**RatFunc.Luroth.q_ne_zero** 是 Mathlib 中的一个引理，位于命名空间 `RatFunc.Luroth`。
形式化陈述：q_ne_zero (h : E != ⊥) : q E != 0
参数：h : E != ⊥。
该定理/引理给出了一组等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**RatFunc.Luroth.Q** 是 Mathlib 中的一个引理，位于命名空间 `RatFunc.Luroth`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**RatFunc.Luroth.swap_** 是 Mathlib 中的一个引理，位于命名空间 `RatFunc.Luroth`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
--- 原说明 ---
Equation (11.3.8) from Cohn's proof, viewed as an equation of polynomials with c
oefficients
in `K⟮X⟯`.
-/
lemma Q₀_mul_Φ (h : E ≠ ⊥) :
...
/-
**RatFunc.Luroth.map_Q** 是 Mathlib 中的一个引理，位于命名空间 `RatFunc.Luroth`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
--- 原说明 ---
Equation (11.3.8) from Cohn's proof, viewed as an equation of bivariate polynomi
als.
-/
...
/-
**RatFunc.Luroth.swap_Q** 是 Mathlib 中的一个引理，位于命名空间 `RatFunc.Luroth`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
--- 原说明 ---
Equation (11.3.8) from Cohn's proof, where we view `Q` as a univariate polynomia
l.
-/
