...
/--
Definition of `Besicovitch.SatelliteConfig` / `Besicovitch.SatelliteConfig` 的定义

English:
structure Besicovitch.SatelliteConfig
  parameters: (α : Type*) [MetricSpace α] (N : Nat) (τ : Real)
  axioms and operations (6):
    - c : Fin N.succ -> α
    - r : Fin N.succ -> Real
    - rpos : forall i, 0 < r i
    - h : Pairwise fun i j => r i <= dist (c i) (c j) ∧ r j <= τ * r i ∨ r j <= dist (c j) (c i) ∧ r i <= τ * r j
    - hlast : forall i < last N, r i <= dist (c i) (c (last N)) ∧ r (last N) <= τ * r i
    - inter : forall i < last N, dist (c i) (c (last N)) <= r i + r (last N)
...
-/
structure Besicovitch.SatelliteConfig (α : Type*) [MetricSpace α] (N : Nat) (τ : Real) where
...
meta def evalBesicovitchSatelliteConfigR : PositivityExt where eval {u α} _zα pα? e :=
  ...
  match u, α, e with
  | 0, ~q(Real), ~q(@Besicovitch.SatelliteConfig.r $β $inst $N $τ $self $i) =>
...
/--
Definition of `HasBesicovitchCovering` / `HasBesicovitchCovering` 的定义

English:
class HasBesicovitchCovering
  parameters: (α : Type*) [MetricSpace α]
...
/--
Instance `Besicovitch.SatelliteConfig.instInhabited` / 实例 `Besicovitch.SatelliteConfig.instInhabited`

English:
instance Besicovitch.SatelliteConfig.instInhabited
  signature: {α : Type*} {τ : Real}
  body: ⟨{ c := default
      r := fun _ => 1
...
中文:
实例 Besicovitch.SatelliteConfig.instInhabited
  签名: {α : 类型} {τ : 实数}
  定义体: ⟨{ c := default
      r := fun _ => 1
      rpos := fun _ => zero_lt_one
...
Depends on / 依赖: Subsingleton, Subsingleton.elim, lt_irrefl, zero_lt_one
-/
instance Besicovitch.SatelliteConfig.instInhabited {α : Type*} {τ : Real}
...
variable {α : Type*} [MetricSpace α] {N : Nat} {τ : Real} (a : SatelliteConfig α N τ)
...
theorem inter'
  given: (i : Fin N.succ)
  statement: dist (a.c i) (a.c (last N)) <= a.r i + a.r (last N)
  proof: by
...
Depends on / 依赖: a.inter, a.rpos, add_nonneg, dist_self, lt_or_ge, top_le_iff
-/
...
/--
theorem `hlast'` / 定理 `hlast'`

English:
theorem hlast'
  given: (i : Fin N.succ) (h : 1 <= τ)
  statement: a.r (last N) <= τ * a.r i
  proof: by
  rcases lt_or_ge i (last N) with (H | H)
  · exact (a.hlast i H).2
...
Depends on / 依赖: a.hlast, a.rpos, le_mul_of_one_le_left, lt_or_ge, top_le_iff
-/
...
/--
Definition of `BallPackage` / `BallPackage` 的定义

English:
structure BallPackage
  parameters: (β : Type*) (α : Type*)
  axioms and operations (5):
    - c : β -> α
    - r : β -> Real
    - rpos : forall b, 0 < r b
    - r_bound : Real
    - r_le : forall b, r b <= r_bound
...
/--
Definition of `unitBallPackage` / `unitBallPackage` 的定义

English:
definition unitBallPackage
  signature: (α : Type*)
  body: id
  r _ := 1
  rpos _ := zero_lt_one
...
/--
Instance `BallPackage.instInhabited` / 实例 `BallPackage.instInhabited`

English:
instance BallPackage.instInhabited
  signature: (α : Type*)
  body: ⟨unitBallPackage α⟩

中文:
实例 BallPackage.instInhabited
  签名: (α : 类型)
  定义体: ⟨unitBallPackage α⟩

Depends on / 依赖: unitBallPackage
-/
instance BallPackage.instInhabited (α : Type*) : Inhabited (BallPackage α α) :=
  ⟨unitBallPackage α⟩

/--
Definition of `TauPackage` / `TauPackage` 的定义

English:
structure TauPackage
  parameters: (β : Type*) (α : Type*)
  extends: BallPackage β α
...
/--
Instance `TauPackage.instInhabited` / 实例 `TauPackage.instInhabited`

English:
instance TauPackage.instInhabited
  signature: (α : Type*)
  body: ⟨{ unitBallPackage α with
      τ := 2
      one_lt_tau := one_lt_two }⟩

中文:
实例 TauPackage.instInhabited
  签名: (α : 类型)
  定义体: ⟨{ unitBallPackage α with
      τ := 2
      one_lt_tau := one_lt_two }⟩

Depends on / 依赖: one_lt_tau, one_lt_two, unitBallPackage
-/
...
English:
definition index
  signature: : Ordinal.{u} -> β
  body: ⋃ j : { j // j < i }, ball (p.c (index j)) (p.r (index j))
...
/--
Definition of `iUnionUpTo` / `iUnionUpTo` 的定义

English:
definition iUnionUpTo
  signature: (i : Ordinal.{u})
  body: ⋃ j : { j // j < i }, ball (p.c (p.index j)) (p.r (p.index j))
...
/--
theorem `monotone_iUnionUpTo` / 定理 `monotone_iUnionUpTo`

English:
theorem monotone_iUnionUpTo
  statement: Monotone p.iUnionUpTo
  proof: by
  intro i j hij
...
Depends on / 依赖: Subset, Subset.rfl, iUnionUpTo, iUnion_mono, trans_le
-/
...
definition R
  signature: (i : Ordinal.{u})
  body: iSup fun b : { b : β // p.c b ∉ p.iUnionUpTo i } => p.r b
...
-/
def R (i : Ordinal.{u}) : Real :=
  iSup fun b : { b : β // p.c b ∉ p.iUnionUpTo i } => p.r b

/--
Definition of `color` / `color` 的定义

English:
definition color
  signature: : Ordinal.{u} -> Nat
  body: ⋃ (j : { j // j < i })
...
Depends on / 依赖: Nonempty, closedBall, decreasing_by, p.index, termination_by
-/
noncomputable def color : Ordinal.{u} -> Nat
  | i =>
    let A : Set Nat :=
      ⋃ (j : { j // j < i })
        (_ : (closedBall (p.c (p.index j)) (p.r (p.index j)) inter
...
/--
Definition of `lastStep` / `lastStep` 的定义

English:
definition lastStep
  signature: : Ordinal.{u}
  body: sInf {i | ¬exists b : β, p.c b ∉ p.iUnionUpTo i ∧ p.R i <= p.τ * p.r b}
...
def lastStep : Ordinal.{u} :=
  sInf {i | ¬exists b : β, p.c b ∉ p.iUnionUpTo i ∧ p.R i <= p.τ * p.r b}

/--
theorem `lastStep_nonempty` / 定理 `lastStep_nonempty`
...
theorem lastStep_nonempty
  ...
  simp only [nonempty_def, not_exists, 

中文:
定理 lastStep_nonempty
  证明: by
  by_contra h
  suffices H : Function.Injective p.index from not_injective_of_ordinal p.index H
  intro x y hxy
...
Depends on / 依赖: Classical, Classical.epsilon, Function, Function.Injective, Injective, epsilon, eq_or_lt_of_le, exists_prop, generalizing, hxy.symm, iUnionUpTo, le_of_not_ge, mem_ofPred_eq, nonempty_def, not_and, not_exists, not_forall, not_injective_of_ordinal, not_le, not_lt
-/
theorem lastStep_nonempty :
    {i | ¬exists b : β, p.c b ∉ p.iUnionUpTo i ∧ p.R i <= p.τ * p.r b}.Nonempty := by
  by_contra h
  suffices H : Function.Injective p.index from not_injective_of_ordinal p.index H
  intro x y hxy
  wlog x_le_y : x <= y generalizing x y
...
/--
theorem `mem_iUnionUpTo_lastStep` / 定理 `mem_iUnionUpTo_lastStep`

English:
theorem mem_iUnionUpTo_lastStep
  given: (x : β)
  statement: p.c x in p.iUnionUpTo p.lastStep
  proof: by
  have A : forall z : β, p.c z in p.iUnionUpTo p.lastStep ∨ p.τ * p.r z < p.R p.lastStep := by
    have : p.lastStep in {i | ¬exists b : β, p.c b ∉ p.iUnionUpTo i ∧ p.R i <= p.τ * p.r b} :=
      csInf_mem p.lastStep_nonempty
    simpa only [not_exists, mem_ofPred_eq, not_and_or, not_le, not_notM

中文:
定理 mem_iUnionUpTo_lastStep
  条件: (x : β)
  结论: p.c x in p.iUnionUpTo p.lastStep
  证明: by
  have A : forall z : β, p.c z in p.iUnionUpTo p.lastStep ∨ p.τ * p.r z < p.R p.lastStep := by
    have : p.lastStep in {i | ¬exists b : β, p.c b ∉ p.iUnionUpTo i ∧ p.R i <= p.τ * p.r b} :=
      csInf_mem p.lastStep_nonempty
...
Depends on / 依赖: _root_, _root_.zero_lt_one.trans, csInf_mem, iUnionUpTo, lastStep, lastStep_nonempty, lt_trans, mem_ofPred_eq, mul_pos, not_and_or, not_exists, not_le, not_notMem, one_lt_tau, p.iUnionUpTo, p.lastStep, p.lastStep_nonempty, p.one_lt_tau, p.rpos, zero_lt_one
-/
theorem mem_iUnionUpTo_lastStep (x : β) : p.c x in p.iUnionUpTo p.lastStep := by
  have A : forall z : β, p.c z in p.iUnionUpTo p.lastStep ∨ p.τ * p.r z < p.R p.lastStep := by
    have : p.lastStep in {i | ¬exists b : β, p.c b ∉ p.iUnionUpTo i ∧ p.R i <= p.τ * p.r b} :=
      csInf_mem p.lastStep_nonempty
  ...
  obtain ⟨y, hy1, hy2⟩ : exists y, p.c y ∉ p.iUnionUpTo p.lastStep ∧ p.τ⁻¹ * p.R p.lastStep < p.r y := by
    have := exists_lt_of_lt_csSup ?_ B
    · simpa only [exists_prop, mem_range, exists_exists_and_eq_and, Subtype.exists,
      Subtype.coe_mk]
    rw [← image_univ]; rw [image_nonempty]
...
/--
theorem `color_lt` / 定理 `color_lt`

English:
theorem color_lt
  statement: {i : Ordinal.{u}} (hi : i < p.lastStep) {N : Nat}
  proof: by
...
定理 color_lt
  ...
  /- By contradiction, consider the first ordinal `i` for which one would have `p.color i = N`.
    ...
    Then this family of `N+1
-/
theorem color_lt {i : Ordinal.{u}} (hi : i < p.lastStep) {N : Nat}
  ...
  intro Inf_eq_N
  have :
    forall k, k < N -> exists j, j < i ∧
      (closedBall (p.c (p.index j)) (p.r (p.index j)) inter
  ...
  -- the last ball.
  let G : Nat -> Ordinal := fun n => if n = N then i else g n
  have color_G : forall n, n <= N -> p.color (G n) = n := by
    intro n hn
  ...
  have G_lt_last : forall n, n <= N -> G n < p.lastStep := by
    intro n hn
    rcases hn.eq_or_lt with (rfl | H)
  ...
  have fGn :
    ...
    have :
      ...
      rw [index]; rfl
    rw [this]
    have : exists t, p.c t ∉ p.iUnionUpTo (G n) ∧ p.R (G n) <= p.τ * p.r t := by
  ...
  have Gab :
    forall a b : Fin (Nat.succ N),
      G a < G b ->
        p.r (p.index (G a)) <= dist (p.c (p.index (G a))) (p.c (p.index (G b))) ∧
          p.r (p.index (G b)) <= p.τ * p.r (p.index (G a)) := by
    intro a b G_lt
    have ha : (a : Nat) <= N := Nat.lt_succ_iff.1 a.2
    have hb : (b : Nat) <= N := Nat.lt_succ_iff.1 b.2
    constructor
    · have := (fGn b hb).1
      simp only [iUnionUpTo, not_exists, exists_prop, mem_iUnion, not_and,
    ...
    { c := fun k => p.c (p.index (G k))
      ...
      h := by
        ...
        have G_lt : G a < G b := by
          ...
          have A : (a : Nat) != b := Fin.val_injective.ne a_ne_b
          rw [← color_G a (Nat.lt_succ_iff.1 a.2)]; rw [← color_G b (Nat.lt_succ_iff.1 b.2)]; rw [H] at A
          exact (A rfl).elim
...
/--
theorem `exist_disjoint_covering_families` / 定理 `exist_disjoint_covering_families`

English:
theorem exist_disjoint_covering_families
  statement: {N : Nat} {τ : Real} (hτ : 1 < τ)
  proof: by
  ...
  · refine ⟨fun _ => ∅, fun _ => pairwiseDisjoint_empty, ?_⟩
    rw [← image_univ]; rw [eq_emp

中文:
定理 exist_disjoint_covering_families
  结论: {N : 自然数} {τ : 实数} (hτ : 1 < τ)
  证明: by
  -- first exclude the trivial case where `β` is empty (we need non-emptiness for the transfinite
  -- induction, to be able to choose garbage when there is no point left).
  cases isEmpty_or_nonempty β
  · refine ⟨fun _ => ∅, fun _ => pairwiseDisjoint_empty, ?_⟩
    rw [← image_univ]; rw [eq_emp
-/
theorem exist_disjoint_covering_families {N : Nat} {τ : Real} (hτ : 1 < τ)
    (hN : IsEmpty (SatelliteConfig α N τ)) (q : BallPackage β α) :
    exists s : Fin N -> Set β,
      (forall i : Fin N, (s i).PairwiseDisjoint fun j => closedBall (q.c j) (q.r j)) ∧
        range q.c subseteq ⋃ i : Fin N, ⋃ j in s i, ball (q.c j) (q.r j) := by
  -- first exclude the trivial case where `β` is empty (we need non-emptiness for the transfinite
  -- induction, to be able to choose garbage when there is no point left).
  cases isEmpty_or_nonempty β
  · refine ⟨fun _ => ∅, fun _ => pairwiseDisjoint_empty, ?_⟩
  ...
  · -- show that balls of the same color are disjoint
    ...
    obtain ⟨jx, jx_lt, jxi, rfl⟩ :
      exists jx : Ordinal, jx < p.lastStep ∧ p.color jx = i ∧ x = p.index jx := by
      simpa only [s, exists_prop, mem_iUnion, mem_singleton_iff] using hx
    obtain ⟨jy, jy_lt, jyi, rfl⟩ :
      exists jy : Ordinal, jy < p.lastStep ∧ p.color jy = i ∧ y = p.index jy := by
    ...
    have h : p.color jy in univ \ A := by
      rw [color_j]
      apply csInf_mem
      refine ⟨N, ?_⟩
  ...
  · -- show that the balls of color at most `N` cover every center.
    ...
    obtain ⟨a, ha⟩ :
      exists a : Ordinal, a < p.lastStep ∧ dist (p.c b) (p.c (p.index a)) < p.r (p.index a) := by
...
/--
theorem `exist_finset_disjoint_balls_large_measure` / 定理 `exist_finset_disjoint_balls_large_measure`

English:
theorem exist_finset_disjoint_balls_large_measure
  statement: (μ : Measure α) [IsFiniteMeasure μ] {N : Nat}
  proof: by
  classical
...
-/
theorem exist_finset_disjoint_balls_large_measure (μ : Measure α) [IsFiniteMeasure μ] {N : Nat}
    {τ : Real} (hτ : 1 < τ) (hN : IsEmpty (SatelliteConfig α N τ)) (s : Set α) (r : α -> Real)
    (rpos : forall x in s, 0 < r x) (rle : forall x in s, r x <= 1) :
    exists t : Finset α, ↑t subseteq s ∧ μ (s \ ⋃ x in t, closedBall x (r x)) <= N / (N + 1) * μ s ∧
  ...
  obtain ⟨o, so, omeas, μo⟩ : exists o : Set α, s subseteq o ∧ MeasurableSet o ∧ μ o = μ s :=
  ...
  have u_count : forall i, (u i).Countable := by
    intro i
  ...
  let v : Fin N -> Set α := fun i => ⋃ (x : s) (_ : x in u i), closedBall x (r x)
  have A : s = ⋃ i : Fin N, s inter v i := by
    refine Subset.antisymm ?_ (iUnion_subset fun i => inter_subset_left)
    intro x hx
    obtain ⟨i, y, hxy, h'⟩ :
        exists (i : Fin N) (i_1 : ↥s), i_1 in u i ∧ x in ball (↑i_1) (r ↑i_1) := by
      have : x in range a.c := by simpa only [a, Subtype.range_coe_subtype, ofPred_mem_eq]
  ...
  have S : ∑ _i : Fin N, μ s / N <= ∑ i, μ (s inter v i) :=
    calc
      ∑ _i : Fin N, μ s / N = μ s := by
        ...
        · finiteness
      _ <= ∑ i, μ (s inter v i) := by
        conv_lhs => rw [A]
        apply measure_iUnion_fintype_le
  -- choose an index `i` of a subfamily covering at least a proportion `1/N` of `s`.
  obtain ⟨i, -, hi⟩ : exists (i : Fin N), i in Finset.univ ∧ μ s / N <= μ (s inter v i) := by
    apply ENNReal.exists_le_of_sum_le _ S
    exact ⟨⟨0, bot_lt_iff_ne_bot.2 Npos⟩, Finset.mem_univ _⟩
  replace hi : μ s / (N + 1) < μ (s inter v i) := by
    grw [← hi, ← _root_.zero_lt_one, add_zero] <;> finiteness
  have B : μ (o inter v i) = ∑' x : u i, μ (o inter closedBall x (r x)) := by
    have : o inter v i = ⋃ (x : s) (_ : x in u i), o inter closedBall x (r x) := by
  ...
  obtain ⟨w, hw⟩ :
    exists w : Finset (u i), μ s / (N + 1) <
      ∑ x in w, μ (o inter closedBall (x : α) (r (x : α))) := by
    have C : HasSum (fun x : u i => μ (o inter closedBall x (r x))) (μ (o inter v i)) := by
      rw [B]; exact ENNReal.summable.hasSum
    have : μ s / (N + 1) < μ (o inter v i) := hi.trans_le (measure_mono (inter_subset_inter_left _ so))
  ...
  · suffices H : μ (o \ ⋃ x in w, closedBall (↑x) (r ↑x)) <= N / (N + 1) * μ s by
      rw [Finset.set_biUnion_finset_image]
      exact le_trans (measure_mono (sdiff_subset_sdiff so (Subset.refl _))) H
    rw [← sdiff_inter_self_eq_sdiff]; rw [measure_sdiff_le_iff_le_add _ inter_subset_right (by finiteness)]
    swap
    · exact .inter
    ...
    calc
      μ o = 1 / (N + 1) * μ s + N / (N + 1) * μ s := by
        rw [μo]; rw [← add_mul]; rw [ENNReal.div_add_div_same]; rw [add_comm]; rw [ENNReal.div_self]; rw [one_mul] <;> simp
      _ <= μ ((⋃ x in w, closedBall (↑x) (r ↑x)) inter o) + N / (N + 1) * μ s := by
        gcongr
        rw [one_div]; rw [mul_comm]; rw [← div_eq_mul_inv]
  ...
  · intro k hk l hl hkl
    obtain ⟨k', _, rfl⟩ : exists k' : u i, k' in w ∧ ↑k' = k := by
      simpa only [mem_image, Finset.mem_coe, Finset.coe_image] using hk
    obtain ⟨l', _, rfl⟩ : exists l' : u i, l' in w ∧ ↑l' = l := by
...
/--
theorem `exists_disjoint_closedBall_covering_ae_of_finiteMeasure_aux` / 定理 `exists_disjoint_closedBall_covering_ae_of_finiteMeasure_aux`

English:
theorem exists_disjoint_closedBall_covering_ae_of_finiteMeasure_aux
  ...
  let P : Finset (α × Real) -> Prop := fun t =>
    ((t : Set (α × Rea
...
Depends on / 依赖: HasBesicovitchCovering, HasBesicovitchCovering.no_satelliteConfig, classical, no_satelliteConfig
-/
theorem exists_disjoint_closedBall_covering_ae_of_finiteMeasure_aux (μ : Measure α)
    [IsFiniteMeasure μ] (f : α -> Set Real) (s : Set α)
    (hf : forall x in s, forall δ > 0, (f x inter Ioo 0 δ).Nonempty) :
    exists t : Set (α × Real), t.Countable ∧ (forall p in t, p.1 in s) ∧ (forall p in t, p.2 in f p.1) ∧
      μ (s \ ⋃ (p : α × Real) (_ : p in t), closedBall p.1 p.2) = 0 ∧
  ...
  /- Introduce a property `P` on finsets saying that we have a nice disjoint covering of a
      subset of `s` by admissible balls. -/
  let P : Finset (α × Real) -> Prop := fun t =>
    ((t : Set (α × Real)).PairwiseDisjoint fun p => closedBall p.1 p.2) ∧
      (forall p : α × Real, p in t -> p.1 in s) ∧ forall p : α × Real, p in t -> p.2 in f p.1
  /- Given a finite good covering of a subset `s`, one can find a larger finite good covering,
    ...
    covering. -/
  have :
      forall t : Finset (α × Real), P t -> exists u : Finset (α × Real), t subseteq u ∧ P u ∧
        μ (s \ ⋃ (p : α × Real) (_ : p in u), closedBall p.1 p.2) <=
          N / (N + 1) * μ (s \ ⋃ (p : α × Real) (_ : p in t), closedBall p.1 p.2) := by
    intro t ht
    set B := ⋃ (p : α × Real) (_ : p in t), closedBall p.1 p.2 with hB
    have B_closed : IsClosed B := isClosed_biUnion_finset fun i _ => isClosed_closedBall
    set s' := s \ B
    have : forall x in s', exists r in f x inter Ioo 0 1, Disjoint B (closedBall x r) := by
      intro x hx
      have xs : x in s := ((mem_sdiff x).1 hx).1
    ...
    obtain ⟨v, vs', hμv, hv⟩ :
      exists v : Finset α,
        ↑v subseteq s' ∧
          μ (s' \ ⋃ x in v, closedBall x (r x)) <= N / (N + 1) * μ s' ∧
            (v : Set α).PairwiseDisjoint fun x : α => closedBall x (r x) :=
      haveI rI : forall x in s', r x in Ioo (0 : Real) 1 := fun x hx => (hr x hx).1.2
      exist_finset_disjoint_balls_large_measure μ hτ hN s' r (fun x hx => (rI x hx).1) fun x hx =>
        (rI x hx).2.le
    refine ⟨t union Finset.image (fun x => (x, r x)) v, Finset.subset_union_left, ⟨?_, ?_, ?_⟩, ?_⟩
    · simp only [Finset.coe_union, pairwiseDisjoint_union, ht.1, true_and, Finset.coe_image]
      ...
      · intro p hp q hq hpq
        ...
        exact subset_biUnion_of_mem (u := fun x : α × Real => closedBall x.1 x.2) hp
    · intro p hp
    ...
    · convert! hμv using 2
      rw [Finset.set_biUnion_union]; rw [← sdiff_sdiff]; rw [Finset.set_biUnion_finset_image]
  ...
  let u n := F^[n] ∅
  have u_succ : forall n : Nat, u n.succ = F (u n) := fun n => by
    simp only [u, Function.comp_apply, Function.iterate_succ']
  have Pu : forall n, P (u n) := by
    intro n
    induction n with
    | zero =>
  ...
  · have A :
      forall n,
        μ (s \ ⋃ (p : α × Real) (_ : p in ⋃ n : Nat, (u n : Set (α × Real))), closedBall p.fst p.snd) <=
          μ (s \ ⋃ (p : α × Real) (_ : p in u n), closedBall p.fst p.snd) := by
      intro n
      gcongr μ (s \ ?_)
      exact biUnion_subset_biUnion_left (subset_iUnion (fun i => (u i : Set (α × Real))) n)
    have B :
        forall n, μ (s \ ⋃ (p : α × Real) (_ : p in u n), closedBall p.fst p.snd) <=
          (N / (N + 1) : Real>=0∞) ^ n * μ s := fun n => by
      induction n with
      | zero =>
      ...
      | succ n IH =>
        calc
          _ <= N / (N + 1) * μ (s \ ⋃ (p : α × Real) (_ : p in u n), closedBall p.fst p.snd) := by
            rw [u_succ]; exact (hF (u n) (Pu n)).2.2
          _ <= _ := by grw [pow_succ', mul_assoc, IH]
    have C : Tendsto (fun n : Nat => ((N : Real>=0∞) / (N + 1)) ^ n * μ s) atTop (𝓝 (0 * μ s)) := by
      apply ENNReal.Tendsto.mul_const _ (Or.inr (measure_lt_top μ s).ne)
      apply ENNReal.tendsto_pow_atTop_nhds_zero_of_lt_one
      rw [ENNReal.div_lt_iff]; rw [one_mul]
      · conv_lhs => rw [← add_zero (N : Real>=0∞)]
...
/--
theorem `exists_disjoint_closedBall_covering_ae_aux` / 定理 `exists_disjoint_closedBall_covering_ae_aux`

English:
theorem exists_disjoint_closedBall_covering_ae_aux
  statement: (μ : Measure α) [SFinite μ] (f : α -> Set Real)
  proof: by
...
定理 exists_disjoint_closedBall_covering_ae_aux
  ...
  rcases exists_disjoint_closedBall_covering_ae_of_finit
-/
theorem exists_disjoint_closedBall_covering_ae_aux (μ : Measure α) [SFinite μ] (f : α -> Set Real)
    (s : Set α) (hf : forall x in s, forall δ > 0, (f x inter Ioo 0 δ).Nonempty) :
    exists t : Set (α × Real), t.Countable ∧ (forall p in t, p.1 in s) ∧ (forall p in t, p.2 in f p.1) ∧
      μ (s \ ⋃ (p : α × Real) (_ : p in t), closedBall p.1 p.2) = 0 ∧
        t.PairwiseDisjoint fun p => closedBall p.1 p.2 := by
  /- This is deduced from the finite measure case, by using a finite measure with respect to which
...
/--
theorem `exists_disjoint_closedBall_covering_ae` / 定理 `exists_disjoint_closedBall_covering_ae`
...
Depends on / 依赖: Nonempty, exists_disjoint_closedBall_covering_ae_aux, graphOn, lt_min, min_le_left, min_le_right, trans_le, v_count, v_disj
-/
theorem exists_disjoint_closedBall_covering_ae (μ : Measure α) [SFinite μ] (f : α -> Set Real)
    (s : Set α) (hf : forall x in s, forall δ > 0, (f x inter Ioo 0 δ).Nonempty) (R : α -> Real)
    (hR : forall x in s, 0 < R x) :
    exists (t : Set α) (r : α -> Real), t.Countable ∧ t subseteq s ∧
      (forall x in t, r x in f x inter Ioo 0 (R x)) ∧ μ (s \ ⋃ x in t, closedBall x (r x)) = 0 ∧
  ...
  obtain ⟨r, t, rfl⟩ : exists (r : α -> Real) (t : Set α), v = graphOn r t := by
    have I : forall p in v, 0 <= p.2 := fun p hp => (vg p hp).2.1.le
...
/--
theorem `exists_closedBall_covering_tsum_measure_le` / 定理 `exists_closedBall_covering_tsum_measure_le`

English:
theorem exists_closedBall_covering_tsum_measure_le
...
theorem exists_closedBall_covering_tsum_measure_le (μ : Measure α) [SFinite μ]
    [Measure.OuterRegular μ] {ε : Real>=0∞} (hε : ε != 0) (f : α -> Set Real) (s : Set α)
    (hf : forall x in s, forall δ > 0, (f x inter Ioo 0 δ).Nonempty) :
    exists (t : Set α) (r : α -> Real), t.Countable ∧ t subseteq s ∧ (forall x in t, r x in f x) ∧
      (s subseteq ⋃ x in t, closedBall x (r x)) ∧ (∑' x : t, μ (closedBall x (r x))) <= μ s + ε := by
  /- For the proof, first cover almost all `s` with disjoint balls thanks to the usual Besicovitch
    theorem. Taking the balls included in a well-chosen open neighborhood `u` of `s`, one may
    ensure that their measures add at most to `μ s + ε / 2`. Let `s'` be the remaining set, of
  ...
  classical
  obtain ⟨u, su, u_open, μu⟩ : exists U, U ⊇ s ∧ IsOpen U ∧ μ U <= μ s + ε / 2 :=
    Set.exists_isOpen_le_add _ _
      (by
        simpa only [or_false, Ne, ENNReal.div_eq_zero_iff, ENNReal.ofNat_ne_top] using hε)
  have : forall x in s, exists R > 0, ball x R subseteq u := fun x hx =>
    Metric.mem_nhds_iff.1 (u_open.mem_nhds (su hx))
  choose! R hR using this
  obtain ⟨t0, r0, t0_count, t0s, hr0, μt0, t0_disj⟩ :
    exists (t0 : Set α) (r0 : α -> Real), t0.Countable ∧ t0 subseteq s ∧
      (forall x in t0, r0 x in f x inter Ioo 0 (R x)) ∧ μ (s \ ⋃ x in t0, closedBall x (r0 x)) = 0 ∧
  ...
  -- remaining set.
  let s' := s \ ⋃ x in t0, closedBall x (r0 x)
  have s's : s' subseteq s := sdiff_subset
  obtain ⟨N, τ, hτ, H⟩ : exists N τ, 1 < τ ∧ IsEmpty (Besicovitch.SatelliteConfig α N τ) :=
    HasBesicovitchCovering.no_satelliteConfig
  obtain ⟨v, s'v, v_open, μv⟩ : exists v, v ⊇ s' ∧ IsOpen v ∧ μ v <= μ s' + ε / 2 / N :=
    Set.exists_isOpen_le_add _ _
      (by simp only [ne_eq, ENNReal.div_eq_zero_iff, hε, ENNReal.ofNat_ne_top, or_self,
          ENNReal.natCast_ne_top, not_false_eq_true])
  have : forall x in s', exists r1 in f x inter Ioo (0 : Real) 1, closedBall x r1 subseteq v := by
    intro x hx
  ...
  obtain ⟨S, S_disj, hS⟩ :
    exists S : Fin N -> Set s',
      (forall i : Fin N, (S i).PairwiseDisjoint fun j => closedBall (q.c j) (q.r j)) ∧
        range q.c subseteq ⋃ i : Fin N, ⋃ j in S i, ball (q.c j) (q.r j) :=
    exist_disjoint_covering_families hτ H q
  have S_count : forall i, (S i).Countable := by
    intro i
    apply (S_disj i).countable_of_nonempty_interior fun j _ => ?_
    have : (ball (j : α) (r1 j)).Nonempty := nonempty_ball.2 (q.rpos _)
    exact this.mono ball_subset_interior_closedBall
  let r x := if x in s' then r1 x else r0 x
  have r_t0 : forall x in t0, r x = r0 x := by
    intro x hx
have : x ∉ s' := fun hxs' => hxs'.2 mem_iUnion₂.2
  ...
  -- second steps.
  refine ⟨t0 union ⋃ i : Fin N, ((↑) : s' -> α) '' S i, r, ?_, ?_, ?_, ?_, ?_⟩
  ...
  · intro x hx
    by_cases h'x : x in s'
    · obtain ⟨i, y, ySi, xy⟩ : exists (i : Fin N) (y : ↥s'), y in S i ∧ x in ball (y : α) (r1 y) := by
        have A : x in range q.c := by
    ...
    · obtain ⟨y, yt0, hxy⟩ : exists y : α, y in t0 ∧ x in closedBall y (r0 y) := by
  ...
  · -- the sets in the first step have measure at most `μ s + ε / 2`
    ...
    have B : forall i : Fin N, (∑' x : ((↑) : s' -> α) '' S i, μ (closedBall x (r x))) <= ε / 2 / N :=
      fun i =>
      calc
    ...
    calc
      (∑' x : ↥(t0 union ⋃ i : Fin N, ((↑) : s' -> α) '' S i), μ (closedBall x (r x))) <=
...
English:
definition vitaliFamily
  signature: (μ : Measure α) [SFinite μ]
  body: (fun r : Real => closedBall x r) '' Ioi (0 : Real)
  ...
  nontrivial x ε εpos := ⟨closedBall x ε, 
...
protected def vitaliFamily (μ : Measure α) [SFinite μ] : VitaliFamily μ where
  setsAt x := (fun r : Real => closedBall x r) '' Ioi (0 : Real)
  measurableSet _ := forall_mem_image.2 fun _ _ => isClosed_closedBall.measurableSet
  nonempty_interior _ := forall_mem_image.2 fun _ rpos =>
    (nonempty_ball.2 rpos).mono ball_subset_interior_closedBall
  ...
  covering := by
    ...
    let g : α -> Set Real := fun x => {r | 0 < r ∧ closedBall x r in f x}
    have A : forall x in s, forall δ > 0, (g x inter Ioo 0 δ).Nonempty := by
      intro x xs δ δpos
      obtain ⟨t, tf, ht⟩ : exists (t : Set α), t in f x ∧ t subseteq closedBall x (δ / 2) :=
        ffine x xs (δ / 2) (half_pos δpos)
      obtain ⟨r, rpos, rfl⟩ : exists r : Real, 0 < r ∧ closedBall x r = t := by simpa using fsubset x xs tf
    ...
    obtain ⟨t, r, _, ts, tg, μt, tdisj⟩ :
      exists (t : Set α) (r : α -> Real),
        t.Countable ∧
          t subseteq s ∧
            (forall x in t, r x in g x inter Ioo 0 1) ∧
              μ (s \ ⋃ x in t, closedBall x (r x)) = 0 ∧
...
/--
theorem `tendsto_filterAt` / 定理 `tendsto_filterAt`

English:
theorem tendsto_filterAt
  given: (μ : Measure α) [SFinite μ] (x : α)
  proof: by
  intro s hs
  simp only [mem_map]
  obtain ⟨ε, εpos, hε⟩ :
    exists (ε : Real), ε > 0 ∧
      forall a : Set α, a in (Besicovitch.vitaliFamily μ).setsAt x -> a subseteq closedBall x ε -> a in s :=
...
Depends on / 依赖: Besicovitch, Besicovitch.vitaliFamily, Ioc_mem_nhdsGT, VitaliFamily, VitaliFamily.mem_filterAt_iff, closedBall, closedBall_subset_closedBall, filter_upwards, mem_filterAt_iff, mem_image_of_mem, mem_map, setsAt, subseteq, vitaliFamily
-/
...
theorem ae_tendsto_rnDeriv
  given: (ρ μ : Measure β) [IsLocallyFiniteMeasure μ] [IsLocallyFiniteMeasure ρ]
  proof: by
...
Depends on / 依赖: Besicovitch, Besicovitch.vitaliFamily, VitaliFamily, VitaliFamily.ae_tendsto_rnDeriv, ae_tendsto_rnDeriv, filter_upwards, hx.comp, tendsto_filterAt, vitaliFamily
-/
...
theorem ae_tendsto_measure_inter_div_of_measurableSet
  statement: (μ : Measure β) [IsLocallyFiniteMeasure μ]
  proof: by
...
Depends on / 依赖: Besicovitch, Besicovitch.vitaliFamily, VitaliFamily, VitaliFamily.ae_tendsto_measure_inter_div_of_measurableSet, ae_tendsto_measure_inter_div_of_measurableSet, filter_upwards, hx.comp, tendsto_filterAt, vitaliFamily
-/
theorem ae_tendsto_measure_inter_div_of_measurableSet (μ : Measure β) [IsLocallyFiniteMeasure μ]
    {s : Set β} (hs : MeasurableSet s) :
    forallᵐ x ∂μ,
      Tendsto (fun r => μ (s inter closedBall x r) / μ (closedBall x r)) (𝓝[>] 0)
...
theorem ae_tendsto_measure_inter_div
  given: (μ : Measure β) [IsLocallyFiniteMeasure μ] (s : Set β)
  proof: by
...
Depends on / 依赖: Besicovitch, Besicovitch.vitaliFamily, VitaliFamily, VitaliFamily.ae_tendsto_measure_inter_div, ae_tendsto_measure_inter_div, filter_upwards, hx.comp, tendsto_filterAt, vitaliFamily
-/
theorem ae_tendsto_measure_inter_div (μ : Measure β) [IsLocallyFiniteMeasure μ] (s : Set β) :
    forallᵐ x ∂μ.restrict s,
      Tendsto (fun r => μ (s inter closedBall x r) / μ (closedBall x r)) (𝓝[>] 0) (𝓝 1) := by
  filter_upwards [VitaliFamily.ae_tendsto_measure_inter_div (Besicovitch.vitaliFamily μ) s] with x
    hx using hx.comp (tendsto_filterAt μ x)
