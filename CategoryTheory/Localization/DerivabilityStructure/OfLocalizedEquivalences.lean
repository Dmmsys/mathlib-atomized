...
/--
lemma `isLeftDerivabilityStructure_of_isLocalizedEquivalence` / 引理 `isLeftDerivabilityStructure_of_isLocalizedEquivalence`
...
/--
lemma `isLeftDerivabilityStructure_iff_of_isLocalizedEquivalence` / 引理 `isLeftDerivabilityStructure_iff_of_isLocalizedEquivalence`
...
set_option backward.isDefEq.respectTransparency.types false in
/--
lemma `isRightDerivabilityStructure_of_isLocalizedEquivalence` / 引理 `isRightDerivabilityStructure_of_isLocalizedEquivalence`
...
set_option backward.isDefEq.respectTransparency.types false in
/--
lemma `isRightDerivabilityStructure_iff_of_isLocalizedEquivalence` / 引理 `isRightDerivabilityStructure_iff_of_isLocalizedEquivalence`
...
set_option backward.isDefEq.respectTransparency.types false in
/--
lemma `isLeftDerivabilityStructure_of_equivalences` / 引理 `isLeftDerivabilityStructure_of_equivalences`
...
中文:
引理 isLeftDerivabilityStructure_of_equivalences
  证明: by
  have := L.isLocalizedEquivalence_of_isInduced
  have := R.isLocalizedEquivalence_of_isInduced
  exact isLeftDerivabilityStructure_of_isLocalizedEquivalence iso

Depends on / 依赖: L.isLocalizedEquivalence_of_isInduced, R.isLocalizedEquivalence_of_isInduced, isLeftDerivabilityStructure_of_isLocalizedEquivalence, isLocalizedEquivalence_of_isInduced
-/
lemma isLeftDerivabilityStructure_of_equivalences
    [T.IsLeftDerivabilityStructure]
    (iso : T.functor ⋙ R.functor ≅ L.functor ⋙ B.functor) :
...
/--
lemma `isLeftDerivabilityStructure_iff_of_equivalences` / 引理 `isLeftDerivabilityStructure_iff_of_equivalences`

English:
lemma isLeftDerivabilityStructure_iff_of_equivalences
  proof: ⟨fun _ => isLeftDerivabilityStructure_of_equivalences iso, fun _ => by
...
引理 isLeftDerivabilityStructure_iff_of_equivalences
  证明: ⟨fun _ => isLeftDerivabilityStructure_of_equivalences iso, fun _ => by
    let e : B.functor ⋙ R.inv.functor ≅ L.inv.functor ⋙ T.functor :=
      (leftUnitor _).symm ≪≫
        isoWhiskerRight L.functor.asEquivalence.counitIso.symm _ ≪≫
        associator _ _ _ ≪≫ isoWhiskerLeft _ (associator _ _ _)
...
/--
lemma `isRightDerivabilityStructure_iff_of_equivalences` / 引理 `isRightDerivabilityStructure_iff_of_equivalences`
...
中文:
引理 isRightDerivabilityStructure_iff_of_equivalences
  证明: by
  let e : T.op.functor ⋙ R.op.functor ≅ L.op.functor ⋙ B.op.functor := NatIso.op iso.symm
  simp only [isRightDerivabilityStructure_iff_op,
    isLeftDerivabilityStructure_iff_of_equivalences e]

Depends on / 依赖: B.op.functor, L.op.functor, NatIso, NatIso.op, R.op.functor, T.op.functor, functor, isLeftDerivabilityStructure_iff_of_equivalences, isRightDerivabilityStructure_iff_op, iso.symm
-/
lemma isRightDerivabilityStructure_iff_of_equivalences
    (iso : T.functor ⋙ R.functor ≅ L.functor ⋙ B.functor) :
    T.IsRightDerivabilityStructure ↔ B.IsRightDerivabilityStructure := by
...
/--
lemma `isRightDerivabilityStructure_of_equivalences` / 引理 `isRightDerivabilityStructure_of_equivalences`
...
中文:
引理 isRightDerivabilityStructure_of_equivalences
  证明: by
  rwa [← isRightDerivabilityStructure_iff_of_equivalences iso]

Depends on / 依赖: isRightDerivabilityStructure_iff_of_equivalences
-/
lemma isRightDerivabilityStructure_of_equivalences
    [T.IsRightDerivabilityStructure]
    (iso : T.functor ⋙ R.functor ≅ L.functor ⋙ B.functor) :
