...
@[simps]
/--
Instance `Monad.algebraPreadditive` / 实例 `Monad.algebraPreadditive`

English:
instance Monad.algebraPreadditive
  signature: : Preadditive (Monad.Algebra T) where
  body: { add α β :=
        { f := α.f + β.f
...
Depends on / 依赖: Algebra, Functor, Functor.map_add, Functor.map_neg, Functor.map_nsmul, Functor.map_sub, Functor.map_zero, Monad.Algebra.Hom.h, add_comp, comp_add, comp_neg, comp_nsmul, comp_sub, comp_zero, map_add, map_neg, map_nsmul, map_sub, map_zero, neg_comp
-/
...
/--
Instance `Monad.forget_additive` / 实例 `Monad.forget_additive`

English:
instance Monad.forget_additive
...
@[simps]
/--
Instance `Comonad.coalgebraPreadditive` / 实例 `Comonad.coalgebraPreadditive`

English:
instance Comonad.coalgebraPreadditive
  signature: : Preadditive (Comonad.Coalgebra U) where
  body: { add α β :=
        { f := α.f + β.f
...
Depends on / 依赖: Coalgebra, Comonad, Comonad.Coalgebra.Hom, Comonad.Coalgebra.Hom.h, Functor, Functor.map_add, Functor.map_neg, Functor.map_nsmul, Functor.map_sub, Functor.map_zero, add_comp, comp_add, comp_neg, comp_nsmul, comp_sub, comp_zero, map_add, map_neg, map_nsmul, map_sub
-/
...
/--
Instance `Comonad.forget_additive` / 实例 `Comonad.forget_additive`

English:
instance Comonad.forget_additive
