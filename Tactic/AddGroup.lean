...
/--
theorem `_zsmul_neg_trick` / 定理 `_zsmul_neg_trick`

English:
theorem _zsmul_neg_trick
  given: {G : Type*} [AddGroup G] (b : G) (n : Int)
  proof: by
...
Depends on / 依赖: DiscreteTopology, TopologicalSpace, add_zsmul, discrete, neg_one_zsmul
-/
theorem _zsmul_neg_trick {G : Type*} [AddGroup G] (b : G) (n : Int) :
    n • b + (-b) = (n + (-1)) • b := by
  rw [← neg_one_zsmul b]; rw [← add_zsmul]

/--
theorem `_neg_zsmul_trick` / 定理 `_neg_zsmul_trick`

English:
theorem _neg_zsmul_trick
  given: {G : Type*} [AddGroup G] (b : G) (n : Int)
  proof: by
  rw [← neg_one_zsmul b]; rw [← add_zsmul]
...
Depends on / 依赖: add_zsmul, neg_one_zsmul
-/
theorem _neg_zsmul_trick {G : Type*} [AddGroup G] (b : G) (n : Int) :
    (-b) + n • b = ((-1) + n) • b := by
  rw [← neg_one_zsmul b]; rw [← add_zsmul]

/--
theorem `_neg_neg_trick` / 定理 `_neg_neg_trick`

English:
theorem _neg_neg_trick
  given: {G : Type*} [AddGroup G] (b : G)
  proof: by
...
/--
theorem `_add_zsmul_neg_trick` / 定理 `_add_zsmul_neg_trick`

English:
theorem _add_zsmul_neg_trick
  given: {G : Type*} [AddGroup G] (a b : G) (n : Int)
  proof: by
...
Depends on / 依赖: _zsmul_neg_trick, add_assoc
-/
theorem _add_zsmul_neg_trick {G : Type*} [AddGroup G] (a b : G) (n : Int) :
    a + n • b + (-b) = a + (n + (-1)) • b := by
  rw [add_assoc]; rw [_zsmul_neg_trick]

/--
theorem `_add_neg_zsmul_trick` / 定理 `_add_neg_zsmul_trick`

English:
theorem _add_neg_zsmul_trick
  given: {G : Type*} [AddGroup G] (a b : G) (n : Int)
  proof: by
...
Depends on / 依赖: _neg_zsmul_trick, add_assoc
-/
theorem _add_neg_zsmul_trick {G : Type*} [AddGroup G] (a b : G) (n : Int) :
    a + (-b) + n • b = a + ((-1) + n) • b := by
  rw [add_assoc]; rw [_neg_zsmul_trick]

/--
theorem `_add_neg_neg_trick` / 定理 `_add_neg_neg_trick`

English:
theorem _add_neg_neg_trick
  given: {G : Type*} [AddGroup G] (a b : G)
  proof: by
...
Depends on / 依赖: _neg_neg_trick, add_assoc
-/
