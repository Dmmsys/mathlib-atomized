...
definition iIndepSets
  ...
  body: forall (s : Finset ι) {f : ι -> Set Ω} (_H : forall i, i in s -> f i in π i),
...
definition IndepSets
  signature: {_mΩ : MeasurableSpace Ω}
  body: forall t1 t2 : Set Ω, t1 in s1 -> t2 in s2 -> (forallᵐ a ∂μ, κ a (t1 inter t2) = κ a t1 * κ a t2)
...
def IndepSets {_mΩ : MeasurableSpace Ω}
  ...
  forall t1 t2 : Set Ω, t1 in s1 -> t2 in s2 -> (forallᵐ a ∂μ, κ a (t1 inter t2) = κ a t1 * κ a t2)
...
English:
definition iIndep
  signature: (m : ι -> MeasurableSpace Ω) {_mΩ : MeasurableSpace Ω} (κ : Kernel α Ω)
  body: iIndepSets (fun x => {s | MeasurableSet[m x] s}) κ μ
...
English:
definition Indep
  signature: (m₁ m₂ : MeasurableSpace Ω) {_mΩ : MeasurableSpace Ω} (κ : Kernel α Ω)
  body: IndepSets {s | MeasurableSet[m₁] s} {s | MeasurableSet[m₂] s} κ μ
...
definition iIndepSet
  signature: {_mΩ : MeasurableSpace Ω} (s : ι -> Set Ω) (κ : Kernel α Ω)
  body: iIndep (m := fun i => generateFrom {s i}) κ μ
...
English:
definition IndepSet
  signature: {_mΩ : MeasurableSpace Ω} (s t : Set Ω) (κ : Kernel α Ω)
  body: Indep (generateFrom {s}) (generateFrom {t}) κ μ
...
/--
lemma `iIndepSets_zero_right` / 引理 `iIndepSets_zero_right`

English:
lemma iIndepSets_zero_right
  statement: iIndepSets π κ 0
  proof: by simp [iIndepSets]

中文:
引理 iIndepSets_zero_right
  结论: iIndepSets π κ 0
  证明: by simp [iIndepSets]
-/
@[simp] lemma iIndepSets_zero_right : iIndepSets π κ 0 := by simp [iIndepSets]

/--
lemma `indepSets_zero_right` / 引理 `indepSets_zero_right`

English:
lemma indepSets_zero_right
  statement: IndepSets s1 s2 κ 0
  proof: by simp [IndepSets]

中文:
引理 indepSets_zero_right
  结论: IndepSets s1 s2 κ 0
  证明: by simp [IndepSets]
-/
@[simp] lemma indepSets_zero_right : IndepSets s1 s2 κ 0 := by simp [IndepSets]

/--
lemma `indepSets_zero_left` / 引理 `indepSets_zero_left`

English:
lemma indepSets_zero_left
  statement: IndepSets s1 s2 (0 : Kernel α Ω) μ
  proof: by simp [IndepSets]
...
/--
lemma `iIndep_zero_right` / 引理 `iIndep_zero_right`

English:
lemma iIndep_zero_right
  statement: iIndep m κ 0
  proof: by simp [iIndep]

中文:
引理 iIndep_zero_right
  结论: iIndep m κ 0
  证明: by simp [iIndep]
-/
...
/--
lemma `indep_zero_right` / 引理 `indep_zero_right`

English:
lemma indep_zero_right
  statement: {m₁ m₂ : MeasurableSpace Ω} {_mΩ : MeasurableSpace Ω}
  proof: by simp [Indep]
...
/--
lemma `indep_zero_left` / 引理 `indep_zero_left`

English:
lemma indep_zero_left
  given: {m₁ m₂ : MeasurableSpace Ω} {_mΩ : MeasurableSpace Ω}
  proof: by simp [Indep]
...
/--
lemma `iIndepSet_zero_right` / 引理 `iIndepSet_zero_right`

English:
lemma iIndepSet_zero_right
  statement: iIndepSet s κ 0
  proof: by simp [iIndepSet]

中文:
引理 iIndepSet_zero_right
  结论: iIndepSet s κ 0
  证明: by simp [iIndepSet]
-/
@[simp] lemma iIndepSet_zero_right : iIndepSet s κ 0 := by simp [iIndepSet]

/--
lemma `indepSet_zero_right` / 引理 `indepSet_zero_right`

English:
lemma indepSet_zero_right
  given: {s t : Set Ω}
  statement: IndepSet s t κ 0
  proof: by simp [IndepSet]
...
/--
lemma `indepSet_zero_left` / 引理 `indepSet_zero_left`

English:
lemma indepSet_zero_left
  given: {s t : Set Ω}
  statement: IndepSet s t (0 : Kernel α Ω) μ
  proof: by
  simp [IndepSet]
...
/--
lemma `iIndepSets_congr` / 引理 `iIndepSets_congr`

English:
lemma iIndepSets_congr
  given: (h : κ =ᵐ[μ] η)
  statement: iIndepSets π κ μ ↔ iIndepSets π η μ
  proof: by
  peel 3
...
引理 iIndepSets_congr
  条件: (h : κ =ᵐ[μ] η)
  结论: iIndepSets π κ μ ↔ iIndepSets π η μ
  证明: by
  peel 3
  refine ⟨fun h' => ?_, fun h' => ?_⟩ <;>
  · filter_upwards [h, h'] with a ha h'a
...
/--
lemma `indepSets_congr` / 引理 `indepSets_congr`

English:
lemma indepSets_congr
  given: (h : κ =ᵐ[μ] η)
  statement: IndepSets s1 s2 κ μ ↔ IndepSets s1 s2 η μ
  proof: by
  peel 4
  refine ⟨fun h' => ?_, fun h' => ?_⟩ <;>
  · filter_upwards [h, h'] with a ha h'a
...
引理 indepSets_congr
  条件: (h : κ =ᵐ[μ] η)
  结论: IndepSets s1 s2 κ μ ↔ IndepSets s1 s2 η μ
  证明: by
  peel 4
  refine ⟨fun h' => ?_, fun h' => ?_⟩ <;>
  · filter_upwards [h, h'] with a ha h'a
...
/--
lemma `iIndep_congr` / 引理 `iIndep_congr`

English:
lemma iIndep_congr
  given: (h : κ =ᵐ[μ] η)
  statement: iIndep m κ μ ↔ iIndep m η μ
  proof: iIndepSets_congr h
...
引理 iIndep_congr
  条件: (h : κ =ᵐ[μ] η)
  结论: iIndep m κ μ ↔ iIndep m η μ
  证明: iIndepSets_congr h

alias ⟨iIndep.congr, _⟩ := iIndep_congr

Depends on / 依赖: iIndepSets_congr
-/
...
/--
lemma `indep_congr` / 引理 `indep_congr`

English:
lemma indep_congr
  statement: {m₁ m₂ : MeasurableSpace Ω} {_mΩ : MeasurableSpace Ω}
  proof: indepSets_congr h
...
/--
lemma `iIndepSet_congr` / 引理 `iIndepSet_congr`

English:
lemma iIndepSet_congr
  given: (h : κ =ᵐ[μ] η)
  statement: iIndepSet s κ μ ↔ iIndepSet s η μ
...
引理 iIndepSet_congr
  条件: (h : κ =ᵐ[μ] η)
  结论: iIndepSet s κ μ ↔ iIndepSet s η μ
  证明: iIndep_congr h
...
/--
lemma `indepSet_congr` / 引理 `indepSet_congr`

English:
lemma indepSet_congr
  given: {s t : Set Ω} (h : κ =ᵐ[μ] η)
  statement: IndepSet s t κ μ ↔ IndepSet s t η μ
  proof: indep_congr h
...
lemma iIndepSets.meas_biInter
  statement: (h : iIndepSets π κ μ) (s : Finset ι)
  proof: h s hf
...
lemma iIndepSets.meas_biInter (h : iIndepSets π κ μ) (s : Finset ι)
    {f : ι -> Set Ω} (hf : forall i, i in s -> f i in π i) :
    forallᵐ a ∂μ, κ a (⋂ i in s, f i) = ∏ i in s, κ a (f i) := h s hf

/--
lemma `iIndepSets.ae_isProbabilityMeasure` / 引理 `iIndepSets.ae_isProbabilityMeasure`

English:
lemma iIndepSets.ae_isProbabilityMeasure
  given: (h : iIndepSets π κ μ)
  proof: by
  filter_upwards [h.meas_biInter ∅ (f := fun _ => Set.univ) (by simp)] with a ha
  exact ⟨by simpa using ha⟩

中文:
引理 iIndepSets.ae_isProbabilityMeasure
  条件: (h : iIndepSets π κ μ)
  证明: by
  filter_upwards [h.meas_biInter ∅ (f := fun _ => Set.univ) (by simp)] with a ha
  exact ⟨by simpa using ha⟩

Depends on / 依赖: Set.univ, filter_upwards, h.meas_biInter, meas_biInter
-/
lemma iIndepSets.ae_isProbabilityMeasure (h : iIndepSets π κ μ) :
    forallᵐ a ∂μ, IsProbabilityMeasure (κ a) := by
  filter_upwards [h.meas_biInter ∅ (f := fun _ => Set.univ) (by simp)] with a ha
  exact ⟨by simpa using ha⟩
...
lemma iIndepSets.meas_iInter
  given: [Fintype ι] (h : iIndepSets π κ μ) (hs : forall i, s i in π i)
  proof: by
...
引理 iIndepSets.meas_i整数er
  ...
  filter_upwards [h.meas_biInter Finset.univ (fun _i _ => hs _)] with a ha using by simp [← ha]
-/
lemma iIndepSets.meas_iInter [Fintype ι] (h : iIndepSets π κ μ) (hs : forall i, s i in π i) :
    forallᵐ a ∂μ, κ a (⋂ i, s i) = ∏ i, κ a (s i) := by
  filter_upwards [h.meas_biInter Finset.univ (fun _i _ => hs _)] with a ha using by simp [← ha]
...
/--
lemma `iIndep.ae_isProbabilityMeasure` / 引理 `iIndep.ae_isProbabilityMeasure`

English:
lemma iIndep.ae_isProbabilityMeasure
  given: (h : iIndep m κ μ)
  proof: h.iIndepSets'.ae_isProbabilityMeasure

中文:
引理 iIndep.ae_isProbabilityMeasure
  条件: (h : iIndep m κ μ)
  证明: h.iIndepSets'.ae_isProbabilityMeasure

Depends on / 依赖: ae_isProbabilityMeasure, h.iIndepSets, iIndepSets
-/
...
lemma iIndep.meas_biInter
  given: (hμ : iIndep m κ μ) (hs : forall i, i in S -> MeasurableSet[m i] (s i))
  proof: hμ _ hs
...
lemma iIndep.meas_biInter (hμ : iIndep m κ μ) (hs : forall i, i in S -> MeasurableSet[m i] (s i)) :
    forallᵐ a ∂μ, κ a (⋂ i in S, s i) = ∏ i in S, κ a (s i) := hμ _ hs
...
lemma iIndep.meas_iInter
  given: [Fintype ι] (h : iIndep m κ μ) (hs : forall i, MeasurableSet[m i] (s i))
  proof: by
...
@[nontriviality, simp]
-/
lemma iIndep.meas_iInter [Fintype ι] (h : iIndep m κ μ) (hs : forall i, MeasurableSet[m i] (s i)) :
    forallᵐ a ∂μ, κ a (⋂ i, s i) = ∏ i, κ a (s i) := by
  filter_upwards [h.meas_biInter (fun i (_ : i in Finset.univ) => hs _)] with a ha
  simp [← ha]
...
lemma iIndepSets.of_subsingleton
  statement: [Subsingleton ι] {m : ι -> Set (Set Ω)} {κ : Kernel α Ω}
  proof: by
  rintro s f hf
...
lemma iIndep.of_subsingleton
  statement: [Subsingleton ι] {m : ι -> MeasurableSpace Ω} {κ : Kernel α Ω}
  proof: by simp [iIndep]
...
lemma iIndepSets.precomp
  given: (hg : Function.Injective g) (h : iIndepSets π κ μ)
  proof: by
  intro s f hf
  let f' := Function.extend g f fun _ => ∅
  have f'_apply x : f' (g x) = f x := hg.extend_apply ..
  classical
  have hf' : forall i in s.image g, f' i in π i := by
...
lemma iIndepSets.of_precomp
  given: (hg : Function.Surjective g) (h : iIndepSets (π ∘ g) κ μ)
  proof: by
  obtain ⟨g', hg'⟩ := hg.hasRightInverse
  convert! h.precomp hg'.injective
  rw [Function.comp_assoc]; rw [hg'.comp_eq_id]; rw [Function.comp_id]
...
lemma iIndep.precomp
  given: (hg : Function.Injective g) (h : iIndep m κ μ)
  proof: (iIndepSets.precomp hg h :)
...
lemma iIndep.of_precomp
  given: (hg : Function.Surjective g) (h : iIndep (m ∘ g) κ μ)
  proof: iIndepSets.of_precomp hg h
...
lemma iIndepSet.precomp
  given: (hg : Function.Injective g) (h : iIndepSet s κ μ)
...
lemma iIndepSet.of_precomp
  given: (hg : Function.Surjective g) (h : iIndepSet (s ∘ g) κ μ)
...
theorem IndepSets.symm
  statement: {_mΩ : MeasurableSpace Ω} {κ : Kernel α Ω} {μ : Measure α}
  proof: by
  intro t1 t2 ht1 ht2
...
English:
theorem Indep.symm
  statement: {m₁ m₂ : MeasurableSpace Ω} {_mΩ : MeasurableSpace Ω} {κ : Kernel α Ω}
...
theorem indep_bot_right
  statement: (m' : MeasurableSpace Ω) {_mΩ : MeasurableSpace Ω}
  proof: by
  intro s t _ ht
...
Depends on / 依赖: Eventually, Filter, Filter.Eventually.of_forall, MeasurableSpace, MeasurableSpace.measurableSet_bot_iff, Set.inter_empty, Set.inter_univ, Set.mem_ofPred_eq, eq_zero_or_isMarkovKernel, inter_empty, inter_univ, measurableSet_bot_iff, measure_empty, measure_univ, mem_ofPred_eq, mul_one, mul_zero, of_forall
-/
...
theorem indepSet_empty_right
  statement: {_mΩ : MeasurableSpace Ω}
  proof: by
...
Depends on / 依赖: IndepSet, generateFrom_singleton_empty, indep_bot_right
-/
...
theorem indepSet_empty_left
  statement: {_mΩ : MeasurableSpace Ω} {κ : Kernel α Ω}
  proof: (indepSet_empty_right s).symm
...
theorem indepSets_of_indepSets_of_le_left
  statement: {s₁ s₂ s₃ : Set (Set Ω)} {_mΩ : MeasurableSpace Ω}
  proof: fun t1 t2 ht1 ht2 => h_indep t1 t2 (Set.mem_of_subset_of_mem h31 ht1) ht2
...
theorem indepSets_of_indepSets_of_le_left {s₁ s₂ s₃ : Set (Set Ω)} {_mΩ : MeasurableSpace Ω}
    {κ : Kernel α Ω} {μ : Measure α} (h_indep : IndepSets s₁ s₂ κ μ) (h31 : s₃ subseteq s₁) :
    IndepSets s₃ s₂ κ μ :=
...
theorem indepSets_of_indepSets_of_le_right
  statement: {s₁ s₂ s₃ : Set (Set Ω)} {_mΩ : MeasurableSpace Ω}
  proof: fun t1 t2 ht1 ht2 => h_indep t1 t2 ht1 (Set.mem_of_subset_of_mem h32 ht2)
...
theorem indepSets_of_indepSets_of_le_right {s₁ s₂ s₃ : Set (Set Ω)} {_mΩ : MeasurableSpace Ω}
    {κ : Kernel α Ω} {μ : Measure α} (h_indep : IndepSets s₁ s₂ κ μ) (h32 : s₃ subseteq s₂) :
    IndepSets s₁ s₃ κ μ :=
...
theorem indep_of_indep_of_le_left
  statement: {m₁ m₂ m₃ : MeasurableSpace Ω} {_mΩ : MeasurableSpace Ω}
  proof: fun t1 t2 ht1 ht2 => h_indep t1 t2 (h31 _ ht1) ht2
...
theorem indep_of_indep_of_le_right
  statement: {m₁ m₂ m₃ : MeasurableSpace Ω} {_mΩ : MeasurableSpace Ω}
  proof: fun t1 t2 ht1 ht2 => h_indep t1 t2 ht1 (h32 _ ht2)
...
theorem indep_of_indep_of_le
  statement: {m₁ m₂ m₃ m₄ : MeasurableSpace Ω} {_mΩ : MeasurableSpace Ω}
  proof: indep_of_indep_of_le_left (indep_of_indep_of_le_right h_indep h42) h31
...
theorem iIndep_of_iIndep_of_le
  statement: {m₁ m₂ : ι -> MeasurableSpace Ω} {_mΩ : MeasurableSpace Ω}
  proof: fun s t ht => h_indep s fun i hi => h_le i (t i) ht i hi
...
theorem iIndep_of_iIndep_of_le {m₁ m₂ : ι -> MeasurableSpace Ω} {_mΩ : MeasurableSpace Ω}
    {κ : Kernel α Ω} {μ : Measure α} (h_indep : iIndep m₂ κ μ) (h_le : forall i, m₁ i <= m₂ i) :
    iIndep m₁ κ μ :=
...
theorem IndepSets.union_iff {s₁ s₂ s' : Set (Set Ω)} {_mΩ : MeasurableSpace Ω}
    {κ : Kernel α Ω} {μ : Measure α} :
    IndepSets (s₁ union s₂) s' κ μ ↔ IndepSets s₁ s' κ μ ∧ IndepSets s₂ s' κ μ :=
  ⟨fun h =>
    ⟨indepSets_of_indepSets_of_le_left h Set.subset_union_left,
      indepSets_of_indepSets_of_le_left h Set.subset_union_right⟩,
    fun h => IndepSets.union h.left h.right⟩
...
theorem IndepSets.iUnion
  statement: {s : ι -> Set (Set Ω)} {s' : Set (Set Ω)} {_mΩ : MeasurableSpace Ω}
  proof: by
  intro t1 t2 ht1 ht2
...
theorem IndepSets.iUnion {s : ι -> Set (Set Ω)} {s' : Set (Set Ω)} {_mΩ : MeasurableSpace Ω}
    {κ : Kernel α Ω} {μ : Measure α} (hyp : forall n, IndepSets (s n) s' κ μ) :
...
theorem IndepSets.biUnion {s : ι -> Set (Set Ω)} {s' : Set (Set Ω)} {_mΩ : MeasurableSpace Ω}
    {κ : Kernel α Ω} {μ : Measure α} {u : Set ι} (hyp : forall n in u, IndepSets (s n) s' κ μ) :
    IndepSets (⋃ n in u, s n) s' κ μ := by
  intro t1 t2 ht1 ht2
  simp_rw [Set.mem_iUnion] at ht1
  rcases ht1 with ⟨n, hpn, ht1⟩
  exact hyp n hpn t1 t2 ht1 ht2
...
theorem IndepSets.inter
  statement: {s₁ s' : Set (Set Ω)} (s₂ : Set (Set Ω)) {_mΩ : MeasurableSpace Ω}
  proof: fun t1 t2 ht1 ht2 => h₁ t1 t2 ((Set.mem_inter_iff _ _ _).mp ht1).left ht2
...
theorem IndepSets.iInter {s : ι -> Set (Set Ω)} {s' : Set (Set Ω)} {_mΩ : MeasurableSpace Ω}
    {κ : Kernel α Ω} {μ : Measure α} (h : exists n, IndepSets (s n) s' κ μ) :
    IndepSets (⋂ n, s n) s' κ μ := by
  intro t1 t2 ht1 ht2; obtain ⟨n, h⟩ := h; exact h t1 t2 (Set.mem_iInter.mp ht1 n) ht2
...
theorem IndepSets.bInter {s : ι -> Set (Set Ω)} {s' : Set (Set Ω)} {_mΩ : MeasurableSpace Ω}
    {κ : Kernel α Ω} {μ : Measure α} {u : Set ι} (h : exists n in u, IndepSets (s n) s' κ μ) :
    IndepSets (⋂ n in u, s n) s' κ μ := by
  intro t1 t2 ht1 ht2
  rcases h with ⟨n, hn, h⟩
  exact h t1 t2 (Set.biInter_subset_of_mem hn ht1) ht2
...
theorem iIndep_comap_mem_iff
  statement: {f : ι -> Set Ω} {_mΩ : MeasurableSpace Ω}
  proof: by
...
Depends on / 依赖: generateFrom_singleton, iIndepSet, simp_rw
-/
theorem iIndep_comap_mem_iff {f : ι -> Set Ω} {_mΩ : MeasurableSpace Ω}
    {κ : Kernel α Ω} {μ : Measure α} :
    iIndep (fun i => MeasurableSpace.comap (· in f i) ⊤) κ μ ↔ iIndepSet f κ μ := by
  simp_rw [← generateFrom_singleton, iIndepSet]
...
theorem iIndepSets_singleton_iff
  statement: {s : ι -> Set Ω} {_mΩ : MeasurableSpace Ω}
  proof: by
  refine ⟨fun h S => h S (fun i _ => rfl), fun h S f hf => ?_⟩
  filter_upwards [h S] with a ha
  have : forall i in S, κ a (f i) = κ a (s i) := fun i hi => by rw [hf i hi]
...
Depends on / 依赖: Finset, Finset.prod_congr, Set.iInter, filter_upwards, prod_congr
-/
theorem iIndepSets_singleton_iff {s : ι -> Set Ω} {_mΩ : MeasurableSpace Ω}
    {κ : Kernel α Ω} {μ : Measure α} :
    iIndepSets (fun i => {s i}) κ μ ↔
      forall S : Finset ι, forallᵐ a ∂μ, κ a (⋂ i in S, s i) = ∏ i in S, κ a (s i) := by
  refine ⟨fun h S => h S (fun i _ => rfl), fun h S f hf => ?_⟩
  filter_upwards [h S] with a ha
  have : forall i in S, κ a (f i) = κ a (s i) := fun i hi => by rw [hf i hi]
  rwa [Finset.prod_congr rfl this, Set.iInter₂_congr hf]
...
theorem indepSets_singleton_iff
  statement: {s t : Set Ω} {_mΩ : MeasurableSpace Ω}
  proof: ⟨fun h => h s t rfl rfl,
...
Depends on / 依赖: Set.mem_singleton_iff.mp, mem_singleton_iff
-/
theorem indepSets_singleton_iff {s t : Set Ω} {_mΩ : MeasurableSpace Ω}
    {κ : Kernel α Ω} {μ : Measure α} :
    IndepSets {s} {t} κ μ ↔ forallᵐ a ∂μ, κ a (s inter t) = κ a s * κ a t :=
  ⟨fun h => h s t rfl rfl,
   fun h s1 t1 hs1 ht1 => by rwa [Set.mem_singleton_iff.mp hs1, Set.mem_singleton_iff.mp ht1]⟩
...
theorem iIndepSets.indepSets
  statement: {s : ι -> Set (Set Ω)} {_mΩ : MeasurableSpace Ω}
  proof: by
  classical
  intro t₁ t₂ ht₁ ht₂
  have hf_m : forall x : ι, x in ({i, j} : Finset ι) -> ite (x = i) t₁ t₂ in s x := by
    intro x hx
    rcases Finset.mem_insert.mp hx with hx | hx
    · simp [hx, ht₁]
    · simp [Finset.mem_singleton.mp hx, hij.symm, ht₂]
  have h_inter : ⋂ (t : ι) (_ : t in 
...
theorem iIndepSets.indepSets {s : ι -> Set (Set Ω)} {_mΩ : MeasurableSpace Ω}
  ...
  have hf_m : forall x : ι, x in ({i, j} : Finset ι) -> ite (x = i) t₁ t₂ in s x := by
    ...
    · simp [hx, ht₁]
    · simp [Finset.mem_singleton.mp hx, hij.symm, ht₂]
  have h_inter : ⋂ (t : ι) (_ : t in ({i, j} : Finset ι)), ite (t = i) t₁ t₂ =
      ite (i = i) t₁ t₂ inter ite (j = i) t₁ t₂ := by
...
theorem iIndep.indep
  statement: {m : ι -> MeasurableSpace Ω} {_mΩ : MeasurableSpace Ω}
  proof: iIndepSets.indepSets h_indep hij
...
theorem iIndep.iIndepSets {_mΩ : MeasurableSpace Ω}
    ...
    {s : ι -> Set (Set Ω)} (hms : forall n, m n = generateFrom (s n)) (h_indep : iIndep m κ μ) :
    iIndepSets s κ μ :=
  fun S f hfs =>
  h_indep S fun x hxS =>
    ((hms x).symm ▸ measurableSet_generateFrom (hfs x hxS) : MeasurableSet[m x] (f x))
...
/--
theorem `IndepSets.indep_aux` / 定理 `IndepSets.indep_aux`

English:
theorem IndepSets.indep_aux
  statement: {m₂ m : MeasurableSpace Ω}
  proof: by
  rcases eq_zero_or_isMarkovKernel κ with rfl | h
  · simp
  ...
  | compl u hu ihu =>
    ...
    rw [← Set.sdiff_eq]; rw [← Set.sdiff_self_inter]; rw [measu
...
Depends on / 依赖: ENNReal, ENNReal.mul_sub, Set.sdiff_eq, Set.sdiff_self_inter, eq_zero_or_isMarkovKernel, filter_upwards, ht1m.inter, induction_on_inter, inter_subset_left, measure_compl, measure_ne_top, measure_sdiff, measure_univ, mul_one, mul_sub, nullMeasurableSet, sdiff_eq, sdiff_self_inter
-/
theorem IndepSets.indep_aux {m₂ m : MeasurableSpace Ω}
    ...
    (ht1 : t1 in p1) (ht1m : MeasurableSet[m] t1) (ht2m : MeasurableSet[m₂] t2) :
    forallᵐ a ∂μ, κ a (t1 inter t2) = κ a t1 * κ a t2 := by
  rcases eq_zero_or_isMarkovKernel κ with rfl | h
  · simp
  induction t2, ht2m using induction_on_inter hpm2 hp2 with
  | empty => simp
  ...
  | compl u hu ihu =>
    filter_upwards [ihu] with a ha
    rw [← Set.sdiff_eq]; rw [← Set.sdiff_self_inter]; rw [measure_sdiff inter_subset_left (ht1m.inter (h2 _ hu)).nullMeasurableSet (measure_ne_top _ _)]; rw [ha]; rw [measure_compl (h2 _ hu) (measure_ne_top _ _)]; rw [measure_univ]; rw [ENNReal.mul_sub]; rw [mul_one]
    exact fun _ _ => measure_ne_top _ _
  | iUnion f hfd hfm ihf =>
    rw [← ae_all_iff] at ihf
    filter_upwards [ihf] with a ha
    rw [inter_iUnion]; rw [measure_iUnion]; rw [measure_iUnion hfd fun i => h2 _ (hfm i)]
...
theorem IndepSets.indep
  statement: {m1 m2 m : MeasurableSpace Ω} {κ : Kernel α Ω} {μ : Measure α}
  proof: by
  rcases eq_zero_or_isMarkovKernel κ with rfl | h
  · simp
  intro t1 t2 ht1 ht2
  ...
  | basic t ht =>
    refine IndepSets.indep_aux h2 hp2 hpm2 hy
...
theorem IndepSets.indep {m1 m2 m : MeasurableSpace Ω} {κ : Kernel α Ω} {μ : Measure α}
  ...
  | compl t ht iht =>
    ...
    have : tᶜ inter t2 = t2 \ (t inter t2) := by
      rw [Set.inter_comm t]; rw [Set.sdiff_self_inter]; rw [Set.sdiff_eq_compl_inter]
    rw [this]; rw [Set.inter_comm t t2]; rw [measure_sdiff Set.inter_subset_left ((h2 _ ht2).inter (h1 _ ht)).nullMeasurableSet
...
theorem IndepSets.indep'
  statement: {_mΩ : MeasurableSpace Ω}
  proof: hyp.indep (generateFrom_le hp1m) (generateFrom_le hp2m) hp1 hp2 rfl rfl
...
theorem indepSets_piiUnionInter_of_disjoint
  ...
  classical
  let g i := ite (i in p1) (f1 i) Set.univ inter ite (i in p2) (f2 i) Set.univ
  have h_P_inter : forallᵐ a ∂μ, κ a (t1 inter t2) = ∏ n in p1 union p2, κ a (g n) := by
...
Depends on / 依赖: Finset, Finset.mem_union, Set.disjoint_left.mp, Set.univ, classical, disjoint_left, h_P_inter, hi_mem_union, ht1_eq, ht1_m, ht2_eq, ht2_m, if_pos, mem_union, simp_rw
-/
theorem indepSets_piiUnionInter_of_disjoint {s : ι -> Set (Set Ω)}
  ...
  let g i := ite (i in p1) (f1 i) Set.univ inter ite (i in p2) (f2 i) Set.univ
  have h_P_inter : forallᵐ a ∂μ, κ a (t1 inter t2) = ∏ n in p1 union p2, κ a (g n) := by
    have hgm : forall i in p1 union p2, g i in s i := by
      ...
      · have hi1 : i ∉ p1 := fun hip1 => Set.disjoint_right.mp hST (hp2 hi2) (hp1 hip1)
        ...
        exact ht2_m i hi2
    have h_p1_inter_p2 :
      ((⋂ x in p1, f1 x) inter ⋂ x in p2, f2 x) =
        ⋂ i in p1 union p2, ite (i in p1) (f1 i) Set.univ inter ite (i in p2) (f2 i) Set.univ := by
      ext1 x
  ...
  have h_μg : forall n, κ a (g n) = (ite (n in p1) (κ a (f1 n)) 1) * (ite (n in p2) (κ a (f2 n)) 1) := by
    intro n
    dsimp only [g]
  ...
  simp_rw [h_P_inter, h_μg, Finset.prod_mul_distrib,
    Finset.prod_ite_mem (p1 union p2) p1 (fun x => κ a (f1 x)), Finset.union_inter_cancel_left,
    Finset.prod_ite_mem (p1 union p2) p2 (fun x => κ a (f2 x)), Finset.union_inter_cancel_right, ht1_eq,
      ← ha1, ht2_eq, ← ha2]
...
theorem iIndepSet.indep_generateFrom_of_disjoint
  ...
  rw [← generateFrom_piiUnionInter_singleton_left]; rw [
...
theorem iIndepSet.indep_generateFrom_of_disjoint {s : ι -> Set Ω}
    (hsm : forall n, MeasurableSet (s n)) (hs : iIndepSet s κ μ) (S T : Set ι) (hST : Disjoint S T) :
    Indep (generateFrom { t | exists n in S, s n = t }) (generateFrom { t | exists k in T, s k = t }) κ μ := by
  rcases eq_or_ne μ 0 with rfl | hμ
  · simp
  obtain ⟨η, η_eq, hη⟩ : exists (η : Kernel α Ω), κ =ᵐ[μ] η ∧ IsMarkovKernel η :=
    exists_ae_eq_isMarkovKernel hs.ae_isProbabilityMeasure hμ
...
theorem indep_iSup_of_disjoint
  ...
  apply Indep.congr (Filter.EventuallyEq.symm η_eq)
  refine
    IndepSets.indep (iSup₂_le fun i _ => h
...
Depends on / 依赖: EventuallyEq, Filter, Filter.EventuallyEq.symm, Indep.congr, IndepSets, IndepSets.indep, IsMarkovKernel, Kernel, ae_isProbabilityMeasure, eq_or_ne, exists_ae_eq_isMarkovKernel, generateFrom_piiUnionInter_measurableSet, h_indep, h_indep.ae_isProbabilityMeasure, h_le, isPiSystem_measurableSe, isPiSystem_piiUnionInter
-/
theorem indep_iSup_of_disjoint {m : ι -> MeasurableSpace Ω}
    (h_le : forall i, m i <= _mΩ) (h_indep : iIndep m κ μ) {S T : Set ι} (hST : Disjoint S T) :
    Indep (⨆ i in S, m i) (⨆ i in T, m i) κ μ := by
  rcases eq_or_ne μ 0 with rfl | hμ
  · simp
  obtain ⟨η, η_eq, hη⟩ : exists (η : Kernel α Ω), κ =ᵐ[μ] η ∧ IsMarkovKernel η :=
    exists_ae_eq_isMarkovKernel h_indep.ae_isProbabilityMeasure hμ
...
Depends on / 依赖: IsPiSystem, MeasurableSet, generateFro, generateFrom, generateFrom_measurableSet, h_gen, h_gen_n, hp_supr_pi, isPiSystem_iUnion_of_directed_le, isPiSystem_measurableSet
-/
theorem indep_iSup_of_directed_le {Ω} {m : ι -> MeasurableSpace Ω} {m' m0 : MeasurableSpace Ω}
    {κ : Kernel α Ω} {μ : Measure α} [IsZeroOrMarkovKernel κ] (h_indep : forall i, Indep (m i) m' κ μ)
    (h_le : forall i, m i <= m0) (h_le' : m' <= m0) (hm : Directed (· <= ·) m) :
...
theorem iIndepSet.indep_generateFrom_lt [Preorder ι] {s : ι -> Set Ω}
    (hsm : forall n, MeasurableSet (s n)) (hs : iIndepSet s κ μ) (i : ι) :
    Indep (generateFrom {s i}) (generateFrom { t | exists j < i, s j = t }) κ μ := by
  convert!
    iIndepSet.indep_generateFrom_of_disjoint hsm hs { i } {j | j < i}
      (Set.disjoint_singleton_left.mpr (lt_irrefl _)) using 1
  simp only [Set.mem_singleton_iff, exists_eq_left, Set.ofPred_eq_eq_singleton']
...
theorem iIndepSet.indep_generateFrom_le [Preorder ι] {s : ι -> Set Ω}
    (hsm : forall n, MeasurableSet (s n)) (hs : iIndepSet s κ μ) (i : ι) {k : ι} (hk : i < k) :
    Indep (generateFrom {s k}) (generateFrom { t | exists j <= i, s j = t }) κ μ := by
  convert!
    iIndepSet.indep_generateFrom_of_disjoint hsm hs { k } {j | j <= i}
      (Set.disjoint_singleton_left.mpr hk.not_ge) using 1
  simp only [Set.mem_singleton_iff, exists_eq_left, Set.ofPred_eq_eq_singleton']
...
theorem iIndepSet.indep_generateFrom_le_nat
  ...
  proof: iIndepSet.indep_generateFrom_le hsm hs _ n.lt_succ_self
...
theorem iIndepSet.indep_generateFrom_le_nat {s : Nat -> Set Ω}
    (hsm : forall n, MeasurableSet (s n)) (hs : iIndepSet s κ μ) (n : Nat) :
    Indep (generateFrom {s (n + 1)}) (generateFrom { t | exists k <= n, s k = t }) κ μ :=
...
theorem indep_iSup_of_monotone
  statement: [SemilatticeSup ι] {Ω} {m : ι -> MeasurableSpace Ω}
  proof: indep_iSup_of_directed_le h_indep h_le h_le' (Monotone.directed_le hm)
...
theorem indep_iSup_of_monotone [SemilatticeSup ι] {Ω} {m : ι -> MeasurableSpace Ω}
    ...
    (h_indep : forall i, Indep (m i) m' κ μ) (h_le : forall i, m i <= m0) (h_le' : m' <= m0)
    (hm : Monotone m) :
    Indep (⨆ i, m i) m' κ μ :=
...
theorem indep_iSup_of_antitone
  statement: [SemilatticeInf ι] {Ω} {m : ι -> MeasurableSpace Ω}
  proof: indep_iSup_of_directed_le h_indep h_le h_le' hm.directed_le
...
theorem iIndepSets.piiUnionInter_of_notMem
  ...
  classical
  let f := fun n => ite (n = a) t2 (ite (n in s) (ft1 n) Set.univ)
  have h_f_mem : forall n in insert a s, f n in π n := by
...
theorem iIndepSets.piiUnionInter_of_notMem {π : ι -> Set (Set Ω)} {a : ι} {S : Finset ι}
  ...
  have h_f_mem : forall n in insert a s, f n in π n := by
    ...
    · grind
  have h_f_mem_pi : forall n in s, f n in π n := fun x hxS => h_f_mem x (by simp [hxS])
  have h_t1 : t1 = ⋂ n in s, f n := by
    suffices h_forall : forall n in s, f n = ft1 n by grind
    intro n hnS
    have hn_ne_a : n != a := by rintro rfl; exact haS (hs_mem hnS)
    simp_rw [f, if_pos hnS, if_neg hn_ne_a]
  have h_μ_t1 : forallᵐ a' ∂μ, κ a' t1 = ∏ n in s, κ a' (f n) := by
    filter_upwards [hp_ind s h_f_mem_pi] with a' ha'
    rw [h_t1]; rw [← ha']
  have h_t2 : t2 = f a := by simp [f]
  have h_μ_inter : forallᵐ a' ∂μ, κ a' (t1 inter t2) = ∏ n in insert a s, κ a' (f n) := by
    have h_t1_inter_t2 : t1 inter t2 = ⋂ n in insert a s, f n := by
...
theorem iIndepSets.iIndep (m : ι -> MeasurableSpace Ω)
    ...
    (h_generate : forall i, m i = generateFrom (π i)) (h_ind : iIndepSets π κ μ) :
    iIndep m κ μ := by
  classical
  rcases eq_or_ne μ 0 with rfl | hμ
  · simp
  ...
  · intro a S ha_notin_S h_rec hf_m
    have hf_m_S : forall x in S, MeasurableSet[m x] (f x) := fun x hx => hf_m x (by simp [hx])
    ...
    have h_indep : Indep m_p (m a) η μ := by
      ...
      have h_le' : forall i, generateFrom (π i) <= _mΩ := fun i => (h_generate i).symm.trans_le (h_le i)
...
theorem iIndepSet_iff_iIndepSets_singleton
  statement: {_mΩ : MeasurableSpace Ω} {κ : Kernel α Ω}
  proof: ⟨iIndep.iIndepSets fun _ => rfl,
...
Depends on / 依赖: IsPiSystem, IsPiSystem.singleton, generateFrom_le, iIndep, iIndep.iIndepSets, iIndepSets, iIndepSets.iIndep, singleton
-/
theorem iIndepSet_iff_iIndepSets_singleton {_mΩ : MeasurableSpace Ω} {κ : Kernel α Ω}
    {μ : Measure α} {f : ι -> Set Ω} (hf : forall i, MeasurableSet (f i)) :
...
theorem iIndepSet_iff_meas_biInter {_mΩ : MeasurableSpace Ω} {κ : Kernel α Ω}
    {μ : Measure α} {f : ι -> Set Ω} (hf : forall i, MeasurableSet (f i)) :
    iIndepSet f κ μ ↔ forall s, forallᵐ a ∂μ, κ a (⋂ i in s, f i) = ∏ i in s, κ a (f i) :=
...
theorem iIndepSets.iIndepSet_of_mem
  statement: {_mΩ : MeasurableSpace Ω} {κ : Kernel α Ω}
  proof: (iIndepSet_iff_meas_biInter hf).2 fun _t => hπ.meas_biInter _ fun _i _ => hfπ _
...
theorem iIndepSets.iIndepSet_of_mem {_mΩ : MeasurableSpace Ω} {κ : Kernel α Ω}
    ...
    (hfπ : forall i, f i in π i) (hf : forall i, MeasurableSet (f i)) (hπ : iIndepSets π κ μ) :
    iIndepSet f κ μ :=
...
theorem indepSet_iff_indepSets_singleton
  statement: {m0 : MeasurableSpace Ω} (hs_meas : MeasurableSet s)
  proof: ⟨Indep.indepSets, fun h =>
    IndepSets.indep
...
Depends on / 依赖: Indep.indepSets, IndepSets, IndepSets.indep, IsPiSystem, IsPiSystem.singleton, Set.mem_singleton_iff.mp, generateFrom_le, indepSets, mem_singleton_iff, singleton
-/
...
theorem indepSet_iff_measure_inter_eq_mul
  statement: {_m0 : MeasurableSpace Ω} (hs_meas : MeasurableSet s)
  proof: (indepSet_iff_indepSets_singleton hs_meas ht_meas κ μ).trans indepSets_singleton_iff
...
theorem indepSet_iff_measure_inter_eq_mul {_m0 : MeasurableSpace Ω} (hs_meas : MeasurableSet s)
    (ht_meas : MeasurableSet t) (κ : Kernel α Ω) (μ : Measure α)
    [IsZeroOrMarkovKernel κ] :
    IndepSet s t κ μ ↔ forallᵐ a ∂μ, κ a (s inter t) = κ a s * κ a t :=
  (indepSet_iff_indepSets_singleton hs_meas ht_meas κ μ).trans indepSets_singleton_iff

/--
theorem `IndepSet.measure_inter_eq_mul` / 定理 `IndepSet.measure_inter_eq_mul`

English:
theorem IndepSet.measure_inter_eq_mul
  statement: {_m0 : MeasurableSpace Ω} (κ : Kernel α Ω) (μ : Measure α)
  proof: Indep.indepSets h _ _ (by simp) (by simp)
...
theorem IndepSet.measure_inter_eq_mul {_m0 : MeasurableSpace Ω} (κ : Kernel α Ω) (μ : Measure α)
    (h : IndepSet s t κ μ) : forallᵐ a ∂μ, κ a (s inter t) = κ a s * κ a t :=
...
theorem IndepSets.indepSet_of_mem
  statement: {_m0 : MeasurableSpace Ω} (hs : s in S) (ht : t in T)
  proof: (indepSet_iff_measure_inter_eq_mul hs_meas ht_meas κ μ).mpr (h_indep s t hs ht)
...
theorem Indep.indepSet_of_measurableSet
  statement: {m₁ m₂ _ : MeasurableSpace Ω} {κ : Kernel α Ω}
  proof: by
...
theorem indep_iff_forall_indepSet
  statement: (m₁ m₂ : MeasurableSpace Ω) {_m0 : MeasurableSpace Ω}
  proof: ⟨fun h => fun _s _t hs ht => h.indepSet_of_measurableSet hs ht, fun h s t hs ht =>
...
Depends on / 依赖: Set.mem_singleton, h.indepSet_of_measurableSet, indepSet_of_measurableSet, measurableSet_generateFrom, mem_singleton
-/
theorem indep_iff_forall_indepSet (m₁ m₂ : MeasurableSpace Ω) {_m0 : MeasurableSpace Ω}
    (κ : Kernel α Ω) (μ : Measure α) :
    Indep m₁ m₂ κ μ ↔ forall s t, MeasurableSet[m₁] s -> MeasurableSet[m₂] t -> IndepSet s t κ μ :=
