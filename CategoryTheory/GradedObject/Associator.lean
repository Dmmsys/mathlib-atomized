...
Depends on / 依赖: HasLimit, HasLimit.mk, associator, hasMap, isLimit, mapIso, mapTrifunctorMapIso, terminal, terminal.from
-/
...
/--
lemma `ι_mapBifunctorAssociator_hom` / 引理 `ι_mapBifunctorAssociator_hom`

English:
lemma ι_mapBifunctorAssociator_hom
  given: (i₁ : I₁) (i₂ : I₂) (i₃ : I₃) (j : J) (h : r (i₁, i₂, i₃) = j)
  proof: by
  dsimp [mapBifunctorAssociator]
  rw [ι_mapBifunctorComp₁₂MapObjIso_inv_assoc]; rw [ιMapTrifunctorMapObj]; rw [ι_mapMap_assoc]; rw [mapTrifunctorMapNatTrans_app_app_app]
  erw [ι_mapBifunctorComp₂₃MapObjIso_hom]

中文:
引理 ι_mapBifunctorAssociator_hom
...
Depends on / 依赖: mapBifunctorAssociator, mapTrifunctorMapNatTrans_app_app_app
-/
...
@[reassoc (attr := simp)]
/--
lemma `ι_mapBifunctorAssociator_inv` / 引理 `ι_mapBifunctorAssociator_inv`
