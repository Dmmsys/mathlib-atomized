...
@[simp]
/-
**Stream.LiftRelO** 是 Mathlib 中的一个定义，位于命名空间 `Stream`。
...
/-
**Stream.LiftRelO.imp** 是 Mathlib 中的一个定理，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.LiftRelO.imp_right** 是 Mathlib 中的一个定理，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.LiftRelO.swap** 是 Mathlib 中的一个定理，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.BisimO** 是 Mathlib 中的一个定义，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
def BisimO (R : WSeq α → WSeq α → Prop) : Option (α × WSeq α) → Option (α × WSeq α) → Prop :=
  LiftRelO (· = ·) R
/-
**Stream.BisimO.imp** 是 Mathlib 中的一个定理，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.LiftRel** 是 Mathlib 中的一个定义，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**Stream.liftRel_destruct** 是 Mathlib 中的一个定理，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.liftRel_destruct_iff** 是 Mathlib 中的一个定理，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
theorem liftRel_destruct_iff {R : α → β → Prop} {s : WSeq α} {t : WSeq β} :
  ...
  ⟨liftRel_destruct, fun h =>
    ⟨fun s t =>
      ...
      apply Or.inl⟩⟩
/-
**Stream.LiftRel.swap_lem** 是 Mathlib 中的一个定理，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.LiftRel.swap** 是 Mathlib 中的一个定理，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.LiftRelO.refl** 是 Mathlib 中的一个实例，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
instance LiftRelO.refl (R : α → α → Prop) [Std.Refl R] : Std.Refl <| LiftRelO R (· = ·) where
  refl a := by
    ...
    · cases a
      ...
      apply refl_of R
/-
**Stream.LiftRel.refl** 是 Mathlib 中的一个实例，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.LiftRel.symm** 是 Mathlib 中的一个实例，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.LiftRel.trans** 是 Mathlib 中的一个实例，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.LiftRel.equiv** 是 Mathlib 中的一个定理，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.Equiv** 是 Mathlib 中的一个定义，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
@[refl]
/-
**Stream.Equiv.refl** 是 Mathlib 中的一个定理，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[symm]
/-
**Stream.Equiv.symm** 是 Mathlib 中的一个定理，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[trans]
/-
**Stream.Equiv.trans** 是 Mathlib 中的一个定理，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
theorem Equiv.trans : ∀ {s t u : WSeq α}, s ~ʷ t → t ~ʷ u → s ~ʷ u :=
  LiftRel.trans Eq |>.trans _ _ _
/-
**Stream.Equiv.equivalence** 是 Mathlib 中的一个定理，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
theorem Equiv.equivalence : Equivalence (@Equiv α) :=
  ⟨@Equiv.refl _, @Equiv.symm _, @Equiv.trans _⟩
/-
**Stream.destruct_congr** 是 Mathlib 中的一个定理，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
theorem destruct_congr {s t : WSeq α} :
  ...
  liftRel_destruct
/-
**Stream.destruct_congr_iff** 是 Mathlib 中的一个定理，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
open Computation
/-
**Stream.liftRel_dropn_destruct** 是 Mathlib 中的一个定理，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.exists_of_liftRel_left** 是 Mathlib 中的一个定理，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.exists_of_liftRel_right** 是 Mathlib 中的一个定理，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.liftRel_nil** 是 Mathlib 中的一个定理，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.liftRel_cons** 是 Mathlib 中的一个定理，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.liftRel_think_left** 是 Mathlib 中的一个定理，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.flatten_equiv** 是 Mathlib 中的一个定理，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
theorem flatten_equiv {c : Computation (WSeq α)} {s} (h : s ∈ c) : flatten c ~ʷ s := by
  ...
  · intro s'
    ...
    simp [think_equiv]
/-
**Stream.liftRel_flatten** 是 Mathlib 中的一个定理，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.flatten_congr** 是 Mathlib 中的一个定理，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
theorem flatten_congr {c1 c2 : Computation (WSeq α)} :
  ...
  liftRel_flatten
/-
**Stream.tail_congr** 是 Mathlib 中的一个定理，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.Equiv.ext** 是 Mathlib 中的一个定理，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
  ...
  ⟨fun s t => ∀ n, get? s n ~ get? t n, h, fun {s t} h => by
    ...
    · intro a b ma mb
      ...
      · obtain ⟨a, s'⟩ := a
        ...
        apply h⟩
/-
**Stream.liftRel_map** 是 Mathlib 中的一个定理，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.map_congr** 是 Mathlib 中的一个定理，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
theorem map_congr (f : α → β) {s t : WSeq α} (h : s ~ʷ t) : map f s ~ʷ map f t :=
  liftRel_map _ _ h fun {_ _} => congr_arg _
/-
**Stream.liftRel_append** 是 Mathlib 中的一个定理，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.liftRel_join.lem** 是 Mathlib 中的一个定理，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.liftRel_join** 是 Mathlib 中的一个定理，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
    ...
    exact fun {o p} h =>
      ...
      | none, none, _ => by
        ...
        · intro b mb
          ...
          · exact mb⟩
/-
**Stream.join_congr** 是 Mathlib 中的一个定理，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
theorem join_congr {S T : WSeq (WSeq α)} (h : LiftRel Equiv S T) : join S ~ʷ join T :=
  liftRel_join _ h
/-
**Stream.liftRel_bind** 是 Mathlib 中的一个定理，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**Stream.bind_congr** 是 Mathlib 中的一个定理，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.join_ret** 是 Mathlib 中的一个定理，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.join_map_ret** 是 Mathlib 中的一个定理，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.join_append** 是 Mathlib 中的一个定理，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.bind_ret** 是 Mathlib 中的一个定理，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.ret_bind** 是 Mathlib 中的一个定理，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.join_join** 是 Mathlib 中的一个定理，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.bind_assoc_comp** 是 Mathlib 中的一个定理，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**Stream.bind_assoc** 是 Mathlib 中的一个定理，位于命名空间 `Stream`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
