...
/--
Definition of `levyProkhorovEDist` / `levyProkhorovEDist` 的定义

English:
definition levyProkhorovEDist
  signature: (μ ν : Measure Ω)
  body: sInf {ε | forall B, MeasurableSet B ->
...
Depends on / 依赖: MeasurableSet, thickening, toReal
-/
noncomputable def levyProkhorovEDist (μ ν : Measure Ω) : Real>=0∞ :=
  sInf {ε | forall B, MeasurableSet B ->
            μ B <= ν (thickening ε.toReal B) + ε ∧ ν B <= μ (thickening ε.toReal B) + ε}

/--
lemma `meas_le_of_le_of_forall_le_meas_thickening_add` / 引理 `meas_le_of_le_of_forall_le_meas_thickening_add`

English:
lemma meas_le_of_le_of_forall_le_meas_thickening_add
  statement: {ε₁ ε₂ : Real>=0∞} (μ ν : Measure Ω)
  proof: by
  by_cases ε_top : ε₂ = ∞
...
Depends on / 依赖: add_le_add, add_top, h_le, le_top, measure_mono, thickening_mono, toReal_mono, toReal_top
-/
lemma meas_le_of_le_of_forall_le_meas_thickening_add {ε₁ ε₂ : Real>=0∞} (μ ν : Measure Ω)
...
/--
lemma `left_measure_le_of_levyProkhorovEDist_lt` / 引理 `left_measure_le_of_levyProkhorovEDist_lt`

English:
lemma left_measure_le_of_levyProkhorovEDist_lt
  statement: {μ ν : Measure Ω} {c : Real>=0∞}
  proof: by
...
Depends on / 依赖: B_mble, lt_c, lt_c.le, meas_le_of_le_of_forall_le_meas_thickening_add, sInf_lt_iff, sInf_lt_iff.mp
-/
lemma left_measure_le_of_levyProkhorovEDist_lt {μ ν : Measure Ω} {c : Real>=0∞}
...
/--
lemma `right_measure_le_of_levyProkhorovEDist_lt` / 引理 `right_measure_le_of_levyProkhorovEDist_lt`

English:
lemma right_measure_le_of_levyProkhorovEDist_lt
  statement: {μ ν : Measure Ω} {c : Real>=0∞}
  proof: by
  obtain ⟨c', ⟨hc', lt_c⟩⟩ := sInf_lt_iff.mp h
...
Depends on / 依赖: B_mble, lt_c, lt_c.le, meas_le_of_le_of_forall_le_meas_thickening_add, sInf_lt_iff, sInf_lt_iff.mp
-/
lemma right_measure_le_of_levyProkhorovEDist_lt {μ ν : Measure Ω} {c : Real>=0∞}
    (h : levyProkhorovEDist μ ν < c) {B : Set Ω} (B_mble : MeasurableSet B) :
...
/--
lemma `levyProkhorovEDist_le_of_forall_add_pos_le` / 引理 `levyProkhorovEDist_le_of_forall_add_pos_le`

English:
lemma levyProkhorovEDist_le_of_forall_add_pos_le
  statement: (μ ν : Measure Ω) (δ : Real>=0∞)
  proof: by
...
Depends on / 依赖: B_mble, ENNReal, ENNReal.le_of_forall_pos_le_add, add_assoc, add_top, coe_lt_top, le_of_forall_pos_le_add, le_top, sInf_le
-/
lemma levyProkhorovEDist_le_of_forall_add_pos_le (μ ν : Measure Ω) (δ : Real>=0∞)
    (h : forall ε B, 0 < ε -> ε < ∞ -> MeasurableSet B ->
...
/--
lemma `levyProkhorovEDist_le_of_forall` / 引理 `levyProkhorovEDist_le_of_forall`

English:
lemma levyProkhorovEDist_le_of_forall
  statement: (μ ν : Measure Ω) (δ : Real>=0∞)
  proof: by
  by_cases δ_top : δ = ∞
...
-/
lemma levyProkhorovEDist_le_of_forall (μ ν : Measure Ω) (δ : Real>=0∞)
    (h : forall ε B, δ < ε -> ε < ∞ -> MeasurableSet B ->
        μ B <= ν (thickening ε.toReal B) + ε ∧ ν B <= μ (thickening ε.toReal B) + ε) :
    levyProkhorovEDist μ ν <= δ := by
  by_cases δ_top : δ = ∞
  · simp only [δ_top, le_top]
...
/--
lemma `levyProkhorovEDist_le_max_measure_univ` / 引理 `levyProkhorovEDist_le_max_measure_univ`

English:
lemma levyProkhorovEDist_le_max_measure_univ
  given: (μ ν : Measure Ω)
  proof: by
...
Depends on / 依赖: le_add_left, measure_mono, sInf_le
-/
...
/--
lemma `levyProkhorovEDist_lt_top` / 引理 `levyProkhorovEDist_lt_top`

English:
lemma levyProkhorovEDist_lt_top
  given: (μ ν : Measure Ω) [IsFiniteMeasure μ] [IsFiniteMeasure ν]
  proof: (levyProkhorovEDist_le_max_measure_univ μ ν).trans_lt by simp [measure_lt_top]
...
/--
lemma `levyProkhorovEDist_ne_top` / 引理 `levyProkhorovEDist_ne_top`

English:
lemma levyProkhorovEDist_ne_top
  given: (μ ν : Measure Ω) [IsFiniteMeasure μ] [IsFiniteMeasure ν]
  proof: (levyProkhorovEDist_lt_top μ ν).ne
...
/--
lemma `levyProkhorovEDist_self` / 引理 `levyProkhorovEDist_self`

English:
lemma levyProkhorovEDist_self
  given: (μ : Measure Ω)
  statement: levyProkhorovEDist μ μ = 0
  proof: by
...
/--
lemma `levyProkhorovEDist_comm` / 引理 `levyProkhorovEDist_comm`

English:
lemma levyProkhorovEDist_comm
  given: (μ ν : Measure Ω)
  proof: by
...
Depends on / 依赖: and_comm, levyProkhorovEDist
-/
...
/--
lemma `levyProkhorovEDist_triangle` / 引理 `levyProkhorovEDist_triangle`

English:
lemma levyProkhorovEDist_triangle
  given: [OpensMeasurableSpace Ω] (μ ν κ : Measure Ω)
  proof: by
...
/--
Definition of `levyProkhorovDist` / `levyProkhorovDist` 的定义

English:
definition levyProkhorovDist
  signature: (μ ν : Measure Ω)
  body: (levyProkhorovEDist μ ν).toReal
...
-/
noncomputable def levyProkhorovDist (μ ν : Measure Ω) : Real :=
  (levyProkhorovEDist μ ν).toReal

/--
lemma `levyProkhorovDist_self` / 引理 `levyProkhorovDist_self`

English:
lemma levyProkhorovDist_self
  given: (μ : Measure Ω)
  proof: by
...
Depends on / 依赖: levyProkhorovDist, levyProkhorovEDist_self, toReal_zero
-/
...
/--
lemma `levyProkhorovDist_comm` / 引理 `levyProkhorovDist_comm`

English:
lemma levyProkhorovDist_comm
  given: (μ ν : Measure Ω)
  proof: by
...
Depends on / 依赖: levyProkhorovDist, levyProkhorovEDist_comm
-/
...
/--
lemma `levyProkhorovDist_triangle` / 引理 `levyProkhorovDist_triangle`

English:
lemma levyProkhorovDist_triangle
  statement: [OpensMeasurableSpace Ω] (μ ν κ : Measure Ω)
  proof: by
...
/--
lemma `measure_le_measure_closure_of_levyProkhorovEDist_eq_zero` / 引理 `measure_le_measure_closure_of_levyProkhorovEDist_eq_zero`

English:
lemma measure_le_measure_closure_of_levyProkhorovEDist_eq_zero
  statement: {μ ν : Measure Ω}
  proof: by
...
lemma measure_le_measure_closure_of_levyProkhorovEDist_eq_zero {μ ν : Measure Ω}
    ...
    (h_finite : exists δ > 0, ν (thickening δ s) != ∞) :
    μ s <= ν (closure s) := by
  have key : Tendsto (fun ε => ν (thickening ε.toReal s)) (𝓝[>] (0 : Real>=0∞)) (𝓝 (ν (closure s))) := by
    have aux : Tendsto ENNReal.toReal (𝓝[>] 0) (𝓝[>] 0) := by
      apply tendsto_nhdsWithin_of_tendsto_nhds_of_eventually_within (s := Ioi 0) ENNReal.toReal
...
/--
lemma `measure_eq_measure_of_levyProkhorovEDist_eq_zero_of_isClosed` / 引理 `measure_eq_measure_of_levyProkhorovEDist_eq_zero_of_isClosed`

English:
lemma measure_eq_measure_of_levyProkhorovEDist_eq_zero_of_isClosed
  statement: {μ ν : Measure Ω}
  proof: by
  apply le_antisymm
...
lemma measure_eq_measure_of_levyProkhorovEDist_eq_zero_of_isClosed {μ ν : Measure Ω}
    ...
    (hμs : exists δ > 0, μ (thickening δ s) != ∞) (hνs : exists δ > 0, ν (thickening δ s) != ∞) :
    μ s = ν s := by
  apply le_antisymm
  · exact measure_le_measure_closure_of_levyProkhorovEDist_eq_zero
.trans hLP s_closed.measurableSet hνs
...
/--
lemma `levyProkhorovEDist_le_of_forall_le` / 引理 `levyProkhorovEDist_le_of_forall_le`
...
-/
lemma levyProkhorovEDist_le_of_forall_le
    (μ ν : Measure Ω) [IsProbabilityMeasure μ] [IsProbabilityMeasure ν] (δ : Real>=0∞)
    (h : forall ε B, δ < ε -> ε < ∞ -> MeasurableSet B -> μ B <= ν (thickening ε.toReal B) + ε) :
    levyProkhorovEDist μ ν <= δ := by
  apply levyProkhorovEDist_le_of_forall μ ν δ
  intro ε B ε_gt ε_lt_top B_mble
  refine ⟨h ε B ε_gt ε_lt_top B_mble, ?_⟩
...
/--
lemma `levyProkhorovDist_le_of_forall_le` / 引理 `levyProkhorovDist_le_of_forall_le`
...
-/
lemma levyProkhorovDist_le_of_forall_le
    (μ ν : Measure Ω) [IsProbabilityMeasure μ] [IsProbabilityMeasure ν] {δ : Real} (δ_nn : 0 <= δ)
    (h : forall ε B, δ < ε -> MeasurableSet B -> μ B <= ν (thickening ε B) + ENNReal.ofReal ε) :
...
/--
Definition of `LevyProkhorov` / `LevyProkhorov` 的定义

English:
structure LevyProkhorov
  parameters: (α : Type*)
...
Depends on / 依赖: delabStructureInstance
-/
...
/--
lemma `toMeasure_injective` / 引理 `toMeasure_injective`

English:
lemma toMeasure_injective
  given: {α : Type*}
  statement: (toMeasure : LevyProkhorov α -> α).Injective
  proof: fun ⟨μ⟩ ⟨ν⟩ => by congr!
...
@[simps]
/--
Definition of `toMeasureEquiv` / `toMeasureEquiv` 的定义

English:
definition toMeasureEquiv
  signature: {α : Type*}
  body: toMeasure
  invFun := ofMeasure
...
/--
Instance `instPseudoEMetricSpaceMeasure` / 实例 `instPseudoEMetricSpaceMeasure`

English:
instance instPseudoEMetricSpaceMeasure
  signature: :
  body: levyProkhorovEDist μ.toMeasure ν.toMeasure
...
中文:
实例 instPseudoEMetricSpaceMeasure
  签名: :
  定义体: levyProkhorovEDist μ.toMeasure ν.toMeasure
  edist_self _ := levyProkhorovEDist_self _
  edist_comm _ _ := levyProkhorovEDist_comm ..
  edist_triangle _ _ _ := levyProkhorovEDist_triangle ..

Depends on / 依赖: levyProkhorovEDist, toMeasure
-/
...
/--
Instance `instPseudoMetricSpaceFiniteMeasure` / 实例 `instPseudoMetricSpaceFiniteMeasure`

English:
instance instPseudoMetricSpaceFiniteMeasure
  signature: :
  body: levyProkhorovEDist μ.toMeasure.toMeasure ν.toMeasure.toMeasure
...
实例 instPseudoMetricSpaceFiniteMeasure
  签名: :
  定义体: levyProkhorovEDist μ.toMeasure.toMeasure ν.toMeasure.toMeasure
  dist μ ν := levyProkhorovDist μ.toMeasure.toMeasure ν.toMeasure.toMeasure
  dist_self _ := levyProkhorovDist_self _
  dist_comm _ _ := levyProkhorovDist_comm ..
  dist_triangle _ _ _ := levyProkhorovDist_triangle ..
...
/--
Instance `instPseudoMetricSpaceProbabilityMeasure` / 实例 `instPseudoMetricSpaceProbabilityMeasure`

English:
instance instPseudoMetricSpaceProbabilityMeasure
  signature: :
  body: .induced (LevyProkhorov.ofMeasure ·.toMeasure.toFiniteMeasure) inferInstance

中文:
实例 instPseudoMetricSpaceProbabilityMeasure
  签名: :
  定义体: .induced (LevyProkhorov.ofMeasure ·.toMeasure.toFiniteMeasure) inferInstance

Depends on / 依赖: LevyProkhorov, LevyProkhorov.ofMeasure, induced, ofMeasure, toFiniteMeasure, toMeasure, toMeasure.toFiniteMeasure
-/
...
/--
lemma `edist_measure_def` / 引理 `edist_measure_def`

English:
lemma edist_measure_def
  given: (μ ν : LevyProkhorov (Measure Ω))
  proof: rfl
...
/--
lemma `edist_finiteMeasure_def` / 引理 `edist_finiteMeasure_def`

English:
lemma edist_finiteMeasure_def
  given: (μ ν : LevyProkhorov (FiniteMeasure Ω))
  proof: rfl
...
/--
lemma `dist_finiteMeasure_def` / 引理 `dist_finiteMeasure_def`

English:
lemma dist_finiteMeasure_def
  given: (μ ν : LevyProkhorov (FiniteMeasure Ω))
  proof: rfl
...
/--
lemma `edist_probabilityMeasure_def` / 引理 `edist_probabilityMeasure_def`

English:
lemma edist_probabilityMeasure_def
  given: (μ ν : LevyProkhorov (ProbabilityMeasure Ω))
  proof: rfl
...
/--
lemma `dist_probabilityMeasure_def` / 引理 `dist_probabilityMeasure_def`

English:
lemma dist_probabilityMeasure_def
  given: (μ ν : LevyProkhorov (ProbabilityMeasure Ω))
  proof: rfl
...
/--
Instance `levyProkhorovDist_metricSpace_probabilityMeasure` / 实例 `levyProkhorovDist_metricSpace_probabilityMeasure`

English:
instance levyProkhorovDist_metricSpace_probabilityMeasure
  signature: [BorelSpace Ω]
  body: by
...
/--
lemma `BoundedContinuousFunction.integral_eq_integral_meas_le_of_hasFiniteIntegral` / 引理 `BoundedContinuousFunction.integral_eq_integral_meas_le_of_hasFiniteIntegral`
...
Depends on / 依赖: BoundedContinuousFunction, BoundedContinuousFunction.apply_le_norm, Eventually, Eventually.of_forall, Integrable, Integrable.integral_eq_integral_Ioc_meas_le, aestronglyMeasurable, apply_le_norm, continuous, f.continuous.measurable.aestronglyMeasurable, f_nn, integral_eq_integral_Ioc_meas_le, measurable, of_forall
-/
lemma BoundedContinuousFunction.integral_eq_integral_meas_le_of_hasFiniteIntegral
    {α : Type*} [MeasurableSpace α] [TopologicalSpace α] [OpensMeasurableSpace α]
    (f : α ->ᵇ Real) (μ : Measure α) (f_nn : 0 <=ᵐ[μ] f) (hf : HasFiniteIntegral f μ) :
...
/--
lemma `BoundedContinuousFunction.integral_eq_integral_meas_le` / 引理 `BoundedContinuousFunction.integral_eq_integral_meas_le`
...
lemma BoundedContinuousFunction.integral_eq_integral_meas_le
    {α : Type*} [MeasurableSpace α] [TopologicalSpace α] [OpensMeasurableSpace α]
    (f : α ->ᵇ Real) (μ : Measure α) [IsFiniteMeasure μ] (f_nn : 0 <=ᵐ[μ] f) :
    ∫ ω, f ω ∂μ = ∫ t in Ioc 0 ‖f‖, μ.real {a : α | t <= f a} :=
  integral_eq_integral_meas_le_of_hasFiniteIntegral _ _ f_nn (f.integrable μ).2

/--
lemma `BoundedContinuousFunction.integral_le_of_levyProkhorovEDist_lt` / 引理 `BoundedContinuousFunction.integral_le_of_levyProkhorovEDist_lt`
...
lemma BoundedContinuousFunction.integral_le_of_levyProkhorovEDist_lt
  ...
  have key : (fun (t : Real) => μ.real {a | t <= f a})
              <= (fun (t : Real) => ν.real (thickening ε {a | t <= f a}) + ε) := by
    intro t
...
lemma BoundedContinuousFunction.integral_le_of_levyProkhorovEDist_lt (μ ν : Measure Ω)
    [IsFiniteMeasure μ] [IsFiniteMeasure ν] {ε : Real} (ε_pos : 0 < ε)
    (hμν : levyProkhorovEDist μ ν < ENNReal.ofReal ε) (f : Ω ->ᵇ Real) (f_nn : 0 <=ᵐ[μ] f) :
    ∫ ω, f ω ∂μ
...
/--
lemma `tendsto_integral_meas_thickening_le` / 引理 `tendsto_integral_meas_thickening_le`

English:
lemma tendsto_integral_meas_thickening_le
  statement: (f : Ω ->ᵇ Real)
  proof: by
...
-/
lemma tendsto_integral_meas_thickening_le (f : Ω ->ᵇ Real)
    {A : Set Real} (A_finmeas : volume A != ∞) (μ : ProbabilityMeasure Ω) :
    Tendsto (fun ε => ∫ t in A, (Measure.real μ (thickening ε {a | t <= f a}))) (𝓝[>] (0 : Real))
...
/--
lemma `LevyProkhorov.continuous_toMeasure_probabilityMeasure` / 引理 `LevyProkhorov.continuous_toMeasure_probabilityMeasure`
...
/--
theorem `LevyProkhorov.le_convergenceInDistribution` / 定理 `LevyProkhorov.le_convergenceInDistribution`

English:
theorem LevyProkhorov.le_convergenceInDistribution
  proof: LevyProkhorov.continuous_toMeasure_probabilityMeasure.coinduced_le

中文:
定理 LevyProkhorov.le_convergenceInDistribution
  证明: LevyProkhorov.continuous_toMeasure_probabilityMeasure.coinduced_le
...
/--
lemma `ProbabilityMeasure.toMeasure_add_pos_gt_mem_nhds` / 引理 `ProbabilityMeasure.toMeasure_add_pos_gt_mem_nhds`

English:
lemma ProbabilityMeasure.toMeasure_add_pos_gt_mem_nhds
  statement: (P : ProbabilityMeasure Ω)
  proof: by
...
lemma ProbabilityMeasure.toMeasure_add_pos_gt_mem_nhds (P : ProbabilityMeasure Ω)
    {G : Set Ω} (G_open : IsOpen G) {ε : Real>=0∞} (ε_pos : 0 < ε) :
    {Q | P.toMeasure G < Q.toMeasure G + ε} in 𝓝 P := by
  by_cases! easy : P.toMeasure G < ε
  · exact Eventually.of_forall (fun _ => lt_of_lt_of_le easy le_add_self)
  by_cases ε_top : ε = ∞
  · simp [ε_top, measure_lt_top]
...
variable (Ω) in
/--
lemma `SeparableSpace.exists_measurable_partition_diam_le` / 引理 `SeparableSpace.exists_measurable_partition_diam_le`

English:
lemma SeparableSpace.exists_measurable_partition_diam_le
  given: {ε : Real} (ε_pos : 0 < ε)
  proof: by
...
-/
lemma SeparableSpace.exists_measurable_partition_diam_le {ε : Real} (ε_pos : 0 < ε) :
    exists (As : Nat -> Set Ω), (forall n, MeasurableSet (As n)) ∧ (forall n, Bornology.IsBounded (As n)) ∧
        (forall n, diam (As n) <= ε) ∧ (⋃ n, As n = univ) ∧
        (Pairwise (fun (n m : Nat) => Disjoint (As n) (As m))) := by
  cases isEmpty_or_nonempty Ω
  · refine ⟨fun _ => ∅, fun _ => MeasurableSet.empty, fun _ => Bornology.isBounded_empty, ?_, ?_,
            fun _ _ _ => disjoint_of_subsingleton⟩
    · intro n
...
/--
lemma `continuous_ofMeasure_probabilityMeasure` / 引理 `continuous_ofMeasure_probabilityMeasure`
...
/--
theorem `eq_convergenceInDistribution` / 定理 `eq_convergenceInDistribution`

English:
theorem eq_convergenceInDistribution
  proof: le_convergenceInDistribution.antisymm' fun s hs => by
    simpa using! hs.preimage continuous_ofMeasure_probabilityMeasure

中文:
定理 eq_convergenceInDistribution
  证明: le_convergenceInDistribution.antisymm' fun s hs => by
    simpa using! hs.preimage continuous_ofMeasure_probabilityMeasure

Depends on / 依赖: antisymm, continuous_ofMeasure_probabilityMeasure, hs.preimage, le_convergenceInDistribution, le_convergenceInDistribution.antisymm, preimage
-/
theorem eq_convergenceInDistribution :
    (inferInstance : TopologicalSpace (ProbabilityMeasure Ω))
...
/--
Definition of `probabilityMeasureHomeomorph` / `probabilityMeasureHomeomorph` 的定义

English:
definition probabilityMeasureHomeomorph
  signature: :
  body: LevyProkhorov.ofMeasure
...
中文:
定义 probabilityMeasureHomeomorph
  签名: :
  定义体: LevyProkhorov.ofMeasure
  invFun := LevyProkhorov.toMeasure
  left_inv _ := rfl
  right_inv _ := rfl
  continuous_toFun := LevyProkhorov.continuous_ofMeasure_probabilityMeasure
...
Depends on / 依赖: LevyProkhorov, LevyProkhorov.ofMeasure, ofMeasure
-/
...
/--
Instance `instMetrizableSpaceProbabilityMeasure` / 实例 `instMetrizableSpaceProbabilityMeasure`

English:
instance instMetrizableSpaceProbabilityMeasure
...
Depends on / 依赖: LevyProkhorov, LevyProkhorov.probabilityMeasureHomeomorph.isEmbedding.metrizableSpace, PseudoMetricSpace, TopologicalSpace, TopologicalSpace.pseudoMetrizableSpacePseudoMetric, isEmbedding, metrizableSpace, probabilityMeasureHomeomorph, pseudoMetrizableSpacePseudoMetric
-/
