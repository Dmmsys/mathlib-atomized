...
@[simps]
/-
**CategoryTheory.GradedObject.mapTrifunctorObj** 是 Mathlib 中的一个定义，位于命名空间 `Catego
ryTheory.GradedObject`。
形式化陈述：mapTrifunctorObj {I₁ : Type*} (X₁ : GradedObject I₁ C₁) (I₂ I₃ : Type*) : 
GradedObject I₂ C₂ ⥤ GradedObject I₃ C₃ ⥤ GradedObject (I₁ × I₂ × I₃) C₄ where o
bj X₂
参数：X₁ : GradedObject I₁ C₁；I₂ I₃ : Type*。
该定义给出了上述对象。
...
@[simps]
/-
**CategoryTheory.GradedObject.mapTrifunctor** 是 Mathlib 中的一个定义，位于命名空间 `CategoryT
heory.GradedObject`。
形式化陈述：mapTrifunctor (I₁ I₂ I₃ : Type*) : GradedObject I₁ C₁ ⥤ GradedObject I₂ C₂
 ⥤ GradedObject I₃ C₃ ⥤ GradedObject (I₁ × I₂ × I₃) C₄ where obj X₁
参数：I₁ I₂ I₃ : Type*。
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
Given a trifunctor `F : C₁ ⥤ C₂ ⥤ C₃ ⥤ C₄` and types `I₁`, `I₂`, `I₃`,
this is the obvious functor
`GradedObject I₁ C₁ ⥤ GradedObject I₂ C₂ ⥤ GradedObject I₃ C₃ ⥤ GradedObject (I₁
 × I₂ × I₃) C₄`.
-/
...
@[simps]
/-
**CategoryTheory.GradedObject.mapTrifunctorMapNatTrans** 是 Mathlib 中的一个定义，位于命名空间
 `CategoryTheory.GradedObject`。
形式化陈述：mapTrifunctorMapNatTrans (α : F ⟶ F') (I₁ I₂ I₃ : Type*) : mapTrifunctor F
 I₁ I₂ I₃ ⟶ mapTrifunctor F' I₁ I₂ I₃ where app X₁
参数：α : F ⟶ F'；I₁ I₂ I₃ : Type*。
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
@[simps]
/-
**CategoryTheory.GradedObject.mapTrifunctorMapIso** 是 Mathlib 中的一个定义，位于命名空间 `Cat
egoryTheory.GradedObject`。
形式化陈述：mapTrifunctorMapIso (e : F ≅ F') (I₁ I₂ I₃ : Type*) : mapTrifunctor F I₁ I
₂ I₃ ≅ mapTrifunctor F' I₁ I₂ I₃ where hom
参数：e : F ≅ F'；I₁ I₂ I₃ : Type*。
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**CategoryTheory.GradedObject.mapTrifunctorMapObj** 是 Mathlib 中的一个定义，位于命名空间 `Cat
egoryTheory.GradedObject`。
形式化陈述：mapTrifunctorMapObj (X₁ : GradedObject I₁ C₁) (X₂ : GradedObject I₂ C₂) (X
₃ : GradedObject I₃ C₃) [HasMap ((((mapTrifunctor F I₁ I₂ I₃).obj X₁).obj X₂).ob
j X₃) p] : GradedObject J C₄
参数：X₁ : GradedObject I₁ C₁；X₂ : GradedObject I₂ C₂；X₃ : GradedObject I₃ C₃；(((ma
pTrifunctor F I₁ I₂ I₃).obj X₁).obj X₂).obj X₃。
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
Given a trifunctor `F : C₁ ⥤ C₂ ⥤ C₃ ⥤ C₃`, graded objects `X₁ : GradedObject I₁
 C₁`,
`X₂ : GradedObject I₂ C₂`, `X₃ : GradedObject I₃ C₃`, and a map `p : I₁ × I₂ × I
₃ → J`,
this is the `J`-graded object sending `j` to the coproduct of
`((F.obj (X₁ i₁)).obj (X₂ i₂)).obj (X₃ i₃)` for `p ⟨i₁, i₂, i₃⟩ = k`.
-/
...
/-
**CategoryTheory.GradedObject.mapTrifunctorMapMap** 是 Mathlib 中的一个定义，位于命名空间 `Cat
egoryTheory.GradedObject`。
形式化陈述：mapTrifunctorMapMap {X₁ Y₁ : GradedObject I₁ C₁} (f₁ : X₁ ⟶ Y₁) {X₂ Y₂ : G
radedObject I₂ C₂} (f₂ : X₂ ⟶ Y₂) {X₃ Y₃ : GradedObject I₃ C₃} (f₃ : X₃ ⟶ Y₃) [H
asMap ((((mapTrifunctor F I₁ I₂ I₃).obj X₁).obj X₂).obj X₃) p] [HasMap ((((mapTr
ifunctor F I₁ I₂ I₃).obj Y₁).obj Y₂).obj Y₃) p] : mapTrifunctorMapObj F p X₁ X₂ 
X₃ ⟶ mapTrifunctorMapObj F p Y₁ Y₂ Y₃
参数：f₁ : X₁ ⟶ Y₁；f₂ : X₂ ⟶ Y₂；f₃ : X₃ ⟶ Y₃；(((mapTrifunctor F I₁ I₂ I₃).obj X₁).o
bj X₂).obj X₃；(((mapTrifunctor F I₁ I₂ I₃).obj Y₁).obj Y₂).obj Y₃。
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
The maps `mapTrifunctorMapObj F p X₁ X₂ X₃ ⟶ mapTrifunctorMapObj F p Y₁ Y₂ Y₃` w
hich
express the functoriality of `mapTrifunctorMapObj`, see `mapTrifunctorMap`
-/
...
@[ext]
/-
**CategoryTheory.GradedObject.mapTrifunctorMapObj_ext** 是 Mathlib 中的一个引理，位于命名空间 
`CategoryTheory.GradedObject`。
形式化陈述：mapTrifunctorMapObj_ext {X₁ : GradedObject I₁ C₁} {X₂ : GradedObject I₂ C₂
} {X₃ : GradedObject I₃ C₃} {Y : C₄} (j : J) [HasMap ((((mapTrifunctor F I₁ I₂ I
₃).obj X₁).obj X₂).obj X₃) p] {φ φ' : mapTrifunctorMapObj F p X₁ X₂ X₃ j ⟶ Y} (h
 : forall (i₁ : I₁) (i₂ : I₂) (i₃ : I₃) (h : p ⟨i₁, i₂, i₃⟩ = j), ιMapTrifunctor
MapObj F p X₁ X₂ X₃ i₁ i₂ i₃ j h ≫ φ = ιMapTrifunctorMapObj F p X₁ X₂ X₃ i₁ i₂ i
₃ j h ≫ φ') : φ = φ'
参数：j : J；(((mapTrifunctor F I₁ I₂ I₃).obj X₁).obj X₂).obj X₃；h : forall (i₁ : I₁
) (i₂ : I₂) (i₃ : I₃) (h : p ⟨i₁, i₂, i₃⟩ = j), ιMapTrifunctorMapObj F p X₁ X₂ X
₃ i₁ i₂ i₃ j h ≫ φ = ιMapTrifunctorMapObj F p X₁ X₂ X₃ i₁ i₂ i₃ j h ≫ φ'。
该定理/引理给出了一组等式。
黑盒证明引用了以下数学事实（定理与引理）：
...
@[simps]
/-
**CategoryTheory.GradedObject.mapTrifunctorMapFunctorObj** 是 Mathlib 中的一个定义，位于命名
空间 `CategoryTheory.GradedObject`。
形式化陈述：mapTrifunctorMapFunctorObj (X₁ : GradedObject I₁ C₁) [forall X₂ X₃, HasMap
 ((((mapTrifunctor F I₁ I₂ I₃).obj X₁).obj X₂).obj X₃) p] : GradedObject I₂ C₂ ⥤
 GradedObject I₃ C₃ ⥤ GradedObject J C₄ where obj X₂
参数：X₁ : GradedObject I₁ C₁；(((mapTrifunctor F I₁ I₂ I₃).obj X₁).obj X₂).obj X₃。
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
Given a trifunctor `F : C₁ ⥤ C₂ ⥤ C₃ ⥤ C₄`, a map `p : I₁ × I₂ × I₃ → J`, and
graded objects `X₁ : GradedObject I₁ C₁`, `X₂ : GradedObject I₂ C₂` and `X₃ : Gr
adedObject I₃ C₃`,
this is the `J`-graded object sending `j` to the coproduct of
`((F.obj (X₁ i₁)).obj (X₂ i₂)).obj (X₃ i₃)` for `p ⟨i₁, i₂, i₃⟩ = j`.
-/
...
`((F.obj (X₁ i₁)).obj (X₂ i₂)).obj (X₃ i₃)` for `p ⟨i₁, i₂, i₃⟩ = j`. -/
/-
**CategoryTheory.GradedObject.mapTrifunctorMap** 是 Mathlib 中的一个定义，位于命名空间 `Catego
ryTheory.GradedObject`。
形式化陈述：mapTrifunctorMap [forall X₁ X₂ X₃, HasMap ((((mapTrifunctor F I₁ I₂ I₃).ob
j X₁).obj X₂).obj X₃) p] : GradedObject I₁ C₁ ⥤ GradedObject I₂ C₂ ⥤ GradedObjec
t I₃ C₃ ⥤ GradedObject J C₄ where obj X₁
参数：(((mapTrifunctor F I₁ I₂ I₃).obj X₁).obj X₂).obj X₃。
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
`GradedObject I₁ C₁ ⥤ GradedObject I₂ C₂ ⥤ GradedObject I₃ C₃ ⥤ GradedObject J C
₄`
sending `X₁ : GradedObject I₁ C₁`, `X₂ : GradedObject I₂ C₂` and `X₃ : GradedObj
ect I₃ C₃`
to the `J`-graded object sending `j` to the coproduct of
`((F.obj (X₁ i₁)).obj (X₂ i₂)).obj (X₃ i₃)` for `p ⟨i₁, i₂, i₃⟩ = j`.
-/
...
/-
**CategoryTheory.GradedObject.BifunctorComp** 是 Mathlib 中的一个结构，位于命名空间 `CategoryT
heory.GradedObject`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
Given a map `r : I₁ × I₂ × I₃ → J`, a `BifunctorComp₁₂IndexData r` consists of t
he data
of a type `I₁₂`, maps `p : I₁ × I₂ → I₁₂` and `q : I₁₂ × I₃ → J`, such that `r` 
is obtained
by composition of `p` and `q`.
-/
...
such that `ρ₁₂.p ⟨i₁, i₂⟩ = i₁₂`. -/
/-
**CategoryTheory.GradedObject.HasGoodTrifunctor** 是 Mathlib 中的一个缩写定义，位于命名空间 `Cat
egoryTheory.GradedObject`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
`X₁ : GradedObject I₁ C₁`, `X₂ : GradedObject I₂ C₂`, `X₃ : GradedObject I₃ C₃` 
and
`ρ₁₂ : BifunctorComp₁₂IndexData r`, this asserts that for all `i₁₂ : ρ₁₂.I₁₂` an
d `i₃ : I₃`,
the functor `G(-, X₃ i₃)` commutes with the coproducts of the `F₁₂(X₁ i₁, X₂ i₂)
`
such that `ρ₁₂.p ⟨i₁, i₂⟩ = i₁₂`.
...
/-
**CategoryTheory.GradedObject.cofan** 是 Mathlib 中的一个定义，位于命名空间 `CategoryTheory.Gr
adedObject`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**CategoryTheory.GradedObject.isColimitCofan** 是 Mathlib 中的一个定义，位于命名空间 `Category
Theory.GradedObject`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
The cofan `cofan₃MapBifunctor₁₂BifunctorMapObj` is a colimit, see the induced is
omorphism
`mapBifunctorComp₁₂MapObjIso`.
-/
...
include ρ₁₂ in
/-
**CategoryTheory.GradedObject.HasGoodTrifunctor** 是 Mathlib 中的一个引理，位于命名空间 `Categ
...
/-
**CategoryTheory.GradedObject.mapBifunctorComp** 是 Mathlib 中的一个定义，位于命名空间 `Catego
ryTheory.GradedObject`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
The action on graded objects of a trifunctor obtained by composition of two
bifunctors can be computed as a composition of the actions of these two bifuncto
rs.
-/
...
`X₁ : GradedObject I₁ C₁`, `X₂ : GradedObject I₂ C₂`, `X₃ : GradedObject I₃ C₃` 
and
`ρ₂₃ : BifunctorComp₂₃IndexData r`, this asserts that for all `i₁ : I₁` and `i₂₃
 : ρ₂₃.I₂₃`,
the functor `F(X₁ i₁, _)` commutes with the coproducts of the `G₂₃(X₂ i₂, X₃ i₃)
`
such that `ρ₂₃.p ⟨i₂, i₃⟩ = i₂₃`.
...
--- 原说明 ---
The cofan `cofan₃MapBifunctorBifunctor₂₃MapObj` is a colimit, see the induced is
omorphism
`mapBifunctorComp₁₂MapObjIso`.
-/
...
@[ext]
/-
**CategoryTheory.GradedObject.mapBifunctorBifunctor** 是 Mathlib 中的一个引理，位于命名空间 `C
...
`mapBifunctorMapObj F ρ₂₃.q X₁ (mapBifunctorMapObj G₂₃ ρ₂₃.p X₂ X₃) j`. -/
/-
**CategoryTheory.GradedObject.mapBifunctorBifunctor** 是 Mathlib 中的一个定义，位于命名空间 `C
ategoryTheory.GradedObject`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
