...
theorem uniformCauchySeqOnFilter_of_fderiv
  ...
  suffices
    TendstoUniformlyOnFilter (fun (n : ι × ι) (z : E) => f n.1 z - f n.2 z -
...
theorem difference_quotients_converge_uniformly
  ...
  rw [SeminormedAddGroup.uniformCauchyS
...
theorem uniformCauchySeqOn_ball_of_deriv
  ...
  exact uniformCauchySeqOn_ball_of_fderiv hf' h
...
theorem hasDerivAt_of_tendstoUniformly
  ...
  have hf' : TendstoUniformlyOn f' g' l Set.univ := by rwa 
