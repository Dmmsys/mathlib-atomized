...
/--
theorem `eventuallyConst_of_isNoetherian` / 定理 `eventuallyConst_of_isNoetherian`

English:
theorem eventuallyConst_of_isNoetherian
  given: [IsNoetherian R M] (f : Nat ->o Submodule R M)
  proof: by
...
Depends on / 依赖: eq_comm, eventuallyConst_atTop, monotone_stabilizes_iff_noetherian, monotone_stabilizes_iff_noetherian.mpr, simp_rw
-/
theorem eventuallyConst_of_isNoetherian [IsNoetherian R M] (f : Nat ->o Submodule R M) :
