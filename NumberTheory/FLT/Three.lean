...
/-
**cube_of_castHom_ne_zero** 是 Mathlib 中的一个引理，位于命名空间 ``。
形式化陈述：cube_of_castHom_ne_zero {n : ZMod 9} : castHom (show 3 ∣ 9 by simp) (ZMod 
3) n != 0 -> n ^ 3 = 1 ∨ n ^ 3 = 8
该定理/引理给出了一组等式。
...
lemma cube_of_castHom_ne_zero {n : ZMod 9} :
  ...
  revert n; decide
/-
**cube_of_not_dvd** 是 Mathlib 中的一个引理，位于命名空间 ``。
形式化陈述：cube_of_not_dvd {n : Int} (h : ¬ 3 ∣ n) : (n : ZMod 9) ^ 3 = 1 ∨ (n : ZMod
 9) ^ 3 = 8
参数：h : ¬ 3 ∣ n。
该定理/引理给出了一组等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**fermatLastTheoremThree_case_1** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：fermatLastTheoremThree_case_1 {a b c : Int} (hdvd : ¬ 3 ∣ a * b * c) : a ^
 3 + b ^ 3 != c ^ 3
参数：hdvd : ¬ 3 ∣ a * b * c。
该定理/引理给出了一组等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**three_dvd_b_of_dvd_a_of_gcd_eq_one_of_case2** 是 Mathlib 中的一个引理，位于命名空间 ``。
形式化陈述：three_dvd_b_of_dvd_a_of_gcd_eq_one_of_case2 {a b c : Int} (ha : a != 0) (H
gcd : Finset.gcd {a, b, c} id = 1) (h3a : 3 ∣ a) (HF : a ^ 3 + b ^ 3 + c ^ 3 = 0
) (H : forall a b c : Int, c != 0 -> ¬ 3 ∣ a -> ¬ 3 ∣ b -> 3 ∣ c -> IsCoprime a 
b -> a ^ 3 + b ^ 3 != c ^ 3) : 3 ∣ b
参数：ha : a != 0；Hgcd : Finset.gcd {a, b, c} id = 1；h3a : 3 ∣ a；HF : a ^ 3 + b ^ 3
 + c ^ 3 = 0；H : forall a b c : Int, c != 0 -> ¬ 3 ∣ a -> ¬ 3 ∣ b -> 3 ∣ c -> Is
Coprime a b -> a ^ 3 + b ^ 3 != c ^ 3。
该定理/引理描述了相关对象所满足的性质。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
open Finset in
/-
**fermatLastTheoremThree_of_dvd_a_of_gcd_eq_one_of_case2** 是 Mathlib 中的一个引理，位于命名
空间 ``。
形式化陈述：fermatLastTheoremThree_of_dvd_a_of_gcd_eq_one_of_case2 {a b c : Int} (ha :
 a != 0) (h3a : 3 ∣ a) (Hgcd : Finset.gcd {a, b, c} id = 1) (H : forall a b c : 
Int, c != 0 -> ¬ 3 ∣ a -> ¬ 3 ∣ b -> 3 ∣ c -> IsCoprime a b -> a ^ 3 + b ^ 3 != 
c ^ 3) : a ^ 3 + b ^ 3 + c ^ 3 != 0
参数：ha : a != 0；h3a : 3 ∣ a；Hgcd : Finset.gcd {a, b, c} id = 1；H : forall a b c :
 Int, c != 0 -> ¬ 3 ∣ a -> ¬ 3 ∣ b -> 3 ∣ c -> IsCoprime a b -> a ^ 3 + b ^ 3 !=
 c ^ 3。
该定理/引理给出了一组等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
-/
/-
**fermatLastTheoremThree_of_three_dvd_only_c** 是 Mathlib 中的一个定理，位于命名空间 ``。
形式化陈述：fermatLastTheoremThree_of_three_dvd_only_c (H : forall a b c : Int, c != 0
 -> ¬ 3 ∣ a -> ¬ 3 ∣ b -> 3 ∣ c -> IsCoprime a b -> a ^ 3 + b ^ 3 != c ^ 3) : Fe
rmatLastTheoremFor 3
参数：H : forall a b c : Int, c != 0 -> ¬ 3 ∣ a -> ¬ 3 ∣ b -> 3 ∣ c -> IsCoprime a 
b -> a ^ 3 + b ^ 3 != c ^ 3。
该定理/引理描述了相关对象所满足的性质。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
To prove Fermat's Last Theorem for `n = 3`, it is enough to show that for all `a
`, `b`, `c`
in `ℤ` such that `c ≠ 0`, `¬ 3 ∣ a`, `¬ 3 ∣ b`, `a` and `b` are coprime and `3 ∣
 c`, we have
`a ^ 3 + b ^ 3 ≠ c ^ 3`.
-/
...
/-
**FermatLastTheoremForThreeGen** 是 Mathlib 中的一个定义，位于命名空间 ``。
形式化陈述：FermatLastTheoremForThreeGen : Prop
该定义给出了上述对象。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
`FermatLastTheoremForThreeGen` is the statement that `a ^ 3 + b ^ 3 = u * c ^ 3`
 has no
nontrivial solutions in `𝓞 K` for all `u : (𝓞 K)ˣ` such that `¬ λ ∣ a`, `¬ λ ∣ b
` and `λ ∣ c`.
The reason to consider `FermatLastTheoremForThreeGen` is to make a descent argum
ent working.
-/
...
/-
**FermatLastTheoremForThree_of_FermatLastTheoremThreeGen** 是 Mathlib 中的一个引理，位于命名
空间 ``。
形式化陈述：FermatLastTheoremForThree_of_FermatLastTheoremThreeGen [NumberField K] [Is
CyclotomicExtension {3} Rat K] : FermatLastTheoremForThreeGen hζ -> FermatLastTh
eoremFor 3
该定理/引理描述了相关对象所满足的性质。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
To prove `FermatLastTheoremFor 3`, it is enough to prove `FermatLastTheoremForTh
reeGen`.
-/
...
/-
**FermatLastTheoremForThreeGen.Solution'** 是 Mathlib 中的一个引理，位于命名空间 `FermatLastTh
eoremForThreeGen`。
形式化陈述：Solution'.multiplicity_lambda_c_finite : FiniteMultiplicity (hζ.toInteger 
- 1) S'.c
该定理/引理描述了相关对象所满足的性质。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**FermatLastTheoremForThreeGen.Solution** 是 Mathlib 中的一个结构，位于命名空间 `FermatLastThe
oremForThreeGen`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
`Solution` is the same as `Solution'` with the additional assumption that `λ ^ 2
 ∣ a + b`.
-/
...
/-
**FermatLastTheoremForThreeGen.Solution'.multiplicity_lambda_c_finite** 是 Mathli
b 中的一个引理，位于命名空间 `FermatLastTheoremForThreeGen`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
number. -/
/-
**FermatLastTheoremForThreeGen.Solution'.multiplicity** 是 Mathlib 中的一个定义，位于命名空间 
`FermatLastTheoremForThreeGen`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
Given `S' : Solution'`, `S'.multiplicity` is the multiplicity of `λ` in `S'.c`, 
as a natural
number.
-/
...
--- 原说明 ---
Given `S : Solution`, `S.multiplicity` is the multiplicity of `λ` in `S.c`, as a
 natural
number.
-/
...
/-
**FermatLastTheoremForThreeGen.Solution.isMinimal** 是 Mathlib 中的一个定义，位于命名空间 `Fer
matLastTheoremForThreeGen`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
We say that `S : Solution` is minimal if for all `S₁ : Solution`, the multiplici
ty of `λ` in
`S.c` is less or equal than the multiplicity in `S₁.c`.
-/
...
/-
**FermatLastTheoremForThreeGen.Solution.exists_minimal** 是 Mathlib 中的一个引理，位于命名空间
 `FermatLastTheoremForThreeGen`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
both congruent to `-1`. -/
/-
**FermatLastTheoremForThreeGen.a_cube_b_cube_congr_one_or_neg_one** 是 Mathlib 中的
一个引理，位于命名空间 `FermatLastTheoremForThreeGen`。
形式化陈述：a_cube_b_cube_congr_one_or_neg_one : fun ^ 4 ∣ S'.a ^ 3 - 1 ∧ fun ^ 4 ∣ S'
.b ^ 3 + 1 ∨ fun ^ 4 ∣ S'.a ^ 3 + 1 ∧ fun ^ 4 ∣ S'.b ^ 3 - 1
该定理/引理描述了相关对象所满足的性质。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
Given `S' : Solution'`, then `S'.a` and `S'.b` are both congruent to `1` modulo 
`λ ^ 4` or are
both congruent to `-1`.
-/
...
/-
**FermatLastTheoremForThreeGen.lambda_pow_four_dvd_c_cube** 是 Mathlib 中的一个引理，位于命
名空间 `FermatLastTheoremForThreeGen`。
形式化陈述：lambda_pow_four_dvd_c_cube : fun ^ 4 ∣ S'.c ^ 3
该定理/引理描述了相关对象所满足的性质。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**FermatLastTheoremForThreeGen.lambda_sq_dvd_c** 是 Mathlib 中的一个引理，位于命名空间 `Fermat
LastTheoremForThreeGen`。
形式化陈述：lambda_sq_dvd_c : fun ^ 2 ∣ S'.c
该定理/引理描述了相关对象所满足的性质。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**FermatLastTheoremForThreeGen.Solution'.two_le_multiplicity** 是 Mathlib 中的一个引理，
位于命名空间 `FermatLastTheoremForThreeGen`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-- Given `S : Solution`, we have that `2 ≤ S.multiplicity`. -/
/-
**FermatLastTheoremForThreeGen.Solution.two_le_multiplicity** 是 Mathlib 中的一个引理，位
于命名空间 `FermatLastTheoremForThreeGen`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**FermatLastTheoremForThreeGen.a_cube_add_b_cube_eq_mul** 是 Mathlib 中的一个引理，位于命名空
间 `FermatLastTheoremForThreeGen`。
形式化陈述：a_cube_add_b_cube_eq_mul : S'.a ^ 3 + S'.b ^ 3 = (S'.a + S'.b) * (S'.a + η
 * S'.b) * (S'.a + η ^ 2 * S'.b)
该定理/引理给出了一组等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**FermatLastTheoremForThreeGen.lambda_sq_dvd_or_dvd_or_dvd** 是 Mathlib 中的一个引理，位于
命名空间 `FermatLastTheoremForThreeGen`。
形式化陈述：lambda_sq_dvd_or_dvd_or_dvd : fun ^ 2 ∣ S'.a + S'.b ∨ fun ^ 2 ∣ S'.a + η *
 S'.b ∨ fun ^ 2 ∣ S'.a + η ^ 2 * S'.b
该定理/引理描述了相关对象所满足的性质。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
result below). -/
/-
**FermatLastTheoremForThreeGen.ex_cube_add_cube_eq_and_isCoprime_and_not_dvd_and
_dvd** 是 Mathlib 中的一个引理，位于命名空间 `FermatLastTheoremForThreeGen`。
形式化陈述：ex_cube_add_cube_eq_and_isCoprime_and_not_dvd_and_dvd : exists (a' b' : 𝓞 
K), a' ^ 3 + b' ^ 3 = S'.u * S'.c ^ 3 ∧ IsCoprime a' b' ∧ ¬ fun ∣ a' ∧ ¬ fun ∣ b
' ∧ fun ^ 2 ∣ a' + b'
该定理/引理给出了一组等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
Given `S' : Solution'`, we may assume that `λ ^ 2` divides `S'.a + S'.b ∨ λ ^ 2`
 (see also the
result below).
-/
...
/-
**FermatLastTheoremForThreeGen.exists_Solution_of_Solution'** 是 Mathlib 中的一个引理，位
于命名空间 `FermatLastTheoremForThreeGen`。
形式化陈述：exists_Solution_of_Solution' : exists (S₁ : Solution hζ), S₁.multiplicity 
= S'.multiplicity
该定理/引理给出了一组等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**FermatLastTheoremForThreeGen.Solution.a_add_eta_mul_b** 是 Mathlib 中的一个引理，位于命名空
间 `FermatLastTheoremForThreeGen.Solution`。
形式化陈述：a_add_eta_mul_b : S.a + η * S.b = (S.a + S.b) + fun * S.b
该定理/引理给出了一组等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**FermatLastTheoremForThreeGen.Solution.lambda_dvd_a_add_eta_mul_b** 是 Mathlib 中
的一个引理，位于命名空间 `FermatLastTheoremForThreeGen.Solution`。
形式化陈述：lambda_dvd_a_add_eta_mul_b : fun ∣ (S.a + η * S.b)
该定理/引理描述了相关对象所满足的性质。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**FermatLastTheoremForThreeGen.Solution.lambda_dvd_a_add_eta_sq_mul_b** 是 Mathli
b 中的一个引理，位于命名空间 `FermatLastTheoremForThreeGen.Solution`。
形式化陈述：lambda_dvd_a_add_eta_sq_mul_b : fun ∣ (S.a + η ^ 2 * S.b)
该定理/引理描述了相关对象所满足的性质。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**FermatLastTheoremForThreeGen.Solution.lambda_sq_not_dvd_a_add_eta_mul_b** 是 Ma
thlib 中的一个引理，位于命名空间 `FermatLastTheoremForThreeGen.Solution`。
形式化陈述：lambda_sq_not_dvd_a_add_eta_mul_b : ¬ fun ^ 2 ∣ (S.a + η * S.b)
该定理/引理描述了相关对象所满足的性质。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**FermatLastTheoremForThreeGen.Solution.lambda_sq_not_dvd_a_add_eta_sq_mul_b** 是
 Mathlib 中的一个引理，位于命名空间 `FermatLastTheoremForThreeGen.Solution`。
形式化陈述：lambda_sq_not_dvd_a_add_eta_sq_mul_b : ¬ fun ^ 2 ∣ (S.a + η ^ 2 * S.b)
该定理/引理描述了相关对象所满足的性质。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**FermatLastTheoremForThreeGen.Solution.associated_of_dvd_a_add_b_of_dvd_a_add_e
ta_mul_b** 是 Mathlib 中的一个引理，位于命名空间 `FermatLastTheoremForThreeGen.Solution`。
形式化陈述：associated_of_dvd_a_add_b_of_dvd_a_add_eta_mul_b {p : 𝓞 K} (hp : Prime p) 
(hpab : p ∣ S.a + S.b) (hpaηb : p ∣ S.a + η * S.b) : Associated p fun
参数：hp : Prime p；hpab : p ∣ S.a + S.b；hpaηb : p ∣ S.a + η * S.b。
该定理/引理描述了相关对象所满足的性质。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
If `p : 𝓞 K` is a prime that divides both `S.a + S.b` and `S.a + η * S.b`, then 
`p`
is associated with `λ`.
-/
...
/-
**FermatLastTheoremForThreeGen.Solution.associated_of_dvd_a_add_b_of_dvd_a_add_e
ta_sq_mul_b** 是 Mathlib 中的一个引理，位于命名空间 `FermatLastTheoremForThreeGen.Solution`。
形式化陈述：associated_of_dvd_a_add_b_of_dvd_a_add_eta_sq_mul_b {p : 𝓞 K} (hp : Prime 
p) (hpab : p ∣ (S.a + S.b)) (hpaηsqb : p ∣ (S.a + η ^ 2 * S.b)) : Associated p f
un
参数：hp : Prime p；hpab : p ∣ (S.a + S.b)；hpaηsqb : p ∣ (S.a + η ^ 2 * S.b)。
该定理/引理描述了相关对象所满足的性质。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
If `p : 𝓞 K` is a prime that divides both `S.a + S.b` and `S.a + η ^ 2 * S.b`, t
hen `p`
is associated with `λ`.
-/
...
is associated with `λ`. -/
/-
**FermatLastTheoremForThreeGen.Solution.associated_of_dvd_a_add_eta_mul_b_of_dvd
_a_add_eta_sq_mul_b** 是 Mathlib 中的一个引理，位于命名空间 `FermatLastTheoremForThreeGen.Solu
tion`。
形式化陈述：associated_of_dvd_a_add_eta_mul_b_of_dvd_a_add_eta_sq_mul_b {p : 𝓞 K} (hp 
: Prime p) (hpaηb : p ∣ S.a + η * S.b) (hpaηsqb : p ∣ S.a + η ^ 2 * S.b) : Assoc
iated p fun
参数：hp : Prime p；hpaηb : p ∣ S.a + η * S.b；hpaηsqb : p ∣ S.a + η ^ 2 * S.b。
该定理/引理描述了相关对象所满足的性质。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
If `p : 𝓞 K` is a prime that divides both `S.a + η * S.b` and `S.a + η ^ 2 * S.b
`, then `p`
is associated with `λ`.
-/
...
/-
**FermatLastTheoremForThreeGen.Solution.y** 是 Mathlib 中的一个定义，位于命名空间 `FermatLastT
heoremForThreeGen.Solution`。
形式化陈述：y
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
Given `S : Solution`, we let `S.y` be any element such that `S.a + η * S.b = λ *
 S.y`
-/
noncomputable def y := (lambda_dvd_a_add_eta_mul_b S).choose
/-
**FermatLastTheoremForThreeGen.Solution.y_spec** 是 Mathlib 中的一个引理，位于命名空间 `Fermat
LastTheoremForThreeGen.Solution`。
形式化陈述：y_spec : S.a + η * S.b = fun * S.y
该定理/引理给出了一组等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**FermatLastTheoremForThreeGen.Solution.z** 是 Mathlib 中的一个定义，位于命名空间 `FermatLastT
heoremForThreeGen.Solution`。
形式化陈述：z
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
Given `S : Solution`, we let `S.z` be any element such that `S.a + η ^ 2 * S.b =
 λ * S.z`
-/
noncomputable def z := (lambda_dvd_a_add_eta_sq_mul_b S).choose
/-
**FermatLastTheoremForThreeGen.Solution.z_spec** 是 Mathlib 中的一个引理，位于命名空间 `Fermat
LastTheoremForThreeGen.Solution`。
形式化陈述：z_spec : S.a + η ^ 2 * S.b = fun * S.z
该定理/引理给出了一组等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
variable [NumberField K] [IsCyclotomicExtension {3} ℚ K]
/-
**FermatLastTheoremForThreeGen.Solution.lambda_not_dvd_y** 是 Mathlib 中的一个引理，位于命名
空间 `FermatLastTheoremForThreeGen.Solution`。
形式化陈述：lambda_not_dvd_y : ¬ fun ∣ S.y
该定理/引理描述了相关对象所满足的性质。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**FermatLastTheoremForThreeGen.Solution.lambda_not_dvd_z** 是 Mathlib 中的一个引理，位于命名
空间 `FermatLastTheoremForThreeGen.Solution`。
形式化陈述：lambda_not_dvd_z : ¬ fun ∣ S.z
该定理/引理描述了相关对象所满足的性质。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**FermatLastTheoremForThreeGen.Solution.lambda_pow_dvd_a_add_b** 是 Mathlib 中的一个引
理，位于命名空间 `FermatLastTheoremForThreeGen.Solution`。
形式化陈述：lambda_pow_dvd_a_add_b : fun ^ (3 * S.multiplicity - 2) ∣ S.a + S.b
该定理/引理描述了相关对象所满足的性质。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**FermatLastTheoremForThreeGen.Solution.x** 是 Mathlib 中的一个定义，位于命名空间 `FermatLastT
heoremForThreeGen.Solution`。
形式化陈述：x
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**FermatLastTheoremForThreeGen.Solution.x_spec** 是 Mathlib 中的一个引理，位于命名空间 `Fermat
LastTheoremForThreeGen.Solution`。
形式化陈述：x_spec : S.a + S.b = fun ^ (3 * S.multiplicity - 2) * S.x
该定理/引理给出了一组等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**FermatLastTheoremForThreeGen.Solution.w** 是 Mathlib 中的一个定义，位于命名空间 `FermatLastT
heoremForThreeGen.Solution`。
形式化陈述：w
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
Given `S : Solution`, we let `S.w` be any element such that `S.c = λ ^ S.multipl
icity * S.w`
-/
noncomputable def w :=
...
omit [NumberField K] [IsCyclotomicExtension {3} ℚ K] in
/-
**FermatLastTheoremForThreeGen.Solution.w_spec** 是 Mathlib 中的一个引理，位于命名空间 `Fermat
LastTheoremForThreeGen.Solution`。
形式化陈述：w_spec : S.c = fun ^ S.multiplicity * S.w
该定理/引理给出了一组等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**FermatLastTheoremForThreeGen.Solution.lambda_not_dvd_w** 是 Mathlib 中的一个引理，位于命名
空间 `FermatLastTheoremForThreeGen.Solution`。
形式化陈述：lambda_not_dvd_w : ¬ fun ∣ S.w
该定理/引理描述了相关对象所满足的性质。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**FermatLastTheoremForThreeGen.Solution.lambda_not_dvd_x** 是 Mathlib 中的一个引理，位于命名
空间 `FermatLastTheoremForThreeGen.Solution`。
形式化陈述：lambda_not_dvd_x : ¬ fun ∣ S.x
该定理/引理描述了相关对象所满足的性质。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
attribute [local instance] IsCyclotomicExtension.Rat.three_pid
/-
**FermatLastTheoremForThreeGen.Solution.isCoprime_helper** 是 Mathlib 中的一个引理，位于命名
空间 `FermatLastTheoremForThreeGen.Solution`。
形式化陈述：isCoprime_helper {r s t w : 𝓞 K} (hr : ¬ fun ∣ r) (hs : ¬ fun ∣ s) (Hp : f
orall {p}, Prime p -> p ∣ t -> p ∣ w -> Associated p fun) (H₁ : forall {q}, q ∣ 
r -> q ∣ t) (H₂ : forall {q}, q ∣ s -> q ∣ w) : IsCoprime r s
参数：hr : ¬ fun ∣ r；hs : ¬ fun ∣ s；Hp : forall {p}, Prime p -> p ∣ t -> p ∣ w -> A
ssociated p fun；H₁ : forall {q}, q ∣ r -> q ∣ t；H₂ : forall {q}, q ∣ s -> q ∣ w。
该定理/引理描述了相关对象所满足的性质。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**FermatLastTheoremForThreeGen.Solution.isCoprime_x_y** 是 Mathlib 中的一个引理，位于命名空间 
`FermatLastTheoremForThreeGen.Solution`。
形式化陈述：isCoprime_x_y : IsCoprime S.x S.y
该定理/引理描述了相关对象所满足的性质。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**FermatLastTheoremForThreeGen.Solution.isCoprime_x_z** 是 Mathlib 中的一个引理，位于命名空间 
`FermatLastTheoremForThreeGen.Solution`。
形式化陈述：isCoprime_x_z : IsCoprime S.x S.z
该定理/引理描述了相关对象所满足的性质。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**FermatLastTheoremForThreeGen.Solution.isCoprime_y_z** 是 Mathlib 中的一个引理，位于命名空间 
`FermatLastTheoremForThreeGen.Solution`。
形式化陈述：isCoprime_y_z : IsCoprime S.y S.z
该定理/引理描述了相关对象所满足的性质。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**FermatLastTheoremForThreeGen.Solution.x_mul_y_mul_z_eq_u_mul_w_cube** 是 Mathli
b 中的一个引理，位于命名空间 `FermatLastTheoremForThreeGen.Solution`。
形式化陈述：x_mul_y_mul_z_eq_u_mul_w_cube : S.x * S.y * S.z = S.u * S.w ^ 3
该定理/引理给出了一组等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
lemma x_mul_y_mul_z_eq_u_mul_w_cube : S.x * S.y * S.z = S.u * S.w ^ 3 := by
  ...
  ring
/-
**FermatLastTheoremForThreeGen.Solution.exists_cube_associated** 是 Mathlib 中的一个引
理，位于命名空间 `FermatLastTheoremForThreeGen.Solution`。
形式化陈述：exists_cube_associated : (exists X, Associated (X ^ 3) S.x) ∧ (exists Y, A
ssociated (Y ^ 3) S.y) ∧ exists Z, Associated (Z ^ 3) S.z
该定理/引理描述了相关对象所满足的性质。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**FermatLastTheoremForThreeGen.Solution.u** 是 Mathlib 中的一个定义，位于命名空间 `FermatLastT
heoremForThreeGen.Solution`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
noncomputable def u₁ := (exists_cube_associated S).1.choose_spec.choose
/-
**FermatLastTheoremForThreeGen.Solution.X_u** 是 Mathlib 中的一个引理，位于命名空间 `FermatLas
tTheoremForThreeGen.Solution`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**FermatLastTheoremForThreeGen.Solution.Y_u** 是 Mathlib 中的一个引理，位于命名空间 `FermatLas
tTheoremForThreeGen.Solution`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**FermatLastTheoremForThreeGen.Solution.Z_u** 是 Mathlib 中的一个引理，位于命名空间 `FermatLas
tTheoremForThreeGen.Solution`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**FermatLastTheoremForThreeGen.Solution.X_ne_zero** 是 Mathlib 中的一个引理，位于命名空间 `Fer
matLastTheoremForThreeGen.Solution`。
形式化陈述：X_ne_zero : S.X != 0
该定理/引理给出了一组等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
set_option linter.style.whitespace false in
/-
**FermatLastTheoremForThreeGen.Solution.formula1** 是 Mathlib 中的一个引理，位于命名空间 `Ferm
atLastTheoremForThreeGen.Solution`。
形式化陈述：formula1 : S.X^3*S.u₁*fun^(3*S.multiplicity-2)+S.Y^3*S.u₂*fun*η+S.Z^3*S.u₃
*fun*η^2 = 0
该定理/引理给出了一组等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**FermatLastTheoremForThreeGen.Solution.u** 是 Mathlib 中的一个引理，位于命名空间 `FermatLastT
heoremForThreeGen.Solution`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**FermatLastTheoremForThreeGen.Solution.** 是 Mathlib 中的一个示例，位于命名空间 `FermatLastTh
eoremForThreeGen.Solution`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
set_option linter.style.whitespace false in
/-
**FermatLastTheoremForThreeGen.Solution.formula2** 是 Mathlib 中的一个引理，位于命名空间 `Ferm
atLastTheoremForThreeGen.Solution`。
形式化陈述：formula2 : S.Y ^ 3 + S.u₄ * S.Z ^ 3 = S.u₅ * (fun ^ (S.multiplicity - 1) *
 S.X) ^ 3
该定理/引理给出了一组等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
set_option linter.style.whitespace false in
/-
**FermatLastTheoremForThreeGen.Solution.lambda_sq_div_u** 是 Mathlib 中的一个引理，位于命名空
间 `FermatLastTheoremForThreeGen.Solution`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**FermatLastTheoremForThreeGen.Solution.formula3** 是 Mathlib 中的一个引理，位于命名空间 `Ferm
atLastTheoremForThreeGen.Solution`。
形式化陈述：formula3 : S.Y ^ 3 + (S.u₄ * S.Z) ^ 3 = S.u₅ * (fun ^ (S.multiplicity - 1)
 * S.X) ^ 3
该定理/引理给出了一组等式。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**FermatLastTheoremForThreeGen.Solution.Solution'_descent** 是 Mathlib 中的一个定义，位于命
名空间 `FermatLastTheoremForThreeGen.Solution`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。

--- 原说明 ---
Given `S : Solution`, we construct `S₁ : Solution'`, with smaller multiplicity o
f `λ` in
  `c` (see `Solution'_descent_multiplicity_lt` below.).
-/
...
/-
**FermatLastTheoremForThreeGen.Solution.Solution'_descent_multiplicity** 是 Mathl
ib 中的一个引理，位于命名空间 `FermatLastTheoremForThreeGen.Solution`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-
**FermatLastTheoremForThreeGen.Solution.Solution'_descent_multiplicity_lt** 是 Ma
thlib 中的一个引理，位于命名空间 `FermatLastTheoremForThreeGen.Solution`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
...
/-- Given any `S : Solution`, there is another `S₁ : Solution` such that
  `S₁.multiplicity < S.multiplicity` -/
/-
**FermatLastTheoremForThreeGen.Solution.exists_Solution_multiplicity_lt** 是 Math
lib 中的一个定理，位于命名空间 `FermatLastTheoremForThreeGen.Solution`。
形式化陈述：exists_Solution_multiplicity_lt : exists S₁ : Solution hζ, S₁.multiplicity
 < S.multiplicity
该定理/引理描述了相关对象所满足的性质。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
