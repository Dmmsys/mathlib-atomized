...
include f in
/--
lemma `Module.FinitePresentation.exists_basis_localizedModule_powers` / 引理 `Module.FinitePresentation.exists_basis_localizedModule_powers`
...
lemma Module.FinitePresentation.exists_basis_localizedModule_powers
    ...
    exists (r : R) (hr : r in S)
      ...
      forall i, (LocalizedModule.lift (.powers r) f fun s => IsLocalizedModule.map_units f
...
include f in
/--
lemma `Module.FinitePresentation.exists_free_localizedModule_powers` / 引理 `Module.FinitePresentation.exists_free_localizedModule_powers`
