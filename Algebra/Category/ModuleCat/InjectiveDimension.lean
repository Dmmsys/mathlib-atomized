...
/--
lemma `hasInjectiveDimensionLE_iff_of_linearEquiv_aux` / 引理 `hasInjectiveDimensionLE_iff_of_linearEquiv_aux`
...
lemma hasInjectiveDimensionLE_iff_of_linearEquiv_aux
  ...
  | zero =>
    simp [HasInjectiveDimensionLE, ← injective_iff_hasInjectiveDimensionLT_one,
      ...
      ← Module.Baer.iff_injec

中文:
引理 hasInjectiveDimensionLE_iff_of_linearEquiv_aux
  结论: [Small.{v} R]
  证明: by
  have : Small.{max v v'} R := small_lift R
  induction n generalizing M N with
...
private lemma hasInjectiveDimensionLE_iff_of_linearEquiv_aux [Small.{v} R]
    ...
    (e : M ≃ₗ[R] N) (n : Nat) : HasInjectiveDimensionLE M n ↔ HasInjectiveDimensionLE N n := by
  have : Small.{max v v'} R := small_lift R
  induction n generalizing M N with
  | zero =>
    simp [HasInjectiveDimensionLE, ← injective_iff_hasInjectiveDimensionLT_one,
...
/--
lemma `hasInjectiveDimensionLE_iff_of_linearEquiv` / 引理 `hasInjectiveDimensionLE_iff_of_linearEquiv`

English:
lemma hasInjectiveDimensionLE_iff_of_linearEquiv
  statement: [Small.{v} R] [Small.{v'} R]
  proof: by
  let eM : M ≃ₗ[R] ModuleCat.of R (ULift.{v'} M) := ULift.moduleEquiv.symm
  rw [hasInjectiveDimensionLE_iff_of_linearEquiv_aux eM]; rw [← hasInjectiveDimensionLE_iff_of_linearEquiv_aux (e.symm.trans eM)]

中文:
引理 hasInjectiveDimensionLE_iff_of_linearEquiv
  结论: [Small.{v} R] [Small.{v'} R]
  证明: by
  let eM : M ≃ₗ[R] ModuleCat.of R (ULift.{v'} M) := ULift.moduleEquiv.symm
  rw [hasInjectiveDimensionLE_iff_of_linearEquiv_aux eM]; rw [← hasInjectiveDimensionLE_iff_of_linearEquiv_aux (e.symm.trans eM)]

Depends on / 依赖: ModuleCat, ModuleCat.of, ULift.moduleEquiv.symm, e.symm.trans, hasInjectiveDimensionLE_iff_of_linearEquiv_aux, moduleEquiv
-/
...
/--
lemma `hasInjectiveDimensionLE_iff_of_semiLinearEquiv_aux` / 引理 `hasInjectiveDimensionLE_iff_of_semiLinearEquiv_aux`
...
中文:
引理 hasInjectiveDimensionLE_iff_of_semiLinearEquiv_aux
  结论: [Small.{v} R']
  证明: by
  induction n generalizing M N with
  | zero =>
...
private lemma hasInjectiveDimensionLE_iff_of_semiLinearEquiv_aux [Small.{v} R']
    ...
    (n : Nat) : HasInjectiveDimensionLE M n ↔ HasInjectiveDimensionLE N n := by
  induction n generalizing M N with
  | zero =>
    simp only [HasInjectiveDimensionLE, zero_add, ← injective_iff_hasInjectiveDimensionLT_one,
      ← Module.injective_iff_injective_object R M, ← Module.injective_iff_injective_object R' N]
...
/--
lemma `hasInjectiveDimensionLE_iff_of_semiLinearEquiv` / 引理 `hasInjectiveDimensionLE_iff_of_semiLinearEquiv`

English:
lemma hasInjectiveDimensionLE_iff_of_semiLinearEquiv
  statement: [Small.{v'} R']
  proof: by
  let eM : M ≃ₗ[R] ModuleCat.of R (ULift.{v'} M) := ULift.moduleEquiv.symm
  let eN : N ≃ₗ[R'] ModuleCat.of R' (ULift.{v} N) := ULift.moduleEquiv.symm
  rw [hasInjectiveDimensionLE_iff_of_linearEquiv_aux eM]; rw [hasInjectiveDimensionLE_iff_of_linearEquiv_aux eN]
  exact hasInjectiveDimensionLE_i

中文:
引理 hasInjectiveDimensionLE_iff_of_semiLinearEquiv
  结论: [Small.{v'} R']
  证明: by
  let eM : M ≃ₗ[R] ModuleCat.of R (ULift.{v'} M) := ULift.moduleEquiv.symm
  let eN : N ≃ₗ[R'] ModuleCat.of R' (ULift.{v} N) := ULift.moduleEquiv.symm
...
Depends on / 依赖: ModuleCat, ModuleCat.of, ULift.moduleEquiv.symm, eM.symm.trans, hasInjectiveDimensionLE_iff_of_linearEquiv_aux, hasInjectiveDimensionLE_iff_of_semiLinearEquiv_aux, moduleEquiv
-/
...
/--
lemma `injectiveDimension_eq_of_semiLinearEquiv` / 引理 `injectiveDimension_eq_of_semiLinearEquiv`

English:
lemma injectiveDimension_eq_of_semiLinearEquiv
  statement: [Small.{v'} R']
  proof: by
  ...
  | coe n =>
    ...
    | top => simp
    | coe n =>
      simp [injectiveDimension_le_iff, hasInjective

中文:
引理 injectiveDimension_eq_of_semiLinearEquiv
  结论: [Small.{v'} R']
  证明: by
  refine eq_of_forall_ge_iff (fun N => ?_)
  induction N with
...
Depends on / 依赖: ModuleCat, ModuleCat.isZero_iff_subsingleton, e.subsingleton_congr, eq_of_forall_ge_iff, hasInjectiveDimensionLE_iff_of_semiLinearEquiv, injectiveDimension_eq_bot_iff, injectiveDimension_le_iff, isZero_iff_subsingleton, subsingleton_congr
-/
...
/--
lemma `injectiveDimension_eq_of_linearEquiv` / 引理 `injectiveDimension_eq_of_linearEquiv`

English:
lemma injectiveDimension_eq_of_linearEquiv
  given: (e : M ≃ₗ[R] N)
  proof: injectiveDimension_eq_of_semiLinearEquiv.{v, v'} (M := M) (N := N) (RingEquiv.refl R) e

中文:
引理 injectiveDimension_eq_of_linearEquiv
  条件: (e : M ≃ₗ[R] N)
  证明: injectiveDimension_eq_of_semiLinearEquiv.{v, v'} (M := M) (N := N) (RingEquiv.refl R) e

Depends on / 依赖: RingEquiv, RingEquiv.refl, injectiveDimension_eq_of_semiLinearEquiv
-/
