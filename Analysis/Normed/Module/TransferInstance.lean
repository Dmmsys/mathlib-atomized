...
English:
abbreviation seminormedCommGroup
  signature: [SeminormedCommGroup β] (e : α ≃ β)
  body: letI := e.commGroup
...
English:
abbreviation normedCommGroup
  signature: [NormedCommGroup β] (e : α ≃ β)
  body: letI := e.commGroup
...
English:
abbreviation normedSpace
  signature: (𝕜 : Type*) [NormedField 𝕜]
  body: Equiv.seminormedAddCommGroup e
    NormedSpace 𝕜 α :=
