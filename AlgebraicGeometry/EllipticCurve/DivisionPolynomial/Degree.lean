...
/-
**WeierstrassCurve.natDegree_** 是 Mathlib 中的一个引理，位于命名空间 `WeierstrassCurve`。
...
@[simp]
/-
**WeierstrassCurve.coeff_** 是 Mathlib 中的一个引理，位于命名空间 `WeierstrassCurve`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**WeierstrassCurve.leadingCoeff_** 是 Mathlib 中的一个引理，位于命名空间 `WeierstrassCurve`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**WeierstrassCurve.natDegree_pre** 是 Mathlib 中的一个引理，位于命名空间 `WeierstrassCurve`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**WeierstrassCurve.coeff_pre** 是 Mathlib 中的一个引理，位于命名空间 `WeierstrassCurve`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
@[simp]
/-
**WeierstrassCurve.leadingCoeff_pre** 是 Mathlib 中的一个引理，位于命名空间 `WeierstrassCurve`
。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**WeierstrassCurve.pre** 是 Mathlib 中的一个引理，位于命名空间 `WeierstrassCurve`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**WeierstrassCurve.expDegree** 是 Mathlib 中的一个定义，位于命名空间 `WeierstrassCurve`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
private def expDegree (n : ℕ) : ℕ :=
  (n ^ 2 - if Even n then 4 else 1) / 2
/-
**WeierstrassCurve.expDegree_cast** 是 Mathlib 中的一个引理，位于命名空间 `WeierstrassCurve`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
private lemma expDegree_cast {n : ℕ} (hn : n ≠ 0) :
  ...
  · push_cast [expDegree, show (2 * n + 1) ^ 2 = 2 * (2 * n * (n + 1)) + 1 by ring1,
    ...
    ring1
/-
**WeierstrassCurve.expDegree_rec** 是 Mathlib 中的一个引理，位于命名空间 `WeierstrassCurve`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**WeierstrassCurve.expCoeff** 是 Mathlib 中的一个定义，位于命名空间 `WeierstrassCurve`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
private def expCoeff (n : ℕ) : ℤ :=
  if Even n then n / 2 else n
/-
**WeierstrassCurve.expCoeff_cast** 是 Mathlib 中的一个引理，位于命名空间 `WeierstrassCurve`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**WeierstrassCurve.expCoeff_rec** 是 Mathlib 中的一个引理，位于命名空间 `WeierstrassCurve`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**WeierstrassCurve.natDegree_coeff_pre** 是 Mathlib 中的一个引理，位于命名空间 `WeierstrassCur
ve`。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
...
/-
**WeierstrassCurve.natDegree_coeff_** 是 Mathlib 中的一个引理，位于命名空间 `WeierstrassCurve`
。
黑盒内容：本声明未引用其他定理/引理；其成立仅依赖定义、结构与类型类实例。
-/
